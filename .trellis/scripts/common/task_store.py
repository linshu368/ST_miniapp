...
- For complex tasks, add `design.md` for technical design, `implement.md` for execution planning, and `task.md` for the executable task breakdown before `task.py start`.
"""


def _default_task_md_content() -> str:
    """Return the default task breakdown skeleton created with every task."""
...
def cmd_create(args: argparse.Namespace) -> int:
    ...
    print("  - Complex task: add design.md, implement.md, and task.md before task.py start", file=sys.stderr)
    if seeded_jsonl:
        print(
