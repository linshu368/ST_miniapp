...
!(function (t) {
  ...
  ((h = t.cleanData),
    ...
    (t.widget = function (e, i, s) {
      var n,
        ...
        r = {},
        l = e.split('.')[0];
      if ('__proto__' === (e = e.split('.')[1]) || 'constructor' === e)
        return t.error('Invalid widget name: ' + e);
      var h = l + '-' + e;
      return (
        s || ((s = i), (i = t.Widget)),
      ...
      option: function (e, i) {
        ...
        if ('string' == typeof e) {
          if (((a = {}), (e = (s = e.split('.')).shift()), s.length)) {
            for (o = 0, n = a[e] = t.widget.extend({}, this.options[e]); o < s.length - 1; o++)
              ((n[s[o]] = n[s[o]] || {}), (n = n[s[o]]));
            ...
            ((a = s.classesElementLookup[n[r]] || t()),
              e.add
                ? ((function () {
                  ...
                  (a = t(t.uniqueSort(a.get().concat(e.element.get())))))
                : (a = t(a.not(e.element).get())),
    ...
    (function () {
      ...
      ((t.position = {
        ...
        getScrollInfo: function (e) {
          ...
          return {
            width:
              'scroll' === s || ('auto' === s && e.height < e.element[0].scrollHeight)
        ...
        (t.fn.position = function (e) {
          ...
          var l,
            ...
            _,
            v,
            b = 'string' == typeof (e = t.extend({}, e)).of ? t(document).find(e.of) : t(e.of),
          ...
          return (
            (v =
              9 === (l = b[0]).nodeType
                ...
                : d(l)
                  ...
                  : l.preventDefault
                    ? { width: 0, height: 0, offset: { top: l.pageY, left: l.pageX } }
            ...
            1 === x.length && (x[1] = x[0]),
            'right' === e.at[0] ? (_.left += f) : 'center' === e.at[0] && (_.left += f / 2),
            ...
            this.each(function () {
              var n,
                ...
                h = u(this, 'marginLeft'),
                d = u(this, 'marginTop'),
                v = r + h + u(this, 'marginRight') + w.width,
                C = l + d + u(this, 'marginBottom') + w.height,
                D = t.extend({}, _),
                I = c(k.my, a.outerWidth(), a.outerHeight());
              ('right' === e.my[0] ? (D.left -= r) : 'center' === e.my[0] && (D.left -= r / 2),
                'bottom' === e.my[1] ? (D.top -= l) : 'center' === e.my[1] && (D.top -= l / 2),
                (D.left += I[0]),
                (D.top += I[1]),
                (n = { marginLeft: h, marginTop: d }),
                t.each(['left', 'top'], function (i, s) {
                  t.ui.position[x[i]] &&
                    t.ui.position[x[i]][s](D, {
                      targetWidth: f,
                      targetHeight: g,
                      elemWidth: r,
                      elemHeight: l,
                ...
                e.using &&
                  (o = function (t) {
                    ...
                    (f < r && s(n + o) < f && (u.horizontal = 'center'),
                      g < l && s(h + c) < g && (u.vertical = 'middle'),
                      i(s(n), s(o)) > i(s(h), s(c))
          ...
          flip: {
            left: function (t, e) {
              var i,
                ...
                f = -2 * e.offset[0];
              c < 0
                ? ((i = t.left + d + p + f + e.collisionWidth - r - a) < 0 || i < s(c)) &&
                  (t.left += d + p + f)
                : u > 0 &&
                  ((n = t.left - e.collisionPosition.marginLeft + d + p + f - l) > 0 || s(n) < u) &&
                  (t.left += d + p + f);
            },
            top: function (t, e) {
              var i,
                ...
                f = -2 * e.offset[1];
              c < 0
                ? ((n = t.top + d + p + f + e.collisionHeight - r - a) < 0 || n < s(c)) &&
                  (t.top += d + p + f)
                : u > 0 &&
                  ((i = t.top - e.collisionPosition.marginTop + d + p + f - l) > 0 || s(i) < u) &&
                  (t.top += d + p + f);
            },
          },
          flipfit: {
    ...
    t.extend(t.expr.pseudos, {
      data: t.expr.createPseudo(function (e) {
        return function (i) {
          return !!t.data(i, e);
        };
      }),
    ...
    t.fn.extend({
      disableSelection:
        ((c = 'onselectstart' in document.createElement('div') ? 'selectstart' : 'mousedown'),
        function () {
          return this.on(c + '.ui-disableSelection', function (t) {
            t.preventDefault();
          });
        }),
  ...
  var h,
    ...
    b = t.each;
  function y(t) {
    return null == t ? t + '' : 'object' == typeof t ? d[p.call(t)] || 'object' : typeof t;
  }
  function w(t, e, i) {
    var s = v[e.type] || {};
    return null == t
      ? i || !e.def
        ? null
        : e.def
      : ((t = s.floor ? ~~t : parseFloat(t)), s.mod)
        ? (t + s.mod) % s.mod
  ...
  function x(e) {
    ...
    b(g, function (t, n) {
      var o,
        ...
        r = a && n.parse(a),
        l = n.space || 'rgba';
      if (r) return ((o = i[l](r)), (i[_[l].cache] = o[_[l].cache]), (s = i._rgba = o._rgba), !1);
    }),
    s.length)
      ? ('0,0,0,0' === s.join() && t.extend(s, u.transparent), i)
      : u[e];
  }
  function k(t, e, i) {
    return 6 * (i = (i + 1) % 1) < 1
  ...
  (b(_, function (t, e) {
    ...
    (m.fn = t.extend(m.prototype, {
      parse: function (e, i, s, n) {
        if (void 0 === e) return ((this._rgba = [null, null, null, null]), this);
        (e.jquery || e.nodeType) && ((e = t(e).css(i)), (i = void 0));
        var o = this,
          a = y(e),
          r = (this._rgba = []);
        return (void 0 !== i && ((e = [e, i, s, n]), (a = 'array')), 'string' === a)
          ? this.parse(x(e) || u._default)
          : 'array' === a
            ? (b(_.rgba.props, function (t, i) {
                r[i.idx] = w(e[i.idx], i);
              }),
              this)
            : 'object' === a
              ? (e instanceof m
                  ? b(_, function (t, i) {
                      e[i.cache] && (o[i.cache] = e[i.cache].slice());
                    })
                  : b(_, function (i, s) {
                      var n = s.cache;
                      (b(s.props, function (t, i) {
                        if (!o[n] && s.to) {
                        ...
                        o[n] &&
                          0 > t.inArray(null, o[n].slice(0, 3)) &&
                          (null == o[n][3] && (o[n][3] = 1), s.from && (o._rgba = s.from(o[n]))));
                    }),
                this)
              : void 0;
      },
      ...
      transition: function (t, e) {
        var i = m(t),
          s = i._space(),
          n = _[s],
          o = 0 === this.alpha() ? m('transparent') : this,
          a = o[n.cache] || n.to(o._rgba),
          r = a.slice();
        return (
          (i = i[n.cache]),
          b(n.props, function (t, s) {
            var n = s.idx,
              o = a[n],
              l = i[n],
              h = v[s.type] || {};
            null !== l &&
              (null === o
                ? (r[n] = l)
                : (h.mod && (l - o > h.mod / 2 ? (o += h.mod) : o - l > h.mod / 2 && (o -= h.mod)),
                  (r[n] = w((l - o) * e + o, s))));
          }),
          this[s](r)
        );
      ...
      toHslaString: function () {
        var e = 'hsla(',
          i = t.map(this.hsla(), function (t, e) {
            return (null == t && (t = +(e > 2)), e && e < 3 && (t = Math.round(100 * t) + '%'), t);
          });
    ...
    (_.hsla.from = function (t) {
      ...
      var e = t[0] / 360,
        ...
        a = 2 * s - o;
      return [
        Math.round(255 * k(a, o, e + 1 / 3)),
        Math.round(255 * k(a, o, e)),
        Math.round(255 * k(a, o, e - 1 / 3)),
        n,
      ];
    }),
    b(_, function (t, e) {
      ...
      ((m.fn[t] = function (t) {
        ...
        return (b(i, function (t, e) {
          ...
          (null == i && (i = l[e.idx]), (l[e.idx] = w(i, e)));
        }),
        o)
          ? (((e = m(o(l)))[s] = l), e)
          : m(l);
          ...
          !m.fn[e] &&
            (m.fn[e] = function (s) {
              var n,
                ...
                r,
                l = y(s);
              return ((o = (n = this[(r = 'alpha' === e ? (this._hsla ? 'hsla' : 'rgba') : t)]())[
                i.idx
              ]),
              'undefined' === l)
                ? o
                : ('function' === l && (l = y((s = s.call(this, o)))), null == s && i.empty)
                  ? this
                  : ('string' === l &&
                      (a = f.exec(s)) &&
                      (s = o + parseFloat(a[2]) * ('+' === a[1] ? 1 : -1)),
                    (n[i.idx] = s),
                    this[r](n));
            });
        }));
    ...
    (m.hook = function (e) {
      b(e.split(' '), function (e, i) {
        ((t.cssHooks[i] = {
          set: function (t, e) {
            var s;
            ('transparent' !== e &&
              ('string' !== y(e) || (s = x(e))) &&
              (e = (e = m(s || e)).toRgbaString()),
              (t.style[i] = e));
          },
        }),
          (t.fx.step[i] = function (e) {
            (e.colorInit || ((e.start = m(e.elem, i)), (e.end = m(e.end)), (e.colorInit = !0)),
    ...
    (t.cssHooks.borderColor = {
      expand: function (t) {
        var e = {};
        return (
          b(['Top', 'Right', 'Bottom', 'Left'], function (i, s) {
            e['border' + s + 'Color'] = t;
          }),
          e
        );
          ...
          removeClass:
            ...
            function (e, s, n, o) {
              return arguments.length > 1
                ? t.effects.animateClass.call(this, { remove: e }, s, n, o)
          ...
          toggleClass:
            ...
            function (e, i, n, o, a) {
              return 'boolean' != typeof i && void 0 !== i
                ? t.effects.animateClass.call(this, { toggle: e }, i, n, o)
                : n
                  ? t.effects.animateClass.call(this, i ? { add: e } : { remove: e }, n, o, a)
    ...
    (function () {
      ...
      function o(e, i, s, n) {
        return (
          ...
          (e = { effect: e }),
          null == i && (i = {}),
          'function' == typeof i && ((n = i), (s = null), (i = {})),
      ...
      (t.expr &&
        ...
        (t.expr.pseudos.animated =
          ((e = t.expr.pseudos.animated),
          function (i) {
            return !!t(i).data(I) || e(i);
          })),
        !0 === t.uiBackCompat &&
          t.extend(t.effects, {
            save: function (t, e) {
                ...
                !0 !== t.uiBackCompat || s
                  ? 'none' === e.mode
                    ...
                    : i.call(o[0], e, function () {
                        (o.removeData(I), t.effects.cleanUp(o), 'hide' === e.mode && o.hide(), a());
                      })
  ...
  (t.effects.define('blind', 'hide', function (e, i) {
    ...
    t.effects.define('bounce', function (e, i) {
      ...
      for (
        ...
        (((s = {})[m] = (_ ? '-=' : '+=') + u),
          ...
          (u = l ? 2 * u : u / 2));
      (l && (((s = { opacity: 0 })[m] = (_ ? '-=' : '+=') + u), a.animate(s, f, g)),
        a.queue(i),
    ...
    t.effects.define('drop', 'hide', function (e, i) {
      ...
      (t.effects.createPlaceholder(n),
        ...
        (h[r] = l + s),
        'show' === o && (n.css(h), (h[r] = ('+=' === l ? '-=' : '+=') + s), (h.opacity = 1)),
    ...
    t.effects.define('explode', 'hide', function (e, i) {
      ...
      function m() {
        (g.push(this),
          g.length === h * h && (c.css({ visibility: 'visible' }), t(g).remove(), i()));
      }
      for (s = 0; s < h; s++)
        for (n = 0, a = d.top + s * f, l = s - (h - 1) / 2; n < h; n++)
          ((o = d.left + n * p),
            (r = n - (h - 1) / 2),
            c
              .clone()
              .appendTo('body')
              .wrap('<div></div>')
              .css({ position: 'absolute', visibility: 'visible', left: -n * p, top: -s * f })
              .parent()
              ...
              .animate(
                { left: o + (u ? 0 : r * p), top: a + (u ? 0 : l * f), opacity: +!!u },
                e.duration || 500,
                e.easing,
                m
              ));
    ...
    t.effects.define('fold', 'hide', function (e, i) {
      var s = t(this),
        ...
        p = [c[r[0]], c[r[1]]],
        f = s.queue().length;
      (a && (o = (parseInt(a[1], 10) / 100) * p[+('hide' !== n)]),
        (u.clip[r[0]] = o),
        (d.clip[r[0]] = o),
        (d.clip[r[1]] = 0),
        'show' === n && (s.cssClip(d.clip), h && h.css(t.effects.clipToBox(d)), (d.clip = c)),
        s
          .queue(function (i) {
            (h &&
              h
    ...
    t.effects.define('scale', function (e, i) {
      var s = t(this),
        n = e.mode,
        o = parseInt(e.percent, 10) || (0 === parseInt(e.percent, 10) ? 0 : 100 * ('effect' === n)),
        a = t.extend(
          !0,
          {
    ...
    t.effects.define('pulsate', 'show', function (e, i) {
      var s = t(this),
        n = e.mode,
        o = 'show' === n,
        a = 2 * (e.times || 5) + +!!(o || 'hide' === n),
        r = e.duration / a,
        l = 0,
        h = 1,
        c = s.queue().length;
      for ((o || !s.is(':visible')) && (s.css('opacity', 0).show(), (l = 1)); h < a; h++)
        (s.animate({ opacity: l }, r, e.easing), (l = 1 - l));
      (s.animate({ opacity: l }, r, e.easing), s.queue(i), t.effects.unshift(s, c, a + 1));
    }),
    ...
    t.effects.define('slide', 'show', function (e, i) {
      ...
      (t.effects.createPlaceholder(o),
        ...
        'show' === r && (o.cssClip(u.clip), o.css(h, u[h]), (u.clip = s), (u[h] = n)),
    ...
    (t.ui.focusable = function (e, i) {
      ...
      return 'area' === l
        ...
        : (/^(input|select|textarea|button|object)$/.test(l)
            ? (a = !e.disabled) && (r = t(e).closest('fieldset')[0]) && (a = !r.disabled)
            : (a = ('a' === l && e.href) || i),
          a && t(e).is(':visible') && 'visible' === t(e).css('visibility'));
    }),
    t.extend(t.expr.pseudos, {
    ...
    (t.ui.formResetMixin = {
      ...
      _bindFormResetHandler: function () {
        if (((this.form = t(this.element.prop('form'))), this.form.length)) {
    ...
    t.widget('ui.accordion', {
      ...
      _setOption: function (t, e) {
        ...
        ('event' === t &&
          (this.options.event && this._off(this.headers, this.options.event), this._setupEvents(e)),
          this._super(t, e),
    ...
    t.widget('ui.menu', {
        ...
        ((this.activeMenu = this.element),
          ...
          this._on({
            ...
            'click .ui-menu-item': function (e) {
              var i = t(e.target),
                s = t(this.document[0].activeElement);
              !this.mouseHandled &&
        ...
        switch (e.keyCode) {
          ...
          default:
            ((a = !1),
              ...
              (i =
                o && -1 !== i.index(this.active.next()) ? this.active.nextAll('.ui-menu-item') : i)
                .length || ((n = String.fromCharCode(e.keyCode)), (i = this._filterMenuItems(n))),
              i.length
                ? (this.focus(e, i),
      ...
      _move: function (t, e, i) {
        ...
        (this.active &&
          ...
          (s && s.length && this.active) || (s = this._menuItems(this.activeMenu)[e]()),
          this.focus(i, s));
      },
      nextPage: function (e) {
        var i, s, n;
          ...
          this._on(this.menu.element, {
            ...
            menuselect: function (t, e) {
              ...
              (this.element[0] !== this.document[0].activeElement &&
                (this.element.trigger('focus'), (this.previous = s)),
  ...
  (t.widget('ui.controlgroup', {
    ...
    _resolveClassesValues: function (e, i) {
      ...
      return (
        t.each(e, function (t) {
          ...
          ((n = String.prototype.trim.call(n.replace(T, ''))),
      ...
      t.ui.formResetMixin,
      {
        ...
        _getRadioGroup: function () {
          var e,
            ...
            s = "input[name='" + CSS.escape(i) + "']";
          return i
            ? (this.form.length
                ? t(this.form[0].elements).filter(s)
                : t(s).filter(function () {
                    return 0 === t(t(this).prop('form')).length;
                  })
              ).not(this.element)
            : t([]);
        },
          ...
          ('showLabel' === t && (this.options.text = e),
            ...
            'icons' === t &&
              (e.primary
                ...
                : e.secondary &&
                  (this._super('icon', e.secondary), this._super('iconPosition', 'end'))),
            this._superApply(arguments));
        },
      }),
      (t.fn.button =
              ...
              ? this.length || 'instance' !== e
                ? this.each(function () {
                    var i,
                      ...
                      a = t.data(
                        this,
                        'ui-' + ('checkbox' !== s && 'radio' !== s ? 'button' : 'checkboxradio')
                      );
                    return 'instance' === e
                      ? ((o = a), !1)
                      : a
                        ? 'function' != typeof a[e] || '_' === e.charAt(0)
                          ? t.error("no such method '" + e + "' for button widget instance")
                          : (i = a[e].apply(a, n)) !== a && void 0 !== i
              ...
              : (n.length && (e = t.widget.extend.apply(null, [e].concat(n))),
                this.each(function () {
                  var i = t(this).attr('type'),
                    n = 'checkbox' !== i && 'radio' !== i ? 'button' : 'checkboxradio',
                    o = t.data(this, 'ui-' + n);
                  if (o) (o.option(e || {}), o._init && o._init());
                    ...
                    t(this).checkboxradio(t.extend({ icon: !1 }, e));
                  }
                })),
            o
          );
    ...
    t.ui.button,
    t.extend(t.ui, { datepicker: { version: '1.14.2' } }),
    t.extend(P.prototype, {
      ...
      _attachments: function (e, i) {
        ...
        (i.append && i.append.remove(),
          a &&
            ((i.append = t('<span>').addClass(this._appendClass).text(a)),
          ...
          ('button' === s || 'both' === s) &&
            ...
            this._get(i, 'buttonImageOnly')
              ...
              : ((i.trigger = t("<button type='button'>").addClass(this._triggerClass)),
                o
                  ? i.trigger.html(t('<img>').attr({ src: o, alt: n, title: n }))
                  : i.trigger.text(n)),
      ...
      _autoSize: function (t) {
        if (this._get(t, 'autoSize') && !t.inline) {
          ...
          (a.match(/[DM]/) &&
            ((e = function (t) {
              for (n = 0, i = 0, s = 0; n < t.length; n++)
                t[n].length > i && ((i = t[n].length), (s = n));
              return s;
            }),
            o.setMonth(e(this._get(t, a.match(/MM/) ? 'monthNames' : 'monthNamesShort'))),
            o.setDate(
              e(this._get(t, a.match(/DD/) ? 'dayNames' : 'dayNamesShort')) + 20 - o.getDay()
            )),
      ...
      _disableDatepicker: function (e) {
        ...
        n.hasClass(this.markerClassName) &&
          ('input' === (i = e.nodeName.toLowerCase())
            ...
            : ('div' === i || 'span' === i) &&
              ((s = n.children('.' + this._inlineClass)).children().addClass('ui-state-disabled'),
            ...
            case 13:
              return (
                (n = t(
                  ...
                  o.dpDiv
                ))[0] && t.datepicker._selectDay(e.target, o.selectedMonth, o.selectedYear, n[0]),
                    ...
                    while (t.length && t[0] !== document) {
                      if (
                        ('absolute' === (e = t.css('position')) ||
                          'relative' === e ||
                          'fixed' === e) &&
                        !isNaN((i = parseInt(t.css('zIndex'), 10))) &&
                        0 !== i
                      )
                        return i;
                      t = t.parent();
      ...
      _findPos: function (e) {
        var i,
          s = this._getInst(e),
          n = this._get(s, 'isRTL');
        while (e && ('hidden' === e.type || 1 !== e.nodeType || t.expr.pseudos.hidden(e)))
      ...
      _hideDatepicker: function (e) {
        ...
        a &&
          ...
          (o = this._get(a, 'onClose')) &&
            o.apply(a.input ? a.input[0] : null, [a.input ? a.input.val() : '', a]),
      ...
      _adjustDate: function (e, i, s) {
        ...
        !this._isDisabledDatepicker(n[0]) &&
          (this._adjustInstDate(o, i, s), this._updateDatepicker(o));
      },
      _gotoToday: function (e) {
        ...
        (this._get(n, 'gotoCurrent') && n.currentDay
          ...
          : ((n.selectedDay = (i = new Date()).getDate()),
      ...
      _selectDay: function (e, i, s, n) {
        var o,
          a = t(e);
        !(t(n).hasClass(this._unselectableClass) || this._isDisabledDatepicker(a[0])) &&
          (((o = this._getInst(a[0])).selectedDay = o.currentDay =
            parseInt(t('a', n).attr('data-date'))),
      ...
      parseDate: function (e, i, s) {
        ...
        if (
          (-1 === g
            ...
            : g < 100 &&
              (g +=
                new Date().getFullYear() - (new Date().getFullYear() % 100) + (g <= c ? 0 : -100)),
          v > -1)
        ) {
          ((m = 1), (_ = v));
          do {
        ...
        if (
          (r = this._daylightSavingAdjust(new Date(g, m - 1, _))).getFullYear() !== g ||
          r.getMonth() + 1 !== m ||
          r.getDate() !== _
        )
          throw 'Invalid date';
            ...
            if (d) "'" !== t.charAt(s) || l("'") ? (u += t.charAt(s)) : (d = !1);
              ...
              switch (t.charAt(s)) {
                ...
                case 'y':
                  u += l('y')
                    ? e.getFullYear()
                    : (e.getFullYear() % 100 < 10 ? '0' : '') + (e.getFullYear() % 100);
                  break;
                case '@':
                  u += e.getTime();
                  break;
            ...
            null == i || '' === i
              ...
              : 'string' == typeof i
                ...
                : 'number' == typeof i
                  ? isNaN(i)
                    ? s
                    : ((n = new Date()).setDate(n.getDate() + i), n)
                  : new Date(i.getTime());
        return (
          (o = o && 'Invalid Date' === o.toString() ? s : o) &&
      ...
      _generateHTML: function (e) {
        ...
        if ((tt < 0 && ((tt += 12), te--), Z)) {
          ((i = this._daylightSavingAdjust(
            new Date(Z.getFullYear(), Z.getMonth() - V[0] * V[1] + 1, Z.getDate())
          )),
            (i = J && i < J ? J : i));
          while (this._daylightSavingAdjust(new Date(te, tt, 1)) > i) --tt < 0 && ((tt = 11), te--);
        }
        for (
          e.drawMonth = tt,
            e.drawYear = te,
            ...
            s = U
              ? this.formatDate(
                  s,
                  this._daylightSavingAdjust(new Date(te, tt - $, 1)),
                  this._getFormatConfig(e)
                )
              : s,
            n = this._canAdjustMonth(e, -1, te, tt)
              ? t('<a>')
                  .attr({
                  ...
                  .append(
                    t('<span>')
                      .addClass('ui-icon ui-icon-circle-triangle-' + (j ? 'e' : 'w'))
                      .text(s)
                  )[0].outerHTML
              : K
                ? ''
                : t('<a>')
                    .attr({ class: 'ui-datepicker-prev ui-corner-all ui-state-disabled', title: s })
                    .append(
                      t('<span>')
                        .addClass('ui-icon ui-icon-circle-triangle-' + (j ? 'e' : 'w'))
                        .text(s)
            ...
            o = U
              ...
              : o,
            a = this._canAdjustMonth(e, 1, te, tt)
              ? t('<a>')
                  .attr({
                  ...
                  .append(
                    t('<span>')
                      .addClass('ui-icon ui-icon-circle-triangle-' + (j ? 'w' : 'e'))
                      .text(o)
                  )[0].outerHTML
              : K
                ? ''
                : t('<a>')
                    ...
                    .append(
                      t('<span>')
                        .attr('class', 'ui-icon ui-icon-circle-triangle-' + (j ? 'w' : 'e'))
                        .text(o)
                    )[0].outerHTML,
            r = this._get(e, 'currentText'),
            l = this._get(e, 'gotoCurrent') && e.currentDay ? Q : B,
            r = U ? this.formatDate(r, l, this._getFormatConfig(e)) : r,
            h = '',
            e.inline ||
              (h = t('<button>')
                .attr({
            ...
            c = '',
            q &&
              (c = t("<div class='ui-datepicker-buttonpane ui-widget-content'>")
                .append(j ? h : '')
                .append(
                  this._isInRange(e, l)
                    ? t('<button>')
          ...
          for (D = 0, C = '', this.maxRows = 4; D < V[1]; D++) {
            if (
              ((I = this._daylightSavingAdjust(new Date(te, tt, e.selectedDay))),
              (T = ' ui-corner-all'),
              (P = ''),
              G)
            ) {
              if (((P += "<div class='ui-datepicker-group"), V[1] > 1))
                switch (D) {
                  case 0:
            ...
            for (
              P +=
                ...
                T +
                "'>" +
                (/all|left/.test(T) && 0 === k ? (j ? a : n) : '') +
                (/all|right/.test(T) && 0 === k ? (j ? n : a) : '') +
                this._generateMonthYearHeader(e, tt, te, J, Z, k > 0 || D > 0, g, m) +
            ...
            for (
              P += M + '</tr></thead><tbody>',
                H = this._getDaysInMonth(te, tt),
                te === e.selectedYear &&
                  tt === e.selectedMonth &&
                  (e.selectedDay = Math.min(e.selectedDay, H)),
                O = Math.ceil(((z = (this._getFirstDayOfMonth(te, tt) - u + 7) % 7) + H) / 7),
                A = G && this.maxRows > O ? this.maxRows : O,
                this.maxRows = A,
                E = this._daylightSavingAdjust(new Date(te, tt, 1 - z)),
                N = 0;
              N < A;
              N++
            ) {
              for (
                ...
                ((F = _ ? _.apply(e.input ? e.input[0] : null, [E]) : [!0, '']),
                  (R = ((L = E.getMonth() !== tt) && !b) || !F[0] || (J && E < J) || (Z && E > Z)),
                  (W +=
                    "<td class='" +
                    ((x + u + 6) % 7 >= 5 ? ' ui-datepicker-week-end' : '') +
                    (L ? ' ui-datepicker-other-month' : '') +
                    ((E.getTime() === I.getTime() && tt === e.selectedMonth && e._keyEvent) ||
                    (y.getTime() === E.getTime() && y.getTime() === I.getTime())
                      ? ' ' + this._dayOverClass
                      : '') +
                    ...
                    (L && !v
                      ...
                      : ' ' +
                        F[1] +
                        (E.getTime() === Q.getTime() ? ' ' + this._currentClass : '') +
                        (E.getTime() === B.getTime() ? ' ui-datepicker-today' : '')) +
                    "'" +
                    ((!L || v) && F[2] ? " title='" + F[2].replace(/'/g, '&#39;') + "'" : '') +
                    (R
                      ? ''
                    ...
                    (L && !v
                      ...
                      : R
                        ...
                        : "<a class='ui-state-default" +
                          (E.getTime() === B.getTime() ? ' ui-state-highlight' : '') +
                          (E.getTime() === Q.getTime() ? ' ui-state-active' : '') +
                          (L ? ' ui-priority-secondary' : '') +
                          "' href='#' aria-current='" +
                          (E.getTime() === Q.getTime() ? 'true' : 'false') +
                          "' data-date='" +
                          E.getDate() +
                          "'>" +
                          E.getDate() +
  ...
  (t(document).on('mouseup', function () {
        ...
        if (!z) {
          ...
          return (
            ...
            this._mouseDistanceMet(e) &&
              ...
              ((this._mouseStarted = !1 !== this._mouseStart(e)), !this._mouseStarted))
              ? e.preventDefault()
    ...
    t.widget('ui.draggable', t.ui.mouse, {
      ...
      _blurActiveElement: function (e) {
        ...
        !t(e.target).closest(i).length && t(i).trigger('blur');
      },
      ...
      _mouseStop: function (e) {
        ...
        return (
          ...
          ('function' == typeof this.options.revert && this.options.revert.call(this.element, s))
      ...
      _generatePosition: function (t, e) {
        ...
        return (
          ...
          e &&
            ...
            a.grid &&
              ((n = a.grid[1]
                ? this.originalPageY + Math.round((h - this.originalPageY) / a.grid[1]) * a.grid[1]
                : this.originalPageY),
              (h = i
    ...
    t.ui.plugin.add('draggable', 'snap', {
      start: function (e, i, s) {
        var n = s.options;
        ((s.snapElements = []),
          t(n.snap.constructor !== String ? n.snap.items || ':data(ui-draggable)' : n.snap).each(
            function () {
              var e = t(this),
                i = e.offset();
              this !== s.element[0] &&
    ...
    t.widget('ui.resizable', t.ui.mouse, {
      ...
      _hasScroll: function (e, i) {
        ...
        if ('scroll' === o || e[(s = i && 'left' === i ? 'scrollLeft' : 'scrollTop')] > 0)
          return !0;
        try {
          ((e[s] = 1), (n = e[s] > 0), (e[s] = 0));
        } catch (t) {}
          ...
          i.autoHide &&
            t(this.element)
              ...
              .on('mouseleave', function () {
                !i.disabled &&
                  (s.resizing || (s._addClass('ui-resizable-autohide'), s._handles.hide()));
              }),
          this._mouseInit());
      },
      _destroy: function () {
      ...
      _setupHandles: function () {
        ...
        if (
          ...
          for (
            ...
            ((n = 'ui-resizable-' + (e = String.prototype.trim.call(s[i]))),
              (o = t('<div>')),
              this._addClass(o, 'ui-resizable-handle ' + n),
              o.css({ zIndex: a.zIndex }),
              (this.handles[e] = '.ui-resizable-' + e),
              this.element.children(this.handles[e]).length ||
                (this.element.append(o), (this._addedHandles = this._addedHandles.add(o))));
      ...
      _mouseStart: function (e) {
        ...
        return (
          ...
          a.containment &&
            ((i += t(a.containment).scrollLeft() || 0), (s += t(a.containment).scrollTop() || 0)),
          (this.offset = this.helper.offset()),
          (this.position = { left: i, top: s }),
          this._helper || (o = this._calculateAdjustedElementDimensions(r)),
      ...
      _applyChanges: function () {
        ...
        return (
          ...
          this.size.height !== this.prevSize.height &&
            ((t.height = this.size.height + 'px'), this.helper.height(t.height)),
          t
        );
      },
      ...
      _updateRatio: function (t) {
        ...
        return (
          ...
          'nw' === s &&
            ((t.top = e.top + (i.height - t.height)), (t.left = e.left + (i.width - t.width))),
          t
        );
      },
      ...
      _calculateAdjustedElementDimensions: function (t) {
        ...
        return 'content-box' === t.css('box-sizing') &&
          (this._hasScroll(n) || this._hasScroll(n, 'left'))
          ? ((e = parseFloat(n.style.width)),
            (i = parseFloat(n.style.height)),
            (s = this._getPaddingPlusBorderDimensions(t)),
            (e = isNaN(e) ? this._getElementTheoreticalSize(t, s, 'width') : e),
            {
              height: (i = isNaN(i) ? this._getElementTheoreticalSize(t, s, 'height') : i),
              width: e,
            })
          : { height: parseFloat(t.css('height')), width: parseFloat(t.css('width')) };
      },
      _getElementTheoreticalSize: function (t, e, i) {
        return (
          Math.max(
            0,
            Math.ceil(t.get(0)['offset' + i[0].toUpperCase() + i.slice(1)] - e[i] - 0.5)
          ) || 0
        );
      },
    ...
    t.ui.plugin.add('resizable', 'animate', {
      stop: function (e) {
        var i = t(this).resizable('instance'),
          ...
          h =
            parseFloat(i.element.css('left')) + (i.position.left - i.originalPosition.left) || null,
      ...
      resize: function (e) {
        ...
        (d[0] !== document && /static/.test(d.css('position')) && (u = l),
          h.left < (a._helper ? l.left : 0) &&
            ((a.size.width =
              a.size.width + (a._helper ? a.position.left - l.left : a.position.left - u.left)),
            c && ((a.size.height = a.size.width / a.aspectRatio), (p = !1)),
            (a.position.left = r.helper ? l.left : 0)),
          h.top < (a._helper ? l.top : 0) &&
            ((a.size.height =
              a.size.height + (a._helper ? a.position.top - l.top : a.position.top)),
          ...
          (i = Math.abs(
            a.sizeDiff.width + (a._helper ? a.offset.left - u.left : a.offset.left - l.left)
          )),
          (s = Math.abs(
            a.sizeDiff.height + (a._helper ? a.offset.top - u.top : a.offset.top - l.top)
          )),
    ...
    t.ui.plugin.add('resizable', 'alsoResize', {
      start: function () {
        var e = t(this).resizable('instance');
        t(e.options.alsoResize).each(function () {
          var i = t(this),
            s = e._calculateAdjustedElementDimensions(i);
    ...
    t.widget('ui.dialog', {
      ...
      close: function (e) {
        ...
        this._isOpen &&
          ...
          this.opener.filter(':focusable').trigger('focus').length ||
            t(this.document[0].activeElement).trigger('blur'),
      ...
      _createWrapper: function () {
        ((this.uiDialog = t('<div>')
          .hide()
          .attr({ tabIndex: -1, role: 'dialog', 'aria-modal': this.options.modal ? 'true' : null })
          .appendTo(this._appendTo())),
      ...
      _setOption: function (e, i) {
        ...
        'disabled' !== e &&
          ...
          'draggable' === e &&
            ((s = o.is(':data(ui-draggable)')) && !i && o.draggable('destroy'),
            !s && i && this._makeDraggable()),
          'position' === e && this._position(),
          'resizable' !== e ||
            ((n = o.is(':data(ui-resizable)')) && !i && o.resizable('destroy'),
            n && 'string' == typeof i && o.resizable('option', 'handles', i),
            n || !1 === i || this._makeResizable()),
          'title' === e && this._title(this.uiDialogTitlebar.find('.ui-dialog-title')),
          'modal' === e && o.attr('aria-modal', i ? 'true' : null));
      },
      _size: function () {
        var t,
          e,
              ...
              this.document.on(
                ...
                function (t) {
                  if (!e) {
                    ...
                    i._allowInteraction(t) || (t.preventDefault(), i._focusTabbable());
                  }
                }.bind(this)
              ),
        ...
        ((this.isover = !1),
          ...
          (this.proportions = function () {
            if (!arguments.length)
              return (
                t ||
                (t = { width: this.element[0].offsetWidth, height: this.element[0].offsetHeight })
              );
            t = arguments[0];
          }),
    ...
    (t.ui.intersect = function (t, e, i, s) {
      if (!e.offset) return !1;
      var n,
        o,
        a,
        r,
        l = (t.positionAbs || t.position.absolute).left + t.margins.left,
        h = (t.positionAbs || t.position.absolute).top + t.margins.top,
        c = l + t.helperProportions.width,
        u = h + t.helperProportions.height,
        d = e.offset.left,
        p = e.offset.top,
        f = d + e.proportions().width,
        g = p + e.proportions().height;
      switch (i) {
        case 'fit':
          return d <= l && c <= f && p <= h && u <= g;
        case 'intersect':
          return (
            d < l + t.helperProportions.width / 2 &&
            c - t.helperProportions.width / 2 < f &&
            p < h + t.helperProportions.height / 2 &&
            u - t.helperProportions.height / 2 < g
          );
        case 'pointer':
          return (
            (n = s.pageY),
            (o = e.proportions().height),
            n >= p && n < p + o && ((a = s.pageX), (r = e.proportions().width), a >= d && a < d + r)
          );
        case 'touch':
          return (
            ((h >= p && h <= g) || (u >= p && u <= g) || (h < p && u > g)) &&
            ((l >= d && l <= f) || (c >= d && c <= f) || (l < d && c > f))
          );
        default:
          return !1;
      }
          ...
          return (
            ...
            this.selectees.each(function () {
              ...
              i &&
                ...
                'touch' === n.tolerance
                  ? (h = !(c.left > r || c.right < o || c.top > l || c.bottom < a))
                  : 'fit' === n.tolerance &&
                    (h = c.left > o && c.right < r && c.top > a && c.bottom < l),
                h
                  ? (i.selected && (s._removeClass(i.$element, 'ui-selected'), (i.selected = !1)),
                    i.unselecting &&
                      (s._removeClass(i.$element, 'ui-unselecting'), (i.unselecting = !1)),
                    i.selecting ||
                  ...
                  : (i.selecting &&
                      ((e.metaKey || e.ctrlKey) && i.startselected
                        ...
                        : (s._removeClass(i.$element, 'ui-selecting'),
                          (i.selecting = !1),
                          i.startselected &&
                            (s._addClass(i.$element, 'ui-unselecting'), (i.unselecting = !0)),
      ...
      t.ui.formResetMixin,
      {
          ...
          t.each(i, function (i, o) {
            ...
            (o.optgroup !== n &&
              ...
              s._addClass(
                ...
                'ui-menu-divider' +
                  (o.element.parent('optgroup').prop('disabled') ? ' ui-state-disabled' : '')
              ),
              a.appendTo(e),
              (n = o.optgroup)),
        ...
        _renderItem: function (e, i) {
          ...
          return (
            ...
            i.hidden ? s.prop('hidden', !0) : this._setText(n, i.label),
          ...
          (this.isOpen
            ...
            (s =
              'first' === t || 'last' === t
                ...
                : i[t + 'All'](n).eq(0)).length && this.menuInstance.focus(e, s));
        },
        ...
        _documentClick: {
          mousedown: function (e) {
            this.isOpen &&
              (t(e.target).closest('.ui-selectmenu-menu, #' + CSS.escape(this.ids.button)).length ||
                this.close(e));
          },
        },
        _buttonEvents: {
    ...
    t.widget('ui.slider', t.ui.mouse, {
      ...
      _uiHash: function (t, e, i) {
        ...
        return (
          this._hasMultipleValues() &&
            ((s.value = void 0 !== e ? e : this.values(t)), (s.values = i || this.values())),
          s
        );
      },
      ...
      values: function (t, e) {
        ...
        for (n = 0, i = this.options.values, s = arguments[0]; n < i.length; n += 1)
      ...
      _values: function (t) {
        ...
        for (s = 0, i = this.options.values.slice(); s < i.length; s += 1)
      ...
      _precision: function () {
        ...
        return (
          null !== this.options.min && (t = Math.max(t, this._precisionOf(this.options.min))),
          t
        );
      },
      ...
      _refreshValue: function () {
        ...
        this._hasMultipleValues()
              ...
              ((i = ((l.values(s) - l._valueMin()) / (l._valueMax() - l._valueMin())) * 100),
                ...
                !0 === l.options.range &&
                  ('horizontal' === l.orientation
                    ? (0 === s &&
                        l.range.stop(1, 1)[h ? 'animate' : 'css']({ left: i + '%' }, r.animate),
                      1 === s &&
                    ...
                    : (0 === s &&
                        l.range.stop(1, 1)[h ? 'animate' : 'css']({ bottom: i + '%' }, r.animate),
                      1 === s &&
                        l.range[h ? 'animate' : 'css'](
                          { height: i - e + '%' },
                          { queue: !1, duration: r.animate }
          ...
          : ((s = this.value()),
            (n = this._valueMin()),
            (i = (o = this._valueMax()) !== n ? ((s - n) / (o - n)) * 100 : 0),
            (c['horizontal' === this.orientation ? 'left' : 'bottom'] = i + '%'),
            this.handle.stop(1, 1)[h ? 'animate' : 'css'](c, r.animate),
            'min' === a &&
              'horizontal' === this.orientation &&
              this.range.stop(1, 1)[h ? 'animate' : 'css']({ width: i + '%' }, r.animate),
            'max' === a &&
              'horizontal' === this.orientation &&
              this.range.stop(1, 1)[h ? 'animate' : 'css']({ width: 100 - i + '%' }, r.animate),
            'min' === a &&
              'vertical' === this.orientation &&
              this.range.stop(1, 1)[h ? 'animate' : 'css']({ height: i + '%' }, r.animate),
            'max' === a &&
              'vertical' === this.orientation &&
              this.range.stop(1, 1)[h ? 'animate' : 'css']({ height: 100 - i + '%' }, r.animate));
      },
      _handleEvents: {
        keydown: function (e) {
          var i,
    ...
    t.widget('ui.sortable', t.ui.mouse, {
      ...
      _mouseStart: function (e, i, s) {
        ...
        if (
          ...
          this.refreshPositions(),
          (this.appendTo = t('parent' !== a.appendTo ? a.appendTo : this.currentItem.parent())),
      ...
      _scroll: function (t) {
        ...
        return (
          this.scrollParent[0] !== this.document[0] && 'HTML' !== this.scrollParent[0].tagName
            ? (this.overflowOffset.top + this.scrollParent[0].offsetHeight - t.pageY <
              e.scrollSensitivity
        ...
        for (
          ...
          if (
            ...
            (o = this._intersectsWithPointer(s)) &&
              ...
              ('semi-dynamic' !== this.options.type || !t.contains(this.element[0], n)))
          ) {
            if (
      ...
      _refreshItems: function (e) {
        ...
        for (i = u.length - 1; i >= 0; i--)
          for (s = 0, a = u[i][1], h = (r = u[i][0]).length; s < h; s++)
            ((l = t(r[s])).data(this.widgetName + '-item', a),
              c.push({ item: l, instance: a, width: 0, height: 0, left: 0, top: 0 }));
      },
      ...
      _createPlaceholder: function (e) {
        ...
        ((n.placeholder && n.placeholder.constructor !== String) ||
          ((i = n.placeholder),
          (s = e.currentItem[0].nodeName.toLowerCase()),
          (n.placeholder = {
            element: function () {
            ...
            update: function (t, o) {
              (!i || n.forcePlaceholderSize) &&
                ((!o.height() || (n.forcePlaceholderSize && ('tbody' === s || 'tr' === s))) &&
                  o.height(
          ...
          s =
            'function' == typeof i.helper
              ...
              : 'clone' === i.helper
                ...
                : this.currentItem;
        return (
          s.parents('body').length || this.appendTo[0].appendChild(s[0]),
      ...
      _getParentOffset: function () {
        ...
        return (
          'absolute' === this.cssPosition &&
            ...
            t.contains(this.scrollParent[0], this.offsetParent[0]) &&
            ((e.left += this.scrollParent.scrollLeft()), (e.top += this.scrollParent.scrollTop())),
          this.offsetParent[0] === this.document[0].body && (e = { top: 0, left: 0 }),
          {
            top: e.top + (parseInt(this.offsetParent.css('borderTopWidth'), 10) || 0),
            left: e.left + (parseInt(this.offsetParent.css('borderLeftWidth'), 10) || 0),
          }
          ...
          this.originalPosition &&
            ...
            n.grid &&
              ...
              (a = this.containment
                ...
                : i),
              (s =
                this.originalPageX + Math.round((o - this.originalPageX) / n.grid[0]) * n.grid[0]),
              (o = this.containment
    ...
    t.widget('ui.spinner', {
      ...
      _events: {
        ...
        wheel: function (t) {
          var e = this.document[0].activeElement,
            i = this.element[0] === e,
            s = t.deltaY || (t.originalEvent && t.originalEvent.deltaY);
          if (i && s) {
            if (!this.spinning && !this._start(t)) return !1;
            (this._spin((s > 0 ? -1 : 1) * this.options.step, t),
        ...
        mousewheel: function (e, i) {
          if (e.isTrigger) {
            var s = t.Event(e);
            return ((s.type = 'wheel'), i && (s.deltaY = -i), this._events.wheel.call(this, s));
          }
        },
    ...
    t.widget('ui.tabs', {
      ...
      _findNextTab: function (e, i) {
        ...
        while (-1 !== t.inArray((e > s && (e = 0), e < 0 && (e = s), e), this.options.disabled))
          e = i ? e + 1 : e - 1;
        return e;
      },
          ...
          this.anchors.each(function (i, s) {
            ...
            (e._isLocal(s)
              ? ((a = (n = s.hash).substring(1)),
                (o = e.element.find('#' + CSS.escape(a))).length ||
                  ((a = decodeURIComponent(a)), (o = e.element.find('#' + CSS.escape(a)))))
              : ((n = '#' + (a = l.attr('aria-controls') || t({}).uniqueId()[0].id)),
                (o = e.element.find(n)).length ||
                  (o = e._createPanel(a)).insertAfter(e.panels[i - 1] || e.tablist),
      ...
      _setOptionDisabled: function (e) {
        var i, s, n;
        for (
          Array.isArray(e) && (e.length ? e.length === this.anchors.length && (e = !0) : (e = !1)),
            n = 0;
          (s = this.tabs[n]);
          n++
        )
      ...
      _setupHeightStyle: function (e) {
        ...
        'fill' === e
          ? ((i = s.height() - (this.element.outerHeight() - this.element.height())),
            this.element.siblings(':visible').each(function () {
              var e = t(this),
                s = e.css('position');
      ...
      _eventHandler: function (e) {
        ...
        (e.preventDefault(),
          !(n.hasClass('ui-state-disabled') || n.hasClass('ui-tabs-loading')) &&
            !this.running &&
            (!o || i.collapsible) &&
      ...
      _toggle: function (e, i) {
        ...
        function r() {
          (s._addClass(i.newTab.closest('li'), 'ui-tabs-active', 'ui-state-active'),
            n.length && s.options.show ? s._show(n, s.options.show, a) : (n.show(), a()));
        }
        ((this.running = !0),
      ...
      _getIndex: function (t) {
        return (
          'string' == typeof t &&
            (t = this.anchors.index(this.anchors.filter("[href$='" + CSS.escape(t) + "']"))),
          t
        );
      },
      _destroy: function () {
      ...
      _getPanelForTab: function (e) {
        ...
        return this.element.find('#' + CSS.escape(i));
      },
    }),
    !0 === t.uiBackCompat &&
    ...
    t.widget('ui.tooltip', {
          ...
          e &&
            ...
            s.parents().each(function () {
              ...
              (s.data('ui-tooltip-open') &&
                (((e = t.Event('blur')).target = e.currentTarget = this), i.close(e, !0)),
                s.attr('title') &&
                  (s.uniqueId(),
      ...
      _updateContent: function (t, e) {
        ...
        (i = s.call(t[0], function (i) {
          t.data('ui-tooltip-open') && (e && (e.type = o), n._open(e, t, i));
        })) && this._open(e, t, i);
      },
