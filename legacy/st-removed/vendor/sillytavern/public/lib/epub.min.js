  ...
  return (function (t) {
    ...
    function (t, e, i) {
      ...
      function c(t) {
        let e = parseFloat(t);
        return (
          !1 !== l(t) && (('string' == typeof t && t.indexOf('.') > -1) || Math.floor(e) !== e)
        );
      }
      function u(t) {
        ...
        if ('undefined' == typeof document || void 0 !== document.body.style[i]) return t;
        for (var s = 0; s < n; s++) if (void 0 !== document.body.style[e[s] + i]) return e[s] + i;
        return t;
      }
      function d(t) {
      ...
      function A(t, e) {
        return void 0 !== t.querySelector ? t.querySelectorAll(e) : t.getElementsByTagName(e);
      }
      function L(t, e, i) {
        var n, s;
      ...
      function B(t, e, i) {
        var n;
        if (
          (void 0 !== t.querySelector && (n = t.querySelector(`${e}[*|type="${i}"]`)),
          n && 0 !== n.length)
        )
          return n;
        n = A(t, e);
      ...
      class H {
        ...
        _commonAncestorContainer(t, e) {
          ...
          if (i[0] == n[0]) for (var s = 0; s < i.length; s++) if (i[s] != n[s]) return i[s - 1];
        }
        _checkCollapsed() {
    ...
    function (t, e, i) {
      ...
      class s {
        constructor(t, e, i) {
          ...
          if ('range' === r) return Object(n.extend)(this, this.fromRange(t, this.base, i));
          if ('node' === r) return Object(n.extend)(this, this.fromNode(t, this.base, i));
        ...
        parse(t) {
          var e,
            i,
            n,
            s = { spinePos: -1, range: !1, base: {}, path: {}, start: null, end: null };
        ...
        parseStep(t) {
          var e, i, n, s, r;
          if (((s = t.match(/\[(.*)\]/)) && s[1] && (r = s[1]), (i = parseInt(t)), !isNaN(i)))
            return (
              i % 2 == 0 ? ((e = 'element'), (n = i / 2 - 1)) : ((e = 'text'), (n = (i - 1) / 2)),
        ...
        parseTerminal(t) {
          var e,
            ...
            s = t.match(/\[(.*)\]/);
          return (
            s && s[1] ? ((e = parseInt(t.split('[')[0])), (i = s[1])) : (e = parseInt(t)),
        ...
        segmentString(t) {
          ...
          return (
            ...
            t.terminal && null != t.terminal.offset && (e += ':' + t.terminal.offset),
            t.terminal && null != t.terminal.assertion && (e += '[' + t.terminal.assertion + ']'),
            e
          );
        }
        toString() {
          ...
          return (
            ...
            this.range && this.start && ((t += ','), (t += this.segmentString(this.start))),
            this.range && this.end && ((t += ','), (t += this.segmentString(this.end))),
            (t += ')')
          );
        }
        compare(t, e) {
          ...
          (t.range
            ...
            e.range
              ? ((n = e.path.steps.concat(e.start.steps)), (o = e.start.terminal))
          ...
          return i.length < n.length ? -1 : r.offset > o.offset ? 1 : r.offset < o.offset ? -1 : 0;
        }
        step(t) {
          var e = 3 === t.nodeType ? 'text' : 'element';
          return { id: t.id, tagName: t.tagName, type: e, index: this.position(t) };
        }
        filteredStep(t, e) {
          var i,
            n = this.filter(t, e);
          if (n)
            return (
              ...
              { id: n.id, tagName: n.tagName, type: i, index: this.filteredPosition(n, e) }
            );
        }
        pathTo(t, e, i) {
          for (
            var n, s = { steps: [], terminal: { offset: null, assertion: null } }, r = t;
            r && r.parentNode && 9 != r.parentNode.nodeType;
          )
            ((n = i ? this.filteredStep(r, i) : this.step(r)) && s.steps.unshift(n),
              (r = r.parentNode));
          return (
            null != e &&
              e >= 0 &&
        ...
        fromRange(t, e, i) {
          ...
          if (
            ...
            'string' == typeof e
              ? ((n.base = this.parseComponent(e)), (n.spinePos = n.base.steps[1].index))
              : 'object' == typeof e && (n.base = e),
            t.collapsed)
          )
            (h && (o = this.patchOffset(s, o, i)), (n.path = this.pathTo(s, o, i)));
          else {
            ((n.range = !0),
            ...
            for (l = 0; l < c && this.equalStep(n.start.steps[l], n.end.steps[l]); l++)
              l === c - 1
        ...
        filter(t, e) {
          ...
          return (
            3 === t.nodeType
              ? ((a = !0), (s = t.parentNode), (i = t.parentNode.classList.contains(e)))
              : ((a = !1), (i = t.classList.contains(e))),
            i && a
              ? ((r = s.previousSibling),
                (o = s.nextSibling),
                r && 3 === r.nodeType ? (n = r) : o && 3 === o.nodeType && (n = o),
                n || t)
              : !(i && !a) && t
          );
        }
        patchOffset(t, e, i) {
          ...
          var n = t,
            s = e;
          for (t.parentNode.classList.contains(i) && (n = t.parentNode); n.previousSibling; ) {
        ...
        normalizedMap(t, e, i) {
          ...
          for (n = 0; n < h; n++)
            (1 === (s = t[n].nodeType) && t[n].classList.contains(i) && (s = 3),
              n > 0 && 3 === s && 3 === r ? (o[n] = a) : e === s && ((a += 1), (o[n] = a)),
              (r = s));
          return o;
        }
        position(t) {
          ...
          return (
            1 === t.nodeType
              ? ((e = t.parentNode.children) || (e = Object(n.findChildren)(t.parentNode)),
        ...
        stepsToQuerySelector(t) {
          ...
          return (
            t.forEach(function (t) {
              var i = t.index + 1;
              t.id ? e.push('#' + t.id) : 'text' === t.type || e.push('*:nth-child(' + i + ')');
            }),
            e.join('>')
          );
        }
        ...
        toRange(t, e) {
          ...
          if (
            ((i = void 0 !== u.createRange ? u.createRange() : new n.RangeObject()),
            this.range
              ? ((s = this.start),
          ...
          try {
            null != s.terminal.offset ? i.setStart(o, s.terminal.offset) : i.setStart(o, 0);
          } catch (t) {
            ((c = this.fixMiss(h, s.terminal.offset, u, d ? e : null)),
              i.setStart(c.container, c.offset));
          }
          if (a)
            try {
              null != r.terminal.offset ? i.setEnd(a, r.terminal.offset) : i.setEnd(a, 0);
            } catch (t) {
        ...
        isCfiString(t) {
          return 'string' == typeof t && 0 === t.indexOf('epubcfi(') && ')' === t[t.length - 1];
        }
      ...
      ((s = function (t, e) {
        ...
        return (
          ...
          n.call(
            ...
            t,
            (i = function () {
              (r.call(s, t, i), d.call(e, this, arguments));
            })
          ),
        ...
        (a = {
          on: (n = function (t, e) {
            ...
            return (
              ...
              v.call(this, '__ee__')
                ? (i = this.__ee__)
                : ((i = y.value = p(null)), g(this, '__ee__', y), (y.value = null)),
              i[t] ? ('object' == typeof i[t] ? i[t].push(e) : (i[t] = [i[t], e])) : (i[t] = e),
              this
            );
          }),
          once: s,
          ...
          emit: (o = function (t) {
            ...
            if (v.call(this, '__ee__') && (s = this.__ee__[t]))
              if ('object' == typeof s) {
                for (i = arguments.length, r = new Array(i - 1), e = 1; e < i; ++e)
                  r[e - 1] = arguments[e];
                for (s = s.slice(), e = 0; (n = s[e]); ++e) d.call(n, this, r);
              } else
      ...
      e.a = class {
        constructor(t) {
          ...
          (t.indexOf('://') > -1 && (t = new URL(t).pathname),
            (e = this.parse(t)),
            (this.path = t),
            this.isDirectory(t) ? (this.directory = t) : (this.directory = e.dir + '/'),
        ...
        relative(t) {
          return t && t.indexOf('://') > -1 ? t : s.a.relative(this.directory, t);
        }
        splitPath(t) {
      ...
      e.a = class {
        constructor(t, e) {
          ...
          if (
            ...
            try {
              (this.base ? (this.Url = new URL(t, this.base)) : (this.Url = new URL(t)),
                (this.href = this.Url.href),
                (this.protocol = this.Url.protocol),
                (this.origin = this.Url.origin),
                (this.hash = this.Url.hash),
                (this.search = this.Url.search),
                (s = this.Url.pathname + (this.Url.search ? this.Url.search : '')));
            } catch (t) {
              ((this.Url = void 0), this.base && (s = new n.a(this.base).resolve(s)));
            }
          ((this.Path = new n.a(s)),
      ...
      e.a = class {
        ...
        register() {
          for (var t = 0; t < arguments.length; ++t)
            ...
            else for (var e = 0; e < arguments[t].length; ++e) this.hooks.push(arguments[t][e]);
        }
        deregister(t) {
          let e;
    ...
    function (t, e, i) {
          ...
          if (47 === i) {
            if (s === o - 1 || 1 === r);
              ...
              if (
                ...
                if (n.length > 2) {
                  for (var a = n.length - 1, h = a; h >= 0 && 47 !== n.charCodeAt(h); --h);
                  if (h !== a) {
              ...
              e && (n.length > 0 ? (n += '/..') : (n = '..'));
            } else n.length > 0 ? (n += '/' + t.slice(s + 1, o)) : (n = t.slice(s + 1, o));
            ((s = o), (r = 0));
          } else 46 === i && -1 !== r ? ++r : (r = -1);
        }
        return n;
      ...
      var o = {
        resolve: function () {
          for (var t, e = '', i = !1, o = arguments.length - 1; o >= -1 && !i; o--) {
            var a;
            (o >= 0 ? (a = arguments[o]) : (void 0 === t && (t = n.cwd()), (a = t)),
              s(a),
              0 !== a.length && ((e = a + '/' + e), (i = 47 === a.charCodeAt(0))));
          }
          return ((e = r(e, !i)), i ? (e.length > 0 ? '/' + e : '/') : e.length > 0 ? e : '.');
        },
        ...
        relative: function (t, e) {
          ...
          for (var n = t.length, r = n - i, a = 1; a < e.length && 47 === e.charCodeAt(a); ++a);
          for (var h = e.length - a, l = r < h ? r : h, c = -1, u = 0; u <= l; ++u) {
            if (u === l) {
              if (h > l) {
                if (47 === e.charCodeAt(a + u)) return e.slice(a + u + 1);
                if (0 === u) return e.slice(a + u);
              } else r > l && (47 === t.charCodeAt(i + u) ? (c = u) : 0 === u && (c = 0));
              break;
            }
          ...
          var f = '';
          for (u = i + c + 1; u <= n; ++u)
            (u !== n && 47 !== t.charCodeAt(u)) || (0 === f.length ? (f += '..') : (f += '/..'));
          return f.length > 0
            ? f + e.slice(a + c)
        ...
        dirname: function (t) {
          if ((s(t), 0 === t.length)) return '.';
          for (var e = t.charCodeAt(0), i = 47 === e, n = -1, r = !0, o = t.length - 1; o >= 1; --o)
          ...
          if (void 0 !== e && e.length > 0 && e.length <= t.length) {
            ...
            for (i = t.length - 1; i >= 0; --i) {
              ...
              if (47 === l) {
                ...
                (-1 === h && ((o = !1), (h = i + 1)),
                  a >= 0 && (l === e.charCodeAt(a) ? -1 == --a && (r = i) : ((a = -1), (r = h))));
            }
            return (n === r ? (r = h) : -1 === r && (r = t.length), t.slice(n, r));
          }
          for (i = t.length - 1; i >= 0; --i)
        ...
        extname: function (t) {
          s(t);
          for (var e = -1, i = 0, n = -1, r = !0, o = 0, a = t.length - 1; a >= 0; --a) {
            var h = t.charCodeAt(a);
            if (47 !== h)
              (-1 === n && ((r = !1), (n = a + 1)),
                46 === h ? (-1 === e ? (e = a) : 1 !== o && (o = 1)) : -1 !== e && (o = -1));
            else if (!r) {
              i = a + 1;
              break;
            }
          }
          return -1 === e || -1 === n || 0 === o || (1 === o && e === n - 1 && e === i + 1)
            ? ''
            : t.slice(e, n);
        },
        format: function (t) {
        ...
        parse: function (t) {
          ...
          var i,
            ...
            r = 47 === n;
          r ? ((e.root = '/'), (i = 1)) : (i = 0);
          for (var o = -1, a = 0, h = -1, l = !0, c = t.length - 1, u = 0; c >= i; --c)
            if (47 !== (n = t.charCodeAt(c)))
              (-1 === h && ((l = !1), (h = c + 1)),
                46 === n ? (-1 === o ? (o = c) : 1 !== u && (u = 1)) : -1 !== o && (u = -1));
            else if (!l) {
              a = c + 1;
              break;
            }
          return (
            -1 === o || -1 === h || 0 === u || (1 === u && o === h - 1 && o === a + 1)
              ? -1 !== h && (e.base = e.name = 0 === a && r ? t.slice(1, h) : t.slice(a, h))
              : (0 === a && r
      ...
      function a(t, e) {
        ...
        t &&
          ...
          (s = Object(n.qs)(i, "link[property='dc.identifier']"))
            ...
            : ((s = t.createElement('meta')).setAttribute('name', 'dc.identifier'),
              s.setAttribute('content', r),
              i.appendChild(s)));
      }
      function h(t, e) {
              ...
              a = function (t) {
                ...
                if (0 !== i.indexOf('mailto:'))
                  if (i.indexOf('://') > -1) t.setAttribute('target', '_blank');
                    ...
                    t.onclick = function () {
                      return (n && n.hash ? e(n.Path.path + n.hash) : e(n ? n.Path.path : i), !1);
                    };
                  }
              }.bind(this),
              h = 0;
      ...
      e.a = class {
        ...
        enqueue() {
          ...
          return (
            (e =
              'function' == typeof i
                ? { task: i, args: s, deferred: (t = new n.defer()), promise: t.promise }
                : { promise: i }),
            this._q.push(e),
        ...
        run() {
          return (
            this.running || ((this.running = !0), (this.defered = new n.defer())),
        ...
        return (
          ...
          e.scrollLeft > 0
            ...
            : 'undefined' != typeof Element && Element.prototype.scrollIntoView
              ? (e.children[0].children[1].scrollIntoView(), e.scrollLeft < 0 && (t = 'negative'))
      ...
      var u = class {
        ...
        create(t) {
          ...
          return (
            ...
            n &&
              ('scroll' === n && 'vertical' === s
                ? ((a.style['overflow-y'] = n), (a.style['overflow-x'] = 'hidden'))
                : 'scroll' === n && 'horizontal' === s
                  ? ((a.style['overflow-y'] = 'hidden'), (a.style['overflow-x'] = n))
                  : (a.style.overflow = n)),
        ...
        onResize(t) {
          (Object(r.isNumber)(this.settings.width) && Object(r.isNumber)(this.settings.height)) ||
            ((this.resizeFunc = c()(t, 50)),
            window.addEventListener('resize', this.resizeFunc, !1));
        }
        onOrientationChange(t) {
          ((this.orientationChangeFunc = t),
            window.addEventListener('orientationchange', this.orientationChangeFunc, !1));
        }
        size(t, e) {
          var i;
          ...
          (null === t
            ? (i = this.element.getBoundingClientRect()).width &&
              ((t = Math.floor(i.width)), (this.container.style.width = t + 'px'))
            : Object(r.isNumber)(t)
          ...
          return (
            n || (t = o.width - h - l),
            ((this.settings.fullsize && !s) || !s) && (e = o.height - c - u),
            {
        ...
        destroy() {
          this.element &&
            ...
            this.element.contains(this.container) && this.element.removeChild(this.container),
      ...
      var d = class {
          ...
          prepend(t) {
            return (
              ...
              this.container && this.container.insertBefore(t.element, this.container.firstChild),
              this.length++,
              t
            );
          }
            ...
            return (
              ...
              this.container &&
                (e < this.container.children.length
                  ? this.container.insertBefore(t.element, this.container.children[e])
          ...
          find(t) {
            for (var e, i = this.length, n = 0; n < i; n++)
              if ((e = this._views[n]).displayed && e.section.index == t.index) return e;
          }
          displayed() {
      ...
      class p {
        ...
        render(t, e) {
          ...
          (void 0 !== this.settings.fullsize ||
            ...
            this.settings.fullsize &&
              ((this.settings.overflow = 'visible'), (this.overflow = this.settings.overflow)),
            ...
            this.orientationTimeout && this.winBounds.width === this.winBounds.height
              ...
              : (this._stageSize &&
                ...
                this.emit(
                  ...
                  { width: this._stageSize.width, height: this._stageSize.height },
                  i
                )));
        }
        createView(t, e) {
          return new this.View(t, Object(r.extend)(this.viewSettings, { forceRight: e }));
        }
        handleNextPrePaginated(t, e, i) {
          let n;
          if ('pre-paginated' === this.layout.name && this.layout.divisor > 1) {
            if (t || 0 === e.index) return;
            if (((n = e.next()), n && !n.properties.includes('page-spread-left')))
        ...
        moveTo(t, e) {
          var i = 0,
            n = 0;
          (this.isPaginated
            ? ((i = Math.floor(t.left / this.layout.delta) * this.layout.delta) +
                this.layout.delta >
                this.container.scrollWidth && (i = this.container.scrollWidth - this.layout.delta),
              (n = Math.floor(t.top / this.layout.delta) * this.layout.delta) + this.layout.delta >
                this.container.scrollHeight &&
                (n = this.container.scrollHeight - this.layout.delta))
            : (n = t.top),
            'rtl' === this.settings.direction && ((i += this.layout.delta), (i -= e)),
            this.scrollTo(i, n, !0));
        }
        add(t, e) {
        ...
        next() {
          ...
          if (this.views.length) {
            if (!this.isPaginated || 'horizontal' !== this.settings.axis || (e && 'ltr' !== e))
              if (this.isPaginated && 'horizontal' === this.settings.axis && 'rtl' === e)
              ...
              ((this.scrollLeft = this.container.scrollLeft),
                this.container.scrollLeft + this.container.offsetWidth + this.layout.delta <=
                      ...
                      (this.isPaginated &&
                        ...
                        ('rtl' === this.settings.direction
                          ? 'default' === this.settings.rtlScrollType
                            ? this.scrollTo(0, 0, !0)
                            : this.scrollTo(
                                -1 * this.container.scrollWidth + this.layout.delta,
                                0,
                                !0
                              )
                          : this.scrollTo(this.container.scrollWidth - this.layout.delta, 0, !0)),
                        this.views.show());
                    }.bind(this)
                  )
              );
        ...
        isVisible(t, e, i, n) {
          var s = t.position(),
            r = n || this.bounds();
          return (
            ('horizontal' === this.settings.axis && s.right > r.left - e && s.left < r.right + i) ||
            ('vertical' === this.settings.axis && s.bottom > r.top - e && s.top < r.bottom + i)
          );
        }
        visible() {
          for (
            var t, e = this.bounds(), i = this.views.displayed(), n = i.length, s = [], r = 0;
            r < n;
            r++
          )
        ...
        scrollBy(t, e, i) {
          ...
          (i && (this.ignore = !0),
            this.settings.fullsize
              ...
              : (t && (this.container.scrollLeft += t * n), e && (this.container.scrollTop += e)),
            (this.scrolled = !0));
        }
        scrollTo(t, e, i) {
          (i && (this.ignore = !0),
        ...
        setLayout(t) {
          ((this.viewSettings.layout = t),
            (this.mapping = new a.a(t.props, this.settings.direction, this.settings.axis)),
            this.views &&
        ...
        updateFlow(t, e = 'auto') {
          ...
          ((this.isPaginated = i),
            'scrolled-doc' === t || 'scrolled-continuous' === t || 'scrolled' === t
      ...
      e.a = class {
        ...
        walk(t, e) {
          if (!t || t.nodeType !== Node.TEXT_NODE) {
            ...
            n.acceptNode = i;
            for (
              var s, r, o = document.createTreeWalker(t, NodeFilter.SHOW_TEXT, n, !1);
              (s = o.nextNode()) && !(r = e(s));
            );
            return r;
          }
        ...
        findStart(t, e, i) {
          for (var n, r, o = [t], a = t; o.length; )
            if (
              ...
              (r = this.walk(n, (t) => {
                var n, r, h, l, c;
                if (((c = Object(s.nodeBounds)(t)), this.horizontal && 'ltr' === this.direction)) {
                  if (
          ...
          for (var n, r, o = [t], a = t; o.length; )
            if (
              ...
              (r = this.walk(n, (t) => {
                var n, r, h, l, c;
                if (((c = Object(s.nodeBounds)(t)), this.horizontal && 'ltr' === this.direction)) {
                  if (((n = Math.round(c.left)), (r = Math.round(c.right)), n > i && a)) return a;
                  if (r > i) return t;
                  ((a = t), o.push(t));
                } else if (this.horizontal && 'rtl' === this.direction) {
                  if (
                    ((n = Math.round(this.horizontal ? c.left : c.top)),
                    (r = Math.round(this.horizontal ? c.right : c.bottom)) < e && a)
                  )
                    return a;
                  if (n < e) return t;
                  ((a = t), o.push(t));
                } else {
                  if (((h = Math.round(c.top)), (l = Math.round(c.bottom)), h > i && a)) return a;
                  if (l > i) return t;
                  ((a = t), o.push(t));
                }
              })))
        ...
        findTextStartRange(t, e, i) {
          for (var n, s, r = this.splitTextNodeIntoRanges(t), o = 0; o < r.length; o++)
            if (
        ...
        findTextEndRange(t, e, i) {
          for (
            var n, s, r, o, a, h, l, c = this.splitTextNodeIntoRanges(t), u = 0;
            u < c.length;
            u++
          ) {
            if (
              ((r = (s = c[u]).getBoundingClientRect()),
              this.horizontal && 'ltr' === this.direction)
            ) {
        ...
        splitTextNodeIntoRanges(t, e) {
          ...
          for ((i = r.createRange()).setStart(t, 0), i.setEnd(t, a), n.push(i), i = !1; -1 != a; )
            (a = s.indexOf(o, a + 1)) > 0 &&
              (i && (i.setEnd(t, a), n.push(i)), (i = r.createRange()).setStart(t, a + 1));
    ...
    function (t, e, i) {
      ...
      class f {
        ...
        css(t, e, i) {
          ...
          return (
            e ? n.style.setProperty(t, e, i ? 'important' : '') : n.style.removeProperty(t),
        ...
        viewport(t) {
          ...
          return (
            ...
            t &&
              ...
              i ||
                ((i = this.document.createElement('meta')).setAttribute('name', 'viewport'),
        ...
        mediaQueryListeners() {
          for (
            ...
            for (var s = 0; s < n.length; s += 1) {
              if (n[s].media) this.window.matchMedia(n[s].media.mediaText).addListener(e);
            }
          }
        }
        resizeObservers() {
        ...
        imageLoadListeners() {
          for (var t, e = this.document.querySelectorAll('img'), i = 0; i < e.length; i++)
          ...
          if (this.epubcfi.isCfiString(t)) {
            ...
            if (s) {
              try {
                ...
                console.error('setting end offset to start container length failed', t);
              }
            ...
            function (e, i) {
              ...
              this.document
                ? (n = this.document.querySelector("link[href='" + t + "']"))
                  ? e(!0)
                  : (((n = this.document.createElement('link')).type = 'text/css'),
                    (n.rel = 'stylesheet'),
                    (n.href = t),
        ...
        addStylesheetCss(t, e) {
          return !(!this.document || !t) && ((this._getStylesheetNode(e).innerHTML = t), !0);
        }
          ...
          return new Promise(
            function (e, i) {
              var n,
                s = !1;
              this.document
                ? (((n = this.document.createElement('script')).type = 'text/javascript'),
                  (n.async = !0),
                  (n.src = t),
                  (n.onload = n.onreadystatechange =
                    function () {
        ...
        addClass(t) {
          var e;
          this.document && (e = this.content || this.document.body) && e.classList.add(t);
        }
        removeClass(t) {
          var e;
          this.document && (e = this.content || this.document.body) && e.classList.remove(t);
        }
        addEventListeners() {
          this.document &&
        ...
        size(t, e) {
          ...
          (this.layoutStyle('scrolling'),
            t >= 0 && (this.width(t), (i.width = t), this.css('padding', '0 ' + t / 12 + 'px')),
        ...
        columns(t, e, i, n, s) {
          let o = Object(r.prefixed)('column-axis'),
            ...
            c = 0 === this.writingMode().indexOf('vertical') ? 'vertical' : 'horizontal';
        ...
        scaler(t, e, i) {
          ...
          (this.css('transform-origin', 'top left'),
            (e >= 0 || i >= 0) && (s = ' translate(' + (e || 0) + 'px, ' + (i || 0) + 'px )'),
    ...
    function (t, e, i) {
      ...
      e.Pane = (function () {
        function t(e) {
          var i = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : document.body;
          (l(this, t),
            (this.target = e),
            ...
            n(e, [
              {
                ...
                value: function (t, i) {
                  ...
                  this.data))
                    this.data.hasOwnProperty(n) && (this.element.dataset[n] = this.data[n]);
      ...
      e.Underline = (function (t) {
        function e(t, i, n, s) {
          return (
            l(this, e),
            a(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this, t, i, n, s))
          );
        }
        return (
          h(e, t),
    ...
    function (t, e, i) {
      ...
      class c {
        constructor(t) {
          ((this.settings = t),
            ...
            'scrolled' === t.flow || 'scrolled-continuous' === t.flow || 'scrolled-doc' === t.flow
              ? (this._flow = 'scrolled')
        ...
        flow(t) {
          return (
            void 0 !== t &&
              ((this._flow =
                'scrolled' === t || 'scrolled-continuous' === t || 'scrolled-doc' === t
                  ? 'scrolled'
                  : 'paginated'),
        ...
        spread(t, e) {
          return (
            t && ((this._spread = 'none' !== t), this.update({ spread: this._spread })),
        ...
        count(t, e) {
          ...
          return (
            'pre-paginated' === this.name
              ? ((i = 1), (n = 1))
              : 'paginated' === this._flow
                ? ((e = e || this.delta), (i = Math.ceil(t / e)), (n = i * this.divisor))
      ...
      var f = class {
        constructor(t) {
          ((this.rendition = t),
            (this._themes = { default: { rules: {}, url: '', serialized: '' } }),
            (this._overrides = {}),
        ...
        registerThemes(t) {
          for (var e in t)
            t.hasOwnProperty(e) &&
              ('string' == typeof t[e] ? this.registerUrl(e, t[e]) : this.registerRules(e, t[e]));
        }
        registerCss(t, e) {
          ...
          i &&
            ...
            (i.url
              ...
              : i.serialized
                ...
                : i.rules && (e.addStylesheetRules(i.rules, t), (i.injected = !0)));
        }
        override(t, e, i) {
        ...
        overrides(t) {
          ...
          for (var i in e) e.hasOwnProperty(i) && t.css(i, e[i].value, e[i].priority);
        }
        fontSize(t) {
      ...
      class p {
        ...
        attach(t) {
          let e,
            { cfiRange: i, data: n, type: s, mark: r, cb: o, className: a, styles: h } = this;
          return (
            'highlight' === s
      ...
      class b {
        constructor(t, e) {
          ((this.settings = Object(r.extend)(this.settings || {}, {
            ...
            'object' == typeof this.settings.manager && (this.manager = this.settings.manager),
            (this.book = t),
            (this.hooks = {}),
        ...
        start() {
          ...
          (this.manager ||
            ...
            this.manager.on(l.c.MANAGERS.ORIENTATION_CHANGE, this.onOrientationChange.bind(this)),
            this.manager.on(l.c.MANAGERS.SCROLLED, this.reportLocation.bind(this)),
        ...
        attachTo(t) {
          return this.q.enqueue(
            function () {
              (this.manager.render(t, { width: this.settings.width, height: this.settings.height }),
        ...
        afterDisplayed(t) {
          (t.on(l.c.VIEWS.MARK_CLICKED, (e, i) => this.triggerMarkEvent(e, i, t.contents)),
        ...
        onResized(t, e) {
          (this.emit(l.c.RENDITION.RESIZED, { width: t.width, height: t.height }, e),
            this.location && this.location.start && this.display(e || this.location.start.cfi));
        }
        onOrientationChange(t) {
        ...
        flow(t) {
          var e = t;
          (('scrolled' !== t && 'scrolled-doc' !== t && 'scrolled-continuous' !== t) ||
            (e = 'scrolled'),
        ...
        spread(t, e) {
          ((this.settings.spread = t),
            ...
            this.manager && this.manager.isRendered() && this.manager.updateLayout());
        }
        direction(t) {
        ...
        located(t) {
          ...
          let e = t[0],
            ...
            n = {
              start: {
                ...
                href: i.href,
                cfi: i.mapping.end,
                displayed: { page: i.pages[i.pages.length - 1] || 1, total: i.totalPages },
              },
            },
          ...
          (null != s &&
            ((n.start.location = s),
            (n.start.percentage = this.book.locations.percentageFromLocation(s))),
            null != r &&
              ((n.end.location = r),
              (n.end.percentage = this.book.locations.percentageFromLocation(r))));
        ...
        adjustImages(t) {
          ...
          let e = t.window.getComputedStyle(t.content, null),
            i =
              0.95 *
              (t.content.offsetHeight - (parseFloat(e.paddingTop) + parseFloat(e.paddingBottom))),
            n = parseFloat(e.paddingLeft) + parseFloat(e.paddingRight);
          return (
            t.addStylesheetRules({
              img: {
                'max-width':
                  (this._layout.columnWidth ? this._layout.columnWidth - n + 'px' : '100%') +
                  '!important',
    ...
    function (t, e, i) {
      ...
      class c {
        ...
        create() {
          return (
            this.iframe ||
              ...
              this.settings.allowScriptedContent && (this.iframe.sandbox += ' allow-scripts'),
              this.settings.allowPopups && (this.iframe.sandbox += ' allow-popups'),
              ...
              'srcdoc' in this.iframe ? (this.supportsSrcdoc = !0) : (this.supportsSrcdoc = !1),
        ...
        lock(t, e, i) {
          ...
          ((n = this.iframe ? Object(r.borders)(this.iframe) : { width: 0, height: 0 }),
            'width' == t && Object(r.isNumber)(e) && (this.lockedWidth = e - s.width - n.width),
            'height' == t && Object(r.isNumber)(i) && (this.lockedHeight = i - s.height - n.height),
            'both' === t &&
              Object(r.isNumber)(e) &&
              Object(r.isNumber)(i) &&
        ...
        expand(t) {
          ...
          this.iframe &&
            ...
            'pre-paginated' === this.layout.name
              ...
              : 'horizontal' === this.settings.axis
                ? ((i = this.contents.textWidth()) % this.layout.pageWidth > 0 &&
                    (i = Math.ceil(i / this.layout.pageWidth) * this.layout.pageWidth),
            ...
            (this._needsReframe || i != this._width || n != this._height) && this.reframe(i, n),
            (this._expanding = !1));
        }
        reframe(t, e) {
          var i;
        ...
        load(t) {
          var e = new r.defer(),
            i = e.promise;
          if (!this.iframe) return (e.reject(new Error('No Iframe Available')), i);
          if (
            ...
            ((this.blobUrl = Object(r.createBlobUrl)(t, 'application/xhtml+xml')),
            ...
            if (
              (this.iframe.contentDocument.open(), window.MSApp && MSApp.execUnsafeLocalFunction)
            ) {
              var n = this;
        ...
        onLoad(t, e) {
          ...
          (i
            ...
            : ((i = this.document.createElement('link')).setAttribute('rel', 'canonical'),
              i.setAttribute('href', this.section.canonical),
              this.document.querySelector('head').appendChild(i)),
            this.contents.on(h.c.CONTENTS.EXPAND, () => {
              this.displayed &&
                this.iframe &&
                (this.expand(), this.contents && this.layout.format(this.contents));
            }),
        ...
        bounds(t) {
          return (
            (!t && this.elementBounds) || (this.elementBounds = Object(r.bounds)(this.element)),
            this.elementBounds
          );
        }
        highlight(t, e = {}, i, n = 'epubjs-hl', s = {}) {
          ...
          ((e.epubcfi = t), this.pane || (this.pane = new l.Pane(this.iframe, this.element)));
          let c = new l.Highlight(o, n, e, r),
            u = this.pane.addMark(c);
          return (
            (this.highlights[t] = { mark: u, element: u.element, listeners: [a, i] }),
            u.element.setAttribute('ref', n),
            u.element.addEventListener('click', a),
            u.element.addEventListener('touchstart', a),
            i &&
              (u.element.addEventListener('click', i), u.element.addEventListener('touchstart', i)),
            u
          );
        }
        underline(t, e = {}, i, n = 'epubjs-ul', s = {}) {
          if (!this.contents) return;
          const r = Object.assign(
            { stroke: 'black', 'stroke-opacity': '0.3', 'mix-blend-mode': 'multiply' },
            s
          );
          let o = this.contents.range(t),
            a = () => {
          ...
          let c = new l.Underline(o, n, e, r),
            u = this.pane.addMark(c);
          return (
            (this.underlines[t] = { mark: u, element: u.element, listeners: [a, i] }),
            u.element.setAttribute('ref', n),
            u.element.addEventListener('click', a),
            u.element.addEventListener('touchstart', a),
            i &&
        ...
        mark(t, e = {}, i) {
          ...
          return (
            ...
            i && (a.addEventListener('click', i), a.addEventListener('touchstart', i)),
            ...
            for (var r = 0; r != o.length; r++)
              ((t = o[r]),
                (!s || t.left < s) &&
                  ((s = t.left),
                  (n =
                    Math.ceil(s / this.layout.props.pageWidth) * this.layout.props.pageWidth -
                    this.layout.gap / 2),
                  (i = t.top)));
          }
    ...
    function (t, e, i) {
      ...
      class c {
        constructor(t, e) {
          ((this.settings = Object(n.extend)(
            { duration: 80, minVelocity: 0.2, minDistance: 10, easing: l.easeInCubic },
            e || {}
          )),
        ...
        setup(t) {
          ((this.manager = t),
            ...
            (this.manager.settings.afterScrolledTimeout = 2 * this.settings.duration),
        ...
        addListeners() {
          ((this._onResize = this.onResize.bind(this)),
            ...
            this.scroller.addEventListener('touchstart', this._onTouchStart, { passive: !0 }),
            this.on('touchstart', this._onTouchStart),
            (this._onTouchMove = this.onTouchMove.bind(this)),
            this.scroller.addEventListener('touchmove', this._onTouchMove, { passive: !0 }),
            this.on('touchmove', this._onTouchMove),
            (this._onTouchEnd = this.onTouchEnd.bind(this)),
            this.scroller.addEventListener('touchend', this._onTouchEnd, { passive: !0 }),
        ...
        removeListeners() {
          (window.removeEventListener('resize', this._onResize),
            ...
            (this._onScroll = void 0),
            this.scroller.removeEventListener('touchstart', this._onTouchStart, { passive: !0 }),
            this.off('touchstart', this._onTouchStart),
            (this._onTouchStart = void 0),
            this.scroller.removeEventListener('touchmove', this._onTouchMove, { passive: !0 }),
            this.off('touchmove', this._onTouchMove),
            (this._onTouchMove = void 0),
            this.scroller.removeEventListener('touchend', this._onTouchEnd, { passive: !0 }),
        ...
        onTouchStart(t) {
          ...
          (this.fullsize && this.enableScroll(),
            ...
            this.startTouchX ||
              ((this.startTouchX = e), (this.startTouchY = i), (this.startTime = this.now())),
            (this.endTouchX = e),
            (this.endTouchY = i),
        ...
        onTouchMove(t) {
          ...
          ((this.touchCanceler = !0),
            !this.fullsize && n < 10 && (this.element.scrollLeft -= e - this.endTouchX),
            (this.endTouchX = e),
            (this.endTouchY = i),
            (this.endTime = this.now()));
        }
        ...
        wasSwiped() {
          ...
          return i <= this.settings.minDistance || i >= t ? 0 : n > s ? -1 : n < -s ? 1 : void 0;
        }
        needsSnap() {
          ...
          return (
            ...
            function n() {
              ...
              if ((o(h), this.touchCanceler || this.resizeCanceler))
                return ((this.resizeCanceler = !1), (this.snapping = !1), void e.resolve());
              h < 1
                ? (window.requestAnimationFrame(n.bind(this)), this.scrollTo(i + (t - i) * h, 0))
      ...
      class p extends s.a {
        ...
        check(t, e) {
          ...
          this.settings.fullsize
            ? ((r && f && 'negative' === d) || (!r && f && 'default' === d)) && (h *= -1)
        ...
        addEventListeners(t) {
          (window.addEventListener(
            ...
            this.isPaginated &&
              ...
              (this.snapper = new u(
                this,
                this.settings.snap && 'object' == typeof this.settings.snap && this.settings.snap
              )));
        }
        addScrollListeners() {
          var t;
          this.tick = n.requestAnimationFrame;
          let e =
            'rtl' === this.settings.direction && 'default' === this.settings.rtlScrollType ? -1 : 1;
        ...
        onScroll() {
          let t,
            e,
            i =
              'rtl' === this.settings.direction && 'default' === this.settings.rtlScrollType
                ? -1
                : 1;
          (this.settings.fullsize
        ...
        scrolled() {
          (this.q.enqueue(
            ...
            this.emit(r.c.MANAGERS.SCROLL, { top: this.scrollTop, left: this.scrollLeft }),
            clearTimeout(this.afterScrolled),
            (this.afterScrolled = setTimeout(
              function () {
                (this.snapper && this.snapper.supportsTouch && this.snapper.needsSnap()) ||
                  this.emit(r.c.MANAGERS.SCROLLED, { top: this.scrollTop, left: this.scrollLeft });
              }.bind(this),
        ...
        updateFlow(t) {
          (this.rendered && this.snapper && (this.snapper.destroy(), (this.snapper = void 0)),
        ...
        })(
          {
            ...
            2: [
              function (t, e, i) {
                ...
                function c(t, e, i) {
                  ((this.promise = t),
                    'function' == typeof e &&
                      ((this.onFulfilled = e), (this.callFulfilled = this.otherCallFulfilled)),
                    'function' == typeof i &&
                      ((this.onRejected = i), (this.callRejected = this.otherCallRejected)));
                }
                function u(t, e, i) {
                  n(function () {
                    var n;
                    ...
                    n === t
                      ? r.reject(t, new TypeError('Cannot resolve promise with itself'))
                      : r.resolve(t, n);
                  });
                }
                function d(t) {
                ...
                ((e.exports = l),
                  ...
                  (r.resolve = function (t, e) {
                    ...
                    if (n) f(t, n);
                      ...
                      for (var s = -1, o = t.queue.length; ++s < o; ) t.queue[s].callFulfilled(e);
                    }
                    return t;
                  }),
                  ...
                  (l.all = function (t) {
                    ...
                    for (var o = new Array(i), a = 0, h = -1, l = new this(s); ++h < i; )
                      c(t[h], h);
                    return l;
                    function c(t, s) {
                      e.resolve(t).then(
                        function (t) {
                          ((o[s] = t), ++a !== i || n || ((n = !0), r.resolve(l, o)));
                        },
                        function (t) {
                          n || ((n = !0), r.reject(l, t));
                        }
            ...
            4: [
              function (t, e, i) {
                ...
                function h(t, e, i) {
                  ('function' == typeof e && t.then(e), 'function' == typeof i && t.catch(i));
                }
                function l(t) {
                  return (
                    'string' != typeof t &&
                  ...
                  return 'boolean' == typeof u
                    ...
                    : (function (t) {
                        return new o(function (e) {
                          var i = t.transaction('local-forage-detect-blob-support', 'readwrite'),
                            n = r(['']);
                          (i.objectStore('local-forage-detect-blob-support').put(n, 'key'),
                      ...
                      (o.onupgradeneeded = function (e) {
                        ...
                        try {
                          (i.createObjectStore(t.storeName),
                            e.oldVersion <= 1 &&
                              i.createObjectStore('local-forage-detect-blob-support'));
                        } catch (i) {
                ...
                function E(t) {
                  return r(
                    [
                      (function (t) {
                        for (
                          var e = t.length, i = new ArrayBuffer(e), n = new Uint8Array(i), s = 0;
                          s < e;
                          s++
                        )
                          n[s] = t.charCodeAt(s);
                ...
                function _(t, e, i, n) {
                  ...
                  try {
                    ...
                    if (
                      n > 0 &&
                      (!t.db || 'InvalidStateError' === s.name || 'NotFoundError' === s.name)
                    )
                      return o
                        .resolve()
                        .then(function () {
                        ...
                        .then(function () {
                          return (function (t) {
                            g(t);
                            for (var e = d[t.name], i = e.forages, n = 0; n < i.length; n++) {
                              var s = i[n];
                            ...
                            return (
                              ...
                              b(t)
                                ...
                                .then(function (n) {
                                  t.db = e.db = n;
                                  for (var s = 0; s < i.length; s++) i[s]._dbInfo.db = n;
                                })
                                .catch(function (e) {
                                  throw (v(t, e), e);
                                })
                ...
                var T = {
                    ...
                    _initStorage: function (t) {
                      ...
                      var s = d[i.name];
                      (s ||
                        ((s = { forages: [], db: null, dbReady: null, deferredOperations: [] }),
                        (d[i.name] = s)),
                        s.forages.push(e),
                        e._initReady || ((e._initReady = e.ready), (e.ready = N)));
                      var r = [];
                      function a() {
                        return o.resolve();
                      }
                      ...
                      return o
                        ...
                        .then(function (t) {
                          return ((i.db = t), x(i, e._defaultConfig.version) ? w(i) : t);
                        })
                        .then(function (t) {
                          ((i.db = s.db = t), (e._dbInfo = i));
                          for (var n = 0; n < c.length; n++) {
                            var r = c[n];
                            r !== e && ((r._dbInfo.db = i.db), (r._dbInfo.version = i.version));
                          }
                        });
                    },
                    _support: (function () {
                    ...
                    iterate: function (t, e) {
                      var i = this,
                        n = new o(function (e, n) {
                          i.ready()
                            .then(function () {
                              _(i._dbInfo, 'readonly', function (s, r) {
                                if (s) return n(s);
                                try {
                                  var o = r.objectStore(i._dbInfo.storeName).openCursor(),
                                    a = 1;
                                  ((o.onsuccess = function () {
                                    var i = o.result;
                                    if (i) {
                        ...
                        i.ready()
                          .then(function () {
                            _(i._dbInfo, 'readonly', function (s, r) {
                              if (s) return n(s);
                              try {
                                var o = r.objectStore(i._dbInfo.storeName).get(t);
                                ((o.onsuccess = function () {
                                  var t = o.result;
                                  (void 0 === t && (t = null), S(t) && (t = E(t)), e(t));
                                }),
                                  (o.onerror = function () {
                                    n(o.error);
                                  }));
                    ...
                    setItem: function (t, e, i) {
                      ...
                      var s = new o(function (i, s) {
                        ...
                        n.ready()
                          ...
                          .then(function (e) {
                            _(n._dbInfo, 'readwrite', function (r, o) {
                              if (r) return s(r);
                              try {
                    ...
                    removeItem: function (t, e) {
                      ...
                      var n = new o(function (e, n) {
                        i.ready()
                          .then(function () {
                            _(i._dbInfo, 'readwrite', function (s, r) {
                              if (s) return n(s);
                              try {
                                var o = r.objectStore(i._dbInfo.storeName).delete(t);
                    ...
                    clear: function (t) {
                      var e = this,
                        i = new o(function (t, i) {
                          e.ready()
                            .then(function () {
                              _(e._dbInfo, 'readwrite', function (n, s) {
                                if (n) return i(n);
                                try {
                                  var r = s.objectStore(e._dbInfo.storeName).clear();
                                  ((s.oncomplete = function () {
                                    t();
                                  }),
                                    (s.onabort = s.onerror =
                                      function () {
                                        var t = r.error ? r.error : r.transaction.error;
                                        i(t);
                                      }));
                                } catch (t) {
                                  i(t);
                    ...
                    length: function (t) {
                      var e = this,
                        i = new o(function (t, i) {
                          e.ready()
                            .then(function () {
                              _(e._dbInfo, 'readonly', function (n, s) {
                                if (n) return i(n);
                                try {
                                  var r = s.objectStore(e._dbInfo.storeName).count();
                            ...
                            : i
                                ...
                                .then(function () {
                                  _(i._dbInfo, 'readonly', function (s, r) {
                                    if (s) return n(s);
                                    try {
                                      var o = r.objectStore(i._dbInfo.storeName),
                                        a = !1,
                                        h = o.openKeyCursor();
                          ...
                          e.ready()
                            .then(function () {
                              _(e._dbInfo, 'readonly', function (n, s) {
                                if (n) return i(n);
                                try {
                                  var r = s.objectStore(e._dbInfo.storeName).openKeyCursor(),
                                    o = [];
                                  ((r.onsuccess = function () {
                                    var e = r.result;
                    ...
                    dropInstance: function (t, e) {
                      ...
                      (t = ('function' != typeof t && t) || {}).name ||
                        ((t.name = t.name || i.name), (t.storeName = t.storeName || i.storeName));
                      var n,
                        r = this;
                      if (t.name) {
                          ...
                          l = h
                            ...
                            : b(t).then(function (e) {
                                var i = d[t.name],
                                  n = i.forages;
                                i.db = e;
                                for (var s = 0; s < n.length; s++) n[s]._dbInfo.db = e;
                                return e;
                              });
                        n = t.storeName
                          ? l.then(function (e) {
                              if (e.objectStoreNames.contains(t.storeName)) {
                                ...
                                for (var a = 0; a < r.length; a++) {
                                  var h = r[a];
                                  ((h._dbInfo.db = null), (h._dbInfo.version = i));
                                }
                                return new o(function (e, n) {
                                  ...
                                  .catch(function (e) {
                                    throw ((v(t, e) || o.resolve()).catch(function () {}), e);
                                  });
                              }
                            })
                          : l.then(function (e) {
                              ...
                              var i = d[t.name],
                                n = i.forages;
                              e.close();
                              for (var r = 0; r < n.length; r++) n[r]._dbInfo.db = null;
                              return new o(function (e, i) {
                                ...
                                .then(function (t) {
                                  i.db = t;
                                  for (var e = 0; e < n.length; e++) m(n[e]._dbInfo);
                                })
                                .catch(function (e) {
                                  throw ((v(t, e) || o.resolve()).catch(function () {}), e);
                                });
                ...
                function L(t) {
                  ...
                  for (e = 0; e < i.length; e += 3)
                    ((n += C[i[e] >> 2]),
                      (n += C[((3 & i[e]) << 4) | (i[e + 1] >> 4)]),
                      (n += C[((15 & i[e + 1]) << 2) | (i[e + 2] >> 6)]),
                      (n += C[63 & i[e + 2]]));
                  return (
                    i.length % 3 == 2
                      ? (n = n.substring(0, n.length - 1) + '=')
                      : i.length % 3 == 1 && (n = n.substring(0, n.length - 2) + '=='),
                    n
                  );
                }
                var j = {
                    ...
                    if (
                      ...
                      t &&
                        ('[object ArrayBuffer]' === i ||
                          (t.buffer && '[object ArrayBuffer]' === k.call(t.buffer))))
                    ) {
                      var n,
                        s = '__lfsc__:';
                      ...
                      ((r.onload = function () {
                        var i = '~~local_forage_type~' + t.type + '~' + L(this.result);
                        e('__lfsc__:blob' + i);
                      }),
                            ...
                            : h.db.transaction(
                                ...
                                function (e) {
                                  if (e.code === e.QUOTA_ERR) {
                                    if (n > 0) return void r(M.apply(s, [t, a, i, n - 1]));
                                    o(e);
                                  }
                                }
                              );
                          ...
                          .then(function () {
                            ...
                            s.db.transaction(function (i) {
                              P(
                                ...
                                [],
                                function (i, n) {
                                  for (var r = n.rows, o = r.length, a = 0; a < o; a++) {
                                    var h = r.item(a),
                                      l = h.value;
                                    if (
                          ...
                          .then(function () {
                            ...
                            n.db.transaction(function (e) {
                              P(
                                ...
                                [],
                                function (e, i) {
                                  for (var n = [], s = 0; s < i.rows.length; s++)
                      ...
                      a(
                        (n = t.name
                          ? new o(function (e) {
                              var n;
                              ((n =
                                t.name === i.name ? s._dbInfo.db : openDatabase(t.name, '', '', 0)),
                                t.storeName ? e({ db: n, storeNames: [t.storeName] }) : e(z(n)));
                            }).then(function (t) {
                              return new o(function (e, i) {
                                t.db.transaction(
                                  function (n) {
                                    ...
                                    for (var r = [], a = 0, h = t.storeNames.length; a < h; a++)
                ...
                function q(t, e) {
                  var i = t.name + '/';
                  return (t.storeName !== e.storeName && (i += t.storeName + '/'), i);
                }
                function F() {
                  return (
                    !(function () {
                ...
                var U = {
                    ...
                    _initStorage: function (t) {
                      ...
                      return (
                        ...
                        F() ? ((this._dbInfo = e), (e.serializer = j), o.resolve()) : o.reject()
                      );
                    },
                    _support: (function () {
                      try {
                    ...
                    clear: function (t) {
                      var e = this,
                        i = e.ready().then(function () {
                          for (
                            var t = e._dbInfo.keyPrefix, i = localStorage.length - 1;
                            i >= 0;
                            i--
                          ) {
                    ...
                    keys: function (t) {
                      var e = this,
                        i = e.ready().then(function () {
                          for (
                            var t = e._dbInfo, i = localStorage.length, n = [], s = 0;
                            s < i;
                            s++
                          ) {
                    ...
                    dropInstance: function (t, e) {
                      ...
                      return (
                        a(
                          (n = t.name
                            ? new o(function (e) {
                                t.storeName ? e(q(t, s._defaultConfig)) : e(t.name + '/');
                              }).then(function (t) {
                  ...
                  W = function (t, e) {
                    for (var i, n, s = t.length, r = 0; r < s; ) {
                      if (
                        (i = t[r]) === (n = e) ||
                        ('number' == typeof i && 'number' == typeof n && isNaN(i) && isNaN(n))
                      )
                        return !0;
                      r++;
                    }
                  ...
                  V = {},
                  X = {},
                  G = { INDEXEDDB: T, WEBSQL: B, LOCALSTORAGE: U },
                ...
                function Q() {
                  for (var t = 1; t < arguments.length; t++) {
                    ...
                    if (e)
                      for (var i in e)
                        e.hasOwnProperty(i) &&
                          (H(e[i]) ? (arguments[0][i] = e[i].slice()) : (arguments[0][i] = e[i]));
                  }
                  return arguments[0];
                }
                var tt = new ((function () {
                  ...
                  return (
                    ...
                    (t.prototype.defineDriver = function (t, e, i) {
                      var n = new o(function (e, i) {
                        try {
                          ...
                          for (var r = K.concat('_initStorage'), h = 0, l = r.length; h < l; h++) {
                            var c = r[h];
                            if ((!W($, c) || t[c]) && 'function' != typeof t[c]) return void i(s);
                          }
                          !(function () {
                            for (
                              var e = function (t) {
                                  return function () {
                                    var e = new Error(
                                        'Method ' + t + ' is not implemented by the current driver'
                                      ),
                                      i = o.reject(e);
                                    return (a(i, arguments[arguments.length - 1]), i);
                                  };
                                },
                                i = 0,
                                n = $.length;
                          ...
                          var u = function (i) {
                            (V[n] && console.info('Redefining LocalForage driver: ' + n),
                              (V[n] = t),
                              (X[n] = i),
                              e());
                          };
                    ...
                    (t.prototype.getDriver = function (t, e, i) {
                      var n = V[t] ? o.resolve(V[t]) : o.reject(new Error('Driver not found.'));
                      return (h(n, e, i), n);
                    }),
                                  ...
                                  (n._initDriver = (function (t) {
                                    return function () {
                                      ...
                                      return (function i() {
                                        ...
                                        return ((n._driverSet = o.reject(h)), n._driverSet);
                                      })();
                                    };
                                  })(s)));
                              })
    ...
    function (t, e, i) {
      ...
      var u = function (t, e, i, n) {
          ...
          for (s in ('overrideMimeType' in u ||
            Object.defineProperty(u, 'overrideMimeType', { value: function () {} }),
          ...
          (c.onreadystatechange = function () {
            if (this.readyState === XMLHttpRequest.DONE) {
              ...
              if (
                ...
                l.reject({ status: this.status, message: this.response, stack: new Error().stack });
            }
          }),
      ...
      var f = class {
          ...
          return (
            ...
            this.load(t)
              .then(
                function (t) {
                  var e =
                      (('undefined' != typeof navigator && navigator.userAgent) || '').indexOf(
                        'Trident'
                      ) >= 0,
                    i = new (
                      'undefined' == typeof XMLSerializer || e ? d.DOMParser : XMLSerializer
                    )();
          ...
          const n = this,
            ...
            r = function (t) {
              ...
              if (-1 != e) {
                ...
                if (e < t[r].length) {
                  let s;
                  for (; a < t.length - 1 && ((h += t[a].length), !(o <= h)); ) a += 1;
                  let l = t[r],
                    c = t[a],
                    u = n.document.createRange();
                  u.setStart(l, e);
                  let d = t.slice(0, a).reduce((t, e) => t + e.textContent.length, 0);
                  (u.setEnd(c, d > o ? o : o - d), (s = n.cfiFromRange(u)));
                  let f = t.slice(0, a + 1).reduce((t, e) => t + e.textContent, '');
                  (f.length > 150 && ((f = f.substring(e - 75, e + 75)), (f = '...' + f + '...')),
                    i.push({ cfi: s, excerpt: f }));
                }
              }
            },
            o = document.createTreeWalker(n.document, NodeFilter.SHOW_TEXT, null, !1);
          let a,
            h = [];
          for (; (a = o.nextNode()); )
        ...
        reconcileLayoutSettings(t) {
          var e = { layout: t.layout, spread: t.spread, orientation: t.orientation };
          return (
            this.properties.forEach(function (t) {
              var i,
                ...
                r = s.indexOf('-');
              -1 != r && ((i = s.slice(0, r)), (n = s.slice(r + 1)), (e[i] = n));
            }),
            e
          );
        }
            ...
            ((this.items = t.spine),
              ...
              this.items.forEach((t, n) => {
                ...
                ((t.index = n),
                  ...
                  t.href && ((t.url = e(t.href, !0)), (t.canonical = i(t.href))),
                  r &&
                    ((t.href = r.href),
                    (t.url = e(t.href, !0)),
                    (t.canonical = i(t.href)),
                    r.properties.length && t.properties.push.apply(t.properties, r.properties)),
                  'yes' === t.linear
                    ? ((t.prev = function () {
                        let e = t.index;
                        for (; e > 0; ) {
      ...
      class v {
          ...
          return t.load(this.request).then(
            function (e) {
              ...
              return (
                ...
                t.unload(),
                (this.processingTimeout = setTimeout(() => i.resolve(n), this.pause)),
                i.promise
              );
            }.bind(this)
          );
          ...
          if (
            (Object(r.sprint)(
              ...
              function (t) {
                ...
                for (
                  0 == c && (((n = this.createRange()).startContainer = t), (n.startOffset = 0)),
                    (i = u - c) > r && ((c += r), (a = r));
                  a < r;
                )
                  if (
            ...
            : t.load(this.request).then(
                function (s) {
                  ...
                  return (
                    ...
                    t.unload(),
                    (this.processingTimeout = setTimeout(() => o.resolve(a), this.pause)),
                    o.promise
                  );
                }.bind(this)
              );
          ...
          return (
            Object(r.sprint)(
              ...
              function (t) {
                ...
                if (t.textContent.length < 10 && 0 === t.textContent.trim().length) return !1;
                var e,
                  i = this.countWords(t.textContent),
                  n = 0;
                if (0 === i) return !1;
                for (
                  (e = u - this._wordCounter) > i && ((this._wordCounter += i), (n = i));
                  n < i;
                )
                  if (n + (e = u - this._wordCounter) >= i) ((this._wordCounter += i - n), (n = i));
                  else {
                    n += e;
                    let i = new h.a(t, o);
        ...
        locationFromCfi(t) {
          ...
          return (
            ...
            0 === this._locations.length
              ? -1
              : ((e = Object(r.locationOf)(t, this._locations, this.epubcfi.compare)),
        ...
        cfiFromPercentage(t) {
          let e;
          if (
            (t > 1 && console.warn('Normalize cfiFromPercentage value to between 0 - 1'), t >= 1)
          ) {
        ...
        setCurrent(t) {
          ...
          0 !== this._locations.length &&
            ('string' == typeof t ? ((e = this.locationFromCfi(t)), (this._current = e)) : (e = t),
            this.emit(m.c.LOCATIONS.CHANGED, { percentage: this.percentageFromLocation(e) }));
        }
        get currentLocation() {
          return this._current;
        }
      ...
      var x = class {
        ...
        parse(t) {
          ...
          if (!(e = Object(r.qs)(t, 'rootfile'))) throw new Error('No RootFile Found');
      ...
      var E = class {
        ...
        parse(t) {
          ...
          if (!(e = Object(r.qs)(t, 'metadata'))) throw new Error('No Metadata Found');
          if (!(i = Object(r.qs)(t, 'manifest'))) throw new Error('No Manifest Found');
          if (!(n = Object(r.qs)(t, 'spine'))) throw new Error('No Spine Found');
          return (
            ...
            (this.metadata.direction = n.getAttribute('page-progression-direction')),
            {
        ...
        parseMetadata(t) {
          ...
          return (
            ...
            (e.media_active_class = this.getPropertyText(t, 'media:active-class')),
        ...
        parseManifest(t) {
          ...
          return (
            Array.prototype.slice.call(i).forEach(function (t) {
              ...
              e[i] = { href: n, type: s, overlay: r, properties: o.length ? o.split(' ') : [] };
            }),
            e
          );
        }
        ...
        findNcxPath(t, e) {
          var i,
            n = Object(r.qsp)(t, 'item', { 'media-type': 'application/x-dtbncx+xml' });
          return (
            n || ((i = e.getAttribute('toc')) && (n = t.querySelector('#' + i))),
        ...
        load(t) {
          ...
          return (
            (this.spine = e.map((t, e) => ((t.index = e), (t.linear = t.linear || 'yes'), t))),
            t.resources.forEach((t, e) => {
              ((this.manifest[e] = t), t.rel && 'cover' === t.rel[0] && (this.coverPath = t.href));
            }),
            (this.spineNodeIndex = 0),
      ...
      var S = class {
          ...
          parse(t) {
            ...
            (n && ((e = Object(r.qs)(t, 'html')), (i = Object(r.qs)(t, 'ncx'))),
              n
                ? e
                  ? ((this.toc = this.parseNav(t)), (this.landmarks = this.parseLandmarks(t)))
          ...
          getByIndex(t, e, i) {
            ...
            if (!n || (t !== n.id && t !== n.href)) {
              ...
              for (
                let s = 0;
                s < i.length && ((n = this.getByIndex(t, e, i[s].subitems)), !n);
                ++s
              );
              return n;
            }
          ...
          navItem(t, e) {
            let i = t.getAttribute('id') || void 0,
              n = Object(r.filterChildren)(t, 'a', !0) || Object(r.filterChildren)(t, 'span', !0);
            if (!n) return;
          ...
          parseLandmarks(t) {
            ...
            if (!s || 0 === o) return a;
            for (e = 0; e < o; ++e)
              (i = this.landmarkItem(s[e])) && (a.push(i), (this.landmarksByType[i.type] = e));
            return a;
          }
          landmarkItem(t) {
            let e = Object(r.filterChildren)(t, 'a', !0);
            if (!e) return;
            let i = e.getAttributeNS('http://www.idpf.org/2007/ops', 'type') || void 0;
            return { href: e.getAttribute('href') || '', label: e.textContent || '', type: i };
          }
          parseNcx(t) {
            var e,
              i,
          ...
          ncxItem(t) {
            ...
            return (
              !a ||
                ('navPoint' !== a.nodeName && 'navPoint' !== a.nodeName.split(':').slice(-1)[0]) ||
                (e = a.getAttribute('id')),
            ...
            if (N.hasOwnProperty(t))
              for (e in N[t])
                if (N[t].hasOwnProperty(e))
                  if ('string' == typeof (i = N[t][e])) s[i] = t + '/' + e;
      ...
      var C = class {
        ...
        split() {
          ((this.html = this.resources.filter(function (t) {
            if ('application/xhtml+xml' === t.type || 'text/html' === t.type) return !0;
          })),
        ...
        createUrl(t) {
          ...
          return this.settings.archive
            ...
            : 'base64' === this.settings.replacements
              ...
              : this.settings.request(t, 'blob').then((t) => Object(r.createBlobUrl)(t, i));
        }
        replacements() {
          ...
          return Promise.all(t).then(
            (t) => ((this.replacementUrls = t.filter((t) => 'string' == typeof t)), t)
          );
        }
        replaceCss(t, e) {
          var i = [];
      ...
      var O = class {
          constructor(t) {
            ((this.pages = []),
              ...
              this.pageList && this.pageList.length && this.process(this.pageList));
          }
          parse(t) {
          ...
          parseNcx(t) {
            ...
            if (((s = (n = Object(r.qsa)(i, 'pageTarget')).length), !n || 0 === n.length)) return o;
          ...
          ncxItem(t) {
            ...
            return { href: Object(r.qs)(t, 'content').getAttribute('src'), page: parseInt(i, 10) };
          }
          item(t) {
            var e,
              i,
          ...
          pageFromCfi(t) {
            ...
            var i = Object(r.indexOfSorted)(t, this.locations, this.epubcfi.compare);
            return (
              -1 != i
                ? (e = this.pages[i])
                : void 0 !==
                    (e =
                      (i = Object(r.locationOf)(t, this.locations, this.epubcfi.compare)) - 1 >= 0
                        ? this.pages[i - 1]
                        : this.pages[0]) || (e = -1),
              e
            );
            ...
            return t in this.urlCache
              ...
              : (a
                  ...
                  : (n = this.getBlob(t)) &&
                    n.then(
                      function (e) {
                        ((i = o.createObjectURL(e)), (this.urlCache[t] = i), s.resolve(i));
                      }.bind(this)
                    ),
                n ||
                  s.reject({
      ...
      class D {
        ...
        checkRequirements() {
          try {
            let t;
            (void 0 === j.a && (t = j.a), (this.storage = t.createInstance({ name: this.name })));
          } catch (t) {
        ...
        add(t, e) {
          let i = t.resources.map((t) => {
            ...
            return this.storage
              .getItem(s)
              .then((t) =>
                !t || e ? this.requester(n, 'binary').then((t) => this.storage.setItem(s, t)) : t
              );
          });
        ...
        put(t, e, i) {
          ...
          return this.storage
            .getItem(n)
            .then(
              (s) => s || this.requester(t, 'binary', e, i).then((t) => this.storage.setItem(n, t))
            );
        }
        request(t, e, i, n) {
          return this.online
        ...
        getBlob(t, e) {
          ...
          return this.storage.getItem(i).then(function (i) {
            if (i) return ((e = e || T.lookup(t)), new Blob([i], { type: e }));
          });
        }
        getText(t, e) {
          let i = window.encodeURIComponent(t);
        ...
        createUrl(t, e) {
          ...
          return t in this.urlCache
            ...
            : (a
              ...
              n ||
                s.reject({ message: 'File not found in storage: ' + t, stack: new Error().stack }),
              s.promise);
        }
        revokeUrl(t) {
          var e = window.URL || window.webkitURL || window.mozURL,
        ...
        parse(t) {
          ...
          return (
            Object(r.qsa)(e, 'option').forEach((t) => {
              let e = '';
              switch (
                (t.childNodes.length && (e = t.childNodes[0].nodeValue), t.attributes.name.value)
              ) {
                case 'interactive':
                  this.interactive = e;
                  break;
      ...
      class H {
        ...
        open(t, e) {
          ...
          return (
            n === z
              ? ((this.archived = !0), (this.url = new o.a('/', '')), (i = this.openEpub(t)))
              : n === B
                ? ((this.archived = !0), (this.url = new o.a('/', '')), (i = this.openEpub(t, n)))
                : n === q
                  ? ((this.archived = !0),
                    (this.url = new o.a('/', '')),
                    (i = this.request(
                  ...
                  : n == F
                    ? ((this.url = new o.a(t)), (i = this.openPackaging(this.url.Path.toString())))
                    : n == U
                      ? ((this.url = new o.a(t)), (i = this.openManifest(this.url.Path.toString())))
                      : ((this.url = new o.a(t)),
        ...
        openContainer(t) {
          return this.load(t).then(
            (t) => ((this.container = new x(t)), this.resolve(this.container.packagePath))
          );
        }
        openPackaging(t) {
          return (
            (this.path = new a.a(t)),
            this.load(t).then((t) => ((this.packaging = new E(t)), this.unpack(this.packaging)))
          );
        }
        openManifest(t) {
          return (
        ...
        load(t) {
          ...
          return this.archived
            ...
            : this.request(e, null, this.settings.requestCredentials, this.settings.requestHeaders);
        }
        resolve(t, e) {
          if (t) {
            var i = t;
        ...
        determineType(t) {
          ...
          return 'base64' === this.settings.encoding
            ...
            : 'string' != typeof t
              ? z
              : ((e = new o.a(t).path().extension) && (e = e.replace(/\?.*$/, '')),
                e ? ('epub' === e ? q : 'opf' === e ? F : 'json' === e ? U : void 0) : W);
        }
        unpack(t) {
          ((this.package = t),
            '' === this.packaging.metadata.layout
              ? this.load(this.url.resolve('META-INF/com.apple.ibooks.display-options.xml'))
                  .then((t) => {
            ...
            (this.resources = new C(this.packaging.manifest, {
            ...
            this.packaging.coverPath && (this.cover = this.resolve(this.packaging.coverPath)),
            ...
            (this.isOpen = !0),
            this.archived || (this.settings.replacements && 'none' != this.settings.replacements)
              ? this.replacements()
                  .then(() => {
          ...
          return i
            ? new Promise((e, n) => {
                ((this.navigation = new S(i)),
                  t.pageList && (this.pageList = new O(t.pageList)),
                  e(this.navigation));
              })
            : e
              ? this.load(e, 'xml').then(
                  (t) => ((this.navigation = new S(t)), (this.pageList = new O(t)), this.navigation)
                )
              : new Promise((t, e) => {
                  ((this.navigation = new S()), (this.pageList = new O()), t(this.navigation));
                });
        }
        section(t) {
        ...
        renderTo(t, e) {
          return ((this.rendition = new I.a(this, e)), this.rendition.attachTo(t), this.rendition);
        }
            ...
            this.opened.then(() => {
              ...
              ((this.resources.settings.replacements = e || 'blobUrl'),
                ...
                this.storage.on('offline', () => {
                  ((this.url = new o.a('/', '')), this.spine.hooks.serialize.register(t));
                }),
        ...
        coverUrl() {
          return this.loaded.cover.then(() =>
            this.cover ? (this.archived ? this.archive.createUrl(this.cover) : this.cover) : null
          );
        }
        replacements() {
          return (
    ...
    function (t, e, i) {
      ...
      function h(t, e) {
        ...
        if (!(i instanceof e)) {
          function n() {}
          ((n.prototype = e.prototype), a(i, (n = new n())), (t.prototype = i = n));
        }
        i.constructor != t &&
          ('function' != typeof t && console.error('unknown Class:' + t), (i.constructor = t));
      }
      var l = {},
        c = (l.ELEMENT_NODE = 1),
        ...
        _ =
          ...
          (E.NO_MODIFICATION_ALLOWED_ERR = ((S[7] = 'No modification allowed'), 7)),
      ...
      function L(t, e, i, s) {
        if ((s ? (e[A(e, s)] = i) : (e[e.length++] = i), t)) {
          ...
          r &&
            ...
            (function (t, e, i) {
              (t && t._inc++,
                i.namespaceURI === n.XMLNS && (e._nsMap[i.prefix ? i.localName : ''] = i.value));
            })(r, t, i));
        }
      }
      function j(t, e, i) {
      ...
      function B() {}
      function q(t, e, i, s) {
        (t && t._inc++, i.namespaceURI === n.XMLNS && delete e._nsMap[i.prefix ? i.localName : '']);
      }
      function F(t, e, i) {
        if (t && t._inc) {
          t._inc++;
          ...
          if (i) n[n.length++] = i;
            ...
            for (var s = e.firstChild, r = 0; s; ) ((n[r++] = s), (s = s.nextSibling));
            n.length = r;
          }
        }
      }
      ...
      function W(t, e, i) {
        ...
        ((s.previousSibling = o),
          (r.nextSibling = i),
          o ? (o.nextSibling = s) : (t.firstChild = s),
          null == i ? (t.lastChild = r) : (i.previousSibling = r));
        do {
          s.parentNode = t;
        } while (s !== r && (s = s.nextSibling));
        return (
      ...
      function nt(t, e) {
        var i = [],
          ...
          s = n.prefix,
          r = n.namespaceURI;
        if (r && null == s && null == (s = n.lookupPrefix(r)))
          var o = [{ namespace: r, prefix: null }];
        ...
        switch (t.nodeType) {
          case c:
            var o = t.attributes,
              ...
              l = t.tagName,
              g = l;
            if (!(i = n.isHTML(t.namespaceURI) || i) && !t.prefix && t.namespaceURI) {
              ...
              if (!x)
                for (var S = r.length - 1; S >= 0; S--) {
                  if ('' === (N = r[S]).prefix && N.namespace === t.namespaceURI) {
                    x = N.namespace;
                    break;
                  }
                }
              if (x !== t.namespaceURI)
                for (S = r.length - 1; S >= 0; S--) {
                  var N;
                  if ((N = r[S]).namespace === t.namespaceURI) {
            ...
            e.push('<', g);
            for (var _ = 0; _ < a; _++) {
              'xmlns' == (T = o.item(_)).prefix
                ? r.push({ prefix: T.localName, namespace: T.value })
                : 'xmlns' == T.nodeName && r.push({ prefix: '', namespace: T.value });
            }
            for (_ = 0; _ < a; _++) {
              var T, C, O;
              if (st((T = o.item(_)), 0, r))
                (rt(e, (C = T.prefix || '') ? 'xmlns:' + C : 'xmlns', (O = T.namespaceURI)),
                  r.push({ prefix: C, namespace: O }));
              ot(T, e, i, s, r);
            }
            if (l === g && st(t, 0, r))
              (rt(e, (C = t.prefix || '') ? 'xmlns:' + C : 'xmlns', (O = t.namespaceURI)),
            ...
            if (h || (i && !/^(?:meta|link|img|br|hr|input)$/i.test(l))) {
              if ((e.push('>'), i && /^script$/i.test(l)))
                for (; h; )
                  (h.data ? e.push(h.data) : ot(h, e, i, s, r.slice()), (h = h.nextSibling));
              else for (; h; ) (ot(h, e, i, s, r.slice()), (h = h.nextSibling));
              e.push('</', g, '>');
            } else e.push('/>');
            return;
          case y:
          case w:
            for (h = t.firstChild; h; ) (ot(h, e, i, s, r.slice()), (h = h.nextSibling));
            return;
          case u:
            return rt(e, t.name, t.value);
          case d:
          ...
          case b:
            ...
            if ((e.push('<!DOCTYPE ', t.name), I))
              (e.push(' PUBLIC ', I), R && '.' != R && e.push(' ', R), e.push('>'));
      ...
      ((C.prototype = Error.prototype),
        ...
        (k.prototype = {
          ...
          setNamedItem: function (t) {
            ...
            if (e && e != this._ownerElement) throw new C(T);
          ...
          setNamedItemNS: function (t) {
            var e,
              i = t.ownerElement;
            if (i && i != this._ownerElement) throw new C(T);
            return (
        ...
        (P.prototype = {
          ...
          cloneNode: function (t) {
            return (function t(e, i, n) {
              ...
              for (var r in i) {
                var o = i[r];
                'object' != typeof o && o != s[r] && (s[r] = o);
              }
              i.childNodes && (s.childNodes = new O());
              switch (((s.ownerDocument = e), s.nodeType)) {
                case c:
                  var a = i.attributes,
                    h = (s.attributes = new k()),
                    l = a.length;
                  h._ownerElement = s;
                  for (var d = 0; d < l; d++) s.setAttributeNode(t(e, a.item(d), !0));
                  break;
                case u:
                  n = !0;
              }
              if (n)
                for (var f = i.firstChild; f; ) (s.appendChild(t(e, f, n)), (f = f.nextSibling));
              return s;
        ...
        (B.prototype = {
          ...
          insertBefore: function (t, e) {
            ...
            return (
              null == this.documentElement && t.nodeType == c && (this.documentElement = t),
              W(this, t, e),
          ...
          importNode: function (t, e) {
            return (function t(e, i, n) {
              ...
              switch (i.nodeType) {
                case c:
                  (s = i.cloneNode(!1)).ownerDocument = e;
                case w:
                  break;
                case u:
                  n = !0;
              ...
              s || (s = i.cloneNode(!1));
              if (((s.ownerDocument = e), (s.parentNode = null), n))
                for (var r = i.firstChild; r; ) (s.appendChild(t(e, r, n)), (r = r.nextSibling));
              return s;
            })(this, t, e);
          },
          getElementById: function (t) {
            ...
            return (
              z(this.documentElement, function (i) {
                if (i.nodeType == c && i.getAttribute('id') == t) return ((e = i), !0);
              }),
              e
            );
          },
          getElementsByClassName: function (t) {
            ...
            return new I(this, function (i) {
              ...
              return (
                e.length > 0 &&
                  z(i.documentElement, function (s) {
                    if (s !== i && s.nodeType === c) {
          ...
          createDocumentFragment: function () {
            var t = new tt();
            return ((t.ownerDocument = this), (t.childNodes = new O()), t);
          },
          ...
          createElementNS: function (t, e) {
            ...
            return (
              ...
              (i.tagName = e),
              (i.namespaceURI = t),
              2 == n.length ? ((i.prefix = n[0]), (i.localName = n[1])) : (i.localName = e),
              (s._ownerElement = i),
              i
            );
          },
        ...
        (H.prototype = {
          ...
          getElementsByTagName: function (t) {
            return new I(this, function (e) {
              ...
              return (
                z(e, function (n) {
                  n === e || n.nodeType != c || ('*' !== t && n.tagName != t) || i.push(n);
                }),
                i
              );
            });
        ...
        (B.prototype.getElementsByTagNameNS = H.prototype.getElementsByTagNameNS),
        h(H, P),
                  ...
                  switch (e.nodeType) {
                    ...
                    case w:
                      ...
                      for (e = e.firstChild; e; )
                        (7 !== e.nodeType && 8 !== e.nodeType && i.push(t(e)), (e = e.nextSibling));
                      return i.join('');
                    default:
                      return e.nodeValue;
                  }
    ...
    function (t, e, i) {
      ...
      t.exports = function (t, e, i) {
        ...
        return (
          s(i) &&
            ((r = 'leading' in i ? !!i.leading : r), (o = 'trailing' in i ? !!i.trailing : o)),
    ...
    function (t, e, i) {
      ...
      (t.exports = function (t, e) {
        ...
        return (
          ...
          null == t
            ? ((i = a = !0), (r = !1))
            : ((i = o.call(t, 'c')), (r = o.call(t, 'e')), (a = o.call(t, 'w'))),
          (l = { value: e, configurable: i, enumerable: r, writable: a }),
          h ? n(s(h), l) : l
        );
      }).gs = function (t, e, i) {
        var a, h, l, c;
        return (
          'string' != typeof t ? ((l = i), (i = e), (e = t), (t = null)) : (l = arguments[3]),
          null == e
            ? (e = void 0)
            : r(e)
              ? null == i
                ...
                : r(i) || ((l = i), (i = void 0))
              : ((l = e), (e = i = void 0)),
          null == t ? ((a = !0), (h = !1)) : ((a = o.call(t, 'c')), (h = o.call(t, 'e'))),
    ...
    function (t, e, i) {
      'use strict';
      t.exports = i(33)() ? Object.assign : i(34);
    },
    function (t, e, i) {
      'use strict';
      t.exports = function () {
    ...
    function (t, e, i) {
      'use strict';
      t.exports = i(36)() ? Object.keys : i(37);
    },
    function (t, e, i) {
      'use strict';
      t.exports = function () {
    ...
    function (t, e, i) {
      'use strict';
      t.exports = i(43)() ? String.prototype.contains : i(44);
    },
    function (t, e, i) {
      'use strict';
      var n = 'razdwatrzy';
      t.exports = function () {
        return (
          'function' == typeof n.contains && !0 === n.contains('dwa') && !1 === n.contains('foo')
        );
      };
    },
    function (t, e, i) {
    ...
    function (t, e, i) {
      ...
      ((u.prototype.parseFromString = function (t, e) {
        var i = this.options,
          n = new c(),
          s = i.domBuilder || new d(),
          o = i.errorHandler,
          a = i.locator,
          l = i.xmlns || {},
          u = /\/x?html?$/.test(e),
          f = u ? r.HTML_ENTITIES : r.XML_ENTITIES;
        return (
          ...
          (n.errorHandler = (function (t, e, i) {
            ...
            return ((i = i || {}), r('warning'), r('error'), r('fatalError'), n);
          })(o, s, a)),
          (n.domBuilder = i.domBuilder || s),
          u && (l[''] = h.HTML),
          (l.xml = l.xml || h.XML),
          t && 'string' == typeof t ? n.parse(t, l, f) : n.errorHandler.error('invalid doc source'),
          s.doc
        );
      }),
        (d.prototype = {
          ...
          startElement: function (t, e, i, n) {
            var s = this.doc,
              r = s.createElementNS(t, i || e),
              o = n.length;
            (m(this, r), (this.currentElement = r), this.locator && f(this.locator, r));
            for (var a = 0; a < o; a++) {
              t = n.getURI(a);
              var h = n.getValue(a),
                l = ((i = n.getQName(a)), s.createAttributeNS(t, i));
          ...
          startDTD: function (t, e, i) {
            ...
            if (n && n.createDocumentType) {
              var s = n.createDocumentType(t, e, i);
              (this.locator && f(this.locator, s), m(this, s), (this.doc.doctype = s));
            }
          },
          warning: function (t) {
        ...
        (e.__DOMHandler = d),
        (e.DOMParser = u),
        (e.DOMImplementation = s.DOMImplementation),
        (e.XMLSerializer = s.XMLSerializer));
    },
    function (t, e, i) {
      var n = i(14).freeze;
    ...
    function (t, e, i) {
      var n = i(14).NAMESPACE,
        ...
        r = new RegExp(
          '[\\-\\.0-9' + s.source.slice(1, -1) + '\\u00B7\\u0300-\\u036F\\u203F-\\u2040]'
        ),
        o = new RegExp('^' + s.source + r.source + '*(?::' + s.source + r.source + '*)?$');
      function a(t, e) {
        ((this.message = t),
          (this.locator = e),
      ...
      function c(t, e, i, s, r, o) {
        function a(t, e, n) {
          (i.attributeNames.hasOwnProperty(t) && o.fatalError('Attribute ' + t + ' redefined'),
            i.addValue(t, e, n));
        }
        for (var h, l = ++e, c = 0; ; ) {
          var u = t.charAt(l);
          switch (u) {
            ...
            case '"':
              if (3 === c || 1 === c) {
                if (
                  (1 === c && (o.warning('attribute value must after "="'), (h = t.slice(e, l))),
                  (e = l + 1),
                  !((l = t.indexOf(u, e)) > 0))
                )
                  throw new Error("attribute value no end '" + u + "' match");
                (a(h, (d = t.slice(e, l).replace(/&#?\w+;/g, r)), e - 1), (c = 5));
              } else {
                if (4 != c) throw new Error('attribute value must after "="');
                (a(h, (d = t.slice(e, l).replace(/&#?\w+;/g, r)), e),
                  o.warning('attribute "' + h + '" missed start quot(' + u + ')!!'),
                  (e = l + 1),
                  (c = 5));
              }
              break;
            case '/':
              ...
              break;
            case '':
              return (o.error('unexpected end of input'), 0 == c && i.setTagName(t.slice(e, l)), l);
            case '>':
              switch (c) {
                case 0:
                  i.setTagName(t.slice(e, l));
                ...
                case 4:
                case 1:
                  '/' === (d = t.slice(e, l)).slice(-1) && ((i.closed = !0), (d = d.slice(0, -1)));
                case 2:
                  (2 === c && (d = h),
                    4 == c
                      ? (o.warning('attribute "' + d + '" missed quot(")!'),
                        a(h, d.replace(/&#?\w+;/g, r), e))
                      : ((n.isHTML(s['']) && d.match(/^(?:disabled|checked|selected)$/i)) ||
                          o.warning('attribute "' + d + '" missed value!! "' + d + '" instead!!'),
                        a(d, d, e)));
                  break;
                case 3:
              ...
              if (u <= ' ')
                switch (c) {
                  ...
                  case 1:
                    ...
                    break;
                  case 4:
                    var d = t.slice(e, l).replace(/&#?\w+;/g, r);
                    (o.warning('attribute "' + d + '" missed quot(")!!'), a(h, d, e));
                  case 5:
                    c = 6;
                }
              else
                switch (c) {
                  case 2:
                    i.tagName;
                    ((n.isHTML(s['']) && h.match(/^(?:disabled|checked|selected)$/i)) ||
                      o.warning('attribute "' + h + '" missed value!! "' + h + '" instead2!!'),
                      a(h, h, e),
                      (e = l),
                      (c = 1));
                    break;
      ...
      function u(t, e, i) {
        ...
        for (o = t.length; o--; ) {
          (c = (a = t[o]).prefix) &&
            ('xml' === c && (a.uri = n.XML), 'xmlns' !== c && (a.uri = i[c || '']));
        }
        var f;
        (f = s.indexOf(':')) > 0
          ? ((c = t.prefix = s.slice(0, f)), (u = t.localName = s.slice(f + 1)))
          : ((c = null), (u = t.localName = s));
        var g = (t.uri = i[c || '']);
        if ((e.startElement(g, u, s, t), !t.closed))
          return ((t.currentNSMap = i), (t.localNSMap = r), !0);
        if ((e.endElement(g, u, s), r)) for (c in r) e.endPrefixMapping(c);
      }
        ...
        if (/^(?:script|textarea)$/i.test(i)) {
          ...
          if (/[&<]/.test(o))
            return /^script$/i.test(i)
              ? (s.characters(o, 0, o.length), r)
              : ((o = o.replace(/&#?\w+;/g, n)), s.characters(o, 0, o.length), r);
        }
        return e + 1;
      }
      function f(t, e, i, n) {
        ...
        return (
          null == s &&
            ((s = t.lastIndexOf('</' + i + '>')) < e && (s = t.lastIndexOf('</' + i)), (n[i] = s)),
          s < e
        );
      }
      function p(t, e) {
      ...
      function g(t, e, i, n) {
        switch (t.charAt(e + 2)) {
          case '-':
            return '-' === t.charAt(e + 3)
              ? (s = t.indexOf('--\x3e', e + 4)) > e
                ? (i.comment(t, e + 4, s - e - 4), s + 3)
                : (n.error('Unclosed comment'), -1)
              : -1;
          default:
            if ('CDATA[' == t.substr(e + 3, 6)) {
              var s = t.indexOf(']]>', e + 9);
              return (i.startCDATA(), i.characters(t, e + 9, s - e - 9), i.endCDATA(), s + 3);
            }
            var r = (function (t, e) {
                var i,
                  n = [],
                ...
                for (; (i = s.exec(t)); ) if ((n.push(i), i[1])) return n;
              })(t, e),
              o = r.length;
      ...
      function m(t, e, i) {
        var n = t.indexOf('?>', e);
        if (n) {
          var s = t.substring(e, n).match(/^<\?(\S*)\s*([\s\S]*?)\s*$/);
          if (s) {
            s[0].length;
            return (i.processingInstruction(s[1], s[2]), n + 2);
          }
          return -1;
        }
        return -1;
              ...
              (function (t, e, i, s, r) {
                ...
                function h(e) {
                  if (e > N) {
                    ...
                    (x && p(N), s.characters(i, 0, e - N), (N = e));
                  }
                }
                function p(e, i) {
                  for (; e >= b && (i = w.exec(t)); )
                  ...
                  try {
                    ...
                    if (_ < 0) {
                      if (!t.substr(N).match(/^\s*$/)) {
                        var T = s.doc,
                          C = T.createTextNode(t.substr(N));
                        (T.appendChild(C), (s.currentElement = C));
                      }
                      return;
                    }
                    switch ((_ > N && h(_), t.charAt(_ + 1))) {
                      case '/':
                        var O = t.indexOf('>', _ + 3),
                          I = t.substring(_ + 2, O).replace(/[ \t\n\r]+$/g, ''),
                          R = E.pop();
                        O < 0
                          ? ((I = t.substring(_ + 2).replace(/[\s<].*/, '')),
                            r.error('end tag name: ' + I + ' is not complete:' + R.tagName),
                            (O = _ + 1 + I.length))
                          : I.match(/\s</) &&
                            ((I = I.replace(/[\s<].*/, '')),
                            r.error('end tag name: ' + I + ' maybe not complete'),
                            (O = _ + 1 + I.length));
                        var k = R.localNSMap,
                          A = R.tagName == I;
                        if (A || (R.tagName && R.tagName.toLowerCase() == I.toLowerCase())) {
                          if ((s.endElement(R.uri, R.localName, I), k))
                            for (var L in k) s.endPrefixMapping(L);
                          A ||
                            r.fatalError(
                              'end tag name: ' +
                                I +
                      ...
                      default:
                        ...
                        var j = new v(),
                          ...
                          P = ((O = c(t, _, j, D, o, r)), j.length);
                        if (
                          (!j.closed &&
                            f(t, O, j.tagName, S) &&
                            ((j.closed = !0), i.nbsp || r.warning('unclosed xml attribute')),
                          x && P)
                        ) {
                          ...
                          ((s.locator = M), u(j, s, D) && E.push(j), (s.locator = x));
                        } else u(j, s, D) && E.push(j);
                        n.isHTML(j.uri) && !j.closed ? (O = d(t, O, j.tagName, o, s)) : O++;
                    }
                  } catch (t) {
                    if (t instanceof a) throw t;
                    (r.error('element parse error: ' + t), (O = -1));
                  }
                  O > N ? (N = O) : h(Math.max(_, N) + 1);
                }
    ...
    function (t, e, i) {
      ...
      function n(t, e) {
        ...
        for (var n = ['mouseup', 'mousedown', 'click', 'touchstart'], o = 0; o < n.length; o++) {
          var a = n[o];
