...
class GSVITtsProvider {
  ...
  async loadSettings(settings) {
    ...
    $('#gsvi_tts_endpoint').on('input', () => {
      this.onSettingsChange();
    });
    $('#gsvi_api_language').on('change', () => {
      this.onSettingsChange();
    });
    ...
    $('#gsvi_batch_size').on('input', () => {
      this.onSettingsChange();
    });
    $('#gsvi_tts_streaming').on('change', () => {
      this.onSettingsChange();
    });
    $('#gsvi_stream_chunk_size').on('input', () => {
      this.onSettingsChange();
    });
  ...
  async fetchTtsVoiceObjects() {
    ...
    const voices = this.voices.map((x) => ({
      name: x,
      voice_id: x,
      preview_url: false,
      lang: 'zh-CN',
