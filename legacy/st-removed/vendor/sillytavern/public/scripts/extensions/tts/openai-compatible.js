...
class OpenAICompatibleTtsProvider {
  ...
  constructor() {
    this.handler = async function (/** @type {string} */ key) {
      ...
      $('#openai_compatible_tts_key').toggleClass(
        'success',
        !!secret_state[SECRET_KEYS.CUSTOM_OPENAI_TTS]
      );
