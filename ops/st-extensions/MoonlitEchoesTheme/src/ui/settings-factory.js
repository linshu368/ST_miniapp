...
export function createCustomSettingsUI(container, settings) {
  ...
  Object.keys(categories).forEach((category) => {
    ...
    titleContainer.style.borderBottom =
      '1px solid color-mix(in srgb, var(--SmartThemeBodyColor) 10%, transparent)';
...
export function createSettingItem(container, setting, settings) {
  ...
  switch (setting.type) {
    ...
    case 'checkbox':
      ...
      break;
    case 'textarea':
      createTextareaInput(settingContainer, setting, settings);
      break;
    default:
      break;
  }
