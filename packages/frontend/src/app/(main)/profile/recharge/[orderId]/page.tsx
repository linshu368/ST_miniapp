...
function Screen({ children }: { children: React.ReactNode }) {
  return (
    <main className="mx-auto flex min-h-screen max-w-md flex-col bg-background pt-[env(safe-area-inset-top)] text-foreground">
      <div className="h-1.5 w-full bg-gradient-to-r from-primary via-rose to-rose-fill" />
      {children}
    </main>
  );
}
  ...
  return (
    <div className="flex flex-1 flex-col items-center gap-6 pt-6">
      <div className="relative flex h-24 w-24 items-center justify-center">
        ...
        <div className="relative flex h-20 w-20 items-center justify-center rounded-full bg-gradient-to-br from-primary to-rose-fill text-primary-foreground shadow-lg shadow-[0_10px_30px_hsl(var(--glow)/0.4)]">
...
function CompletedView({
  ...
  return (
    <div className="flex flex-1 flex-col items-center gap-6 pt-8">
      <div className="relative flex h-24 w-24 items-center justify-center">
        <div className="absolute inset-0 rounded-full bg-success/15" aria-hidden />
        <div className="relative flex h-20 w-20 items-center justify-center rounded-full bg-success text-primary-foreground shadow-lg shadow-success/30">
...
function Row({
  ...
  return (
    <div className="flex items-center justify-between py-1.5">
      ...
      <span className={cn('text-sm text-foreground/90', bold && 'font-bold text-foreground')}>
        {value}
      </span>
    </div>
  );
