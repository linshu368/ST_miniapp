      ...
      <section className="flex flex-1 flex-col gap-3 px-4 py-4 pb-[calc(env(safe-area-inset-bottom)+1rem)]">
        {query.isLoading && items.length === 0 ? (
          ...
          <div className="flex flex-1 flex-col items-center justify-center gap-3 py-20 text-center">
            <RefreshCw className="h-8 w-8 text-muted-foreground" aria-hidden />
...
function SpendingRow({ item }: { item: WalletSpendingRecord }) {
  return (
    <article className="app-surface flex items-center gap-4 p-4">
      ...
      <div className="min-w-0 flex-1">
        ...
        <time
          ...
          className="mt-1 block text-[10px] font-medium tabular-nums tracking-wide text-muted-foreground"
        >
