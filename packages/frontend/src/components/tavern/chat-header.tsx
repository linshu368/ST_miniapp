...
export function ChatHeader() {
  ...
  return (
    ...
    >
      <div className="flex h-10 items-center rounded-full border border-white/80 bg-transparent px-0.5 shadow-[0_6px_18px_rgba(0,0,0,0.28)]">
        <ChatSidebar />
        <ChatToolsMenu />
      </div>
      ...
      <button
        onClick={() => router.push('/')}
        className="flex size-10 shrink-0 items-center justify-center rounded-full border border-white/80 bg-transparent text-white shadow-[0_6px_18px_rgba(0,0,0,0.28)] transition-colors hover:bg-white/10 hover:text-white active:scale-95"
        aria-label="返回大厅"
      >
