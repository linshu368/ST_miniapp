...
export function VipBenefitArt() {
  return (
    <section className="relative overflow-hidden rounded-[24px] bg-gradient-to-br from-[#fff0b0] via-[#a77c30] to-[#dfb959] p-[1.5px] shadow-[0_0_24px_rgba(215,174,100,0.08)]">
      <div className="relative overflow-hidden rounded-[23px] bg-[#261e17] px-5 py-5 text-center">
        ...
        <div className="relative">
          <h2 className="bg-gradient-to-r from-[#d7ad65] via-[#fff2ba] to-[#d7ad65] bg-clip-text text-[25px] font-black tracking-[0.12em] text-transparent">
            VIP 会员
          </h2>
