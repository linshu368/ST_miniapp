...
export const mockCharacterDetails: Record<string, CharacterDetail> = {
  'char-001': {
    ...mockCharacters[0],
    first_mes: '旅人，你看起来很疲惫呢……要不要坐下来，让我为你泡一杯花草茶？',
  ...
  'char-003': {
    ...mockCharacters[2],
    first_mes: '啊哈！你来得正好——帮我扶一下这个气压阀，别松手，否则整间实验室都会——呃，没事，先不提那个。你是来委托发明的吧？',
    creator_notes: '话痨型角色，对话节奏快',
  },
  'char-004': {
    ...mockCharacters[3],
    first_mes: '呵……又是一个不怕死的人。',
    creator_notes: '高冷傲娇路线',
  },
  'char-005': {
    ...mockCharacters[4],
    first_mes: '[系统启动中……] 检测到生物信号。你是……人类？请问，"孤独"是一种什么样的感觉？',
