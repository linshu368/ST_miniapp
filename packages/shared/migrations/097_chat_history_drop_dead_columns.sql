...
-- **test 库已按原编号执行过**，**生产已于 2026-08-27 13:00 UTC 执行**（见
-- docs/schema划分-批次A进度交接.md §十）。本文件全程 IF EXISTS，重复执行无副作用。
--
-- 生产执行前提（2026-08-25 实测，2026-08-27 已满足）：当时 origin/main 仍在写
-- llm_model_markup，必须先发停写热修再跑本迁移。已按 PR #292 → 写入抽查 → 本文件 完成。
--
