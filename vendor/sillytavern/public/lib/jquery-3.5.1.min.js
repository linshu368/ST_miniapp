...
!(function (e, t) {
  ...
  ((S.fn = S.prototype =
    ...
    S.extend({
      ...
      makeArray: function (e, t) {
        var n = t || [];
        return (
          null != e && (p(Object(e)) ? S.merge(n, 'string' == typeof e ? [e] : e) : u.call(n, e)),
          n
        );
      },
    ...
    S.each(S.expr.match.bool.source.match(/\w+/g), function (e, t) {
      ...
      dt[t] = function (e, t, n) {
        var r,
          ...
          o = t.toLowerCase();
        return (
          n || ((i = dt[o]), (dt[o] = r), (r = null != a(e, t, n) ? o : null), (dt[o] = i)),
          r
        );
      };
    }));
  ...
  S.parseXML = function (e) {
    ...
    return (
      (t && !t.getElementsByTagName('parsererror').length) || S.error('Invalid XML: ' + e),
      t
    );
  };
  var St = /\[\]$/,
    ...
    S.each(['get', 'post'], function (e, i) {
      S[i] = function (e, t, n, r) {
        return (
          ...
          S.ajax(
            S.extend({ url: e, type: i, dataType: r, data: t, success: n }, S.isPlainObject(e) && e)
          )
        );
      };
    }),
