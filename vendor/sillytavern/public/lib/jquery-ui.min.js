...
!(function (t) {
  ...
  ((V.cleanData =
    ...
    (V.Widget.prototype = {
      ...
      _classes: function (n) {
        ...
        return (
          (n = V.extend({ element: this.element, classes: this.options.classes || {} }, n)).keys &&
      ...
      _trigger: function (t, e, i) {
        ...
        return (
          ...
          !(
            ('function' == typeof o && !1 === o.apply(this.element[0], [e].concat(i))) ||
      ...
      flip: {
        left: function (t, e) {
          var i = e.within,
            ...
            a = -2 * e.offset[0];
          r < 0
            ? ((s = t.left + h + i + a + e.collisionWidth - n - s) < 0 || s < k(r)) &&
              (t.left += h + i + a)
            : 0 < l &&
              (0 < (o = t.left - e.collisionPosition.marginLeft + h + i + a - o) || k(o) < l) &&
              (t.left += h + i + a);
        },
        top: function (t, e) {
          var i = e.within,
            ...
            a = -2 * e.offset[1];
          r < 0
            ? ((s = t.top + h + i + a + e.collisionHeight - n - s) < 0 || s < k(r)) &&
              (t.top += h + i + a)
            : 0 < l &&
              (0 < (o = t.top - e.collisionPosition.marginTop + h + i + a - o) || k(o) < l) &&
              (t.top += h + i + a);
        },
      },
      flipfit: {
        ...
        return (
          w(i.props, function (t, e) {
            ...
            null !== n &&
              (null === s
                ? (l[i] = n)
                : (o.mod && (n - s > o.mod / 2 ? (s += o.mod) : s - n > o.mod / 2 && (s -= o.mod)),
                  (l[i] = M((n - s) * a + s, e))));
          }),
          this[e](l)
        );
  ...
  ((y = V.effects),
    ...
    V.effects.define('bounce', function (t, e) {
      ...
      for (
        ...
        (((i = {})[p] = (f ? '-=' : '+=') + h),
          ...
          (h = a ? 2 * h : h / 2));
      (a && (((i = { opacity: 0 })[p] = (f ? '-=' : '+=') + h), n.animate(i, u, d)),
        n.queue(e),
    ...
    V.effects.define('explode', 'hide', function (t, e) {
      ...
      function m() {
        (g.push(this),
          g.length === l * h && (c.css({ visibility: 'visible' }), V(g).remove(), e()));
      }
      for (i = 0; i < l; i++)
    ...
    V.widget('ui.menu', {
          ...
          this._on({
            ...
            blur: function (t) {
              this._delay(function () {
                V.contains(this.element[0], V.ui.safeActiveElement(this.document[0])) ||
                  this.collapseAll(t);
              });
            },
            keydown: '_keydown',
            ...
            (this._hasScroll()
              ? ((i = this.active.offset().top),
                ...
                0 === V.fn.jquery.indexOf('3.2.') &&
                  (s += this.element[0].offsetHeight - this.element.outerHeight()),
      ...
      _filterMenuItems: function (t) {
        ...
        return this.activeMenu
          ...
          .filter(function () {
            return e.test(
              String.prototype.trim.call(V(this).children('.ui-menu-item-wrapper').text())
            );
          });
      },
    }));
  (V.widget('ui.autocomplete', {
    ...
    _appendTo: function () {
      ...
      return (t = !(t =
        !(t = t && (t.jquery || t.nodeType ? V(t) : this.document.find(t).eq(0))) || !t[0]
      ...
      return t.length && t[0].label && t[0].value
        ...
        : V.map(t, function (t) {
            return 'string' == typeof t
              ? { label: t, value: t }
              : V.extend({}, t, { label: t.label || t.value, value: t.value || t.label });
          });
    },
    _suggest: function (t) {
              ...
              ? this.length || 'instance' !== i
                ? this.each(function () {
                    var t = V(this).attr('type'),
                      e = V.data(
                        this,
                        'ui-' + ('checkbox' !== t && 'radio' !== t ? 'button' : 'checkboxradio')
                      );
                    return 'instance' === i
                      ? ((n = e), !1)
                      : e
    ...
    V.extend(st.prototype, {
          ...
          ('button' !== i && 'both' !== i) ||
            ...
            this._get(e, 'buttonImageOnly')
              ...
              : ((e.trigger = V("<button type='button'>").addClass(this._triggerClass)),
                i
                  ? e.trigger.html(V('<img>').attr({ src: i, alt: s, title: s }))
                  : e.trigger.text(s)),
        ...
        if (((s._keyEvent = !0), V.datepicker._datepickerShowing))
          switch (t.keyCode) {
            ...
            case 13:
              return (
                (i = V(
                  'td.' + V.datepicker._dayOverClass + ':not(.' + V.datepicker._currentClass + ')',
                  s.dpDiv
                ))[0] && V.datepicker._selectDay(t.target, s.selectedMonth, s.selectedYear, i[0]),
      ...
      _findPos: function (t) {
        for (
          ...
          t && ('hidden' === t.type || 1 !== t.nodeType || V.expr.pseudos.hidden(t));
        )
      ...
      parseDate: function (e, n, t) {
        ...
        if (
          (-1 === d
            ...
            : d < 100 &&
              (d +=
                new Date().getFullYear() - (new Date().getFullYear() % 100) + (d <= r ? 0 : -100)),
          -1 < g)
        )
          for (p = 1, f = g; ; ) {
        ...
        if (
          (o = this._daylightSavingAdjust(new Date(d, p - 1, f))).getFullYear() !== d ||
          o.getMonth() + 1 !== p ||
          o.getDate() !== f
        )
          throw 'Invalid date';
            ...
            null == t || '' === t
              ...
              : 'string' == typeof t
                ? (function (t) {
                    ...
                    for (
                      var e =
                          (t.toLowerCase().match(/^c/) ? V.datepicker._getDate(r) : null) ||
                          new Date(),
                        i = e.getFullYear(),
                        s = e.getMonth(),
                        n = e.getDate(),
        ...
        if ((K < 0 && ((K += 12), U--), q))
          for (
            e = this._daylightSavingAdjust(
              new Date(q.getFullYear(), q.getMonth() - L[0] * L[1] + 1, q.getDate())
            ),
              e = j && e < j ? j : e;
        ...
        return i && !s && this._mouseCapture(t)
          ? ((this.mouseDelayMet = !this.options.delay),
            ...
            ((this._mouseStarted = !1 !== this._mouseStart(t)), !this._mouseStarted)
              ? (t.preventDefault(), !0)
              : (!0 === V.data(t.target, this.widgetName + '.preventClickEvent') &&
                  V.removeData(t.target, this.widgetName + '.preventClickEvent'),
  ...
  (V.widget('ui.draggable', V.ui.mouse, {
    ...
    _getHandle: function (t) {
      return (
        !this.options.handle || !!V(t.target).closest(this.element.find(this.options.handle)).length
      );
    },
    ...
    _createHelper: function (t) {
      ...
      return (
        t.parents('body').length ||
          t.appendTo('parent' === e.appendTo ? this.element[0].parentNode : e.appendTo),
      ...
      start: function (e, t, i) {
        ...
        ((i.sortables = []),
          V(i.options.connectToSortable).each(function () {
            ...
            t &&
              !t.options.disabled &&
              (i.sortables.push(t), t.refreshPositions(), t._trigger('activate', e, s));
          }));
      },
      stop: function (e, t, i) {
        var s = V.extend({}, t, { item: i.element });
        ...
        (o !== a && 'HTML' !== o.tagName
          ...
          : ((s.axis && 'x' === s.axis) ||
              (t.pageY - V(a).scrollTop() < s.scrollSensitivity
                ...
                : V(window).height() - (t.pageY - V(a).scrollTop()) < s.scrollSensitivity &&
                  (n = V(a).scrollTop(V(a).scrollTop() + s.scrollSpeed))),
            (s.axis && 'y' === s.axis) ||
    ...
    V.ui.plugin.add('draggable', 'snap', {
      start: function (t, e, i) {
        var s = i.options;
        ((i.snapElements = []),
          V(s.snap.constructor !== String ? s.snap.items || ':data(ui-draggable)' : s.snap).each(
            function () {
              var t = V(this),
                e = t.offset();
              this !== i.element[0] &&
      ...
      drag: function (t, e, i) {
        for (
          ...
          ((l = (r = i.snapElements[v].left - i.margins.left) + i.snapElements[v].width),
            ...
            _ < h - p ||
            c + p < m ||
            !V.contains(i.snapElements[v].item.ownerDocument, i.snapElements[v].item)
              ...
              : ('inner' !== d.snapMode &&
                  ...
                  a &&
                    (e.position.left = i._convertPositionTo('relative', { top: 0, left: l }).left)),
                (u = s || n || o || a),
                'outer' !== d.snapMode &&
                  ((s = Math.abs(h - m) <= p),
                  (n = Math.abs(c - _) <= p),
                  ...
                  o &&
                    (e.position.left = i._convertPositionTo('relative', { top: 0, left: r }).left),
                  a &&
                    (e.position.left = i._convertPositionTo('relative', {
                      top: 0,
      ...
      start: function (t, e, i) {
        var s,
          ...
          i = V.makeArray(V(i.stack)).sort(function (t, e) {
            return (
              (parseInt(V(t).css('zIndex'), 10) || 0) - (parseInt(V(e).css('zIndex'), 10) || 0)
            );
          });
        i.length &&
  ...
  (V.widget('ui.resizable', V.ui.mouse, {
    ...
    _mouseStart: function (t) {
      ...
      return (
        ...
        s.containment &&
          ((e += V(s.containment).scrollLeft() || 0), (i += V(s.containment).scrollTop() || 0)),
    ...
    _mouseStop: function (t) {
      ...
      return (
        this._helper &&
          ((s =
            (e =
              (i = this._proportionallyResizeElements).length && /textarea/i.test(i[0].nodeName)) &&
          ...
          (i =
            parseFloat(o.element.css('left')) + (o.position.left - o.originalPosition.left) ||
            null),
          (s =
            parseFloat(o.element.css('top')) + (o.position.top - o.originalPosition.top) || null),
      ...
      resize: function (t) {
        ...
        (r[0] !== document && /static/.test(r.css('position')) && (a = s),
          n.left < (e._helper ? s.left : 0) &&
            ((e.size.width =
              e.size.width + (e._helper ? e.position.left - s.left : e.position.left - a.left)),
            o && ((e.size.height = e.size.width / e.aspectRatio), (t = !1)),
            (e.position.left = i.helper ? s.left : 0)),
          n.top < (e._helper ? s.top : 0) &&
            ((e.size.height =
              e.size.height + (e._helper ? e.position.top - s.top : e.position.top)),
          ...
          (n = Math.abs(
            e.sizeDiff.width + (e._helper ? e.offset.left - a.left : e.offset.left - s.left)
          )),
          (s = Math.abs(
            e.sizeDiff.height + (e._helper ? e.offset.top - a.top : e.offset.top - s.top)
          )),
    ...
    V.ui.plugin.add('resizable', 'ghost', {
      ...
      resize: function () {
        var t = V(this).resizable('instance');
        t.ghost &&
          t.ghost.css({ position: 'relative', height: t.size.height, width: t.size.width });
      },
      stop: function () {
        var t = V(this).resizable('instance');
  ...
  (V.widget('ui.dialog', {
    ...
    _allowInteraction: function (t) {
      return (
        !!V(t.target).closest('.ui-dialog').length || !!V(t.target).closest('.ui-datepicker').length
      );
    },
        ...
        t: for (i = 0; i < n.length; i++)
          if (
            !(
              ...
              (t && !n[i].accept.call(n[i].element[0], t.currentItem || t.element))
            )
          ) {
        ...
        (n.options.refreshPositions && V.ui.ddmanager.prepareOffsets(n, o),
          V.each(V.ui.ddmanager.droppables[n.options.scope] || [], function () {
            ...
            this.options.disabled ||
              ...
              !this.visible ||
              ((s =
                !(i = V.ui.intersect(n, this, this.options.tolerance, o)) && this.isover
                  ? 'isout'
                  : i && !this.isover
                    ? 'isover'
                    : null) &&
  ...
  (V.ui.droppable,
            ...
            this.selectees.each(function () {
              ...
              t &&
                ...
                'touch' === o.tolerance
                  ...
                  : 'fit' === o.tolerance &&
                    (e = i.left > a && i.right < l && i.top > r && i.bottom < h),
                e
                  ? (t.selected && (n._removeClass(t.$element, 'ui-selected'), (t.selected = !1)),
                    t.unselecting &&
                      (n._removeClass(t.$element, 'ui-unselecting'), (t.unselecting = !1)),
                    t.selecting ||
                  ...
                  : (t.selecting &&
                      ((s.metaKey || s.ctrlKey) && t.startselected
                        ...
                        : (n._removeClass(t.$element, 'ui-selecting'),
                          (t.selecting = !1),
                          t.startselected &&
                            (n._addClass(t.$element, 'ui-unselecting'), (t.unselecting = !0)),
    ...
    V.widget('ui.selectmenu', [
      V.ui.formResetMixin,
      {
        ...
        _documentClick: {
          mousedown: function (t) {
            this.isOpen &&
              (V(t.target).closest('.ui-selectmenu-menu, #' + V.escapeSelector(this.ids.button))
                .length ||
                this.close(t));
          },
        },
    ...
    V.widget('ui.slider', V.ui.mouse, {
      ...
      _mouseCapture: function (t) {
        ...
        return (
          ...
          this.handles.each(function (t) {
            ...
            (e < s || (s === e && (t === r._lastChangedValue || r.values(t) === l.min))) &&
              ((s = e), (n = V(this)), (o = t));
          }),
          !1 !== this._start(t, o) &&
      ...
      _precision: function () {
        ...
        return (t =
          null !== this.options.min ? Math.max(t, this._precisionOf(this.options.min)) : t);
      },
        ...
        this._hasMultipleValues()
              ...
              ((i = ((r.values(t) - r._valueMin()) / (r._valueMax() - r._valueMin())) * 100),
                ...
                !0 === r.options.range &&
                  ('horizontal' === r.orientation
                    ? (0 === t &&
                        r.range.stop(1, 1)[l ? 'animate' : 'css']({ left: i + '%' }, a.animate),
                      1 === t &&
                    ...
                    : (0 === t &&
                        r.range.stop(1, 1)[l ? 'animate' : 'css']({ bottom: i + '%' }, a.animate),
                      1 === t &&
                        r.range[l ? 'animate' : 'css'](
                          { height: i - e + '%' },
                          { queue: !1, duration: a.animate }
          ...
          : ((t = this.value()),
            ...
            'min' === o &&
              ...
              this.range.stop(1, 1)[l ? 'animate' : 'css']({ height: i + '%' }, a.animate),
            'max' === o &&
              'vertical' === this.orientation &&
    ...
    V.widget('ui.sortable', V.ui.mouse, {
        ...
        for (e = c.length - 1; 0 <= e; e--)
          for (o = c[e][1], l = (a = c[e][(i = 0)]).length; i < l; i++)
            ((r = V(a[i])).data(this.widgetName + '-item', o),
              h.push({ item: r, instance: o, width: 0, height: 0, left: 0, top: 0 }));
      },
      ...
      _contactContainers: function (t) {
        for (
          var e, i, s, n, o, a, r, l, h, c = null, u = null, d = this.containers.length - 1;
          0 <= d;
          d--
        )
          V.contains(this.currentItem[0], this.containers[d].element[0]) ||
            (this._intersectsWith(this.containers[d].containerCache)
              ? (c && V.contains(this.containers[d].element[0], c.element[0])) ||
      ...
      _generatePosition: function (t) {
        ...
        return (
          ...
          this.originalPosition &&
            ...
            e.grid &&
              ((t =
                this.originalPageY + Math.round((s - this.originalPageY) / e.grid[1]) * e.grid[1]),
              (s =
                !this.containment ||
                (t - this.offset.click.top >= this.containment[1] &&
                  ...
                  : t - this.offset.click.top >= this.containment[1]
                    ...
                    : t + e.grid[1]),
              (t =
                this.originalPageX + Math.round((i - this.originalPageX) / e.grid[0]) * e.grid[0]),
              (i =
                !this.containment ||
    ...
    _events: {
      ...
      'mousedown .ui-spinner-button': function (t) {
        ...
        ((e =
          ...
          !1 !== this._start(t) &&
            this._repeat(null, V(t.currentTarget).hasClass('ui-spinner-up') ? 1 : -1, t));
      },
      ...
      'mouseenter .ui-spinner-button': function (t) {
        if (V(t.currentTarget).hasClass('ui-state-active'))
          return (
            !1 !== this._start(t) &&
            void this._repeat(null, V(t.currentTarget).hasClass('ui-spinner-up') ? 1 : -1, t)
          );
      },
  ...
  (V.widget('ui.tabs', {
    ...
    _initialActive: function () {
      ...
      return (
        null === i &&
          ...
          (null !== (i = null === i ? this.tabs.index(this.tabs.filter('.ui-tabs-active')) : i) &&
            -1 !== i) ||
          ...
          (l._isLocal(e)
            ...
            : ((n = a.attr('aria-controls') || V({}).uniqueId()[0].id),
              (s = l.element.find((i = '#' + n))).length ||
                (s = l._createPanel(n)).insertAfter(l.panels[t - 1] || l.tablist),
    ...
    _setOptionDisabled: function (t) {
      var e, i;
      for (
        Array.isArray(t) && (t.length ? t.length === this.anchors.length && (t = !0) : (t = !1)),
          i = 0;
        (e = this.tabs[i]);
        i++
      )
    ...
    _getIndex: function (t) {
      return (t =
        'string' == typeof t
          ? this.anchors.index(this.anchors.filter("[href$='" + V.escapeSelector(t) + "']"))
          : t);
    },
    _destroy: function () {
      (this.xhr && this.xhr.abort(),
        ...
        t &&
          ...
          e.parents().each(function () {
            ...
            (e.data('ui-tooltip-open') &&
              (((t = V.Event('blur')).target = t.currentTarget = this), i.close(t, !0)),
              e.attr('title') &&
                (e.uniqueId(),
                (i.parents[this.id] = { element: this, title: e.attr('title') }),
                e.attr('title', '')));
          }),
    ...
    _open: function (t, e, i) {
      ...
      i &&
        ((s = this._find(e))
          ...
          : (e.is('[title]') &&
              (t && 'mouseover' === t.type ? e.attr('title', '') : e.removeAttr('title')),
            (s = this._tooltip(e)),
            (n = s.tooltip),
