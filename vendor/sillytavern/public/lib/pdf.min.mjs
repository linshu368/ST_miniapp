 ...
 */ var t = {
    d: (e, i) => {
      for (var s in i)
        t.o(i, s) && !t.o(e, s) && Object.defineProperty(e, s, { enumerable: !0, get: i[s] });
    },
    o: (t, e) => Object.prototype.hasOwnProperty.call(t, e),
  },
  __webpack_exports__ = (globalThis.pdfjsLib = {});
t.d(__webpack_exports__, {
...
const e = !(
  ...
  c = 128,
  u = 256,
  p = { DISABLE: 0, ENABLE: 1, ENABLE_FORMS: 2, ENABLE_STORAGE: 3 },
  g = { DISABLE: -1, NONE: 0, FREETEXT: 3, HIGHLIGHT: 9, STAMP: 13, INK: 15 },
  m = {
    RESIZE: 1,
    CREATE: 2,
    FREETEXT_SIZE: 11,
  ...
  w = 3,
  x = 4,
  _ = { GRAYSCALE_1BPP: 1, RGB_24BPP: 2, RGBA_32BPP: 3 },
  E = 1,
  C = 2,
  S = 3,
  T = 4,
  ...
  Y = { NEED_PASSWORD: 1, INCORRECT_PASSWORD: 2 };
let Q = q.WARNINGS;
function setVerbosityLevel(t) {
  Number.isInteger(t) && (Q = t);
}
function getVerbosityLevel() {
  return Q;
}
function info(t) {
  Q >= q.INFOS && console.log(`Info: ${t}`);
}
function warn(t) {
  Q >= q.WARNINGS && console.log(`Warning: ${t}`);
}
...
const J = (function BaseExceptionClosure() {
...
class PasswordException extends J {
  constructor(t, e) {
    super(t, 'PasswordException');
    this.code = e;
  }
}
class UnknownErrorException extends J {
  constructor(t, e) {
    super(t, 'UnknownErrorException');
    this.details = e;
  }
}
class InvalidPDFException extends J {
  constructor(t) {
    super(t, 'InvalidPDFException');
  }
}
class MissingPDFException extends J {
  constructor(t) {
    super(t, 'MissingPDFException');
  }
}
class UnexpectedResponseException extends J {
  constructor(t, e) {
    super(t, 'UnexpectedResponseException');
    this.status = e;
  }
}
class FormatError extends J {
  constructor(t) {
    super(t, 'FormatError');
  }
}
class AbortException extends J {
  constructor(t) {
...
const Z = Array.from(Array(256).keys(), (t) => t.toString(16).padStart(2, '0'));
class Util {
  ...
  static #e(t, e, i, s, n, a, r, o, l, h, d, c) {
    if (Math.abs(l) < 1e-12) {
      Math.abs(h) >= 1e-12 && this.#t(t, e, i, s, n, a, r, o, -d / h, c);
      return;
    }
    const u = h ** 2 - 4 * d * l;
    if (u < 0) return;
    const p = Math.sqrt(u),
      g = 2 * l;
    this.#t(t, e, i, s, n, a, r, o, (-h + p) / g, c);
    this.#t(t, e, i, s, n, a, r, o, (-h - p) / g, c);
  }
  static bezierBoundingBox(t, e, i, s, n, a, r, o, l) {
    if (l) {
      l[0] = Math.min(l[0], t, r);
      l[1] = Math.min(l[1], e, o);
      l[2] = Math.max(l[2], t, r);
      l[3] = Math.max(l[3], e, o);
    } else l = [Math.min(t, r), Math.min(e, o), Math.max(t, r), Math.max(e, o)];
    this.#e(t, i, n, r, e, s, a, o, 3 * (3 * (i - n) - t + r), 6 * (t - 2 * i + n), 3 * (i - t), l);
    this.#e(t, i, n, r, e, s, a, o, 3 * (3 * (s - a) - e + o), 6 * (e - 2 * s + a), 3 * (s - e), l);
    return l;
  }
}
let tt = null,
...
function normalizeUnicode(t) {
  ...
  return t.replaceAll(tt, (t, e, i) => (e ? e.normalize('NFKC') : et.get(i)));
}
const it = 'pdfjs_internal_id_',
  st = 0,
  nt = 1,
  at = 2,
  rt = 3,
...
class DOMCMapReaderFactory extends BaseCMapReaderFactory {
  _fetchData(t, e) {
    return fetchData(t, this.isCompressed ? 'arraybuffer' : 'text').then((t) => ({
      cMapData: t instanceof ArrayBuffer ? new Uint8Array(t) : stringToBytes(t),
      compressionType: e,
    }));
  }
}
...
class DOMSVGFactory extends BaseSVGFactory {
  _createSVG(t) {
    return document.createElementNS(ut, t);
  }
}
class PageViewport {
  constructor({
  ...
  convertToViewportPoint(t, e) {
    return Util.applyTransform([t, e], this.transform);
  }
  convertToViewportRectangle(t) {
    const e = Util.applyTransform([t[0], t[1]], this.transform),
      i = Util.applyTransform([t[2], t[3]], this.transform);
    return [e[0], e[1], i[0], i[1]];
  }
  convertToPdfPoint(t, e) {
    return Util.applyInverseTransform([t, e], this.transform);
  }
}
class RenderingCancelledException extends J {
  constructor(t, e = 0) {
...
class StatTimer {
  ...
  times = [];
  time(t) {
    t in this.started && warn(`Timer is already running for ${t}`);
    this.started[t] = Date.now();
  }
  timeEnd(t) {
    t in this.started || warn(`Timer has not been started for ${t}`);
...
class PDFDateString {
  static toDateObject(t) {
    ...
    return new Date(Date.UTC(i, s, n, a, r, o));
  }
}
...
function getRGB(t) {
  ...
  if (t.startsWith('rgba('))
    return t
      ...
      .map((t) => parseInt(t))
      .slice(0, 3);
  warn(`Not a valid color format: "${t}"`);
  return [0, 0, 0];
}
...
function setLayerDimensions(t, e, i = !1, s = !0) {
  if (e instanceof PageViewport) {
    const { pageWidth: s, pageHeight: n } = e.rawDims,
      { style: a } = t,
      r = util_FeatureTest.isCSSRoundSupported,
      o = `var(--scale-factor) * ${s}px`,
      l = `var(--scale-factor) * ${n}px`,
      h = r ? `round(down, ${o}, var(--scale-round-x, 1px))` : `calc(${o})`,
      d = r ? `round(down, ${l}, var(--scale-round-y, 1px))` : `calc(${l})`;
...
class EditorToolbar {
  ...
  render() {
    ...
    t.addEventListener('contextmenu', noContextMenu, { signal: e });
    t.addEventListener('pointerdown', EditorToolbar.#h, { signal: e });
  ...
  #p(t) {
    const e = this.#a._uiManager._signal;
    t.addEventListener('focusin', this.#c.bind(this), { capture: !0, signal: e });
    t.addEventListener('focusout', this.#u.bind(this), { capture: !0, signal: e });
    t.addEventListener('contextmenu', noContextMenu, { signal: e });
  }
  hide() {
  ...
  #d() {
    ...
    i.className = 'delete';
    i.tabIndex = 0;
    i.setAttribute('data-l10n-id', EditorToolbar.#l[t]);
    this.#p(i);
    i.addEventListener(
      'click',
      (t) => {
...
class HighlightToolbar {
  ...
  #f() {
    ...
    t.setAttribute('role', 'toolbar');
    t.addEventListener('contextmenu', noContextMenu, { signal: this.#m._signal });
  ...
  #A(t, e) {
    ...
    for (const n of t) {
      ...
      if (t > i) {
        s = a;
        i = t;
      } else e ? a > s && (s = a) : a < s && (s = a);
    }
    return [e ? 1 - s : s, i];
  }
  show(t, e, i) {
    const [s, n] = this.#A(e, i),
      { style: a } = (this.#s ||= this.#f());
    t.append(this.#s);
  ...
  #b() {
    ...
    const i = this.#m._signal;
    t.addEventListener('contextmenu', noContextMenu, { signal: i });
    t.addEventListener(
      'click',
      () => {
...
class IdManager {
  #v = 0;
  get id() {
    return 'pdfjs_internal_editor_' + this.#v++;
  }
}
class ImageManager {
  #y = (function getUuid() {
  ...
  static get _isSVGFittingCanvas() {
    const t = new OffscreenCanvas(1, 3).getContext('2d', { willReadFrequently: !0 }),
      e = new Image();
    e.src =
  ...
  async #x(t, e) {
    ...
    try {
      i ||= { bitmap: null, id: `image_${this.#y}_${this.#v++}`, refCounter: 0, isSvg: !1 };
      let t;
      if ('string' == typeof e) {
        i.url = e;
        t = await fetchData(e, 'blob');
      } else e instanceof File ? (t = i.file = e) : e instanceof Blob && (t = e);
  ...
  async getFromId(t) {
    ...
    if (e.blobPromise) {
      ...
      return this.getFromBlob(e.id, t);
    }
...
class CommandManager {
  ...
  add({
    ...
    if (a && this.#_[this.#S].type === n) {
      r && (o.undo = this.#_[this.#S].undo);
      this.#_[this.#S] = o;
      return;
    }
    const l = this.#S + 1;
    if (l === this.#C) this.#_.splice(0, 1);
    else {
      this.#S = l;
      l < this.#_.length && this.#_.splice(l);
    }
    this.#_.push(o);
  }
  undo() {
    if (-1 === this.#S) return;
    this.#E = !0;
    const { undo: t, post: e } = this.#_[this.#S];
    t();
    e?.();
    this.#E = !1;
    this.#S -= 1;
  ...
  redo() {
    if (this.#S < this.#_.length - 1) {
      this.#S += 1;
      this.#E = !0;
      const { cmd: t, post: e } = this.#_[this.#S];
      t();
      e?.();
      this.#E = !1;
    }
...
class KeyboardManager {
  constructor(t) {
    ...
    const { isMac: e } = util_FeatureTest.platform;
...
class ColorManager {
  ...
  getHexCode(t) {
    ...
    return e ? Util.makeHexColor(...e) : t;
  }
}
class AnnotationEditorUIManager {
    ...
    return shadow(
      ...
      new KeyboardManager([
        ...
        [
          ...
          {
            checker: (t, { target: e }) =>
              !(e instanceof HTMLButtonElement) && t.#ut.contains(e) && !t.isEnterHandled,
          },
        ],
        [
          [' ', 'mac+ '],
          ...
          {
            checker: (t, { target: e }) =>
              !(e instanceof HTMLButtonElement) && t.#ut.contains(document.activeElement),
          },
        ],
  ...
  constructor(t, e, i, s, n, a, r, o, l, h, d) {
    const c = (this._signal = this.#M.signal);
    this.#ut = t;
    this.#pt = e;
    this.#D = i;
    this._eventBus = s;
    s._on('editingaction', this.onEditingAction.bind(this), { signal: c });
    s._on('pagechanging', this.onPageChanging.bind(this), { signal: c });
    s._on('scalechanging', this.onScaleChanging.bind(this), { signal: c });
    s._on('rotationchanging', this.onRotationChanging.bind(this), { signal: c });
    s._on('setpreference', this.onSetPreference.bind(this), { signal: c });
    s._on('switchannotationeditorparams', (t) => this.updateParams(t.type, t.value), { signal: c });
    this.#mt();
    this.#ft();
    this.#bt();
    this.#R = n.annotationStorage;
    this.#$ = n.filterFactory;
    this.#ot = a;
    this.#X = r || null;
    this.#j = o;
    this.#W = l;
  ...
  destroy() {
    ...
    this.#M = null;
    this._signal = null;
    for (const t of this.#F.values()) t.destroy();
    this.#F.clear();
    this.#P.clear();
    this.#U.clear();
    this.#k = null;
  ...
  get hcmFilter() {
    return shadow(
      this,
      'hcmFilter',
      this.#ot ? this.#$.addHCMFilter(this.#ot.foreground, this.#ot.background) : 'none'
    );
  }
  get direction() {
    return shadow(this, 'direction', getComputedStyle(this.#ut).direction);
  }
  get highlightColors() {
    return shadow(
      this,
      'highlightColors',
      this.#X ? new Map(this.#X.split(',').map((t) => t.split('=').map((t) => t.trim()))) : null
    );
  }
  ...
  onScaleChanging({ scale: t }) {
    this.commitOrRemove();
    this.viewParameters.realScale = t * PixelsPerInch.PDF_TO_CSS_UNITS;
  ...
  #vt(t) {
    ...
    for (const e of this.#F.values()) if (e.hasTextLayer(t)) return e;
    return null;
  }
  highlightSelection(t = '') {
    ...
    const { anchorNode: i, anchorOffset: s, focusNode: n, focusOffset: a } = e,
      r = e.toString(),
      o = this.#At(e).closest('.textLayer'),
      l = this.getSelectionBoxes(o);
    if (!l) return;
    e.empty();
    const h = this.#vt(o),
      d = this.#nt === g.NONE,
    ...
    d ? this.switchToMode(g.HIGHLIGHT, callback) : callback();
  }
  #yt() {
    const t = document.getSelection();
    if (!t || t.isCollapsed) return;
    const e = this.#At(t).closest('.textLayer'),
      i = this.getSelectionBoxes(e);
    if (i) {
      this.#Y ||= new HighlightToolbar(this);
      this.#Y.show(e, i, 'ltr' === this.direction);
    }
  }
  ...
  #wt() {
    ...
    if (!t || t.isCollapsed) {
      if (this.#rt) {
        this.#Y?.hide();
        this.#rt = null;
        this.#xt({ hasSelectedText: !1 });
      }
      return;
    }
    const { anchorNode: e } = t;
    if (e === this.#rt) return;
    const i = this.#At(t).closest('.textLayer');
    if (i) {
      this.#Y?.hide();
      this.#rt = e;
      this.#xt({ hasSelectedText: !0 });
      if (this.#nt === g.HIGHLIGHT || this.#nt === g.NONE) {
        this.#nt === g.HIGHLIGHT && this.showAllEditors('highlight', !0, !0);
        this.#K = this.isShiftKeyDown;
        if (!this.isShiftKeyDown) {
          const t = this.#nt === g.HIGHLIGHT ? this.#vt(i) : null;
          t?.toggleDrawing();
          const e = new AbortController(),
            s = this.combinedSignal(e),
            pointerup = (i) => {
              if ('pointerup' !== i.type || 0 === i.button) {
                e.abort();
                t?.toggleDrawing(!0);
                'pointerup' === i.type && this.#_t('main_toolbar');
              }
            };
          window.addEventListener('pointerup', pointerup, { signal: s });
          window.addEventListener('blur', pointerup, { signal: s });
        }
      }
    } else if (this.#rt) {
      this.#Y?.hide();
  ...
  #_t(t = '') {
    this.#nt === g.HIGHLIGHT ? this.highlightSelection(t) : this.#j && this.#yt();
  }
  #mt() {
    document.addEventListener('selectionchange', this.#wt.bind(this), { signal: this._signal });
  }
  #Et() {
    if (this.#q) return;
  ...
  keyup(t) {
    if (this.isShiftKeyDown && 'Shift' === t.key) {
      this.isShiftKeyDown = !1;
      if (this.#K) {
        this.#K = !1;
        this.#_t('main_toolbar');
  ...
  #xt(t) {
    if (Object.entries(t).some(([t, e]) => this.#ht[t] !== e)) {
      this._eventBus.dispatch('annotationeditorstateschanged', {
        source: this,
        details: Object.assign(this.#ht, t),
      });
      this.#nt === g.HIGHLIGHT && !1 === t.hasSelectedEditor && this.#Ft([[m.HIGHLIGHT_FREE, !0]]);
    }
  }
  #Ft(t) {
  ...
  registerEditorTypes(t) {
    if (!this.#z) {
      this.#z = t;
      for (const t of this.#z) this.#Ft(t.defaultPropertiesToUpdate);
    }
  }
  getId() {
    return this.#Q.id;
  ...
  addLayer(t) {
    this.#F.set(t.pageIndex, t);
    this.#J ? t.enable() : t.disable();
  }
  removeLayer(t) {
    this.#F.delete(t.pageIndex);
  }
  async updateMode(t, e = null, i = !1) {
    if (this.#nt !== t) {
      if (this.#gt) {
        await this.#gt.promise;
        if (!this.#gt) return;
      }
      this.#gt = Promise.withResolvers();
      this.#nt = t;
      if (t !== g.NONE) {
        this.setEditingState(!0);
        await this.#Rt();
        this.unselectAll();
        for (const e of this.#F.values()) e.updateMode(t);
        if (e) {
          ...
          i && this.addNewEditorFromKeyboard();
          this.#gt.resolve();
        }
      } else {
  ...
  updateToolbar(t) {
    t !== this.#nt &&
      this._eventBus.dispatch('switchannotationeditormode', { source: this, mode: t });
  }
  updateParams(t, e) {
    if (this.#z) {
      switch (t) {
  ...
  async #Rt() {
    if (!this.#J) {
      this.#J = !0;
      const t = [];
      for (const e of this.#F.values()) t.push(e.enable());
      await Promise.all(t);
  ...
  #It() {
    ...
    if (this.#J) {
      this.#J = !1;
      for (const t of this.#F.values()) t.disable();
  ...
  removeEditor(t) {
    ...
    this.#P.delete(t.id);
    this.unselect(t);
    (t.annotationElementId && this.#B.has(t.annotationElementId)) || this.#R?.remove(t.id);
  }
  ...
  #kt(t) {
    const e = this.#F.get(t.pageIndex);
    if (e) e.addOrRebuild(t);
    else {
      this.addEditor(t);
  ...
  setActiveEditor(t) {
    if (this.#k !== t) {
      this.#k = t;
      t && this.#Ft(t.propertiesToUpdate);
    }
  }
  get #Lt() {
    let t = null;
  ...
  updateUI(t) {
    this.#Lt === t && this.#Ft(t.propertiesToUpdate);
  }
  toggleSelected(t) {
    if (this.#at.has(t)) {
      this.#at.delete(t);
      t.unselect();
      this.#xt({ hasSelectedEditor: this.hasSelection });
    } else {
      this.#at.add(t);
      t.select();
      this.#Ft(t.propertiesToUpdate);
      this.#xt({ hasSelectedEditor: !0 });
    }
  }
  setSelected(t) {
  ...
  addCommands(t) {
    this.#L.add(t);
    this.#xt({ hasSomethingToUndo: !0, hasSomethingToRedo: !1, isEmpty: this.#Dt() });
  }
  #Dt() {
    if (0 === this.#P.size) return !0;
    if (1 === this.#P.size) for (const t of this.#P.values()) return t.isEmpty();
    return !1;
  }
  delete() {
    this.commitOrRemove();
  ...
  unselectAll() {
    if (this.#k) {
      this.#k.commitOrRemove();
      if (this.#nt !== g.NONE) return;
    }
    if (this.hasSelection) {
      for (const t of this.#at) t.unselect();
      this.#at.clear();
      this.#xt({ hasSelectedEditor: !1 });
    }
  }
  ...
  dragSelectedEditors(t, e) {
    if (this.#H) for (const i of this.#H.keys()) i.drag(t, e);
  }
  rebuild(t) {
    if (null === t.parent) {
  ...
  get isEditorHandlingKeyboard() {
    return (
      ...
      (1 === this.#at.size && this.firstSelectedEditor.shouldGetKeyboardEvents())
    );
  }
  isActive(t) {
    return this.#k === t;
  ...
  getSelectionBoxes(t) {
    ...
    switch (t.getAttribute('data-main-rotation')) {
      ...
      case '270':
        ...
        break;
      default:
        r = (t, e, r, o) => ({ x: (t - i) / n, y: (e - s) / a, width: r / n, height: o / a });
    }
    const o = [];
  ...
  addChangedExistingAnnotation({ annotationElementId: t, id: e }) {
    (this.#I ||= new Map()).set(t, e);
  }
  removeChangedExistingAnnotation({ annotationElementId: t }) {
    this.#I?.delete(t);
  }
  renderAnnotationElement(t) {
    const e = this.#I?.get(t.data.id);
    if (!e) return;
    const i = this.#R.getRawValue(e);
    i && (this.#nt !== g.NONE || i.hasBeenModified) && i.renderAnnotationElement(t);
  }
}
class AltText {
  #o = null;
  ...
  constructor(t) {
    this.#a = t;
    this.#Gt = t._uiManager.useNewAltTextFlow;
    AltText.#$t ||= Object.freeze({
  ...
  async render() {
    ...
    if (this.#Gt) {
      t.classList.add('new');
      e = await AltText._l10nPromise.get(AltText.#$t.missing);
    } else e = await AltText._l10nPromise.get('pdfjs-editor-alt-text-button-label');
    t.textContent = e;
    ...
    t.addEventListener('click', onClick, { capture: !0, signal: i });
    t.addEventListener(
      'keydown',
      (e) => {
  ...
  finish() {
    if (this.#Ot) {
      this.#Ot.focus({ focusVisible: this.#zt });
      this.#zt = !1;
    }
  }
  isEmpty() {
    return this.#Gt ? null === this.#o : !this.#o && !this.#Nt;
  }
  hasData() {
    return this.#Gt ? null !== this.#o || !!this.#jt : this.isEmpty();
  }
  get guessedText() {
    return this.#jt;
  }
  async setGuessedText(t) {
    if (null === this.#o) {
      this.#jt = t;
      this.#Wt = await AltText._l10nPromise.get(
  ...
  toggleAltTextBadge(t = !1) {
    if (this.#Gt && !this.#o) {
      if (!this.#Ut) {
        const t = (this.#Ut = document.createElement('div'));
        t.className = 'noAltTextBadge';
        this.#a.div.append(t);
      }
      this.#Ut.classList.toggle('hidden', !t);
    } else {
      this.#Ut?.remove();
      this.#Ut = null;
    }
  ...
  serialize(t) {
    let e = this.#o;
    t || this.#jt !== e || (e = this.#Wt);
    return {
      altText: e,
      decorative: this.#Nt,
      guessedText: this.#jt,
      textWithDisclaimer: this.#Wt,
    };
  }
  get data() {
  ...
  async #qt() {
    ...
    if (this.#Gt) {
      ...
      AltText._l10nPromise.get(AltText.#$t[this.#Vt]).then((e) => {
        t.setAttribute('aria-label', e);
    ...
    let e = this.#Bt;
    if (!e) {
      this.#Bt = e = document.createElement('span');
      e.className = 'tooltip';
...
class AnnotationEditor {
  ...
  static get _resizerKeyboardManager() {
    const t = AnnotationEditor.prototype._resizeWithKeyboard,
      e = AnnotationEditorUIManager.TRANSLATE_SMALL,
      i = AnnotationEditorUIManager.TRANSLATE_BIG;
    return shadow(
      this,
  ...
  static initialize(t, e, i) {
    ...
    AnnotationEditor._l10nPromise ||= new Map([
      ...
      ...['pdfjs-editor-new-alt-text-generated-alt-text-with-disclaimer'].map((e) => [
        e,
        t.get.bind(t, e),
      ]),
    ]);
    if (i?.strings) for (const e of i.strings) AnnotationEditor._l10nPromise.set(e, t.get(e));
    if (-1 !== AnnotationEditor._borderLineWidth) return;
    const s = getComputedStyle(document.documentElement);
    AnnotationEditor._borderLineWidth = parseFloat(s.getPropertyValue('--outline-width')) || 0;
  }
  ...
  focusin(t) {
    this._focusEventsAllowed && (this.#ie ? (this.#ie = !1) : this.parent.setSelected(this));
  }
  focusout(t) {
  ...
  translate(t, e) {
    this.#ge(this.parentDimensions, t, e);
  }
  translateInPage(t, e) {
    this.#se ||= [this.x, this.y];
    this.#ge(this.pageDimensions, t, e);
  ...
  get _hasBeenMoved() {
    return !!this.#se && (this.#se[0] !== this.x || this.#se[1] !== this.y);
  }
  getBaseTranslation() {
  ...
  screenToPageTranslation(t, e) {
    return AnnotationEditor.#me(t, e, this.parentRotation);
  }
  pageTranslationToScreen(t, e) {
    return AnnotationEditor.#me(t, e, 360 - this.parentRotation);
  }
  #fe(t) {
    switch (t) {
      case 90: {
  ...
  setDims(t, e) {
    ...
    this.#Qt || (this.div.style.height = `${((100 * e) / s).toFixed(2)}%`);
  }
  fixDims() {
    const { style: t } = this.div,
      { height: e, width: i } = t,
      s = i.endsWith('%'),
      n = !this.#Qt && e.endsWith('%');
    if (s && n) return;
    const [a, r] = this.parentDimensions;
    s || (t.width = `${((100 * parseFloat(i)) / a).toFixed(2)}%`);
    this.#Qt || n || (t.height = `${((100 * parseFloat(e)) / r).toFixed(2)}%`);
  }
  ...
  #be() {
    ...
    this.#Jt.classList.add('resizers');
    ...
    for (const i of t) {
      ...
      t.addEventListener('pointerdown', this.#Ae.bind(this, i), { signal: e });
      t.addEventListener('contextmenu', noContextMenu, { signal: e });
      t.tabIndex = -1;
    }
    this.div.prepend(this.#Jt);
  }
  #Ae(t, e) {
    e.preventDefault();
    ...
    window.addEventListener('pointermove', this.#ve.bind(this, t), {
      passive: !0,
      capture: !0,
      signal: a,
    });
    window.addEventListener('contextmenu', noContextMenu, { signal: a });
    const r = this.x,
      o = this.y,
      l = this.width,
      h = this.height,
      d = this.parent.div.style.cursor,
      c = this.div.style.cursor;
    ...
    const pointerUpCallback = () => {
      ...
      this.div.style.cursor = c;
      this.#ye(r, o, l, h);
    };
    window.addEventListener('pointerup', pointerUpCallback, { signal: a });
    window.addEventListener('blur', pointerUpCallback, { signal: a });
  }
  #ye(t, e, i, s) {
    const n = this.x,
      a = this.y,
  ...
  #ve(t, e) {
    const [i, s] = this.parentDimensions,
      ...
      d = this.#fe(this.rotation),
      transf = (t, e) => [d[0] * t + d[2] * e, d[1] * t + d[3] * e],
      c = this.#fe(360 - this.rotation);
    let u,
      p,
      g = !1,
      m = !1;
    ...
    let w = 1,
      x = 1,
      [_, E] = this.screenToPageTranslation(e.movementX, e.movementY);
    [_, E] = ((C = _ / i), (S = E / s), [c[0] * C + c[2] * S, c[1] * C + c[3] * S]);
    var C, S;
    if (g) {
      const t = Math.hypot(r, o);
      w = x = Math.max(
        Math.min(Math.hypot(b[0] - f[0] - _, b[1] - f[1] - E) / t, 1 / r, 1 / o),
        l / r,
        h / o
      );
    } else
      m
        ? (w = Math.max(l, Math.min(1, Math.abs(b[0] - f[0] - _))) / r)
        : (x = Math.max(h, Math.min(1, Math.abs(b[1] - f[1] - E))) / o);
    const T = round(r * w),
      M = round(o * x);
    A = transf(...p(T, M));
    const k = v - A[0],
  ...
  async addEditToolbar() {
    if (this._editToolbar || this.#ae) return this._editToolbar;
  ...
  pointerdown(t) {
    ...
    if (0 !== t.button || (t.ctrlKey && e)) t.preventDefault();
      ...
      this.#ie = !0;
      this._isDraggable ? this.#xe(t) : this.#_e(t);
    }
  }
  #_e(t) {
    const { isMac: e } = util_FeatureTest.platform;
  ...
  #xe(t) {
    ...
    if (e) {
      ...
      this.#le = t.clientX;
      this.#he = t.clientY;
      const pointerMoveCallback = (t) => {
        const { clientX: e, clientY: i } = t,
          [s, n] = this.screenToPageTranslation(e - this.#le, i - this.#he);
        this.#le = e;
        this.#he = i;
    ...
    const pointerUpCallback = () => {
      ...
      this.#ie = !1;
      this._uiManager.endDragSession() || this.#_e(t);
    };
    window.addEventListener('pointerup', pointerUpCallback, { signal: s });
    window.addEventListener('blur', pointerUpCallback, { signal: s });
  }
  moveInDOM() {
    this.#oe && clearTimeout(this.#oe);
    this.#oe = setTimeout(() => {
      this.#oe = null;
  ...
  #we() {
    if (this.#te || !this.div) return;
    this.#te = new AbortController();
    const t = this._uiManager.combinedSignal(this.#te);
  ...
  makeResizable() {
    if (this.isResizable) {
      this.#be();
      this.#Jt.classList.remove('hidden');
  ...
  keydown(t) {
    ...
    this.#Zt = { savedX: this.x, savedY: this.y, savedWidth: this.width, savedHeight: this.height };
    const e = this.#Jt.children;
    if (!this.#Kt) {
      ...
      for (const e of this.#Kt) {
        ...
        e.addEventListener('focus', this.#Se.bind(this, n), { signal: s });
        e.setAttribute('data-l10n-id', AnnotationEditor._l10nResizer[n]);
      }
    }
    const i = this.#Kt[0];
    let s = 0;
    ...
    const n = (((360 - this.rotation + this.parentRotation) % 360) / 90) * (this.#Kt.length / 4);
    if (n !== s) {
      if (n < s) for (let t = 0; t < s - n; t++) this.#Jt.append(this.#Jt.firstChild);
      else if (n > s)
        for (let t = 0; t < n - s; t++) this.#Jt.firstChild.before(this.#Jt.lastChild);
      let t = 0;
      for (const i of e) {
        const e = this.#Kt[t++].getAttribute('data-resizer-name');
        i.setAttribute('data-l10n-id', AnnotationEditor._l10nResizer[e]);
      }
    }
    this.#Te(0);
    this.#re = !0;
    this.#Jt.firstChild.focus({ focusVisible: !0 });
    t.preventDefault();
  ...
  #Ce(t) {
    this.#re && t.relatedTarget?.parentNode !== this.#Jt && this.#pe();
  }
  #Se(t) {
    this.#ee = this.#re ? t : '';
  }
  ...
  _resizeWithKeyboard(t, e) {
    this.#re && this.#ve(this.#ee, { movementX: t, movementY: e });
  }
  #pe() {
    this.#re = !1;
    this.#Te(-1);
    if (this.#Zt) {
      const { savedX: t, savedY: e, savedWidth: i, savedHeight: s } = this.#Zt;
      this.#ye(t, e, i, s);
      this.#Zt = null;
    }
  }
...
class MurmurHash3_64 {
  constructor(t) {
    this.h1 = t ? 4294967295 & t : gt;
    this.h2 = t ? 4294967295 & t : gt;
  }
  update(t) {
    let e, i;
    if ('string' == typeof t) {
  ...
  hexdigest() {
    let t = this.h1,
      e = this.h2;
    t ^= e >>> 1;
    t = ((3981806797 * t) & mt) | ((36045 * t) & ft);
    e = ((4283543511 * e) & mt) | (((2950163797 * ((e << 16) | (t >>> 16))) & mt) >>> 16);
    t ^= e >>> 1;
    t = ((444984403 * t) & mt) | ((60499 * t) & ft);
    e = ((3301882366 * e) & mt) | (((3120437893 * ((e << 16) | (t >>> 16))) & mt) >>> 16);
    t ^= e >>> 1;
    return (t >>> 0).toString(16).padStart(8, '0') + (e >>> 0).toString(16).padStart(8, '0');
  }
}
const bt = Object.freeze({ map: null, hash: '', transfer: void 0 });
class AnnotationStorage {
  ...
  remove(t) {
    this.#Pe.delete(t);
    0 === this.#Pe.size && this.resetModified();
    if ('function' == typeof this.onAnnotationEditor) {
      for (const t of this.#Pe.values()) if (t instanceof AnnotationEditor) return;
      this.onAnnotationEditor(null);
    }
  }
  setValue(t, e) {
    ...
    s && this.#Fe();
    e instanceof AnnotationEditor &&
      'function' == typeof this.onAnnotationEditor &&
      this.onAnnotationEditor(e.constructor._type);
  }
  has(t) {
    return this.#Pe.has(t);
  }
  getAll() {
    return this.#Pe.size > 0 ? objectFromMap(this.#Pe) : null;
  }
  setAll(t) {
  ...
  get serializable() {
    if (0 === this.#Pe.size) return bt;
    const t = new Map(),
      e = new MurmurHash3_64(),
      i = [],
      s = Object.create(null);
    let n = !1;
    for (const [i, a] of this.#Pe) {
      const r = a instanceof AnnotationEditor ? a.serialize(!1, s) : a;
      if (r) {
        t.set(i, r);
    ...
    return t.size > 0 ? { map: t, hash: e.hexdigest(), transfer: i } : bt;
  }
  get editorStats() {
    let t = null;
    const e = new Map();
    for (const i of this.#Pe.values()) {
      if (!(i instanceof AnnotationEditor)) continue;
  ...
  get modifiedIds() {
    if (this.#ke) return this.#ke;
    const t = [];
    for (const e of this.#Pe.values())
      e instanceof AnnotationEditor &&
        e.annotationElementId &&
        e.serialize() &&
        t.push(e.annotationElementId);
    return (this.#ke = { ids: new Set(t), hash: t.join(',') });
  }
}
class PrintAnnotationStorage extends AnnotationStorage {
  ...
  get modifiedIds() {
    return shadow(this, 'modifiedIds', { ids: new Set(), hash: '' });
  }
}
class FontLoader {
  #Re = new Set();
    ...
    if (this.isFontLoadingAPISupported) {
      ...
      if (e) {
        ...
        try {
          ...
          warn(`Failed to load font '${e.family}': '${i}'.`);
          t.disableFontFace = !0;
          throw i;
        }
      }
  ...
  get isSyncFontLoadingSupported() {
    ...
    (e ||
      ...
      (t = !0);
    return shadow(this, 'isSyncFontLoadingSupported', t);
  }
    ...
    const { loadingRequests: e } = this,
      i = {
        ...
        complete: function completeRequest() {
          assert(!i.done, 'completeRequest() cannot be called twice.');
          i.done = !0;
  ...
  _prepareFontLoadEvent(t, e) {
    ...
    const h = 1482184792;
    let d = int32(l, 16);
    for (i = 0, s = o.length - 3; i < s; i += 4) d = (d - h + int32(o, i)) | 0;
    i < o.length && (d = (d - h + int32(o + 'XXX', i)) | 0);
    l = spliceString(
      l,
      16,
      4,
    ...
    const c = `@font-face {font-family:"${o}";src:${`url(data:font/opentype;base64,${btoa(l)});`}}`;
    this.insertRule(c);
    const u = this._document.createElement('div');
    u.style.visibility = 'hidden';
    u.style.width = u.style.height = '10px';
    u.style.position = 'absolute';
    u.style.top = u.style.left = '0px';
    for (const e of [t.loadedName, o]) {
      const t = this._document.createElement('span');
      t.textContent = 'Hi';
      t.style.fontFamily = e;
      u.append(t);
    }
    this._document.body.append(u);
...
class FontFaceObject {
  ...
  createFontFaceRule() {
    if (!this.data || this.disableFontFace) return null;
    const t = bytesToString(this.data),
  ...
  getPathGenerator(t, e) {
    ...
    try {
      ...
      warn(`getPathGenerator - ignoring character: "${t}".`);
    }
    ...
    for (let t = 0, e = i.length; t < e; )
      switch (i[t++]) {
        case st:
          {
            const [e, n, a, r, o, l] = i.slice(t, t + 6);
            s.push((t) => t.bezierCurveTo(e, n, a, r, o, l));
            t += 6;
          }
          break;
        case nt:
        ...
        case rt:
          {
            ...
            s.push((t) => t.quadraticCurveTo(e, n, a, r));
            t += 4;
          }
          break;
        case ot:
        ...
        case lt:
          ...
          break;
        case ht:
          assert(2 === s.length, 'Scale command is only valid at the third position.');
          break;
        case dt:
          {
            const [e, n, a, r, o, l] = i.slice(t, t + 6);
            s.push((t) => t.transform(e, n, a, r, o, l));
            t += 6;
          }
          break;
        case ct: {
          const [e, n] = i.slice(t, t + 2);
          s.push((t) => t.translate(e, n));
          t += 2;
        }
      }
    return (this.compiledGlyphs[e] = function glyphDrawer(t, e) {
      s[0](t);
      s[1](t);
      t.scale(e, -e);
...
if (e) {
  var At = Promise.withResolvers(),
    vt = null;
  (async () => {
    const t = await import('fs'),
      e = await import('http'),
      i = await import('https'),
      s = await import('url');
    return new Map(
      Object.entries({ fs: t, http: e, https: i, url: s, canvas: undefined, path2d: undefined })
    );
  })().then(
    (t) => {
      vt = t;
...
const node_utils_fetchData = function (t) {
  return NodePackages.get('fs')
    .promises.readFile(t)
...
class RadialAxialShadingPattern extends BaseShadingPattern {
  ...
  getPattern(t, e, i, s) {
    let n;
    if (s === wt || s === yt) {
      const a = e.current.getClippedPathBoundingBox(s, getCurrentTransform(t)) || [0, 0, 0, 0],
      ...
      h.translate(-a[0], -a[1]);
      i = Util.transform(i, [1, 0, 0, 1, a[0], a[1]]);
...
function drawTriangle(t, e, i, s, n, a, r, o) {
  ...
  for (let t = M; t <= k; t++) {
    ...
    N = y - (y - S) * e;
    O = w - (w - T) * e;
    const i = Math.round(Math.min(P, I)),
      s = Math.round(Math.max(P, I));
    let n = c * t + 4 * i;
    for (let t = i; t <= s; t++) {
      e = (P - t) / (P - I);
      e < 0 ? (e = 0) : e > 1 && (e = 1);
...
class MeshShadingPattern extends BaseShadingPattern {
  ...
  _createMeshCanvas(t, e, i) {
    ...
    return { canvas: g.canvas, offsetX: s - 2 * h, offsetY: n - 2 * d, scaleX: h, scaleY: d };
  }
  getPattern(t, e, i, s) {
    applyBoundingBox(t, this._bbox);
    let n;
    if (s === xt) n = Util.singularValueDecompose2dScale(getCurrentTransform(t));
    else {
      n = Util.singularValueDecompose2dScale(e.baseTransform);
      if (this.matrix) {
        const t = Util.singularValueDecompose2dScale(this.matrix);
        n = [n[0] * t[0], n[1] * t[1]];
      }
    }
    const a = this._createMeshCanvas(n, s === xt ? null : this._background, e.cachedCanvases);
    if (s !== xt) {
    ...
    return t.createPattern(a.canvas, 'no-repeat');
  }
}
...
class TilingPattern {
  ...
  createPatternCanvas(t) {
    ...
    const h = e[0],
      ...
      p = c - h,
      g = u - d,
      m = Util.singularValueDecompose2dScale(this.matrix),
      f = Util.singularValueDecompose2dScale(this.baseTransform),
      b = m[0] * f[0],
      A = m[1] * f[1];
    let v = p,
      y = g,
      w = !1,
      x = !1;
    const _ = Math.ceil(o * b),
      E = Math.ceil(l * A);
    _ >= Math.ceil(p * b) ? (v = o) : (w = !0);
    E >= Math.ceil(g * A) ? (y = l) : (x = !0);
    const C = this.getSizeAndScale(v, this.ctx.canvas.width, b),
      S = this.getSizeAndScale(y, this.ctx.canvas.height, A),
      T = t.cachedCanvases.getCanvas('pattern', C.size, S.size),
      M = T.context,
      k = r.createCanvasGraphics(M);
    k.groupLevel = t.groupLevel;
    this.setFillAndStrokeStyleToContext(k, s, a);
    M.translate(-C.scale * h, -S.scale * d);
    k.transform(C.scale, 0, 0, S.scale, 0, 0);
    M.save();
    this.clipBbox(k, h, d, c, u);
    k.baseTransform = getCurrentTransform(k.ctx);
    ...
    if (w || x) {
      ...
      w && (v = o);
      x && (y = l);
      const i = this.getSizeAndScale(v, this.ctx.canvas.width, b),
        s = this.getSizeAndScale(y, this.ctx.canvas.height, A),
        n = i.size,
        a = s.size,
        ...
        m = x ? Math.floor(g / l) : 0;
      for (let t = 0; t <= u; t++)
        for (let i = 0; i <= m; i++) c.drawImage(e, n * t, a * i, n, a, 0, 0, n, a);
      return { canvas: r.canvas, scaleX: i.scale, scaleY: s.scale, offsetX: h, offsetY: d };
    }
    return { canvas: T.canvas, scaleX: C.scale, scaleY: S.scale, offsetX: h, offsetY: d };
  }
  ...
  clipBbox(t, e, i, s, n) {
    const a = s - e,
      r = n - i;
    t.ctx.rect(e, i, a, r);
    t.current.updateRectMinMax(getCurrentTransform(t.ctx), [e, i, s, n]);
    t.clip();
    t.endPath();
  }
  setFillAndStrokeStyleToContext(t, e, i) {
    ...
    switch (e) {
      case _t:
        ...
        break;
      case Et:
        const a = Util.makeHexColor(i[0], i[1], i[2]);
        s.fillStyle = a;
        s.strokeStyle = a;
        n.fillColor = a;
        n.strokeColor = a;
        break;
      default:
        throw new FormatError(`Unsupported paint type: ${e}`);
    }
  }
  getPattern(t, e, i, s) {
    let n = i;
    if (s !== xt) {
      n = Util.transform(n, e.baseTransform);
      this.matrix && (n = Util.transform(n, this.matrix));
    }
...
function convertBlackAndWhiteToRGBA({
  ...
  const o = util_FeatureTest.isLittleEndian ? 4278190080 : 255,
    [l, h] = r ? [a, o] : [o, a],
    d = s >> 3,
    c = 7 & s,
    u = t.length;
...
function drawImageAtIntegerCoords(t, e, i, s, n, a, r, o, l, h) {
  const [d, c, u, p, g, m] = getCurrentTransform(t);
  if (0 === c && 0 === u) {
    const f = r * d + g,
      b = Math.round(f),
      A = o * p + m,
      ...
      x = (o + h) * p + m,
      _ = Math.abs(Math.round(x) - v) || 1;
    t.setTransform(Math.sign(d), 0, 0, Math.sign(p), b, v);
    t.drawImage(e, i, s, n, a, 0, 0, w, _);
    t.setTransform(d, c, u, p, g, m);
    return [w, _];
  }
  if (0 === d && 0 === p) {
    const f = o * u + g,
      ...
      x = (r + l) * c + m,
      _ = Math.abs(Math.round(x) - v) || 1;
    t.setTransform(0, Math.sign(c), Math.sign(u), 0, b, v);
    t.drawImage(e, i, s, n, a, 0, 0, _, w);
    t.setTransform(d, c, u, p, g, m);
    return [_, w];
  }
  t.drawImage(e, i, s, n, a, r, o, l, h);
  return [Math.hypot(d, c) * l, Math.hypot(u, p) * h];
}
class CanvasExtraState {
  ...
  updateRectMinMax(t, e) {
    const i = Util.applyTransform(e, t),
      s = Util.applyTransform(e.slice(2), t),
  ...
  updateCurvePathMinMax(t, e, i, s, n, a, r, o, l, h) {
    const d = Util.bezierBoundingBox(e, i, s, n, a, r, o, l, h);
    h || this.updateRectMinMax(t, d);
  }
  getPathBoundingBox(t = yt, e = null) {
    const i = [this.minX, this.minY, this.maxX, this.maxY];
    if (t === wt) {
      e || unreachable('Stroke bounding box must include transform.');
      const t = Util.singularValueDecompose2dScale(e),
  ...
  updateClipFromPath() {
    const t = Util.intersect(this.clipBox, this.getPathBoundingBox());
  ...
  getClippedPathBoundingBox(t = yt, e = null) {
    return Util.intersect(this.clipBox, this.getPathBoundingBox(t, e));
  }
}
function putBinaryImageData(t, e) {
  ...
  const i = e.height,
    ...
    a = (i - n) / Ct,
    r = 0 === n ? a : a + 1,
    o = t.createImageData(s, Ct);
  let l,
    h = 0;
  const d = e.data,
    c = o.data;
  let u, p, g, m;
  if (e.kind === _.GRAYSCALE_1BPP) {
    const e = d.byteLength,
      i = new Uint32Array(c.buffer, 0, c.byteLength >> 2),
      m = i.length,
      f = (s + 7) >> 3,
      b = 4294967295,
      A = util_FeatureTest.isLittleEndian ? 4278190080 : 255;
    for (u = 0; u < r; u++) {
      g = u < a ? Ct : n;
      l = 0;
      for (p = 0; p < g; p++) {
      ...
      for (; l < m; ) i[l++] = 0;
      t.putImageData(o, 0, u * Ct);
    }
  } else if (e.kind === _.RGBA_32BPP) {
    p = 0;
    m = s * Ct * 4;
    for (u = 0; u < a; u++) {
      c.set(d.subarray(h, h + m));
      h += m;
    ...
    if (e.kind !== _.RGB_24BPP) throw new Error(`bad image kind: ${e.kind}`);
    g = Ct;
    m = s * g;
    for (u = 0; u < r; u++) {
      if (u >= a) {
...
function getImageSmoothingEnabled(t, e) {
  if (e) return !0;
  const i = Util.singularValueDecompose2dScale(t);
  i[0] = Math.fround(i[0]);
  i[1] = Math.fround(i[1]);
  const s = Math.fround((globalThis.devicePixelRatio || 1) * PixelsPerInch.PDF_TO_CSS_UNITS);
  return i[0] <= s && i[1] <= s;
}
const St = ['butt', 'round', 'square'],
  Tt = ['miter', 'round', 'bevel'],
  Mt = {},
  kt = {};
class CanvasGraphics {
  ...
  executeOperatorList(t, e, i, s) {
    ...
    const o = n.length;
    if (o === r) return r;
    const l = o - r > 10 && 'function' == typeof i,
      h = l ? Date.now() + 15 : 0;
    let d = 0;
    const c = this.commonObjs,
      u = this.objs;
    let p;
    for (;;) {
      if (void 0 !== s && r === s.nextBreakPoint) {
        s.breakIt(r, i);
        return r;
      }
      p = a[r];
      if (p !== K.dependency) this[p].apply(this, n[r]);
      else
        for (const t of n[r]) {
          const e = t.startsWith('g_') ? c : u;
          if (!e.has(t)) {
            e.get(t, i);
            return r;
          }
  ...
  _createMaskCanvas(t) {
    ...
    if ((t.bitmap || t.data) && t.count > 1) {
      ...
      l = JSON.stringify(a ? r : [r.slice(0, 4), n]);
      o = this._cachedBitmapsMap.get(e);
      if (!o) {
        o = new Map();
        this._cachedBitmapsMap.set(e, o);
      }
      const i = o.get(l);
      if (i && !a) {
        return {
    ...
    if (!h) {
      d = this.cachedCanvases.getCanvas('maskCanvas', i, s);
      putBinaryImageMask(d.context, t);
    }
    let c = Util.transform(r, [1 / i, 0, 0, -1 / s, 0, 0]);
    c = Util.transform(c, [1, 0, 0, 1, 0, -s]);
    const [u, p, g, m] = Util.getAxialAlignedBoundingBox([0, 0, i, s], c),
      f = Math.round(g - u) || 1,
      b = Math.round(m - p) || 1,
      A = this.cachedCanvases.getCanvas('fillCanvas', f, b),
      v = A.context,
      y = u,
      w = p;
    v.translate(-y, -w);
    v.transform(...c);
    if (!h) {
      h = this._scaleImage(d.canvas, getCurrentTransformInverse(v));
      h = h.img;
      o && a && o.set(l, h);
    }
    v.imageSmoothingEnabled = getImageSmoothingEnabled(getCurrentTransform(v), t.interpolate);
    drawImageAtIntegerCoords(v, h, 0, 0, h.width, h.height, 0, 0, i, s);
    v.globalCompositeOperation = 'source-in';
    const x = Util.transform(getCurrentTransformInverse(v), [1, 0, 0, 1, -y, -w]);
    v.fillStyle = a ? n.getPattern(e, this, x, yt) : n;
    v.fillRect(0, 0, i, s);
    if (o && !a) {
      this.cachedCanvases.delete('fillCanvas');
      o.set(l, A.canvas);
    }
    return { canvas: A.canvas, offsetX: Math.round(y), offsetY: Math.round(w) };
  }
  setLineWidth(t) {
  ...
  setLineCap(t) {
    this.ctx.lineCap = St[t];
  }
  setLineJoin(t) {
    this.ctx.lineJoin = Tt[t];
  }
  setMiterLimit(t) {
  ...
  beginSMaskMode() {
    ...
    this.ctx = s.context;
    const n = this.ctx;
    n.setTransform(...getCurrentTransform(this.suspendedCtx));
    copyCtxState(this.suspendedCtx, n);
    ...
    if (a)
      if (u < 0 || p < 0 || u + i > c.width || p + s > c.height) {
        ...
        if (a.some((t) => 0 !== t)) {
          ...
          e.fillStyle = Util.makeHexColor(...a);
          e.fillRect(0, 0, i, s);
          e.globalCompositeOperation = 'source-over';
        }
        c = t.canvas;
        u = p = 0;
      } else if (a.some((t) => 0 !== t)) {
        t.save();
        t.globalAlpha = 1;
        t.setTransform(1, 0, 0, 1, 0, 0);
        const e = new Path2D();
        ...
        t.fillStyle = Util.makeHexColor(...a);
        t.fillRect(u, p, i, s);
        t.restore();
      }
    e.save();
      ...
      switch (0 | t[i]) {
        case K.rectangle:
          ...
          const t = e[u++],
            ...
            g = l + i;
          s.moveTo(o, l);
          if (0 === t || 0 === i) s.lineTo(p, g);
          else {
            s.lineTo(p, l);
            s.lineTo(p, g);
            s.lineTo(o, g);
          }
          d || n.updateRectMinMax(h, [o, l, p, g]);
          s.closePath();
          break;
        case K.moveTo:
          o = e[u++];
        ...
        case K.curveTo:
          ...
          o = e[u + 4];
          l = e[u + 5];
          s.bezierCurveTo(e[u], e[u + 1], e[u + 2], e[u + 3], o, l);
          n.updateCurvePathMinMax(h, a, r, e[u], e[u + 1], e[u + 2], e[u + 3], o, l, c);
          u += 6;
          break;
        case K.curveTo2:
          a = o;
          r = l;
          s.bezierCurveTo(o, l, e[u], e[u + 1], e[u + 2], e[u + 3]);
          n.updateCurvePathMinMax(h, a, r, o, l, e[u], e[u + 1], e[u + 2], e[u + 3], c);
          o = e[u + 2];
          l = e[u + 3];
          u += 4;
          break;
        case K.curveTo3:
          ...
          o = e[u + 2];
          l = e[u + 3];
          s.bezierCurveTo(e[u], e[u + 1], o, l, o, l);
          n.updateCurvePathMinMax(h, a, r, e[u], e[u + 1], o, l, o, l, c);
          u += 4;
          break;
        case K.closePath:
          s.closePath();
      }
    d && n.updateScalingPathMinMax(h, c);
  ...
  stroke(t = !0) {
    ...
    if (this.contentVisible)
      if ('object' == typeof i && i?.getPattern) {
        e.save();
        e.strokeStyle = i.getPattern(e, this, getCurrentTransformInverse(e), wt);
  ...
  fill(t = !0) {
    ...
    if (this.current.patternFill) {
      e.save();
      e.fillStyle = i.getPattern(e, this, getCurrentTransformInverse(e), yt);
      s = !0;
    }
    const n = this.current.getClippedPathBoundingBox();
    if (this.contentVisible && null !== n)
  ...
  setFont(t, e) {
    ...
    n.fontMatrix = i.fontMatrix || s;
    (0 !== n.fontMatrix[0] && 0 !== n.fontMatrix[3]) || warn('Invalid font matrix for font ' + t);
    if (e < 0) {
      e = -e;
      n.fontDirection = -1;
  ...
  paintChar(t, e, i, s) {
    const n = this.ctx,
      ...
      h = o & w,
      d = !!(o & x),
      c = a.patternFill && !r.missingFile;
    let u;
    (r.disableFontFace || d || c) && (u = r.getPathGenerator(this.commonObjs, t));
    if (r.disableFontFace || c) {
      n.save();
      n.translate(e, i);
      n.beginPath();
      u(n, l);
      ...
      (h !== b && h !== v) || n.fillText(t, e, i);
      (h !== A && h !== v) || n.strokeText(t, e, i);
    }
    if (d) {
      (this.pendingTextPaths ||= []).push({
        transform: getCurrentTransform(n),
        x: e,
        y: i,
        fontSize: l,
        addToPath: u,
  ...
  showText(t) {
    ...
    const n = this.ctx,
      ...
      p = i.defaultVMetrics,
      g = s * e.fontMatrix[0],
      m = e.textRenderingMode === b && !i.disableFontFace && !e.patternFill;
    n.save();
    n.transform(...e.textMatrix);
    n.translate(e.x, e.y + e.textRise);
    l > 0 ? n.scale(h, -1) : n.scale(h, 1);
    let f;
    if (e.patternFill) {
      n.save();
      const t = e.fillColor.getPattern(n, this, getCurrentTransformInverse(n), yt);
      f = getCurrentTransform(n);
      n.restore();
      n.fillStyle = t;
    }
    let y = e.lineWidth;
    ...
    if (0 === x || 0 === y) {
      const t = e.textRenderingMode & w;
      (t !== A && t !== v) || (y = this.getSinglePixelWidth());
    } else y /= x;
    if (1 !== a) {
      n.scale(a, a);
      y /= a;
    ...
    for (_ = 0; _ < d; ++_) {
      ...
      if (i.remeasure && w > 0) {
        ...
        if (w < t && this.isFontSubpixelAAEnabled) {
          const e = w / t;
          h = !0;
          n.save();
          n.scale(e, 1);
          v /= e;
        } else w !== t && (v += (((w - t) / 2e3) * s) / a);
      }
      if (this.contentVisible && (e.isInFont || i.missingFile))
        if (m && !A) n.fillText(b, v, y);
        else {
          this.paintChar(b, v, y, f);
          if (A) {
            const t = v + (s * A.offset.x) / a,
              e = y - (s * A.offset.y) / a;
            this.paintChar(A.fontChar, t, e, f);
          }
        }
      E += c ? w * g - d * l : w * g + d * l;
      h && n.restore();
  ...
  showType3Text(t) {
    ...
    if (!(i.textRenderingMode === y) && 0 !== a) {
      ...
      for (p = 0; p < u; ++p) {
        ...
        const s = (g.isSpace ? h : 0) + l,
          r = n.charProcOperatorList[g.operatorListId];
        if (!r) {
          warn(`Type3 character "${g.operatorListId}" is not available.`);
          continue;
        }
        if (this.contentVisible) {
          ...
          e.scale(a, a);
          e.transform(...c);
          this.executeOperatorList(r);
          this.restore();
        }
        m = Util.applyTransform([g.width, 0], c)[0] * a + s;
        e.translate(m, 0);
        i.x += m * d;
      }
      e.restore();
  ...
  getColorN_Pattern(t) {
    ...
    if ('TilingPattern' === t[0]) {
      const i = t[1],
        s = this.baseTransform || getCurrentTransform(this.ctx),
        n = {
      ...
      e = new TilingPattern(t, i, this.ctx, n, s);
  ...
  setStrokeRGBColor(t, e, i) {
    this.ctx.strokeStyle = this.current.strokeColor = Util.makeHexColor(t, e, i);
  }
  setStrokeTransparent() {
    this.ctx.strokeStyle = this.current.strokeColor = 'transparent';
  }
  setFillRGBColor(t, e, i) {
    this.ctx.fillStyle = this.current.fillColor = Util.makeHexColor(t, e, i);
  ...
  shadingFill(t) {
    ...
    e.fillStyle = i.getPattern(e, this, getCurrentTransformInverse(e), xt);
    const s = getCurrentTransformInverse(e);
    if (s) {
      const { width: t, height: i } = e.canvas,
        [n, a, r, o] = Util.getAxialAlignedBoundingBox([0, 0, t, i], s);
  ...
  paintFormXObjectBegin(t, e) {
    if (this.contentVisible) {
      ...
      if (e) {
        ...
        this.current.updateRectMinMax(getCurrentTransform(this.ctx), e);
        this.clip();
        this.endPath();
      }
    }
  ...
  beginGroup(t) {
    ...
    const e = this.ctx;
    t.isolated || info('TODO: Support non-isolated groups.');
    t.knockout && warn('Knockout groups not supported.');
    const i = getCurrentTransform(e);
    t.matrix && e.transform(...t.matrix);
    if (!t.bbox) throw new Error('Bounding box is required.');
    let s = Util.getAxialAlignedBoundingBox(t.bbox, getCurrentTransform(e));
    const n = [0, 0, e.canvas.width, e.canvas.height];
    s = Util.intersect(s, n) || [0, 0, 0, 0];
    const a = Math.floor(s[0]),
      r = Math.floor(s[1]),
      o = Math.max(Math.ceil(s[2]) - a, 1),
      l = Math.max(Math.ceil(s[3]) - r, 1);
    this.current.startNewPathAndClipBox([0, 0, o, l]);
    let h = 'groupAt' + this.groupLevel;
    t.smask && (h += '_smask_' + (this.smaskCounter++ % 2));
    const d = this.cachedCanvases.getCanvas(h, o, l),
      c = d.context;
    c.translate(-a, -r);
    c.transform(...i);
    if (t.smask)
  ...
  endGroup(t) {
    ...
    if (t.smask) {
      ...
      const i = Util.getAxialAlignedBoundingBox([0, 0, e.canvas.width, e.canvas.height], t);
  ...
  beginAnnotation(t, e, i, s, n) {
    ...
    if (e) {
      ...
      if (n && this.annotationCanvasMap) {
        ...
        e[2] = s;
        e[3] = a;
        const [n, r] = Util.singularValueDecompose2dScale(getCurrentTransform(this.ctx)),
          { viewportScale: o } = this,
          l = Math.ceil(s * this.outputScaleX * o),
          h = Math.ceil(a * this.outputScaleY * o);
        this.annotationCanvas = this.canvasFactory.create(l, h);
        const { canvas: d, context: c } = this.annotationCanvas;
  ...
  paintImageMaskXObjectRepeat(t, e, i = 0, s = 0, n, a) {
    ...
    const r = this.ctx;
    r.save();
    const o = getCurrentTransform(r);
    r.transform(e, i, s, n, 0, 0);
    const l = this._createMaskCanvas(t);
    r.setTransform(1, 0, 0, 1, l.offsetX - o[4], l.offsetY - o[5]);
    for (let t = 0, h = a.length; t < h; t += 2) {
      const h = Util.transform(o, [e, i, s, n, a[t], a[t + 1]]),
        [d, c] = Util.applyTransform([0, 0], h);
      r.drawImage(l.canvas, d, c);
    }
    r.restore();
    this.compose();
  }
  paintImageMaskXObjectGroup(t) {
    ...
    for (const n of t) {
      const { data: t, width: a, height: r, transform: o } = n,
        l = this.cachedCanvases.getCanvas('maskCanvas', a, r),
        h = l.context;
      h.save();
      putBinaryImageMask(h, this.getObject(t, n));
      h.globalCompositeOperation = 'source-in';
      h.fillStyle = s ? i.getPattern(h, this, getCurrentTransformInverse(e), yt) : i;
      h.fillRect(0, 0, a, r);
      h.restore();
      e.save();
      e.transform(...o);
      e.scale(1, -1);
      drawImageAtIntegerCoords(e, l.canvas, 0, 0, a, r, 0, -1, 1, 1);
      e.restore();
    }
    this.compose();
  }
  paintImageXObject(t) {
    ...
    e ? this.paintInlineImageXObject(e) : warn("Dependent image isn't ready yet");
  }
  paintImageXObjectRepeat(t, e, i, s) {
    ...
    for (let t = 0, n = s.length; t < n; t += 2)
      o.push({ transform: [e, 0, 0, i, s[t], s[t + 1]], x: 0, y: 0, w: a, h: r });
  ...
  paintInlineImageXObject(t) {
    ...
    if (t.bitmap) a = this.applyTransferMapsToBitmap(t);
      ...
      const e = this.cachedCanvases.getCanvas('inlineImage', i, s).context;
      putBinaryImageData(e, t);
      a = this.applyTransferMapsToCanvas(e);
    }
    const r = this._scaleImage(a, getCurrentTransformInverse(n));
    n.imageSmoothingEnabled = getImageSmoothingEnabled(getCurrentTransform(n), t.interpolate);
    drawImageAtIntegerCoords(n, r.img, 0, 0, r.paintWidth, r.paintHeight, 0, -s, i, s);
    this.compose();
    this.restore();
  }
  ...
  consumePath(t) {
    ...
    const i = this.ctx;
    if (this.pendingClip) {
      e || (this.pendingClip === kt ? i.clip('evenodd') : i.clip());
      this.pendingClip = null;
    }
...
for (const t in K)
  void 0 !== CanvasGraphics.prototype[t] &&
    (CanvasGraphics.prototype[K[t]] = CanvasGraphics.prototype[t]);
...
function wrapReason(t) {
  ...
  switch (t.name) {
    case 'AbortException':
      return new AbortException(t.message);
    case 'MissingPDFException':
      return new MissingPDFException(t.message);
    case 'PasswordException':
      return new PasswordException(t.message, t.code);
    case 'UnexpectedResponseException':
      return new UnexpectedResponseException(t.message, t.status);
    case 'UnknownErrorException':
      return new UnknownErrorException(t.message, t.details);
    default:
      return new UnknownErrorException(t.message, t.toString());
  }
}
class MessageHandler {
  constructor(t, e, i) {
    ...
    this._onComObjOnMessage = (t) => {
      ...
      if (e.callback) {
        ...
        if (e.callback === Pt) i.resolve(e.data);
        else {
          if (e.callback !== Ft) throw new Error('Unexpected callback case');
      ...
      } else e.streamId ? this.#He(e) : s(e.data);
    };
    ...
    return new ReadableStream(
      {
        ...
        cancel: (t) => {
          assert(t instanceof Error, 'cancel must have a valid reason');
          const e = Promise.withResolvers();
  ...
  #He(t) {
    const e = t.streamId,
      ...
      o = {
        enqueue(t, a = 1, r) {
          ...
          n.postMessage({ sourceName: i, targetName: s, stream: Lt, streamId: e, chunk: t }, r);
        },
        close() {
          if (!this.isCancelled) {
            this.isCancelled = !0;
            n.postMessage({ sourceName: i, targetName: s, stream: It, streamId: e });
            delete a.streamSinks[e];
          }
        },
        error(t) {
          assert(t instanceof Error, 'error must have a valid reason');
          if (!this.isCancelled) {
            this.isCancelled = !0;
            n.postMessage({
              sourceName: i,
    ...
    new Promise(function (e) {
      ...
      function () {
        n.postMessage({ sourceName: i, targetName: s, stream: Ht, streamId: e, success: !0 });
      },
      function (t) {
        n.postMessage({
          sourceName: i,
  ...
  #Be(t) {
    ...
    switch (t.stream) {
      case Ht:
        t.success ? a.startCall.resolve() : a.startCall.reject(wrapReason(t.reason));
        break;
      case Bt:
        t.success ? a.pullCall.resolve() : a.pullCall.reject(wrapReason(t.reason));
        break;
      case Ot:
        if (!r) {
          n.postMessage({ sourceName: i, targetName: s, stream: Bt, streamId: e, success: !0 });
          break;
        }
        ...
        break;
      case Lt:
        assert(a, 'enqueue should have stream controller');
        if (a.isClosed) break;
        a.controller.enqueue(t.chunk);
        break;
      case It:
        assert(a, 'close should have stream controller');
        if (a.isClosed) break;
        a.isClosed = !0;
        a.controller.close();
        this.#ze(a, e);
        break;
      case Nt:
        assert(a, 'error should have stream controller');
        a.controller.error(wrapReason(t.reason));
        this.#ze(a, e);
        break;
      case Rt:
        t.success ? a.cancelCall.resolve() : a.cancelCall.reject(wrapReason(t.reason));
        this.#ze(a, e);
        break;
      case Dt:
        if (!r) break;
        new Promise(function (e) {
          e(r.onCancel?.(wrapReason(t.reason)));
        }).then(
          function () {
            n.postMessage({ sourceName: i, targetName: s, stream: Rt, streamId: e, success: !0 });
          },
          function (t) {
            n.postMessage({
              sourceName: i,
        ...
        r.sinkCapability.reject(wrapReason(t.reason));
        r.isCancelled = !0;
...
class Metadata {
  ...
  get(t) {
    return this.#Ue.get(t) ?? null;
  }
  getAll() {
    return objectFromMap(this.#Ue);
  }
  has(t) {
    return this.#Ue.has(t);
  }
}
const zt = Symbol('INTERNAL');
class OptionalContentGroup {
  ...
  get visible() {
    if (this.#$e) return this.#Ve;
    if (!this.#Ve) return !1;
    const { print: t, view: e } = this.usage;
    return this.#We ? 'OFF' !== e?.viewState : !this.#Ge || 'OFF' !== t?.printState;
  }
  _setVisible(t, e, i = !1) {
    t !== zt && unreachable('Internal method `_setVisible` called.');
    this.#$e = i;
    this.#Ve = e;
  }
}
class OptionalContentConfig {
  ...
  constructor(t, e = r) {
    ...
    if (null !== t) {
      ...
      this.#Ye = t.order;
      for (const i of t.groups) this.#Xe.set(i.id, new OptionalContentGroup(e, i));
      if ('OFF' === t.baseState) for (const t of this.#Xe.values()) t._setVisible(zt, !1);
      for (const e of t.on) this.#Xe.get(e)._setVisible(zt, !0);
      for (const e of t.off) this.#Xe.get(e)._setVisible(zt, !1);
      this.#Ke = this.getHash();
    }
  }
  #Qe(t) {
    const e = t.length;
    ...
    for (let s = 1; s < e; s++) {
      const e = t[s];
      let n;
      if (Array.isArray(e)) n = this.#Qe(e);
      else {
        if (!this.#Xe.has(e)) {
          warn(`Optional content group not found: ${e}`);
          return !0;
        }
        n = this.#Xe.get(e).visible;
      }
      switch (i) {
        case 'And':
          if (!n) return !1;
  ...
  isVisible(t) {
    ...
    if ('OCG' === t.type) {
      if (!this.#Xe.has(t.id)) {
        warn(`Optional content group not found: ${t.id}`);
        return !0;
      }
      return this.#Xe.get(t.id).visible;
    }
    if ('OCMD' === t.type) {
      if (t.expression) return this.#Qe(t.expression);
      if (!t.policy || 'AnyOn' === t.policy) {
        for (const e of t.ids) {
          ...
          if (this.#Xe.get(e).visible) return !0;
        }
        return !1;
      }
      if ('AllOn' === t.policy) {
        for (const e of t.ids) {
          ...
          if (!this.#Xe.get(e).visible) return !1;
        }
        return !0;
      }
      if ('AnyOff' === t.policy) {
      ...
      warn(`Unknown optional content policy ${t.policy}.`);
      return !0;
    }
    warn(`Unknown group type ${t.type}.`);
    return !0;
  }
  setVisibility(t, e = !0) {
    const i = this.#Xe.get(t);
    if (i) {
      i._setVisible(zt, !!e, !0);
      this.#qe = null;
    } else warn(`Optional content group not found: ${t}`);
  }
      ...
      if (t)
        switch (i) {
          ...
          case 'OFF':
            ...
            break;
          case 'Toggle':
            t._setVisible(zt, !t.visible);
        }
    }
    this.#qe = null;
  }
  get hasInitialVisibility() {
    return null === this.#Ke || this.getHash() === this.#Ke;
  }
  getOrder() {
    return this.#Xe.size ? (this.#Ye ? this.#Ye.slice() : [...this.#Xe.keys()]) : null;
  }
  getGroups() {
    return this.#Xe.size > 0 ? objectFromMap(this.#Xe) : null;
  }
  getGroup(t) {
    return this.#Xe.get(t) || null;
  }
  getHash() {
    if (null !== this.#qe) return this.#qe;
    const t = new MurmurHash3_64();
    for (const [e, i] of this.#Xe) t.update(`${e}:${i.visible}`);
    return (this.#qe = t.hexdigest());
  }
}
class PDFDataTransportStream {
  constructor(t, { disableRange: e = !1, disableStream: i = !1 }) {
    assert(t, 'PDFDataTransportStream - missing required "pdfDataRangeTransport" argument.');
    const { length: s, initialData: n, progressiveDone: a, contentDispositionFilename: r } = t;
    this._queuedChunks = [];
  ...
  _onProgress(t) {
    void 0 === t.total
      ...
      : this._fullRequestReader?.onProgress?.({ loaded: t.loaded, total: t.total });
  }
  _onProgressiveDone() {
...
class PDFDataTransportStreamReader {
  constructor(t, e, i = !1, s = null) {
    this._stream = t;
    this._done = i || !1;
    this._filename = isPdfFile(s) ? s : null;
...
function validateRangeRequestCapabilities({
  ...
  if ('identity' !== (t.get('Content-Encoding') || 'identity')) return n;
...
function getArrayBuffer(t) {
  ...
  warn(`getArrayBuffer - unexpected data format: ${t}`);
...
class PDFFetchStream {
  constructor(t) {
    ...
    this.headers = createHeaders(this.isHttp, t.httpHeaders);
    this._fullRequestReader = null;
...
class PDFFetchStreamReader {
  constructor(t) {
    ...
    const i = new Headers(t.headers),
      s = e.url;
    fetch(s, createFetchOptions(i, this._withCredentials, this._abortController))
      .then((e) => {
        if (!validateResponseStatus(e.status)) throw createResponseStatusError(e.status, s);
        this._reader = e.body.getReader();
        this._headersCapability.resolve();
        const i = e.headers,
          { allowRangeRequests: n, suggestedLength: a } = validateRangeRequestCapabilities({
            responseHeaders: i,
            isHttp: t.isHttp,
        ...
        this._filename = extractFilenameFromHeader(i);
...
class PDFFetchStreamRangeReader {
  constructor(t, e, i) {
    ...
    const a = s.url;
    fetch(a, createFetchOptions(n, this._withCredentials, this._abortController))
      .then((t) => {
        if (!validateResponseStatus(t.status)) throw createResponseStatusError(t.status, a);
...
class NetworkManager {
  constructor({ url: t, httpHeaders: e, withCredentials: i }) {
    ...
    this.headers = createHeaders(this.isHttp, e);
  ...
  onStateChange(t, e) {
    ...
    const a = (function network_getArrayBuffer(t) {
      const e = t.response;
      return 'string' != typeof e ? e : stringToBytes(e).buffer;
    })(s);
    if (206 === n) {
...
class PDFNetworkStream {
  constructor(t) {
    this._source = t;
    this._manager = new NetworkManager(t);
...
class PDFNetworkStreamFullRequestReader {
  ...
  _onHeadersReceived() {
    const t = this._fullRequestId,
      ...
      { allowRangeRequests: s, suggestedLength: n } = validateRangeRequestCapabilities({
        responseHeaders: i,
  ...
  _onError(t) {
    this._storedError = createResponseStatusError(t, this._url);
...
function createRequest(t, e, i) {
  if ('http:' === t.protocol) {
    return NodePackages.get('http').request(t, { headers: e }, i);
  }
  return NodePackages.get('https').request(t, { headers: e }, i);
}
class PDFNodeStream {
  constructor(t) {
    this.source = t;
    this.url = (function parseUrlOrPath(t) {
      if (Ut.test(t)) return new URL(t);
      const e = NodePackages.get('url');
...
class PDFNodeStreamFullReader extends BaseFullReader {
  constructor(t) {
    ...
    this._request = createRequest(this._url, e, (e) => {
      if (404 === e.statusCode) {
        const t = new MissingPDFException(`Missing PDF "${this._url}".`);
        this._storedError = t;
        this._headersCapability.reject(t);
        return;
      }
...
class PDFNodeStreamRangeReader extends BaseRangeReader {
  constructor(t, e, i) {
    ...
    s.Range = `bytes=${e}-${i - 1}`;
    this._request = createRequest(this._url, s, (t) => {
...
class PDFNodeStreamFsFullReader extends BaseFullReader {
  constructor(t) {
    ...
    e.promises.lstat(this._url).then(
      ...
      (t) => {
        'ENOENT' === t.code && (t = new MissingPDFException(`Missing PDF "${this._url}".`));
        this._storedError = t;
        this._headersCapability.reject(t);
      }
    );
...
class PDFNodeStreamFsRangeReader extends BaseRangeReader {
  constructor(t, e, i) {
    super(t);
    const s = NodePackages.get('fs');
    this._setReadableStream(s.createReadStream(this._url, { start: e, end: i - 1 }));
  }
}
const jt = 30;
class TextLayer {
  #Je = Promise.withResolvers();
  #ut = null;
  #Ze = !1;
  ...
  static #mi = new Map();
  static #fi = new Map();
  static #bi = new WeakMap();
  static #Ai = null;
  static #vi = new Set();
  constructor({ textContentSource: t, container: e, viewport: i }) {
    if (t instanceof ReadableStream) this.#ci = t;
    else {
      if ('object' != typeof t) throw new Error('No "textContentSource" parameter specified.');
      this.#ci = new ReadableStream({
        start(e) {
          e.enqueue(t);
          e.close();
        },
    ...
    this.#ut = this.#ri = e;
    this.#li = i.scale * (globalThis.devicePixelRatio || 1);
    this.#oi = i.rotation;
    this.#ii = { div: null, properties: null, ctx: null };
    const { pageWidth: s, pageHeight: n, pageX: a, pageY: r } = i.rawDims;
    this.#gi = [1, 0, 0, -1, -a, r + n];
    this.#ni = s;
    this.#si = n;
    TextLayer.#yi();
    setLayerDimensions(e, i);
    this.#Je.promise
      .finally(() => {
        TextLayer.#vi.delete(this);
        this.#ii = null;
        this.#hi = null;
      })
      .catch(() => {});
  ...
  static get fontFamilyMap() {
    const { isWindows: t, isFirefox: e } = util_FeatureTest.platform;
    return shadow(
      this,
      'fontFamilyMap',
      new Map([
  ...
  render() {
    const pump = () => {
      this.#ai.read().then(({ value: t, done: e }) => {
        if (e) this.#Je.resolve();
        else {
          this.#ei ??= t.lang;
          Object.assign(this.#hi, t.styles);
          this.#wi(t.items);
          pump();
        }
      }, this.#Je.reject);
    };
    this.#ai = this.#ci.getReader();
    TextLayer.#vi.add(this);
    pump();
  ...
  update({ viewport: t, onBefore: e = null }) {
    ...
    if (s !== this.#oi) {
      e?.();
      this.#oi = s;
      setLayerDimensions(this.#ri, { rotation: s });
    }
    if (i !== this.#li) {
      e?.();
      this.#li = i;
      const t = { div: null, properties: null, ctx: TextLayer.#xi(this.#ei) };
      for (const e of this.#ui) {
        t.properties = this.#pi.get(e);
        t.div = e;
        this.#_i(t);
      }
    }
  ...
  cancel() {
    const t = new AbortException('TextLayer task cancelled.');
    this.#ai?.cancel(t).catch(() => {});
    this.#ai = null;
    this.#Je.reject(t);
  }
  get textDivs() {
  ...
  #wi(t) {
    if (this.#Ze) return;
    this.#ii.ctx ??= TextLayer.#xi(this.#ei);
    const e = this.#ui,
      i = this.#di;
    for (const s of t) {
      if (e.length > 1e5) {
  ...
  #Ei(t) {
    ...
    this.#ui.push(e);
    const s = Util.transform(this.#gi, t.transform);
    let n = Math.atan2(s[1], s[0]);
    const a = this.#hi[t.fontName];
    a.vertical && (n += Math.PI / 2);
    let r = (this.#ti && a.fontSubstitution) || a.fontFamily;
    r = TextLayer.fontFamilyMap.get(r) || r;
    const o = Math.hypot(s[2], s[3]),
      l = o * TextLayer.#Ci(r, this.#ei);
    let h, d;
    if (0 === n) {
      h = s[4];
      d = s[5] - l;
    ...
    const c = 'calc(var(--scale-factor)*',
      u = e.style;
    if (this.#ut === this.#ri) {
      u.left = `${((100 * h) / this.#ni).toFixed(2)}%`;
      u.top = `${((100 * d) / this.#si).toFixed(2)}%`;
    } else {
      u.left = `${c}${h.toFixed(2)}px)`;
      u.top = `${c}${d.toFixed(2)}px)`;
    }
    u.fontSize = `${c}${(TextLayer.#Ai * o).toFixed(2)}px)`;
    u.fontFamily = r;
    i.fontSize = o;
    e.setAttribute('role', 'presentation');
    e.textContent = t.str;
    e.dir = t.dir;
    this.#ti && (e.dataset.fontName = a.fontSubstitutionLoadedName || t.fontName);
  ...
  static cleanup() {
    if (!(this.#vi.size > 0)) {
      this.#mi.clear();
      for (const { canvas: t } of this.#fi.values()) t.remove();
      this.#fi.clear();
    }
  }
  static #xi(t = null) {
    ...
    if (!e) {
      ...
      this.#fi.set(t, e);
      this.#bi.set(e, { size: 0, family: '' });
    }
    return e;
  }
  static #Si(t, e, i) {
    const s = this.#bi.get(t);
    if (e !== s.size || i !== s.family) {
      t.font = `${e}px ${i}`;
      s.size = e;
      s.family = i;
    }
  ...
  static #yi() {
    ...
    this.#Ai = t.getBoundingClientRect().height;
    t.remove();
  }
  static #Ci(t, e) {
    const i = this.#mi.get(t);
    if (i) return i;
    const s = this.#xi(e);
    s.canvas.width = s.canvas.height = jt;
    this.#Si(s, jt, t);
    ...
    s.strokeStyle = 'red';
    s.clearRect(0, 0, jt, jt);
    s.strokeText('g', 0, 0);
    let o = s.getImageData(0, 0, jt, jt).data;
    r = 0;
    ...
    s.clearRect(0, 0, jt, jt);
    s.strokeText('A', 0, jt);
    o = s.getImageData(0, 0, jt, jt).data;
    a = 0;
    for (let t = 0, e = o.length; t < e; t += 4)
      if (o[t] > 0) {
        a = jt - Math.floor(t / 4 / jt);
        break;
      }
    s.canvas.width = s.canvas.height = 0;
    const l = a ? a / (a + r) : 0.8;
...
const Wt = 65536,
  Gt = e
    ? class NodeCanvasFactory extends BaseCanvasFactory {
        _createCanvas(t, e) {
          return NodePackages.get('canvas').createCanvas(t, e);
        }
      }
  ...
  $t = e
    ? class NodeCMapReaderFactory extends BaseCMapReaderFactory {
        _fetchData(t, e) {
          return node_utils_fetchData(t).then((t) => ({ cMapData: t, compressionType: e }));
        }
      }
  ...
  Vt = e
    ...
    : class DOMFilterFactory extends BaseFilterFactory {
        ...
        get #w() {
          return (this.#Mi ||= new Map());
        }
        get #Ri() {
          return (this.#Di ||= new Map());
        }
        get #Ii() {
          if (!this.#ki) {
            ...
            e.top = e.left = 0;
            e.zIndex = -1;
            const i = this.#Fi.createElementNS(ut, 'svg');
            i.setAttribute('width', 0);
            i.setAttribute('height', 0);
            this.#ki = this.#Fi.createElementNS(ut, 'defs');
            t.append(i);
            i.append(this.#ki);
        ...
        #Ni(t) {
          ...
          return `url(${this.#Ti}#${t})`;
        }
        addFilter(t) {
          if (!t) return 'none';
          let e = this.#w.get(t);
          if (e) return e;
          const [i, s, n] = this.#Li(t),
          ...
          const r = `g_${this.#Pi}_transfer_map_${this.#v++}`,
            o = this.#Ni(r);
          this.#w.set(t, o);
          this.#w.set(a, o);
          const l = this.#Oi(r);
        ...
        addHCMFilter(t, e) {
          ...
          if (!t || !e) return n.url;
          const a = this.#Hi(t);
          t = Util.makeHexColor(...a);
          const r = this.#Hi(e);
          e = Util.makeHexColor(...r);
          this.#Ii.style.color = '';
          if (('#000000' === t && '#ffffff' === e) || t === e) return n.url;
          ...
          const l = o.join(','),
            h = `g_${this.#Pi}_hcm_filter`,
            d = (n.filter = this.#Oi(h));
          this.#Bi(l, l, l, d);
          this.#zi(d);
          const getSteps = (t, e) => {
            const i = a[t] / 255,
          ...
          this.#Bi(getSteps(0, 5), getSteps(1, 5), getSteps(2, 5), d);
          n.url = this.#Ni(h);
          return n.url;
        }
        addAlphaFilter(t) {
          ...
          const n = `g_${this.#Pi}_alpha_map_${this.#v++}`,
            a = this.#Ni(n);
          this.#w.set(t, a);
          this.#w.set(s, a);
          const r = this.#Oi(n);
        ...
        addLuminosityFilter(t) {
          ...
          const n = `g_${this.#Pi}_luminosity_map_${this.#v++}`,
            a = this.#Ni(n);
          this.#w.set(t, a);
          this.#w.set(i, a);
          const r = this.#Oi(n);
        ...
        addHighlightHCMFilter(t, e, i, s, n) {
          ...
          if (!e || !i) return r.url;
          const [o, l] = [e, i].map(this.#Hi.bind(this));
          let h = Math.round(0.2126 * o[0] + 0.7152 * o[1] + 0.0722 * o[2]),
            d = Math.round(0.2126 * l[0] + 0.7152 * l[1] + 0.0722 * l[2]),
            [c, u] = [s, n].map(this.#Hi.bind(this));
          d < h && ([h, d, c, u] = [d, h, u, c]);
          this.#Ii.style.color = '';
          const getSteps = (t, e, i) => {
            ...
            p = `g_${this.#Pi}_hcm_${t}_filter`,
            g = (r.filter = this.#Oi(p));
          this.#zi(g);
          this.#Bi(getSteps(c[0], u[0], 5), getSteps(c[1], u[1], 5), getSteps(c[2], u[2], 5), g);
          r.url = this.#Ni(p);
          return r.url;
        }
        destroy(t = !1) {
          if (!t || 0 === this.#Ri.size) {
            if (this.#ki) {
              this.#ki.parentNode.parentNode.remove();
              this.#ki = null;
            }
            if (this.#Mi) {
              this.#Mi.clear();
        ...
        #ji(t) {
          const e = this.#Fi.createElementNS(ut, 'feColorMatrix');
        ...
        #Oi(t) {
          const e = this.#Fi.createElementNS(ut, 'filter');
        ...
        #Wi(t, e, i) {
          const s = this.#Fi.createElementNS(ut, e);
          s.setAttribute('type', 'discrete');
          s.setAttribute('tableValues', i);
          t.append(s);
        }
        #Bi(t, e, i, s) {
          const n = this.#Fi.createElementNS(ut, 'feComponentTransfer');
          s.append(n);
          this.#Wi(n, 'feFuncR', t);
          this.#Wi(n, 'feFuncG', e);
          this.#Wi(n, 'feFuncB', i);
        ...
        #Ui(t, e) {
          const i = this.#Fi.createElementNS(ut, 'feComponentTransfer');
          e.append(i);
          this.#Wi(i, 'feFuncA', t);
        }
        #Hi(t) {
          this.#Ii.style.color = t;
          return getRGB(getComputedStyle(this.#Ii).getPropertyValue('color'));
        }
      },
  qt = e
    ? class NodeStandardFontDataFactory extends BaseStandardFontDataFactory {
        _fetchData(t) {
          return node_utils_fetchData(t);
        }
      }
...
function getDocument(t = {}) {
  ...
  const i = new PDFDocumentLoadingTask(),
    ...
    a = t.data
      ? (function getDataProp(t) {
          if (e && 'undefined' != typeof Buffer && t instanceof Buffer)
            throw new Error('Please provide binary data as `Uint8Array`, rather than `Buffer`.');
          if (t instanceof Uint8Array && t.byteLength === t.buffer.byteLength) return t;
          if ('string' == typeof t) return stringToBytes(t);
          if (
    ...
    l = t.password ?? null,
    h = t.range instanceof PDFDataRangeTransport ? t.range : null,
    d = Number.isInteger(t.rangeChunkSize) && t.rangeChunkSize > 0 ? t.rangeChunkSize : Wt;
  let c = t.worker instanceof PDFWorker ? t.worker : null;
  const u = t.verbosity,
    p = 'string' != typeof t.docBaseUrl || isDataScheme(t.docBaseUrl) ? null : t.docBaseUrl,
    g = 'string' == typeof t.cMapUrl ? t.cMapUrl : null,
    m = !1 !== t.cMapPacked,
    f = t.CMapReaderFactory || $t,
    b = 'string' == typeof t.standardFontDataUrl ? t.standardFontDataUrl : null,
    A = t.StandardFontDataFactory || qt,
    v = !0 !== t.stopAtErrors,
    y = Number.isInteger(t.maxImageSize) && t.maxImageSize > -1 ? t.maxImageSize : -1,
    w = !1 !== t.isEvalSupported,
    x = 'boolean' == typeof t.isOffscreenCanvasSupported ? t.isOffscreenCanvasSupported : !e,
    _ = Number.isInteger(t.canvasMaxAreaInBytes) ? t.canvasMaxAreaInBytes : -1,
    E = 'boolean' == typeof t.disableFontFace ? t.disableFontFace : e,
    ...
    F = !0 === t.pdfBug,
    D = t.CanvasFactory || Gt,
    R = t.FilterFactory || Vt,
    I = !0 === t.enableHWA,
    L = h ? h.length : (t.length ?? NaN),
    N = 'boolean' == typeof t.useSystemFonts ? t.useSystemFonts : !e && !E,
    O =
      'boolean' == typeof t.useWorkerFetch
        ? t.useWorkerFetch
        : f === DOMCMapReaderFactory &&
          A === DOMStandardFontDataFactory &&
          g &&
          b &&
          isValidFetchUrl(g, document.baseURI) &&
          isValidFetchUrl(b, document.baseURI);
  t.canvasFactory &&
  ...
  setVerbosityLevel(u);
  const B = {
    canvasFactory: new D({ ownerDocument: T, enableHWA: I }),
    filterFactory: new R({ docId: s, ownerDocument: T }),
    cMapReaderFactory: O ? null : new f({ baseUrl: g, isCompressed: m }),
    standardFontDataFactory: O ? null : new A({ baseUrl: b }),
  };
  if (!c) {
    const t = { verbosity: u, port: GlobalWorkerOptions.workerPort };
  ...
  c.promise
    .then(function () {
      ...
      const t = c.messageHandler.sendWithPromise('GetDocRequest', H, a ? [a.buffer] : null);
      let l;
      if (h) l = new PDFDataTransportStream(h, { disableRange: M, disableStream: k });
      else if (!a) {
        ...
        if (e) {
          t =
            ...
            isValidFetchUrl(n)
              ? PDFFetchStream
              : PDFNodeStream;
        } else t = isValidFetchUrl(n) ? PDFFetchStream : PDFNetworkStream;
        l = new t({
          url: n,
          length: L,
          httpHeaders: r,
      ...
      return t.then((t) => {
        if (i.destroyed) throw new Error('Loading aborted');
        if (c.destroyed) throw new Error('Worker was destroyed');
        const e = new MessageHandler(s, t, c.port),
          n = new WorkerTransport(e, i, l, z, B);
        i._transport = n;
        e.send('Ready', null);
      });
    })
...
class PDFDocumentLoadingTask {
  ...
  constructor() {
    ...
    this._worker = null;
    this.docId = 'd' + PDFDocumentLoadingTask.#Pi++;
    this.destroyed = !1;
...
class PDFPageProxy {
  ...
  constructor(t, e, i, s = !1) {
    ...
    this._pageInfo = e;
    this._transport = i;
    this._stats = s ? new StatTimer() : null;
    this._pdfBug = s;
  ...
  render({
    ...
    const u = this._transport.getRenderingIntent(i, s, d, c),
      { renderingIntent: g, cacheKey: m } = u;
    this.#$i = !1;
    this.#Vi();
    r ||= this._transport.getOptionalContentConfig(g);
    let f = this._intentStates.get(m);
    if (!f) {
      f = Object.create(null);
      this._intentStates.set(m, f);
    }
    if (f.streamReaderCancelTimeout) {
      clearTimeout(f.streamReaderCancelTimeout);
      f.streamReaderCancelTimeout = null;
    }
    const b = !!(g & o);
    if (!f.displayReadyCapability) {
      f.displayReadyCapability = Promise.withResolvers();
      f.operatorList = { fnArray: [], argsArray: [], lastChunk: !1, separateAnnots: null };
      this._stats?.time('Page Request');
      this._pumpOperatorList(u);
    }
    const complete = (t) => {
        f.renderTasks.delete(A);
        (this._maybeCleanupAfterRender || b) && (this.#$i = !0);
        this.#qi(!b);
        if (t) {
          A.capability.reject(t);
          this._abortOperatorList({
            intentState: f,
            reason: t instanceof Error ? t : new Error(t),
          });
        } else A.capability.resolve();
        if (this._stats) {
    ...
    (f.renderTasks ||= new Set()).add(A);
    const v = A.task;
    Promise.all([f.displayReadyCapability.promise, r])
      .then(([t, e]) => {
        if (this.destroyed) complete();
        else {
          this._stats?.time('Rendering');
          if (!(e.renderingIntent & g))
            throw new Error(
          ...
          A.initializeGraphics({ transparency: t, optionalContentConfig: e });
  ...
  getTextContent(t = {}) {
    if (this._transport._htmlForXfa) return this.getXfa().then((t) => XfaText.textContent(t));
  ...
  cleanup(t = !1) {
    this.#$i = !0;
    const e = this.#qi(!1);
    t && e && (this._stats &&= new StatTimer());
    return e;
  }
  #qi(t = !1) {
    this.#Vi();
    if (!this.#$i || this.destroyed) return !1;
    if (t) {
      this.#Gi = setTimeout(() => {
        this.#Gi = null;
        this.#qi(!1);
  ...
  _pumpOperatorList({
    ...
    const pump = () => {
      r.read().then(
        ({ value: t, done: e }) => {
          if (e) o.streamReader = null;
          else if (!this._transport.destroyed) {
            this._renderPageChunk(t, o);
            pump();
          }
        },
        (t) => {
  ...
  _abortOperatorList({ intentState: t, reason: e, force: i = !1 }) {
    if (t.streamReader) {
      ...
      t.streamReader.cancel(new AbortException(e.message)).catch(() => {});
      t.streamReader = null;
      if (!this._transport.destroyed) {
...
class LoopbackPort {
  ...
  postMessage(t, e) {
    ...
    this.#Ki.then(() => {
      for (const t of this.#Xi) t.call(this, i);
    });
  }
...
class PDFWorker {
  ...
  constructor({ name: t = null, port: e = null, verbosity: i = getVerbosityLevel() } = {}) {
    this.name = t;
    this.destroyed = !1;
    this.verbosity = i;
    this._readyCapability = Promise.withResolvers();
    ...
    if (e) {
      if (PDFWorker.#Ji?.has(e)) throw new Error('Cannot use more than one PDFWorker per port.');
      (PDFWorker.#Ji ||= new WeakMap()).set(e, this);
      this._initializeFromPort(e);
    } else this._initialize();
  }
  get promise() {
    return e
      ? Promise.all([NodePackages.promise, this._readyCapability.promise])
  ...
  _initializeFromPort(t) {
    this._port = t;
    this._messageHandler = new MessageHandler('main', 'worker', t);
    this._messageHandler.on('ready', function () {});
    this.#Zi();
  }
  _initialize() {
    if (PDFWorker.#Qi || PDFWorker.#ts) {
      this._setupFakeWorker();
      return;
    }
    let { workerSrc: t } = PDFWorker;
    try {
      PDFWorker._isSameOrigin(window.location.href, t) ||
        (t = PDFWorker._createCDNWrapper(new URL(t, window.location).href));
      const e = new Worker(t, { type: 'module' }),
        i = new MessageHandler('main', 'worker', e),
        terminateEarly = () => {
          s.abort();
          i.destroy();
          e.terminate();
  ...
  _setupFakeWorker() {
    ...
    PDFWorker._setupFakeWorkerGlobal
      .then((t) => {
        ...
        this._port = e;
        const i = 'fake' + PDFWorker.#Yi++,
          s = new MessageHandler(i + '_worker', i, e);
        t.setup(s, e);
        this._messageHandler = new MessageHandler(i, i + '_worker', e);
        this.#Zi();
      })
      .catch((t) => {
  ...
  destroy() {
    ...
    PDFWorker.#Ji?.delete(this._port);
    this._port = null;
...
class WorkerTransport {
  ...
  getRenderingIntent(t, e = p.ENABLE, i = null, s = !1, n = !1) {
    let g = r,
      m = bt;
    switch (t) {
      case 'any':
      ...
      case 'print':
        ...
        break;
      default:
        warn(`getRenderingIntent - invalid intent: ${t}`);
    }
    const f = g & o && i instanceof PrintAnnotationStorage ? i : this.annotationStorage;
    switch (e) {
      case p.DISABLE:
        g += d;
        break;
      ...
      case p.ENABLE_STORAGE:
        ...
        break;
      default:
        warn(`getRenderingIntent - invalid annotationMode: ${e}`);
    }
    s && (g += c);
    n && (g += u);
    const { ids: b, hash: A } = f.modifiedIds;
    return {
      renderingIntent: g,
      cacheKey: [g, m.hash, A].join('_'),
  ...
  destroy() {
    ...
    const t = [];
    for (const e of this.#is.values()) t.push(e._destroy());
    this.#is.clear();
    this.#ss.clear();
    this.#ns.clear();
  ...
  setupMessageHandler() {
        ...
        this._fullReader
          ...
          .then(function ({ value: t, done: i }) {
            if (i) e.close();
              ...
              assert(t instanceof ArrayBuffer, 'GetReader - expected an ArrayBuffer.');
          ...
          i.read()
            .then(function ({ value: t, done: i }) {
              if (i) e.close();
                ...
                assert(t instanceof ArrayBuffer, 'GetRangeReader - expected an ArrayBuffer.');
                e.enqueue(new Uint8Array(t), 1, [t]);
              }
            })
            .catch((t) => {
    ...
    t.on('DocException', function (t) {
      ...
      switch (t.name) {
        case 'PasswordException':
          i = new PasswordException(t.message, t.code);
          break;
        case 'InvalidPDFException':
          i = new InvalidPDFException(t.message);
          break;
        case 'MissingPDFException':
          i = new MissingPDFException(t.message);
          break;
        case 'UnexpectedResponseException':
          i = new UnexpectedResponseException(t.message, t.status);
          break;
        case 'UnknownErrorException':
          i = new UnknownErrorException(t.message, t.details);
          break;
        default:
    ...
    t.on('PasswordRequest', (t) => {
      ...
      if (e.onPassword) {
        const updatePassword = (t) => {
          t instanceof Error ? this.#as.reject(t) : this.#as.resolve({ password: t });
        };
        try {
      ...
      } else this.#as.reject(new PasswordException(t.message, t.code));
    ...
    t.on('StartRenderPage', (t) => {
      ...
      this.#is.get(t.pageIndex)._startRenderPage(t.transparency, t.cacheKey);
    });
    t.on('commonobj', ([e, i, s]) => {
      ...
      switch (i) {
        case 'Font':
          const { disableFontFace: n, fontExtraProperties: a, pdfBug: r } = this._params;
          if ('error' in s) {
            const t = s.error;
            warn(`Error during font loading: ${t}`);
          ...
          const o =
              r && globalThis.FontInspector?.enabled
                ...
                : null,
            l = new FontFaceObject(s, { disableFontFace: n, inspectFont: o });
          this.fontLoader
            .bind(l)
            .catch(() => t.sendWithPromise('FontFallback', { id: e }))
            .finally(() => {
              !a && l.data && (l.data = null);
              this.commonObjs.resolve(e, l);
            });
          break;
        case 'CopyLocalImage':
          const { imageRef: h } = s;
          assert(h, 'The imageRef must be defined.');
          for (const t of this.#is.values())
  ...
  getPage(t) {
    ...
    const e = t - 1,
      i = this.#ss.get(e);
    if (i) return i;
    const s = this.messageHandler.sendWithPromise('GetPage', { pageIndex: e }).then((i) => {
      if (this.destroyed) throw new Error('Transport destroyed');
      i.refStr && this.#ns.set(i.refStr, t);
      const s = new PDFPageProxy(e, i, this, this._params.pdfBug);
      this.#is.set(e, s);
      return s;
    });
    this.#ss.set(e, s);
  ...
  getFieldObjects() {
    return this.#rs('GetFieldObjects');
  }
  hasJSActions() {
    return this.#rs('HasJSActions');
  }
  getCalculationOrderIds() {
  ...
  getDocJSActions() {
    return this.#rs('GetDocJSActions');
  }
  getPageJSActions(t) {
  ...
  getOptionalContentConfig(t) {
    return this.#rs('GetOptionalContentConfig').then((e) => new OptionalContentConfig(e, t));
  }
  getPermissions() {
  ...
  cachedPageNumber(t) {
    if (!isRefProxy(t)) return null;
    const e = 0 === t.gen ? `${t.num}R` : `${t.num}R${t.gen}`;
    return this.#ns.get(e) ?? null;
  }
}
...
class PDFObjects {
  ...
  #ls(t) {
    return (this.#os[t] ||= { ...Promise.withResolvers(), data: Xt });
  }
  get(t, e = null) {
    if (e) {
      const i = this.#ls(t);
      i.promise.then(() => e(i.data));
      return null;
    }
    const i = this.#os[t];
    if (!i || i.data === Xt) throw new Error(`Requesting object that isn't resolved yet ${t}.`);
    return i.data;
  }
  has(t) {
    const e = this.#os[t];
  ...
  clear() {
    for (const t in this.#os) {
      const { data: e } = this.#os[t];
      e?.bitmap?.close();
    }
...
class RenderTask {
  ...
  get promise() {
    return this.#hs.capability.promise;
  }
  cancel(t = 0) {
    this.#hs.cancel(null, t);
  }
  get separateAnnots() {
    const { separateAnnots: t } = this.#hs.operatorList;
    if (!t) return !1;
    const { annotationCanvasMap: e } = this.#hs;
    return t.form || (t.canvas && e?.size > 0);
  }
}
class InternalRenderTask {
  #ds = null;
  static #cs = new WeakSet();
  constructor({
    callback: t,
    params: e,
    objs: i,
  ...
  initializeGraphics({ transparency: t = !1, optionalContentConfig: e }) {
    ...
    if (this._canvas) {
      if (InternalRenderTask.#cs.has(this._canvas))
        throw new Error(
          'Cannot use the same canvas during multiple render() operations. Use different canvas or ensure previous operations were cancelled or completed.'
        );
      InternalRenderTask.#cs.add(this._canvas);
    }
  ...
  cancel(t = null, e = 0) {
    ...
    this.gfx?.endDrawing();
    if (this.#ds) {
      window.cancelAnimationFrame(this.#ds);
      this.#ds = null;
    }
    InternalRenderTask.#cs.delete(this._canvas);
    this.callback(
      t || new RenderingCancelledException(`Rendering cancelled, page ${this._pageIndex + 1}`, e)
    );
  }
  operatorListChanged() {
  ...
  _scheduleNext() {
    this._useRequestAnimationFrame
      ? (this.#ds = window.requestAnimationFrame(() => {
          this.#ds = null;
        ...
        if (null !== a.value) {
          ...
          for (const t of i.children)
            t.attributes.value === a.value
              ...
              : t.attributes.hasOwnProperty('selected') && delete t.attributes.selected;
        }
        t.addEventListener('input', (t) => {
  ...
  static render(t) {
    ...
    if (0 === s.children.length) {
      if (s.value) {
        ...
        a.append(t);
        r && XfaText.shouldBuildText(s.name) && l.push(t);
      }
      return { textDivs: l };
    }
    const h = [[s, -1, a]];
    for (; h.length > 0; ) {
      ...
      const c = o?.attributes?.xmlns
        ? document.createElementNS(o.attributes.xmlns, d)
        : document.createElement(d);
      a.append(c);
      o.attributes &&
        this.setAttributes({ html: c, element: o, storage: e, intent: n, linkService: i });
      if (o.children?.length > 0) h.push([o, -1, c]);
      else if (o.value) {
        const t = document.createTextNode(o.value);
        r && XfaText.shouldBuildText(d) && l.push(t);
        c.append(t);
      }
    }
    for (const t of o.querySelectorAll('.xfaNonInteractive input, .xfaNonInteractive textarea'))
...
class AnnotationElement {
  ...
  constructor(
    t,
    { isRenderable: e = !1, ignoreBorder: i = !1, createQuadrilaterals: s = !1 } = {}
  ) {
    this.isRenderable = e;
    this.data = t.data;
    this.layer = t.layer;
  ...
  updateEdited(t) {
    ...
    this.#us ||= { rect: this.data.rect.slice(0) };
    const { rect: e } = t;
    e && this.#ms(e);
    this.#gs?.popup.updateEdited(t);
  }
  resetEdited() {
    if (this.#us) {
      this.#ms(this.#us.rect);
      this.#gs?.popup.resetEdited();
      this.#us = null;
    }
  }
  #ms(t) {
    ...
    i?.splice(0, 4, ...t);
    const { width: l, height: h } = getRectDims(t);
    e.left = (100 * (t[0] - r)) / n + '%';
    e.top = (100 * (a - t[3] + o)) / a + '%';
    if (0 === s) {
      e.width = (100 * l) / n + '%';
      e.height = (100 * h) / a + '%';
    } else this.setRotation(s);
  }
  _createContainer(t) {
    const {
        data: e,
    ...
    this instanceof WidgetAnnotationElement || (n.tabIndex = Qt);
    const { style: a } = n;
    a.zIndex = this.parent.zIndex++;
    e.popupRef && n.setAttribute('aria-haspopup', 'dialog');
    e.alternativeText && (n.title = e.alternativeText);
    e.noRotate && n.classList.add('norotate');
    if (!e.rect || this instanceof PopupAnnotationElement) {
      const { rotation: t } = e;
      e.hasOwnCanvas || 0 === t || this.setRotation(t, n);
      return n;
    }
    const { width: r, height: o } = getRectDims(e.rect);
    if (!t && e.borderStyle.width > 0) {
      ...
      if (s) {
        this.#ps = !0;
        a.borderColor = Util.makeHexColor(0 | s[0], 0 | s[1], 0 | s[2]);
      } else a.borderWidth = 0;
    }
  ...
  get _commonActions() {
    const setColor = (t, e, i) => {
      ...
      this.annotationStorage.setValue(this.data.id, { [e]: ColorConverters[`${n}_rgb`](a) });
    };
  ...
  _createQuadrilaterals() {
    ...
    for (let i = 2, s = t.length; i < s; i += 8) {
      ...
      u.append(p);
      r?.push(
        `<rect vector-effect="non-scaling-stroke" x="${g}" y="${m}" width="${f}" height="${b}"/>`
      );
    }
    if (this.#ps) {
      r.push("</g></svg>')");
  ...
  _createPopup() {
    ...
    const i = (this.#gs = new PopupAnnotationElement({
      data: {
        color: e.color,
        titleObj: e.titleObj,
  ...
  _getElementsByName(t, e = null) {
      ...
      if (s)
        for (const { page: t, id: n, exportValues: a } of s) {
          ...
          !r || Jt.has(r)
            ...
            : warn(`_getElementsByName - element not allowed: ${n}`);
        }
      return i;
    }
    for (const s of document.getElementsByName(t)) {
      ...
      n !== e && Jt.has(s) && i.push({ id: n, exportValue: t, domElement: s });
    }
    return i;
  }
  show() {
...
class LinkAnnotationElement extends AnnotationElement {
  ...
  render() {
    ...
    if (t.url) {
      ...
      this.#fs(i, t.attachment, t.attachmentDest);
      s = !0;
    } else if (t.setOCGState) {
      this.#bs(i, t.setOCGState);
      s = !0;
    } else if (t.dest) {
        ...
        for (const t of a) {
          ...
          i &&
            (Jt.has(i)
              ...
              : warn(`_bindResetFormAction - element not allowed: ${e}`));
        }
        this.enableScripting &&
          this.linkService.eventBus?.dispatch('dispatcheventinsandbox', {
            source: this,
...
class WidgetAnnotationElement extends AnnotationElement {
  ...
  _getKeyModifier(t) {
    return util_FeatureTest.platform.isMac ? t.metaKey : t.ctrlKey;
  }
  ...
  _setBackgroundColor(t) {
    ...
    t.style.backgroundColor = null === e ? 'transparent' : Util.makeHexColor(e[0], e[1], e[2]);
  }
  _setTextStyle(t) {
    ...
    if (this.data.multiLine) {
      const t = Math.abs(this.data.rect[3] - this.data.rect[1] - 2),
        e = t / (Math.round(t / (n * s)) || 1);
      r = Math.min(s, roundToOneDecimal(e / n));
    } else {
      const t = Math.abs(this.data.rect[3] - this.data.rect[1] - 2);
      r = Math.min(s, roundToOneDecimal(t / n));
    }
    a.fontSize = `calc(${r}px * var(--scale-factor))`;
    a.color = Util.makeHexColor(i[0], i[1], i[2]);
...
class TextWidgetAnnotationElement extends WidgetAnnotationElement {
  constructor(t) {
    super(t, {
      isRenderable:
        t.renderForms || t.data.hasOwnCanvas || (!t.data.hasAppearance && !!t.data.fieldValue),
    });
  }
...
class RadioButtonWidgetAnnotationElement extends WidgetAnnotationElement {
  ...
  render() {
    ...
    if (s) for (const s of this._getElementsByName(e.fieldName, i)) t.setValue(s.id, { value: !1 });
    const n = document.createElement('input');
    Jt.add(n);
    n.setAttribute('data-element-id', i);
    n.disabled = e.readOnly;
...
class PopupAnnotationElement extends AnnotationElement {
  ...
  render() {
    ...
    const t = (this.popup = new PopupElement({
    ...
    this.container.setAttribute('aria-controls', e.map((t) => `${it}${t}`).join(','));
    return this.container;
  }
}
class PopupElement {
  #vs = this.#ys.bind(this);
  #ws = this.#xs.bind(this);
  #_s = this.#Es.bind(this);
  #Cs = this.#Ss.bind(this);
  #Ts = null;
  #ut = null;
  #Ms = null;
  #ks = null;
  ...
  constructor({
    ...
    this.#Ds = h;
    this.#Ps = i;
    this.#ks = PDFDateString.toDateObject(n);
    this.trigger = i.flatMap((t) => t.getElementsToTriggerPopup());
    for (const t of this.trigger) {
      t.addEventListener('click', this.#Cs);
      t.addEventListener('mouseenter', this.#_s);
      t.addEventListener('mouseleave', this.#ws);
      t.classList.add('popupTriggerArea');
    }
    for (const t of i) t.container?.addEventListener('keydown', this.#vs);
    this.#ut.hidden = !0;
    d && this.#Ss();
  }
  render() {
    if (this.#Is) return;
    const t = (this.#Is = document.createElement('div'));
    t.className = 'popup';
    if (this.#Ts) {
      const e = (t.style.outlineColor = Util.makeHexColor(...this.#Ts));
      if (CSS.supports('background-color', 'color-mix(in srgb, red 30%, white)'))
        t.style.backgroundColor = `color-mix(in srgb, ${e} 30%, white)`;
      else {
        const e = 0.7;
        t.style.backgroundColor = Util.makeHexColor(
          ...this.#Ts.map((t) => Math.floor(e * (255 - t) + t))
        );
      }
    }
    const e = document.createElement('span');
    ...
    e.append(i);
    ({ dir: i.dir, str: i.textContent } = this.#Os);
    t.append(e);
    if (this.#ks) {
      const t = document.createElement('span');
      t.classList.add('popupDate');
      t.setAttribute('data-l10n-id', 'pdfjs-annotation-date-time-string');
      t.setAttribute('data-l10n-args', JSON.stringify({ dateObj: this.#ks.valueOf() }));
      e.append(t);
    }
    const s = this.#Hs;
    if (s) {
      XfaLayer.render({ xfaHtml: s, intent: 'richText', div: t });
      t.lastChild.classList.add('richText', 'popupContent');
    } else {
      const e = this._formatContents(this.#Ms);
      t.append(e);
    }
    this.#ut.append(t);
  }
  get #Hs() {
    const t = this.#Ns,
      e = this.#Ms;
    return !t?.str || (e?.str && e.str !== t.str) ? null : this.#Ns.html || null;
  }
  get #zs() {
    return this.#Hs?.attributes?.style?.fontSize || 0;
  }
  get #Us() {
    return this.#Hs?.attributes?.style?.color || null;
  }
  #js(t) {
    const e = [],
      i = {
        str: t,
        html: { name: 'div', attributes: { dir: 'auto' }, children: [{ name: 'p', children: e }] },
      },
      s = {
        style: {
          color: this.#Us,
          fontSize: this.#zs ? `calc(${this.#zs}px * var(--scale-factor))` : '',
        },
      };
  ...
  #ys(t) {
    t.altKey ||
      ...
      t.ctrlKey ||
      t.metaKey ||
      (('Enter' === t.key || ('Escape' === t.key && this.#Rs)) && this.#Ss());
  }
  updateEdited({ rect: t, popupContent: e }) {
    this.#us ||= { contentsObj: this.#Ms, richText: this.#Ns };
    t && (this.#S = null);
    if (e) {
      this.#Ns = this.#js(e);
      this.#Ms = null;
  ...
  resetEdited() {
    if (this.#us) {
      ({ contentsObj: this.#Ms, richText: this.#Ns } = this.#us);
      this.#us = null;
      this.#Is?.remove();
      this.#Is = null;
      this.#S = null;
  ...
  #Ws() {
    ...
    for (const t of this.#Ps)
      if (!r || null !== Util.intersect(t.data.rect, r)) {
        r = t.data.rect;
        a = !0;
        break;
      }
    const o = Util.normalizeRect([r[0], t[3] - r[1] + t[1], r[2], t[3] - r[3] + t[1]]),
      l = a ? r[2] - r[0] + 5 : 0,
      h = o[0] + l,
      d = o[1];
    this.#S = [(100 * (h - s)) / e, (100 * (d - n)) / i];
    const { style: c } = this.#ut;
    c.left = `${this.#S[0]}%`;
    c.top = `${this.#S[1]}%`;
  }
  #Ss() {
    ...
    if (this.#Rs) {
      this.#Es();
      this.#ut.addEventListener('click', this.#Cs);
      this.#ut.addEventListener('keydown', this.#vs);
    } else {
      this.#xs();
      this.#ut.removeEventListener('click', this.#Cs);
      this.#ut.removeEventListener('keydown', this.#vs);
    }
  }
  #Es() {
    this.#Is || this.render();
    if (this.isVisible) this.#Rs && this.#ut.classList.add('focused');
    else {
      this.#Ws();
      this.#ut.hidden = !1;
  ...
  #xs() {
    ...
    if (!this.#Rs && this.isVisible) {
      this.#ut.hidden = !0;
      this.#ut.style.zIndex = parseInt(this.#ut.style.zIndex) - 1e3;
    }
  }
  forceHide() {
    this.#Bs = this.isVisible;
    this.#Bs && (this.#ut.hidden = !0);
  }
  maybeShow() {
    if (this.#Bs) {
      this.#Is || this.#Es();
...
class LineAnnotationElement extends AnnotationElement {
  ...
  render() {
    ...
    const t = this.data,
      ...
      n = (this.#Gs = this.svgFactory.createElement('svg:line'));
...
class SquareAnnotationElement extends AnnotationElement {
  ...
  render() {
    ...
    const t = this.data,
      ...
      a = (this.#$s = this.svgFactory.createElement('svg:rect'));
...
class CircleAnnotationElement extends AnnotationElement {
  ...
  render() {
    ...
    const t = this.data,
      ...
      s = this.svgFactory.create(e, i, !0),
      n = t.borderStyle.width,
      a = (this.#Vs = this.svgFactory.createElement('svg:ellipse'));
...
class PolylineAnnotationElement extends AnnotationElement {
  ...
  render() {
    ...
    const { width: n, height: a } = getRectDims(t),
    ...
    o = o.join(' ');
    const l = (this.#qs = this.svgFactory.createElement(this.svgElementName));
...
class InkAnnotationElement extends AnnotationElement {
  ...
  render() {
    ...
    const {
      ...
      { width: n, height: a } = getRectDims(t),
      r = this.svgFactory.create(n, a, !0);
    for (const n of e) {
      let e = [];
      ...
      a.setAttribute('stroke-width', i.width || 1);
      a.setAttribute('stroke', 'transparent');
      a.setAttribute('fill', 'transparent');
      !s && this.hasPopupData && this._createPopup();
      r.append(a);
...
class FileAttachmentAnnotationElement extends AnnotationElement {
  ...
  render() {
    ...
    i.addEventListener('dblclick', this.#Ys.bind(this));
    this.#Ks = i;
    const { isMac: s } = util_FeatureTest.platform;
    t.addEventListener('keydown', (t) => {
      'Enter' === t.key && (s ? t.metaKey : t.ctrlKey) && this.#Ys();
    });
...
class AnnotationLayer {
  ...
  async #en(t, e) {
    const i = t.firstChild || t,
      s = (i.id = `${it}${e}`),
      n = await this.#tn?.getAriaAttributes(s);
    if (n) for (const [t, e] of n) i.setAttribute(t, e);
    this.div.append(t);
    this.#Qs?.moveElementInDOM(this.div, t, i, !1);
  }
  async render(t) {
    ...
    const s = new Map(),
      n = {
        ...
        annotationStorage: t.annotationStorage || new AnnotationStorage(),
    ...
    for (const t of e) {
      ...
      n.data = t;
      const i = AnnotationElementFactory.create(n);
      ...
      await this.#en(a, t.id);
      if (i._isEditable) {
        this.#Zs.set(i.data.id, i);
  ...
  update({ viewport: t }) {
    const e = this.div;
    this.viewport = t;
    setLayerDimensions(e, { rotation: t.rotation });
    this.#in();
    e.hidden = !1;
  }
  #in() {
  ...
  getEditableAnnotations() {
    return Array.from(this.#Zs.values());
  }
  getEditableAnnotation(t) {
    return this.#Zs.get(t);
  }
}
const Zt = /\r\n?|\n/g;
class FreeTextEditor extends AnnotationEditor {
  ...
  constructor(t) {
    ...
    this.#Ts = t.color || FreeTextEditor._defaultColor || AnnotationEditor._defaultLineColor;
    this.#zs = t.fontSize || FreeTextEditor._defaultFontSize;
  }
  static initialize(t, e) {
    AnnotationEditor.initialize(t, e, { strings: ['pdfjs-free-text-default-content'] });
  ...
  static get defaultPropertiesToUpdate() {
    return [
      [m.FREETEXT_SIZE, FreeTextEditor._defaultFontSize],
      [m.FREETEXT_COLOR, FreeTextEditor._defaultColor || AnnotationEditor._defaultLineColor],
    ];
  }
  get propertiesToUpdate() {
    return [
      [m.FREETEXT_SIZE, this.#zs],
      [m.FREETEXT_COLOR, this.#Ts],
    ];
  }
  #rn(t) {
    const setFontsize = (t) => {
        this.editorDiv.style.fontSize = `calc(${t}px * var(--scale-factor))`;
        this.translate(0, -(t - this.#zs) * this.parentScale);
        this.#zs = t;
        this.#ln();
      },
      e = this.#zs;
    this.addCommands({
      cmd: setFontsize.bind(this, t),
      undo: setFontsize.bind(this, e),
  ...
  #on(t) {
    const setColor = (t) => {
        this.#Ts = this.editorDiv.style.color = t;
      },
      e = this.#Ts;
    this.addCommands({
      cmd: setColor.bind(this, t),
      undo: setColor.bind(this, e),
      post: this._uiManager.updateUI.bind(this._uiManager, this),
      mustExec: !0,
  ...
  getInitialTranslation() {
    ...
    return [
      ...
      -(FreeTextEditor._internalPadding + this.#zs) * t,
    ];
  }
  rebuild() {
    if (this.parent) {
  ...
  enableEditMode() {
    ...
    this.#an = new AbortController();
    const t = this._uiManager.combinedSignal(this.#an);
  ...
  disableEditMode() {
    if (this.isInEditMode()) {
      ...
      this.div.setAttribute('aria-activedescendant', this.#nn);
      this._isDraggable = !0;
      this.#an?.abort();
      this.#an = null;
  ...
  #hn() {
    ...
    for (const i of this.editorDiv.childNodes)
      if (e?.nodeType !== Node.TEXT_NODE || 'BR' !== i.nodeName) {
        t.push(FreeTextEditor.#dn(i));
        e = i;
      }
    return t.join('\n');
  }
  ...
  render() {
    ...
    this.editorDiv.setAttribute('id', this.#nn);
    this.editorDiv.setAttribute('data-l10n-id', 'pdfjs-free-text');
    this.enableEditing();
    AnnotationEditor._l10nPromise
      .get('pdfjs-free-text-default-content')
      .then((t) => this.editorDiv?.setAttribute('default-content', t));
    this.editorDiv.contentEditable = !0;
    const { style: i } = this.editorDiv;
    i.fontSize = `calc(${this.#zs}px * var(--scale-factor))`;
    i.color = this.#Ts;
  ...
  static #dn(t) {
    return (t.nodeType === Node.TEXT_NODE ? t.nodeValue : t.innerText).replaceAll(Zt, '');
  }
  editorDivPaste(t) {
    ...
    t.preventDefault();
    const s = FreeTextEditor.#un(e.getData('text') || '').replaceAll(Zt, '\n');
    if (!s) return;
    ...
    if (r.nodeType === Node.TEXT_NODE) {
      ...
      h.push(r.nodeValue.slice(o).replaceAll(Zt, ''));
      if (t !== this.editorDiv) {
        let e = l;
        for (const i of this.editorDiv.childNodes)
          i !== t ? e.push(FreeTextEditor.#dn(i)) : (e = h);
      }
      l.push(r.nodeValue.slice(0, o).replaceAll(Zt, ''));
    ...
    this.#cn();
    const d = new Range();
    let c = l.reduce((t, e) => t + e.length, 0);
  ...
  static async deserialize(t, e, i) {
    ...
    n.#zs = t.fontSize;
    n.#Ts = Util.makeHexColor(...t.color);
    n.#sn = FreeTextEditor.#un(t.value);
  ...
  serialize(t = !1) {
    ...
    const e = FreeTextEditor._internalPadding * this.parentScale,
      i = this.getRect(e, e),
      s = AnnotationEditor._colorManager.convert(
        this.isAttachedToDOM ? getComputedStyle(this.editorDiv).color : this.#Ts
      ),
      n = {
        annotationType: g.FREETEXT,
        color: s,
    ...
    if (t) return n;
    if (this.annotationElementId && !this.#gn(n)) return null;
  ...
  renderAnnotationElement(t) {
    ...
    const s = FreeTextEditor._internalPadding * this.parentScale;
    t.updateEdited({ rect: this.getRect(s, s), popupContent: this.#sn });
    return e;
  }
  resetAnnotationElement(t) {
    super.resetAnnotationElement(t);
    t.resetEdited();
  }
}
class Outliner {
  ...
  constructor(t, e = 0, i = 0, s = !0) {
    ...
    for (const { x: i, y: s, width: h, height: d } of t) {
      const t = Math.floor((i - e) / l) * l,
        c = Math.ceil((i + h + e) / l) * l,
        u = Math.floor((s - e) / l) * l,
        p = Math.ceil((s + d + e) / l) * l,
        g = [t, u, p, !0],
        m = [c, u, p, !1];
      this.#fn.push(g, m);
      n = Math.min(n, t);
    ...
    this.#mn = { x: c, y: u, width: h, height: d, lastPoint: g };
  }
  getOutlines() {
    this.#fn.sort((t, e) => t[0] - e[0] || t[1] - e[1] || t[2] - e[2]);
    const t = [];
    for (const e of this.#fn)
      if (e[3]) {
        t.push(...this.#An(e));
        this.#vn(e);
      } else {
  ...
  #wn(t) {
    ...
    return new HighlightOutline(s, this.#mn);
  }
  #xn(t) {
    const e = this.#bn;
    let i = 0,
  ...
  #vn([, t, e]) {
    const i = this.#xn(t);
    this.#bn.splice(i, 0, [t, e]);
  }
  #yn([, t, e]) {
    const i = this.#xn(t);
    for (let s = i; s < this.#bn.length; s++) {
      const [i, n] = this.#bn[s];
      if (i !== t) break;
      if (i === t && n === e) {
        this.#bn.splice(s, 1);
...
class FreeOutliner {
  ...
  static #Nn = 8;
  static #On = 2;
  static #Bn = FreeOutliner.#Nn + FreeOutliner.#On;
  constructor({ x: t, y: e }, i, s, n, a, r = 0) {
    this.#mn = i;
    this.#In = n * s;
    this.#Sn = a;
    this.#Mn.set([NaN, NaN, NaN, NaN, t, e], 6);
    this.#Cn = r;
    this.#Dn = FreeOutliner.#Nn * s;
    this.#Fn = FreeOutliner.#Bn * s;
    this.#Rn = s;
    this.#Ln.push(t, e);
  }
  get free() {
  ...
  isEmpty() {
    return isNaN(this.#Mn[8]);
  }
  #Hn() {
    const t = this.#Mn.subarray(4, 6),
      e = this.#Mn.subarray(16, 18),
      [i, s, n, a] = this.#mn;
    return [
      (this.#kn + (t[0] - e[0]) / 2 - i) / n,
      (this.#Pn + (t[1] - e[1]) / 2 - s) / a,
      (this.#kn + (e[0] - t[0]) / 2 - i) / n,
      (this.#Pn + (e[1] - t[1]) / 2 - s) / a,
    ];
  }
  add({ x: t, y: e }) {
    this.#kn = t;
    this.#Pn = e;
    const [i, s, n, a] = this.#mn;
    let [r, o, l, h] = this.#Mn.subarray(8, 12);
    const d = t - l,
      c = e - h,
      u = Math.hypot(d, c);
    if (u < this.#Fn) return !1;
    const p = u - this.#Dn,
      g = p / u,
      m = g * d,
      f = g * c;
    ...
    const v = m / p,
      y = (-f / p) * this.#In,
      w = v * this.#In;
    this.#Mn.set(this.#Mn.subarray(2, 8), 0);
    this.#Mn.set([l + y, h + w], 4);
    this.#Mn.set(this.#Mn.subarray(14, 18), 12);
    this.#Mn.set([l - y, h - w], 16);
    if (isNaN(this.#Mn[6])) {
      if (0 === this.#Tn.length) {
        this.#Mn.set([r + y, o + w], 2);
        this.#Tn.push(NaN, NaN, NaN, NaN, (r + y - i) / n, (o + w - s) / a);
        this.#Mn.set([r - y, o - w], 14);
        this.#En.push(NaN, NaN, NaN, NaN, (r - y - i) / n, (o - w - s) / a);
      }
      this.#Mn.set([b, A, r, o, l, h], 6);
      return !this.isEmpty();
    }
    this.#Mn.set([b, A, r, o, l, h], 6);
    if (Math.abs(Math.atan2(A - o, b - r) - Math.atan2(f, m)) < Math.PI / 2) {
      [r, o, l, h] = this.#Mn.subarray(2, 6);
      this.#Tn.push(NaN, NaN, NaN, NaN, ((r + l) / 2 - i) / n, ((o + h) / 2 - s) / a);
      [r, o, b, A] = this.#Mn.subarray(14, 18);
      this.#En.push(NaN, NaN, NaN, NaN, ((b + r) / 2 - i) / n, ((A + o) / 2 - s) / a);
      return !0;
    }
    [b, A, r, o, l, h] = this.#Mn.subarray(0, 6);
    this.#Tn.push(
      ((b + 5 * r) / 6 - i) / n,
      ((A + 5 * o) / 6 - s) / a,
      ((5 * r + l) / 6 - i) / n,
    ...
    [l, h, r, o, b, A] = this.#Mn.subarray(12, 18);
    this.#En.push(
      ((b + 5 * r) / 6 - i) / n,
      ((A + 5 * o) / 6 - s) / a,
      ((5 * r + l) / 6 - i) / n,
  ...
  toSVGPath() {
    ...
    const t = this.#Tn,
      e = this.#En,
      i = this.#Mn.subarray(4, 6),
      s = this.#Mn.subarray(16, 18),
      [n, a, r, o] = this.#mn,
      [l, h, d, c] = this.#Hn();
    if (isNaN(this.#Mn[6]) && !this.isEmpty())
      return `M${(this.#Mn[2] - n) / r} ${(this.#Mn[3] - a) / o} L${(this.#Mn[4] - n) / r} ${(this.#Mn[5] - a) / o} L${l} ${h} L${d} ${c} L${(this.#Mn[16] - n) / r} ${(this.#Mn[17] - a) / o} L${(this.#Mn[14] - n) / r} ${(this.#Mn[15] - a) / o} Z`;
    const u = [];
    u.push(`M${t[4]} ${t[5]}`);
    for (let e = 6; e < t.length; e += 6)
      isNaN(t[e])
        ? u.push(`L${t[e + 4]} ${t[e + 5]}`)
        : u.push(`C${t[e]} ${t[e + 1]} ${t[e + 2]} ${t[e + 3]} ${t[e + 4]} ${t[e + 5]}`);
    u.push(
      `L${(i[0] - n) / r} ${(i[1] - a) / o} L${l} ${h} L${d} ${c} L${(s[0] - n) / r} ${(s[1] - a) / o}`
    );
    for (let t = e.length - 6; t >= 6; t -= 6)
      isNaN(e[t])
        ? u.push(`L${e[t + 4]} ${e[t + 5]}`)
        : u.push(`C${e[t]} ${e[t + 1]} ${e[t + 2]} ${e[t + 3]} ${e[t + 4]} ${e[t + 5]}`);
    u.push(`L${e[4]} ${e[5]} Z`);
    return u.join(' ');
  }
  getOutlines() {
    const t = this.#Tn,
      ...
      n = i.subarray(16, 18),
      [a, r, o, l] = this.#mn,
      h = new Float64Array((this.#Ln?.length ?? 0) + 2);
    for (let t = 0, e = h.length - 2; t < e; t += 2) {
      h[t] = (this.#Ln[t] - a) / o;
      h[t + 1] = (this.#Ln[t + 1] - r) / l;
    }
    h[h.length - 2] = (this.#kn - a) / o;
    h[h.length - 1] = (this.#Pn - r) / l;
    const [d, c, u, p] = this.#Hn();
    if (isNaN(i[6]) && !this.isEmpty()) {
      ...
      return new FreeHighlightOutline(t, h, this.#mn, this.#Rn, this.#Cn, this.#Sn);
    }
    const g = new Float64Array(this.#Tn.length + 24 + this.#En.length);
    let m = t.length;
    for (let e = 0; e < m; e += 2)
      if (isNaN(t[e])) g[e] = g[e + 1] = NaN;
      else {
        g[e] = t[e];
        g[e + 1] = t[e + 1];
      }
    ...
    g.set([NaN, NaN, NaN, NaN, e[4], e[5]], m);
    return new FreeHighlightOutline(g, h, this.#mn, this.#Rn, this.#Cn, this.#Sn);
  }
}
class FreeHighlightOutline extends Outline {
  ...
  constructor(t, e, i, s, n, a) {
    ...
    this.#Sn = a;
    this.#jn(a);
    const { x: r, y: o, width: l, height: h } = this.#zn;
  ...
  toSVGPath() {
    const t = [`M${this.#Un[4]} ${this.#Un[5]}`];
    for (let e = 6, i = this.#Un.length; e < i; e += 6)
      isNaN(this.#Un[e])
        ? t.push(`L${this.#Un[e + 4]} ${this.#Un[e + 5]}`)
        : t.push(
            `C${this.#Un[e]} ${this.#Un[e + 1]} ${this.#Un[e + 2]} ${this.#Un[e + 3]} ${this.#Un[e + 4]} ${this.#Un[e + 5]}`
          );
    t.push('Z');
    return t.join(' ');
  }
  serialize([t, e, i, s], n) {
    ...
    switch (n) {
      case 0:
        o = this.#Wn(this.#Un, t, s, a, -r);
        l = this.#Wn(this.#Ln, t, s, a, -r);
        break;
      case 90:
        o = this.#Gn(this.#Un, t, e, a, r);
        l = this.#Gn(this.#Ln, t, e, a, r);
        break;
      case 180:
        o = this.#Wn(this.#Un, i, e, -a, r);
        l = this.#Wn(this.#Ln, i, e, -a, r);
        break;
      case 270:
        o = this.#Gn(this.#Un, i, s, -a, -r);
        l = this.#Gn(this.#Ln, i, s, -a, -r);
    }
  ...
  #jn(t) {
    ...
    for (let t = 6, c = e.length; t < c; t += 6) {
      if (isNaN(e[t])) {
        ...
        if (h < e[t + 5]) {
          l = e[t + 4];
          h = e[t + 5];
        } else h === e[t + 5] && (l = d(l, e[t + 4]));
      } else {
        const c = Util.bezierBoundingBox(i, s, ...e.slice(t, t + 6));
        n = Math.min(n, c[0]);
        a = Math.min(a, c[1]);
        r = Math.max(r, c[2]);
        o = Math.max(o, c[3]);
    ...
    const c = n - this.#Cn,
      ...
      p = r - n + 2 * this.#Cn,
      g = o - a + 2 * this.#Cn;
    this.#zn = { x: c, y: u, width: p, height: g, lastPoint: [l, h] };
  }
  get box() {
    return this.#zn;
  }
  getNewOutline(t, e) {
    const { x: i, y: s, width: n, height: a } = this.#zn,
      [r, o, l, h] = this.#mn,
      d = n * l,
      c = a * h,
      u = i * l + r,
      p = s * h + o,
      g = new FreeOutliner(
        { x: this.#Ln[0] * d + u, y: this.#Ln[1] * c + p },
        this.#mn,
        this.#Rn,
        t,
        this.#Sn,
    ...
    for (let t = 2; t < this.#Ln.length; t += 2)
      g.add({ x: this.#Ln[t] * d + u, y: this.#Ln[t + 1] * c + p });
...
class ColorPicker {
  ...
  constructor({ editor: t = null, uiManager: e = null }) {
    if (t) {
      this.#Qn = !1;
      this.#Zn = m.HIGHLIGHT_COLOR;
      this.#a = t;
    } else {
      this.#Qn = !0;
      this.#Zn = m.HIGHLIGHT_DEFAULT_COLOR;
    }
    this.#m = t?._uiManager || e;
    this.#Jn = this.#m._eventBus;
    this.#Xn = t?.color || this.#m?.highlightColors.values().next().value || '#FFFF98';
    ColorPicker.#ta ||= Object.freeze({
  ...
  renderButton() {
    const t = (this.#Vn = document.createElement('button'));
    t.className = 'colorPicker';
    t.tabIndex = '0';
    t.setAttribute('data-l10n-id', 'pdfjs-editor-colorpicker-button');
    t.setAttribute('aria-haspopup', !0);
    const e = this.#m._signal;
    t.addEventListener('click', this.#ea.bind(this), { signal: e });
    t.addEventListener('keydown', this.#vs, { signal: e });
    const i = (this.#qn = document.createElement('span'));
    i.className = 'swatch';
    i.setAttribute('aria-hidden', !0);
    i.style.backgroundColor = this.#Xn;
    t.append(i);
    return t;
  }
  renderMainDropdown() {
    const t = (this.#Kn = this.#ia());
  ...
  #ia() {
    ...
    for (const [i, s] of this.#m.highlightColors) {
      const n = document.createElement('button');
      n.tabIndex = '0';
      n.role = 'option';
      n.setAttribute('data-color', s);
      n.title = i;
      n.setAttribute('data-l10n-id', ColorPicker.#ta[i]);
      const a = document.createElement('span');
      n.append(a);
      a.className = 'swatch';
      a.style.backgroundColor = s;
      n.setAttribute('aria-selected', s === this.#Xn);
      n.addEventListener('click', this.#sa.bind(this, s), { signal: e });
      t.append(n);
    }
    t.addEventListener('keydown', this.#vs, { signal: e });
    return t;
  ...
  #sa(t, e) {
    e.stopPropagation();
    this.#Jn.dispatch('switchannotationeditorparams', { source: this, type: this.#Zn, value: t });
  }
  ...
  _moveToNext(t) {
    this.#na
      ? t.target !== this.#Vn
        ...
        : this.#Kn.firstChild?.focus()
      : this.#ea(t);
  }
  _moveToPrevious(t) {
    if (t.target !== this.#Kn?.firstChild && t.target !== this.#Vn) {
      this.#na || this.#ea(t);
      t.target.previousSibling?.focus();
    } else this.#na && this._hideDropdownFromKeyboard();
  }
  _moveToBeginning(t) {
    this.#na ? this.#Kn.firstChild?.focus() : this.#ea(t);
  }
  _moveToEnd(t) {
    this.#na ? this.#Kn.lastChild?.focus() : this.#ea(t);
  }
  #ys(t) {
  ...
  #ea(t) {
    ...
    this.#Yn = 0 === t.detail;
    window.addEventListener('pointerdown', this.#$n, { signal: this.#m._signal });
    if (this.#Kn) {
      this.#Kn.classList.remove('hidden');
      return;
    }
    const e = (this.#Kn = this.#ia());
    this.#Vn.append(e);
  }
  #h(t) {
    this.#Kn?.contains(t.target) || this.hideDropdown();
  }
  hideDropdown() {
    this.#Kn?.classList.add('hidden');
    window.removeEventListener('pointerdown', this.#$n);
  }
  get #na() {
    return this.#Kn && !this.#Kn.classList.contains('hidden');
  }
  _hideDropdownFromKeyboard() {
    if (!this.#Qn)
      if (this.#na) {
        this.hideDropdown();
        this.#Vn.focus({ preventScroll: !0, focusVisible: this.#Yn });
      } else this.#a?.unselect();
  }
  updateColor(t) {
    this.#qn && (this.#qn.style.backgroundColor = t);
    if (!this.#Kn) return;
    const e = this.#m.highlightColors.values();
    for (const i of this.#Kn.children) i.setAttribute('aria-selected', e.next().value === t);
  }
  destroy() {
    this.#Vn?.remove();
    this.#Vn = null;
...
class HighlightEditor extends AnnotationEditor {
  ...
  static get _keyboardManager() {
    const t = HighlightEditor.prototype;
    return shadow(
      this,
      '_keyboardManager',
      new KeyboardManager([
  ...
  constructor(t) {
    ...
    this.#In = t.thickness || HighlightEditor._defaultThickness;
    this.#fa = t.opacity || HighlightEditor._defaultOpacity;
    this.#oa = t.boxes || null;
    this.#va = t.methodOfCreation || '';
    this.#Aa = t.text || '';
    this._isDraggable = !1;
    if (t.highlightId > -1) {
      this.#ga = !0;
      ...
      this.#aa = t.anchorNode;
      this.#ra = t.anchorOffset;
      this.#da = t.focusNode;
      this.#ca = t.focusOffset;
      this.#xa();
      this.#wa();
  ...
  get telemetryInitialData() {
    return {
      action: 'added',
      type: this.#ga ? 'free_highlight' : 'highlight',
      color: this._uiManager.highlightColorNames.get(this.color),
      thickness: this.#In,
      methodOfCreation: this.#va,
    };
  }
  get telemetryFinalData() {
  ...
  #xa() {
    const t = new Outliner(this.#oa, 0.001);
    this.#pa = t.getOutlines();
    ({ x: this.x, y: this.y, width: this.width, height: this.height } = this.#pa.box);
    const e = new Outliner(this.#oa, 0.0025, 0.001, 'ltr' === this._uiManager.direction);
    this.#ha = e.getOutlines();
    const { lastPoint: i } = this.#ha.box;
    this.#ma = [(i[0] - this.x) / this.width, (i[1] - this.y) / this.height];
  }
  #ya({ highlightOutlines: t, highlightId: e, clipPathId: i }) {
    this.#pa = t;
    this.#ha = t.getNewOutline(this.#In / 2 + 1.5, 0.0025);
    if (e >= 0) {
      this.#v = e;
      this.#la = i;
      this.parent.drawLayer.finalizeLine(e, t);
      this.#ba = this.parent.drawLayer.highlightOutline(this.#ha);
    } else if (this.parent) {
      const e = this.parent.viewport.rotation;
      this.parent.drawLayer.updateLine(this.#v, t);
      this.parent.drawLayer.updateBox(
        this.#v,
        HighlightEditor.#_a(this.#pa.box, (e - this.rotation + 360) % 360)
      );
      this.parent.drawLayer.updateLine(this.#ba, this.#ha);
      this.parent.drawLayer.updateBox(this.#ba, HighlightEditor.#_a(this.#ha.box, e));
    }
    ...
    const { lastPoint: o } = this.#ha.box;
    this.#ma = [(o[0] - s) / a, (o[1] - n) / r];
  }
  static initialize(t, e) {
    AnnotationEditor.initialize(t, e);
    HighlightEditor._defaultColor ||= e.highlightColors?.values().next().value || '#fff066';
  }
  static updateDefaultParams(t, e) {
    switch (t) {
      case m.HIGHLIGHT_DEFAULT_COLOR:
        HighlightEditor._defaultColor = e;
        break;
      case m.HIGHLIGHT_THICKNESS:
        HighlightEditor._defaultThickness = e;
    }
  }
  translateInPage(t, e) {}
  get toolbarPosition() {
  ...
  static get defaultPropertiesToUpdate() {
    return [
      [m.HIGHLIGHT_DEFAULT_COLOR, HighlightEditor._defaultColor],
      [m.HIGHLIGHT_THICKNESS, HighlightEditor._defaultThickness],
    ];
  }
  get propertiesToUpdate() {
    return [
      [m.HIGHLIGHT_COLOR, this.color || HighlightEditor._defaultColor],
      [m.HIGHLIGHT_THICKNESS, this.#In || HighlightEditor._defaultThickness],
      [m.HIGHLIGHT_FREE, this.#ga],
    ];
  }
  #on(t) {
    const setColorAndOpacity = (t, e) => {
        this.color = t;
        this.parent?.drawLayer.changeColor(this.#v, t);
        this.#n?.updateColor(t);
        this.#fa = e;
        this.parent?.drawLayer.changeOpacity(this.#v, e);
      },
      e = this.color,
      i = this.#fa;
    this.addCommands({
      cmd: setColorAndOpacity.bind(this, t, HighlightEditor._defaultOpacity),
      undo: setColorAndOpacity.bind(this, e, i),
      post: this._uiManager.updateUI.bind(this._uiManager, this),
      mustExec: !0,
    ...
    this._reportTelemetry(
      { action: 'color_changed', color: this._uiManager.highlightColorNames.get(t) },
      !0
    );
  }
  #Ea(t) {
    ...
    this.addCommands({
      cmd: setThickness.bind(this, t),
      undo: setThickness.bind(this, e),
      post: this._uiManager.updateUI.bind(this._uiManager, this),
      mustExec: !0,
  ...
  fixAndSetPosition() {
    return super.fixAndSetPosition(this.#Sa());
  }
  getBaseTranslation() {
    return [0, 0];
  }
  getRect(t, e) {
    return super.getRect(t, e, this.#Sa());
  }
  onceAdded() {
  ...
  #Ca(t) {
    if (!this.#ga) return;
    this.#ya({ highlightOutlines: this.#pa.getNewOutline(t / 2) });
    this.fixAndSetPosition();
    const [e, i] = this.parentDimensions;
    this.setDims(this.width * e, this.height * i);
  }
  #Ta() {
    if (null !== this.#v && this.parent) {
      this.parent.drawLayer.remove(this.#v);
      this.#v = null;
      this.parent.drawLayer.remove(this.#ba);
      this.#ba = null;
    }
  }
  #wa(t = this.parent) {
    if (null === this.#v) {
      ({ id: this.#v, clipPathId: this.#la } = t.drawLayer.highlight(
        this.#pa,
        this.color,
        this.#fa
      ));
      this.#ba = t.drawLayer.highlightOutline(this.#ha);
      this.#ua && (this.#ua.style.clipPath = this.#la);
    }
  }
  static #_a({ x: t, y: e, width: i, height: s }, n) {
    switch (n) {
      case 90:
  ...
  rotate(t) {
    ...
    if (this.#ga) {
      ...
      i = HighlightEditor.#_a(this.#pa.box, t);
    } else i = HighlightEditor.#_a(this, t);
    e.rotate(this.#v, t);
    e.rotate(this.#ba, t);
    e.updateBox(this.#v, i);
    e.updateBox(this.#ba, HighlightEditor.#_a(this.#ha.box, t));
  }
  render() {
    if (this.div) return this.div;
    const t = super.render();
    if (this.#Aa) {
      t.setAttribute('aria-label', this.#Aa);
      t.setAttribute('role', 'mark');
    }
    this.#ga
      ? t.classList.add('free')
      : this.div.addEventListener('keydown', this.#Ma.bind(this), {
          signal: this._uiManager._signal,
        });
    const e = (this.#ua = document.createElement('div'));
    t.append(e);
    e.setAttribute('aria-hidden', 'true');
    e.className = 'internal';
    e.style.clipPath = this.#la;
    const [i, s] = this.parentDimensions;
    this.setDims(this.width * i, this.height * s);
    bindEvents(this, this.#ua, ['pointerover', 'pointerleave']);
    this.enableEditing();
    return t;
  }
  pointerover() {
    this.parent.drawLayer.addClass(this.#ba, 'hovered');
  }
  pointerleave() {
    this.parent.drawLayer.removeClass(this.#ba, 'hovered');
  }
  #Ma(t) {
    HighlightEditor._keyboardManager.exec(this, t);
  }
  _moveCaret(t) {
  ...
  #ka(t) {
    ...
    t ? e.setPosition(this.#aa, this.#ra) : e.setPosition(this.#da, this.#ca);
  }
  select() {
    super.select();
    if (this.#ba) {
      this.parent?.drawLayer.removeClass(this.#ba, 'hovered');
      this.parent?.drawLayer.addClass(this.#ba, 'selected');
    }
  }
  unselect() {
    super.unselect();
    if (this.#ba) {
      this.parent?.drawLayer.removeClass(this.#ba, 'selected');
      this.#ga || this.#ka(!1);
    }
  }
  get _mustFixPosition() {
  ...
  show(t = this._isVisible) {
    super.show(t);
    if (this.parent) {
      this.parent.drawLayer.show(this.#v, t);
      this.parent.drawLayer.show(this.#ba, t);
    }
  }
  #Sa() {
    return this.#ga ? this.rotation : 0;
  }
  #Pa() {
  ...
  #Fa(t) {
    return this.#pa.serialize(t, this.#Sa());
  }
  static startHighlighting(t, e, { target: i, x: s, y: n }) {
    const { x: a, y: r, width: o, height: l } = i.getBoundingClientRect(),
      h = new AbortController(),
      d = t.combinedSignal(h),
      pointerUpCallback = (e) => {
        h.abort();
        this.#Da(t, e);
      };
    window.addEventListener('blur', pointerUpCallback, { signal: d });
    window.addEventListener('pointerup', pointerUpCallback, { signal: d });
    window.addEventListener(
      ...
      { capture: !0, passive: !1, signal: d }
    );
    window.addEventListener('contextmenu', noContextMenu, { signal: d });
    i.addEventListener('pointermove', this.#Ra.bind(this, t), { signal: d });
    ...
    ({ id: this._freeHighlightId, clipPathId: this._freeHighlightClipId } = t.drawLayer.highlight(
      this._freeHighlight,
      this._defaultColor,
  ...
  static #Da(t, e) {
    this._freeHighlight.isEmpty()
      ? t.drawLayer.removeFreeHighlight(this._freeHighlightId)
  ...
  static async deserialize(t, e, i) {
    let s = null;
    if (t instanceof HighlightAnnotationElement) {
      const {
        data: { quadPoints: e, rect: i, rotation: n, id: a, color: r, opacity: o, popupRef: l },
        parent: {
          page: { pageNumber: h },
        },
      } = t;
    ...
    } else if (t instanceof InkAnnotationElement) {
      const {
        data: {
          inkLists: e,
          rect: i,
    ...
    l.color = Util.makeHexColor(...n);
    l.#fa = o || 1;
    r && (l.#In = t.thickness);
    l.annotationElementId = t.id || null;
    l._initialData = s;
    const [h, d] = l.pageDimensions,
      [c, u] = l.pageTranslation;
    if (a) {
      const t = (l.#oa = []);
      ...
      const t = r[0],
        i = { x: t[0] - c, y: d - (t[1] - u) },
        s = new FreeOutliner(i, [0, 0, h, d], 1, l.#In / 2, !0, 0.001);
      for (let e = 0, n = t.length; e < n; e += 2) {
        i.x = t[e] - c;
        i.y = d - (t[e + 1] - u);
        s.add(i);
      }
      const { id: n, clipPathId: a } = e.drawLayer.highlight(s, l.color, l._defaultOpacity, !0);
      l.#ya({ highlightOutlines: s.getOutlines(), highlightId: n, clipPathId: a });
      l.#wa();
    }
    return l;
  }
  serialize(t = !1) {
    ...
    const e = this.getRect(0, 0),
      i = AnnotationEditor._colorManager.convert(this.color),
      s = {
        annotationType: g.HIGHLIGHT,
        color: i,
        opacity: this.#fa,
    ...
    if (this.annotationElementId && !this.#gn(s)) return null;
  ...
  renderAnnotationElement(t) {
    t.updateEdited({ rect: this.getRect(0, 0) });
    return null;
  }
  static canCreateNewEmptyEditor() {
    return !1;
...
class InkEditor extends AnnotationEditor {
  ...
  static get defaultPropertiesToUpdate() {
    return [
      [m.INK_THICKNESS, InkEditor._defaultThickness],
      [m.INK_COLOR, InkEditor._defaultColor || AnnotationEditor._defaultLineColor],
      [m.INK_OPACITY, Math.round(100 * InkEditor._defaultOpacity)],
    ];
  }
  get propertiesToUpdate() {
    return [
      [m.INK_THICKNESS, this.thickness || InkEditor._defaultThickness],
      [m.INK_COLOR, this.color || InkEditor._defaultColor || AnnotationEditor._defaultLineColor],
      [m.INK_OPACITY, Math.round(100 * (this.opacity ?? InkEditor._defaultOpacity))],
    ];
  }
  #Ea(t) {
  ...
  #qa(t) {
    ...
    this.addCommands({
      cmd: setOpacity.bind(this, t),
      undo: setOpacity.bind(this, e),
      post: this._uiManager.updateUI.bind(this._uiManager, this),
      mustExec: !0,
      type: m.INK_OPACITY,
      overwriteIfSameType: !0,
  ...
  #ir() {
    ...
    t.lineJoin = 'round';
    t.miterLimit = 10;
    t.strokeStyle = `${e}${(function opacityToHex(t) {
  ...
  #sr(t, e) {
    this.canvas.addEventListener('contextmenu', noContextMenu, { signal: this._uiManager._signal });
    this.#tr();
    this.#Ha = new AbortController();
    const i = this._uiManager.combinedSignal(this.#Ha);
    this.canvas.addEventListener('pointerleave', this.canvasPointerleave.bind(this), { signal: i });
    this.canvas.addEventListener('pointermove', this.canvasPointermove.bind(this), { signal: i });
    this.canvas.addEventListener('pointerup', this.canvasPointerup.bind(this), { signal: i });
    this.isEditing = !0;
    if (!this.#Ua) {
      this.#Ua = !0;
      this.#Ja();
    ...
    this.#Va = () => {
      this.#nr();
      this.#Va && window.requestAnimationFrame(this.#Va);
    };
    window.requestAnimationFrame(this.#Va);
  }
  #ar(t, e) {
    ...
    if (n.length <= 2) {
      ...
      if (3 === n.length) {
        this.#Oa = a = new Path2D();
        a.moveTo(...n[0]);
      }
      this.#rr(a, ...n.at(-3), ...n.at(-2), t, e);
    }
  }
  #or() {
  ...
  #lr(t, e) {
    ...
    this.#or();
    let i;
    if (1 !== this.currentPath.length) i = this.#hr();
    else {
      const s = [t, e];
  ...
  #Za() {
    ...
    const t = this._uiManager.combinedSignal(this.#Wa);
  ...
  canvasPointerdown(t) {
    if (0 === t.button && this.isInEditMode() && !this.#Ba) {
      this.setInForeground();
      t.preventDefault();
      this.div.contains(document.activeElement) || this.div.focus({ preventScroll: !0 });
      this.#sr(t.offsetX, t.offsetY);
    }
  }
  canvasPointermove(t) {
    t.preventDefault();
    this.#ar(t.offsetX, t.offsetY);
  }
  canvasPointerup(t) {
    t.preventDefault();
    this.#cr(t);
  ...
  #br(t, e, i, s) {
    ...
    for (const e of this.paths) {
      ...
      n.push({
        bezier: InkEditor.#mr(i, s, this.rotation),
        points: InkEditor.#mr(a, s, this.rotation),
      });
    }
    return n;
  }
  #Ar() {
    ...
    for (const n of this.paths)
      for (const [a, r, o, l] of n) {
        const n = Util.bezierBoundingBox(...a, ...r, ...o, ...l);
        t = Math.min(t, n[0]);
        i = Math.min(i, n[1]);
        e = Math.max(e, n[2]);
        s = Math.max(s, n[3]);
  ...
  #pr() {
    return this.#Ba ? Math.ceil(this.thickness * this.parentScale) : 0;
  }
  #Xa(t = !1) {
    if (this.isEmpty()) return;
    if (!this.#Ba) {
    ...
    const e = this.#Ar(),
      i = this.#pr();
    this.#La = Math.max(AnnotationEditor.MIN_SIZE, e[2] - e[0]);
    this.#Ia = Math.max(AnnotationEditor.MIN_SIZE, e[3] - e[1]);
    const s = Math.ceil(i + this.#La * this.scaleFactor),
      n = Math.ceil(i + this.#Ia * this.scaleFactor),
      [a, r] = this.parentDimensions;
    this.width = s / a;
    this.height = n / r;
    this.setAspectRatio(s, n);
  ...
  static async deserialize(t, e, i) {
    ...
    s.#Ga = Math.round(r);
    s.#$a = Math.round(o);
    const { paths: d, rect: c, rotation: u } = t;
    for (let { bezier: t } of d) {
      t = InkEditor.#fr(t, c, u);
      const e = [];
      s.paths.push(e);
      let i = l * (t[0] - h),
        n = l * (t[1] - h);
    ...
    const p = s.#Ar();
    s.#La = Math.max(AnnotationEditor.MIN_SIZE, p[2] - p[0]);
    s.#Ia = Math.max(AnnotationEditor.MIN_SIZE, p[3] - p[1]);
    s.#ur(r, o);
    return s;
  }
  serialize() {
    ...
    const t = this.getRect(0, 0),
      e = AnnotationEditor._colorManager.convert(this.ctx.strokeStyle);
    return {
      annotationType: g.INK,
      color: e,
      thickness: this.thickness,
      opacity: this.opacity,
      paths: this.#br(this.scaleFactor / this.parentScale, this.translationX, this.translationY, t),
      pageIndex: this.pageIndex,
      rect: t,
      rotation: this.rotation,
      structTreeParentId: this._structTreeParentId,
...
class StampEditor extends AnnotationEditor {
  ...
  static get supportedTypes() {
    return shadow(
      this,
      'supportedTypes',
      ['apng', 'avif', 'bmp', 'gif', 'jpeg', 'png', 'svg+xml', 'webp', 'x-icon'].map(
        (t) => `image/${t}`
      )
    );
  }
  ...
  static paste(t, e) {
    e.pasteEditor(g.STAMP, { bitmapFile: t.getAsFile() });
  }
  altTextFinish() {
  ...
  async mlGuessAltText(t = null, e = !0) {
    ...
    const { data: s, width: n, height: a } = t || this.copyCanvas(null, null, !0).imageData,
      r = await i.guess({
        name: 'altText',
  ...
  #Fr() {
    ...
    if (this.#xr) {
      ...
      this.#xr = null;
      this._uiManager.enableWaiting(!0);
      this.#wr = this._uiManager.imageManager
        .getFromUrl(t)
        .then((t) => this.#kr(t))
        .finally(() => this.#Pr());
      return;
  ...
  remove() {
    if (this.#yr) {
      this.#vr = null;
      this._uiManager.imageManager.deleteId(this.#yr);
      this.#Cr?.remove();
      this.#Cr = null;
      this.#ja?.disconnect();
      this.#ja = null;
      if (this.#Sr) {
        clearTimeout(this.#Sr);
        this.#Sr = null;
      }
    }
    super.remove();
  ...
  rebuild() {
    if (this.parent) {
      super.rebuild();
      if (null !== this.div) {
        this.#yr && null === this.#Cr && this.#Fr();
        this.isAttachedToDOM || this.parent.add(this);
      }
    } else this.#yr && this.#Fr();
  }
  onceAdded() {
    this._isDraggable = !0;
    this.div.focus();
  ...
  isEmpty() {
    return !(this.#wr || this.#vr || this.#xr || this.#_r || this.#yr);
  }
  get isResizable() {
    return !0;
  }
  ...
  #Ya() {
    ...
    this._uiManager.enableWaiting(!1);
    const l = (this.#Cr = document.createElement('canvas'));
    ...
    this.#Er && l.setAttribute('aria-label', this.#Er);
  }
  copyCanvas(t, e, i = !1) {
    t || (t = 224);
    const { width: s, height: n } = this.#vr,
      a = new OutputScale();
    let r = this.#vr,
      o = s,
      l = n,
    ...
    if (e) {
      ...
      const t = (h.width = Math.ceil(o * a.sx)),
        i = (h.height = Math.ceil(l * a.sy));
      this.#Tr || (r = this.#Rr(t, i));
      const d = h.getContext('2d');
      d.filter = this._uiManager.hcmFilter;
      let c = 'white',
        u = '#cfcfd8';
      if ('none' !== this._uiManager.hcmFilter) u = 'black';
      ...
      d.fillRect(0, 0, t, i);
      d.drawImage(r, 0, 0, r.width, r.height, 0, 0, t, i);
    }
    let d = null;
    if (i) {
      let e, i;
      if (a.symmetric && r.width < t && r.height < t) {
        ...
        if (s > t || n > t) {
          ...
          e = Math.floor(s * a);
          i = Math.floor(n * a);
          this.#Tr || (r = this.#Rr(e, i));
        }
      }
      const o = new OffscreenCanvas(e, i).getContext('2d', { willReadFrequently: !0 });
      o.drawImage(r, 0, 0, r.width, r.height, 0, 0, e, i);
      d = { width: e, height: i, data: o.getImageData(0, 0, e, i).data };
    }
    return { canvas: h, width: o, height: l, imageData: d };
  }
  #Ir(t, e) {
    const [i, s] = this.parentDimensions;
    this.width = t / i;
    ...
    this._initialOptions = null;
    null !== this.#Sr && clearTimeout(this.#Sr);
    this.#Sr = setTimeout(() => {
      this.#Sr = null;
      this.#Dr(t, e);
    }, 200);
  ...
  #Rr(t, e) {
    const { width: i, height: s } = this.#vr;
    let n = i,
      a = s,
      r = this.#vr;
    for (; n > 2 * t || a > 2 * e; ) {
  ...
  #Dr(t, e) {
    ...
    a.width = s;
    a.height = n;
    const r = this.#Tr ? this.#vr : this.#Rr(s, n),
      o = a.getContext('2d');
  ...
  #Lr(t) {
    if (t) {
      if (this.#Tr) {
        const t = this._uiManager.imageManager.getSvgUrl(this.#yr);
        if (t) return t;
      }
      const t = document.createElement('canvas');
      ({ width: t.width, height: t.height } = this.#vr);
      t.getContext('2d').drawImage(this.#vr, 0, 0);
      return t.toDataURL();
    }
    if (this.#Tr) {
      const [t, e] = this.pageDimensions,
        i = Math.round(this.width * t * PixelsPerInch.PDF_TO_CSS_UNITS),
        s = Math.round(this.height * e * PixelsPerInch.PDF_TO_CSS_UNITS),
        n = new OffscreenCanvas(i, s);
      n.getContext('2d').drawImage(this.#vr, 0, 0, this.#vr.width, this.#vr.height, 0, 0, i, s);
      return n.transferToImageBitmap();
    }
    return structuredClone(this.#vr);
  }
  #Qa() {
    if (this._uiManager._signal) {
      this.#ja = new ResizeObserver((t) => {
        const e = t[0].contentRect;
        e.width && e.height && this.#Ir(e.width, e.height);
      });
      this.#ja.observe(this.div);
      this._uiManager._signal.addEventListener(
        'abort',
  ...
  static async deserialize(t, e, i) {
    ...
    if (t instanceof StampAnnotationElement) {
      const {
          data: { rect: n, rotation: a, id: r, structParent: o, popupRef: l },
          container: h,
          parent: {
            page: { pageNumber: d },
          },
        } = t,
        c = h.querySelector('canvas'),
        u = i.imageManager.getFromCanvas(h.id, c);
      c.remove();
      const p = (await e._structTree.getAriaAttributes(`${it}${r}`))?.get('aria-label') || '';
      s = t = {
    ...
    const n = await super.deserialize(t, e, i),
      { rect: a, bitmap: r, bitmapUrl: o, bitmapId: l, isSvg: h, accessibilityData: d } = t;
    if (l && i.imageManager.isValidId(l)) {
      n.#yr = l;
      r && (n.#vr = r);
    } else n.#xr = o;
    n.#Tr = h;
    const [c, u] = n.pageDimensions;
    n.width = (a[2] - a[0]) / c;
    n.height = (a[3] - a[1]) / u;
    n.annotationElementId = t.id || null;
    d && (n.altTextData = d);
  ...
  serialize(t = !1, e = null) {
    ...
    if (null === e) return i;
    e.stamps ||= new Map();
    const a = this.#Tr ? (i.rect[2] - i.rect[0]) * (i.rect[3] - i.rect[1]) : null;
    if (e.stamps.has(this.#yr)) {
      if (this.#Tr) {
        const t = e.stamps.get(this.#yr);
        if (a > t.area) {
          t.area = a;
          t.serialized.bitmap.close();
          t.serialized.bitmap = this.#Lr(!1);
        }
      }
    } else {
      e.stamps.set(this.#yr, { area: a, serialized: i });
      i.bitmap = this.#Lr(!1);
    }
    return i;
  }
...
class AnnotationEditorLayer {
  ...
  static #z = new Map(
    [FreeTextEditor, InkEditor, StampEditor, HighlightEditor].map((t) => [t._editorType, t])
  );
  constructor({
    uiManager: t,
    pageIndex: e,
    ...
    const d = [...AnnotationEditorLayer.#z.values()];
    if (!AnnotationEditorLayer._initialized) {
      AnnotationEditorLayer._initialized = !0;
      for (const e of d) e.initialize(h, t);
    }
  ...
  get isEmpty() {
    return 0 === this.#zr.size;
  }
  get isInvisible() {
    return this.isEmpty && this.#m.getMode() === g.NONE;
  }
  updateToolbar(t) {
    this.#m.updateToolbar(t);
  }
  updateMode(t = this.#m.getMode()) {
    this.#Vr();
    switch (t) {
      case g.NONE:
    ...
    for (const i of AnnotationEditorLayer.#z.values())
      e.toggle(`${i._type}Editing`, t === i._editorType);
    this.div.hidden = !1;
  }
  hasTextLayer(t) {
    return t === this.#Gr?.div;
  }
  addInkEditorIfNeeded(t) {
    if (this.#m.getMode() !== g.INK) return;
    if (!t)
      for (const t of this.#zr.values())
        if (t.isEmpty()) {
          t.setInBackground();
          return;
        }
  ...
  setEditingState(t) {
    this.#m.setEditingState(t);
  }
  addCommands(t) {
    this.#m.addCommands(t);
  }
  toggleDrawing(t = !1) {
  ...
  toggleAnnotationLayerPointerEvents(t = !1) {
    this.#Or?.div.classList.toggle('disabled', !t);
  }
  async enable() {
    this.div.tabIndex = 0;
    this.togglePointerEvents(!0);
    const t = new Set();
    for (const e of this.#zr.values()) {
      e.enableEditing();
      e.show(!0);
      if (e.annotationElementId) {
        this.#m.removeChangedExistingAnnotation(e);
        t.add(e.annotationElementId);
      }
    }
    if (!this.#Or) return;
    const e = this.#Or.getEditableAnnotations();
    for (const i of e) {
      i.hide();
      if (this.#m.isDeletedAnnotationElement(i.data.id)) continue;
  ...
  disable() {
    ...
    for (const i of this.#zr.values()) {
      ...
      if (i.annotationElementId)
        if (null === i.serialize()) {
          ...
          i.remove();
        } else t.set(i.annotationElementId, i);
    }
    if (this.#Or) {
      const i = this.#Or.getEditableAnnotations();
      for (const s of i) {
        const { id: i } = s.data;
        if (this.#m.isDeletedAnnotationElement(i)) continue;
        let n = e.get(i);
        if (n) {
          n.resetAnnotationElement(s);
          n.show(!1);
          s.show();
        } else {
          n = t.get(i);
          if (n) {
            this.#m.addChangedExistingAnnotation(n);
    ...
    for (const t of AnnotationEditorLayer.#z.values()) i.remove(`${t._type}Editing`);
    this.disableTextSelection();
    this.toggleAnnotationLayerPointerEvents(!0);
    this.#Wr = !1;
  }
  getEditableAnnotation(t) {
    return this.#Or?.getEditableAnnotation(t) || null;
  }
  setActiveEditor(t) {
    this.#m.getActive() !== t && this.#m.setActiveEditor(t);
  }
  enableTextSelection() {
    this.div.tabIndex = -1;
    if (this.#Gr?.div && !this.#$r) {
      this.#$r = new AbortController();
      const t = this.#m.combinedSignal(this.#$r);
      this.#Gr.div.addEventListener('pointerdown', this.#qr.bind(this), { signal: t });
      this.#Gr.div.classList.add('highlighting');
    }
  }
  disableTextSelection() {
    ...
    if (this.#Gr?.div && this.#$r) {
      this.#$r.abort();
      this.#$r = null;
      this.#Gr.div.classList.remove('highlighting');
    }
  }
  #qr(t) {
    this.#m.unselectAll();
    ...
    if (
      e === this.#Gr.div ||
      (('img' === e.getAttribute('role') || e.classList.contains('endOfContent')) &&
        this.#Gr.div.contains(e))
    ) {
      const { isMac: e } = util_FeatureTest.platform;
      if (0 !== t.button || (t.ctrlKey && e)) return;
      this.#m.showAllEditors('highlight', !0, !0);
      this.#Gr.div.classList.add('free');
      this.toggleDrawing();
      HighlightEditor.startHighlighting(this, 'ltr' === this.#m.direction, {
        target: this.#Gr.div,
        x: t.x,
        y: t.y,
      });
      this.#Gr.div.addEventListener(
        'pointerup',
        () => {
          this.#Gr.div.classList.remove('free');
          this.toggleDrawing(!0);
        },
        { once: !0, signal: this.#m._signal }
      );
      t.preventDefault();
    }
  }
  enableClick() {
    if (this.#Br) return;
    this.#Br = new AbortController();
    const t = this.#m.combinedSignal(this.#Br);
    this.div.addEventListener('pointerdown', this.pointerdown.bind(this), { signal: t });
    this.div.addEventListener('pointerup', this.pointerup.bind(this), { signal: t });
  }
  disableClick() {
    this.#Br?.abort();
    this.#Br = null;
  ...
  attach(t) {
    ...
    e && this.#m.isDeletedAnnotationElement(e) && this.#m.removeDeletedAnnotationElement(t);
  }
  detach(t) {
    this.#zr.delete(t.id);
    this.#Qs?.removePointerInTextLayer(t.contentDiv);
    !this.#Wr && t.annotationElementId && this.#m.addDeletedAnnotationElement(t);
  }
  remove(t) {
    this.detach(t);
    this.#m.removeEditor(t);
    t.div.remove();
    t.isAttachedToDOM = !1;
  ...
  changeParent(t) {
    if (t.parent !== this) {
      if (t.parent && t.annotationElementId) {
        this.#m.addDeletedAnnotationElement(t.annotationElementId);
        AnnotationEditor.deleteAnnotationElement(t);
  ...
  add(t) {
    if (t.parent !== this || !t.isAttachedToDOM) {
      ...
      t.fixAndSetPosition();
      t.onceAdded();
      this.#m.addToAnnotationStorage(t);
  ...
  moveEditorInDOM(t) {
    ...
    t._structTreeParentId = this.#Qs?.moveElementInDOM(this.div, t.div, t.contentDiv, !0);
  }
  addOrRebuild(t) {
  ...
  get #Xr() {
    return AnnotationEditorLayer.#z.get(this.#m.getMode());
  }
  combinedSignal(t) {
    return this.#m.combinedSignal(t);
  }
  #Kr(t) {
    const e = this.#Xr;
  ...
  canCreateNewEmptyEditor() {
    return this.#Xr?.canCreateNewEmptyEditor();
  }
  pasteEditor(t, e) {
    this.#m.updateToolbar(t);
    this.#m.updateMode(t);
    const { offsetX: i, offsetY: s } = this.#Yr(),
      n = this.getNextId(),
      a = this.#Kr({ parent: this, id: n, x: i, y: s, uiManager: this.#m, isCentered: !0, ...e });
    a && this.add(a);
  }
  async deserialize(t) {
    return (
      (await AnnotationEditorLayer.#z
        .get(t.annotationType ?? t.annotationEditorType)
        ?.deserialize(t, this, this.#m)) || null
    );
  }
  ...
  addNewEditor() {
    this.createAndAddNewEditor(this.#Yr(), !0);
  }
  setSelected(t) {
    this.#m.setSelected(t);
  }
  toggleSelected(t) {
    this.#m.toggleSelected(t);
  }
  isSelected(t) {
    return this.#m.isSelected(t);
  }
  unselect(t) {
    this.#m.unselect(t);
  }
  pointerup(t) {
    const { isMac: e } = util_FeatureTest.platform;
    if (!(0 !== t.button || (t.ctrlKey && e)) && t.target === this.div && this.#Ur) {
      this.#Ur = !1;
      this.#Nr
        ? this.#m.getMode() !== g.STAMP
  ...
  pointerdown(t) {
    ...
    this.#Ur = !0;
    const i = this.#m.getActive();
    this.#Nr = !i || i.isEmpty();
  }
  findNewParent(t, e, i) {
    const s = this.#m.findParent(e, i);
  ...
  #Vr() {
    this.#jr = !0;
    for (const t of this.#zr.values()) t.isEmpty() && t.remove();
    this.#jr = !1;
  }
  render({ viewport: t }) {
    this.viewport = t;
    setLayerDimensions(this.div, t);
    for (const t of this.#m.getEditors(this.pageIndex)) {
      this.add(t);
      t.rebuild();
    }
    this.updateMode();
  ...
  update({ viewport: t }) {
    ...
    const e = this.viewport.rotation,
      i = t.rotation;
    this.viewport = t;
    setLayerDimensions(this.div, { rotation: i });
    if (e !== i) for (const t of this.#zr.values()) t.rotate(i);
    this.addInkEditorIfNeeded(!1);
  }
  get pageDimensions() {
...
class DrawLayer {
  ...
  static #Zr(t, { x: e = 0, y: i = 0, width: s = 1, height: n = 1 } = {}) {
    const { style: a } = t;
    a.top = 100 * i + '%';
    a.left = 100 * e + '%';
    a.width = 100 * s + '%';
  ...
  highlight(t, e, i, s = !1) {
    ...
    s && this.#Jr.set(n, o);
    const h = this.#eo(r, l),
      d = DrawLayer._svgFactory.createElement('use');
    a.append(d);
    a.setAttribute('fill', e);
    a.setAttribute('fill-opacity', i);
    d.setAttribute('href', `#${l}`);
    this.#Qr.set(n, a);
    return { id: n, clipPathId: `url(#${h})` };
  }
  highlightOutline(t) {
    const e = this.#v++,
      i = this.#to(t.box);
    i.classList.add('highlightOutline');
    const s = DrawLayer._svgFactory.createElement('defs');
    i.append(s);
    const n = DrawLayer._svgFactory.createElement('path');
    s.append(n);
    ...
    if (t.free) {
      ...
      const t = DrawLayer._svgFactory.createElement('mask');
      s.append(t);
      r = `mask_p${this.pageIndex}_${e}`;
      t.setAttribute('id', r);
      t.setAttribute('maskUnits', 'objectBoundingBox');
      const n = DrawLayer._svgFactory.createElement('rect');
      t.append(n);
      ...
      o.setAttribute('fill-rule', 'nonzero');
      o.classList.add('mask');
    }
    const o = DrawLayer._svgFactory.createElement('use');
    i.append(o);
    o.setAttribute('href', `#${a}`);
  ...
  finalizeLine(t, e) {
    const i = this.#Jr.get(t);
    this.#Jr.delete(t);
    this.updateBox(t, e.box);
    i.setAttribute('d', e.toSVGPath());
  }
  updateLine(t, e) {
    this.#Qr.get(t).firstChild.firstChild.setAttribute('d', e.toSVGPath());
  }
  ...
  updatePath(t, e) {
    this.#Jr.get(t).setAttribute('d', e.toSVGPath());
  }
  updateBox(t, e) {
    DrawLayer.#Zr(this.#Qr.get(t), e);
  }
  show(t, e) {
    this.#Qr.get(t).classList.toggle('hidden', !e);
  }
  rotate(t, e) {
    this.#Qr.get(t).setAttribute('data-main-rotation', e);
  }
  changeColor(t, e) {
    this.#Qr.get(t).setAttribute('fill', e);
  }
  changeOpacity(t, e) {
    this.#Qr.get(t).setAttribute('fill-opacity', e);
  }
  addClass(t, e) {
    this.#Qr.get(t).classList.add(e);
  }
  removeClass(t, e) {
    this.#Qr.get(t).classList.remove(e);
  }
  getSVGRoot(t) {
    return this.#Qr.get(t);
  }
  remove(t) {
    if (null !== this.#Fs) {
      this.#Qr.get(t).remove();
      this.#Qr.delete(t);
    }
  }
  destroy() {
    this.#Fs = null;
    for (const t of this.#Qr.values()) t.remove();
    this.#Qr.clear();
  }
}
var te = __webpack_exports__.AbortException,
  ...
  ae = __webpack_exports__.AnnotationLayer,
  re = __webpack_exports__.AnnotationMode,
  oe = __webpack_exports__.CMapCompressionType,
  le = __webpack_exports__.ColorPicker,
  he = __webpack_exports__.DOMSVGFactory,
  de = __webpack_exports__.DrawLayer,
  ce = __webpack_exports__.FeatureTest,
  ue = __webpack_exports__.GlobalWorkerOptions,
  pe = __webpack_exports__.ImageKind,
  ge = __webpack_exports__.InvalidPDFException,
  me = __webpack_exports__.MissingPDFException,
  fe = __webpack_exports__.OPS,
  be = __webpack_exports__.OutputScale,
  Ae = __webpack_exports__.PDFDataRangeTransport,
  ve = __webpack_exports__.PDFDateString,
  ye = __webpack_exports__.PDFWorker,
  we = __webpack_exports__.PasswordResponses,
  xe = __webpack_exports__.PermissionFlag,
  _e = __webpack_exports__.PixelsPerInch,
  Ee = __webpack_exports__.RenderingCancelledException,
  Ce = __webpack_exports__.TextLayer,
  Se = __webpack_exports__.UnexpectedResponseException,
  Te = __webpack_exports__.Util,
  Me = __webpack_exports__.VerbosityLevel,
  ke = __webpack_exports__.XfaLayer,
  Pe = __webpack_exports__.build,
  Fe = __webpack_exports__.createValidAbsoluteUrl,
  De = __webpack_exports__.fetchData,
  Re = __webpack_exports__.getDocument,
  Ie = __webpack_exports__.getFilenameFromUrl,
  Le = __webpack_exports__.getPdfFilenameFromUrl,
  Ne = __webpack_exports__.getXfaPageViewport,
  Oe = __webpack_exports__.isDataScheme,
  Be = __webpack_exports__.isPdfFile,
  He = __webpack_exports__.noContextMenu,
  ze = __webpack_exports__.normalizeUnicode,
  Ue = __webpack_exports__.setLayerDimensions,
  je = __webpack_exports__.shadow,
  We = __webpack_exports__.version;
export {
  ...
  ae as AnnotationLayer,
  re as AnnotationMode,
  oe as CMapCompressionType,
  le as ColorPicker,
  he as DOMSVGFactory,
  de as DrawLayer,
  ce as FeatureTest,
  ue as GlobalWorkerOptions,
  pe as ImageKind,
  ge as InvalidPDFException,
  me as MissingPDFException,
  fe as OPS,
  be as OutputScale,
  Ae as PDFDataRangeTransport,
  ve as PDFDateString,
  ye as PDFWorker,
  we as PasswordResponses,
  xe as PermissionFlag,
  _e as PixelsPerInch,
  ...
  ke as XfaLayer,
  Pe as build,
  Fe as createValidAbsoluteUrl,
  De as fetchData,
  Re as getDocument,
  Ie as getFilenameFromUrl,
  Le as getPdfFilenameFromUrl,
  Ne as getXfaPageViewport,
  Oe as isDataScheme,
  Be as isPdfFile,
  He as noContextMenu,
  ze as normalizeUnicode,
