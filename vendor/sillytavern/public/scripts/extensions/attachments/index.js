...
function handleCharacterRename(oldAvatar, newAvatar) {
  ...
  if (Array.isArray(extension_settings?.character_attachments?.[oldAvatar])) {
    extension_settings.character_attachments[newAvatar] =
      extension_settings.character_attachments[oldAvatar];
...
export async function init() {
  ...
  const localEnumProviders = {
    ...
    attachments:
      ...
      (/** @type {SlashCommandExecutor} */ executor) => {
        const source =
          executor.namedArgumentList.find((it) => it.name == 'source')?.value ?? fallbackSource;
        if (source instanceof SlashCommandClosure)
          throw new Error("Argument 'source' does not support closures");
        const attachments = getAttachments(source);
  ...
  SlashCommandParser.addCommandObject(
    SlashCommand.fromProps({
      ...
      helpString:
        'List attachments in the Data Bank as a JSON-serialized array. Optionally, provide the source of the attachments and the field to list by.',
      namedArgumentList: [
        new SlashCommandNamedArgument(
          'source',
          'The source of the attachments.',
  ...
  SlashCommandParser.addCommandObject(
    SlashCommand.fromProps({
      ...
      helpString:
        'Get attachment text from the Data Bank. Either provide the name or URL of the attachment. Optionally, provide the source of the attachment.',
      namedArgumentList: [
        new SlashCommandNamedArgument(
          'source',
  ...
  SlashCommandParser.addCommandObject(
    SlashCommand.fromProps({
      ...
      helpString:
        'Add an attachment to the Data Bank. If name is not provided, it will be generated automatically. Returns the URL of the attachment.',
      namedArgumentList: [
        new SlashCommandNamedArgument(
          'source',
          'The source for the attachment.',
          ARGUMENT_TYPE.STRING,
          false,
          false,
          'chat',
  ...
  SlashCommandParser.addCommandObject(
    SlashCommand.fromProps({
      ...
      helpString:
        'Update an attachment in the Data Bank, preserving its name. Returns a new URL of the attachment.',
      namedArgumentList: [
        new SlashCommandNamedArgument(
          'source',
          'The source for the attachment.',
  ...
  SlashCommandParser.addCommandObject(
    SlashCommand.fromProps({
      ...
      helpString:
        'Disable an attachment in the Data Bank by its name or URL. Optionally, provide the source of the attachment.',
      namedArgumentList: [
        new SlashCommandNamedArgument(
          'source',
          'The source of the attachment.',
  ...
  SlashCommandParser.addCommandObject(
    SlashCommand.fromProps({
      ...
      helpString:
        'Enable an attachment in the Data Bank by its name or URL. Optionally, provide the source of the attachment.',
      namedArgumentList: [
        new SlashCommandNamedArgument(
          'source',
          'The source of the attachment.',
