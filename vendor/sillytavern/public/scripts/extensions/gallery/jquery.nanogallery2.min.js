...
(!(function (e) {
  ...
  function t(e) {
    ...
    return (
      null === t &&
        (((t = document.createElement('div')).id = 'ngyColorHelperToRGB'),
  ...
  function n(e, t, n) {
    var i = '';
    if (
      ('RGBA(' == t.toUpperCase().substring(0, 5) && ((i = 'a'), (t = 'rgb(' + t.substring(5))),
      'number' != typeof e ||
        e < -1 ||
        e > 1 ||
        'string' != typeof t ||
    ...
    function a(e) {
      ...
      if (t > 9) {
        ...
        (t < 6 &&
          (e = '#' + e[1] + e[1] + e[2] + e[2] + e[3] + e[3] + (t > 4 ? e[4] + '' + e[4] : '')),
          (e = o(e.slice(1), 16)),
          (n[0] = (e >> 16) & 255),
          (n[1] = (e >> 8) & 255),
          (n[2] = 255 & e),
              ...
              (u[3] > -1 && c[3] > -1
                ...
                : c[3] > -1
                  ...
                  : u[3] > -1
                    ? r(255 * u[3])
                    : 255) +
            65536 * r((c[0] - u[0]) * e + u[0]) +
            256 * r((c[1] - u[1]) * e + u[1]) +
            r((c[2] - u[2]) * e + u[2])
          )
            .toString(16)
            .slice(u[3] > -1 || c[3] > -1 ? 1 : 3)
      : null;
  }
  function i(e) {
  ...
  function l() {
    ((this.LightboxReOpen = function () {
      ...
      (this.ItemsSetSelectedValue = function (e, t) {
        for (var n = e.length, i = 0; i < n; i++) ge(e[i], t);
      }),
    ...
    ((this.Search = function (e) {
      ...
      (this.Search2 = function (e, t) {
        return (
          (u.GOM.albumSearch = null != e && null != e ? e.toUpperCase().trim() : ''),
      ...
      (this.Destroy = function () {
        (null != u.GOM.hammertime && (u.GOM.hammertime.destroy(), (u.GOM.hammertime = null)),
          null != u.VOM.hammertime && (u.VOM.hammertime.destroy(), (u.VOM.hammertime = null)),
          ...
          null !== u.$E.scrollableParent &&
            u.$E.scrollableParent.off('scroll.nanogallery2.' + u.baseEltID),
      ...
      (this.PaginationCountPages = function () {
        return 0 == u.GOM.items.length
          ? 0
          : Math.ceil((u.GOM.items[u.GOM.items.length - 1].row + 1) / u.galleryMaxRows.Get());
      }));
    ...
    ((window.ng_draf = function (e) {
      ...
      (window.requestTimeout = function (e, t) {
        ...
        var n = new Date().getTime(),
          i = new Object();
        return (
          (i.value = requestAnimFrame(function a() {
    ...
    ((u.I = []),
      ...
      (u.layout = {
        ...
        SetEngine: function () {
          if (u.layout.internal) {
            if (
              'auto' == u.tn.settings.width[u.GOM.curNavLevel][u.GOM.curWidth] ||
              '' == u.tn.settings.width[u.GOM.curNavLevel][u.GOM.curWidth]
            )
              return (
                (u.layout.engine = 'JUSTIFIED'),
                (u.layout.support.rows = !0),
                void (u.layout.prerequisite.imageSize = !0)
              );
            if (
              'auto' == u.tn.settings.height[u.GOM.curNavLevel][u.GOM.curWidth] ||
              '' == u.tn.settings.height[u.GOM.curNavLevel][u.GOM.curWidth]
            )
              return (
                (u.layout.engine = 'CASCADING'),
                (u.layout.support.rows = !1),
                void (u.layout.prerequisite.imageSize = !0)
              );
            if (null != u.tn.settings.getMosaic())
              return (
                (u.layout.engine = 'MOSAIC'),
                (u.layout.support.rows = !0),
      ...
      (u.tn = {
        ...
        defaultSize: {
          width: {
            l1: { xs: 0, sm: 0, me: 0, la: 0, xl: 0 },
            lN: { xs: 0, sm: 0, me: 0, la: 0, xl: 0 },
          },
          height: {
            l1: { xs: 0, sm: 0, me: 0, la: 0, xl: 0 },
            lN: { xs: 0, sm: 0, me: 0, la: 0, xl: 0 },
          ...
          getOuterWidth: function () {
            ...
            var e =
              u.tn.defaultSize.width[u.GOM.curNavLevel][u.GOM.curWidth] +
              2 * u.tn.opt.Get('borderHorizontal');
            return (
              ('right' != u.O.thumbnailLabel.get('position') &&
                'left' != u.O.thumbnailLabel.get('position')) ||
                (e += u.tn.defaultSize.width[u.GOM.curNavLevel][u.GOM.curWidth]),
              e
            );
          },
          getHeight: function () {
          ...
          getOuterHeight: function () {
            return (
              u.tn.defaultSize.height[u.GOM.curNavLevel][u.GOM.curWidth] +
              2 * u.tn.opt.Get('borderVertical')
            );
          },
        },
        settings: {
          ...
          getH: function (e, t) {
            ...
            return 'MOSAIC' == u.layout.engine
              ? this.height[n][i] * this.mosaic[n + 'Factor'].h[i]
              : this.height[n][i];
          },
          getW: function (e, t) {
            var n = null == e ? u.GOM.curNavLevel : e,
              i = null == t ? u.GOM.curWidth : t;
            return 'MOSAIC' == u.layout.engine
              ? this.width[n][i] * this.mosaic[n + 'Factor'].w[i]
              : this.width[n][i];
          },
          mosaic: {
            ...
            l1Factor: {
              h: { xs: 1, sm: 1, me: 1, la: 1, xl: 1 },
              w: { xs: 1, sm: 1, me: 1, la: 1, xl: 1 },
            },
            lNFactor: {
              h: { xs: 1, sm: 1, me: 1, la: 1, xl: 1 },
              w: { xs: 1, sm: 1, me: 1, la: 1, xl: 1 },
      ...
      (u.CSSbackfaceVisibilityName = mt([
        'backfaceVisibility',
        ...
        ScrollToTop: function () {
          ...
          if (
            ...
            (null !== u.$E.scrollableParent ||
              ...
              (t = 20),
              (n = a()),
              (i = e.offset()).top >= n.t && i.top <= n.t + n.h - t) ||
              u.$E.base.get(0).scrollIntoView(),
            null !== u.$E.scrollableParent)
          ) {
      ...
      (u.VOM = {
        ...
        IdxNext: function () {
          var e = 0;
          return (
            u.VOM.content.current.vIdx < u.VOM.items.length - 1 &&
              (e = u.VOM.content.current.vIdx + 1),
            e
          );
        },
          ...
          Resize: function () {
            if ('none' != u.O.viewerGallery)
              if (this.firstDisplay)
                ...
                if (
                  ((this.vwidth = t * this.oneTmbWidth),
                  this.$elt.css({ width: this.vwidth, left: (e - this.vwidth) / 2 }),
                  u.VOM.items.length >= t)
                ) {
                  var n = this.oneTmbWidth * u.VOM.content.current.vIdx;
                  n + this.posX < this.vwidth
                    ? n + this.posX < 0 && (this.posX = -n)
                    : n + this.posX >= this.vwidth &&
                      (this.posX = this.vwidth - (n + this.oneTmbWidth));
                }
                this.PanGallery(0);
              }
          },
          PanGallery: function (e) {
            (this.gwidth < u.VOM.$viewer.width() &&
              ((this.posX = (u.VOM.$viewer.width() - this.gwidth) / 2), (e = 0)),
          ...
          loadImage: function (e, t) {
            if ('img' == t.mediaKind) {
              ...
              if (((n.src = t.responsiveURL()), n.width && n.height)) e(n.width, n.height, t, 0);
                ...
                var i,
                  a = { image: n, url: t.responsiveURL(), ngitem: t, callback: e, checks: 1 };
            ...
            for (var e, t = 0, n = u.VOM.ImageLoader.list, i = 0; i < n.length; i++)
              null != (e = n[i]) &&
                (e.image.width && e.image.height
                  ? ((u.VOM.ImageLoader.list[i] = null),
                    e.callback(e.image.width, e.image.height, e.ngitem, e.checks))
                  : e.checks > u.VOM.ImageLoader.maxChecks
                    ? ((u.VOM.ImageLoader.list[i] = null), e.callback(0, 0, e.ngitem, e.checks))
                    : (t++, e.checks++));
            0 == t &&
              ((u.VOM.ImageLoader.list = []),
        ...
        close: function () {
          null != this.$elt &&
            new NGTweenable().tween({
              ...
              finish: function (e, t) {
                (null != t.t.$elt && (t.t.$elt.remove(), (t.t.$elt = null)),
                  (t.t.isDisplayed = !1));
              },
            });
        },
    ...
    function m() {
      ...
      u.VOM.items.length > 0 ? Ne(i) : d(u, 'No content for Lightbox standalone.');
    }
    function p(e) {
      var t = { albumID: '0', imageID: '0' },
        n = e.split('/');
      return (n.length > 0 && ((t.albumID = n[0]), n.length > 1 && (t.imageID = n[1])), t);
    }
    function g(e, t) {
      u.VOM.viewerDisplayed && nt(null);
      var n = NGY2Item.GetIdx(u, t);
      ((u.GOM.curNavLevel = 'lN'),
        0 == n && (u.GOM.curNavLevel = 'l1'),
        u.layout.SetEngine(),
        (u.galleryResizeEventEnabled = !1),
        -1 == n && (NGY2Item.New(u, '', '', t, '0', 'album'), (n = u.I.length - 1)),
        u.I[n].contentIsLoaded
          ? (me(), (u.GOM.pagination.currentPage = 0), lt(t, ''), w(n))
          : Z(t, g, e, t));
    }
    function f() {
      switch (u.galleryDisplayMode.Get()) {
        case 'PAGINATION':
          u.layout.support.rows &&
            u.galleryMaxRows.Get() > 0 &&
            (function () {
              if (
                (u.$E.conTnBottom.css('opacity', 0),
                u.$E.conTnBottom.children().remove(),
                0 == u.GOM.items.length)
              )
                return;
              var e = Math.ceil(
                (u.GOM.items[u.GOM.items.length - 1].row + 1) / u.galleryMaxRows.Get()
              );
              if (1 == e) return;
              ...
              if ('NUMBERS' == u.O.galleryPaginationMode && u.GOM.pagination.currentPage > 0) {
                jQuery('<div class="nGY2PaginationPrev">' + u.O.icons.paginationPrevious + '</div>')
                  .appendTo(u.$E.conTnBottom)
                  .click(function (e) {
                    G();
                  });
              }
              ...
              if ('NUMBERS' != u.O.galleryPaginationMode) t = 0;
                ...
                if (i >= e) t = 0;
                  ...
                  var a = 0;
                  ((a = i % 2 == 1 ? (i + 1) / 2 : i / 2),
                    u.GOM.pagination.currentPage < a
                      ? ((t = 0), (n = i - 1) > e && (n = e - 1))
                      : (n = (t = u.GOM.pagination.currentPage - a) + i) > e && (n = e - 1),
                    n - t < i && (t = n - i) < 0 && (t = 0));
                }
              }
              for (var o = t; o < n; o++) {
              ...
              if ('NUMBERS' == u.O.galleryPaginationMode && u.GOM.pagination.currentPage + 1 < e) {
                jQuery('<div class="nGY2PaginationNext">' + u.O.icons.paginationNext + '</div>')
                  .appendTo(u.$E.conTnBottom)
                  .click(function (e) {
                    y();
                  });
        ...
        case 'MOREBUTTON':
          ...
          0 == e
            ? u.$E.conTnBottom.empty()
            : (u.$E.conTnBottom.html(
                '<div class="nGY2GalleryMoreButton"><div class="nGY2GalleryMoreButtonAnnotation">+' +
                  e +
                  ' ' +
                  u.O.icons.galleryMoreButton +
                  '</div></div>'
              ),
    ...
    function b(e) {
      ...
      u.O.breadcrumbHideIcons ||
        ((t = u.O.icons.breadcrumbAlbum), 0 == e && (t = u.O.icons.breadcrumbHome));
      var n = jQuery('<div class="oneItem">' + t + u.I[e].title + '</div>').appendTo(
        u.GOM.navigationBar.$newContent.find('.nGY2Breadcrumb')
      );
      (u.O.breadcrumbOnlyCurrentLevel
        ? 0 == e
          ? jQuery(n).data('albumID', '0')
          : jQuery(n).data('albumID', u.I[e].albumID)
        : jQuery(n).data('albumID', u.I[e].GetID()),
        n.click(function () {
    ...
    function v(e) {
      var t = jQuery(
        '<div class="oneItem">' +
          (u.O.RTL ? u.O.icons.breadcrumbSeparatorRtl : u.O.icons.breadcrumbSeparator) +
          '</div>'
      ).appendTo(u.GOM.navigationBar.$newContent.find('.nGY2Breadcrumb'));
    ...
    function O(e) {
      if (
        ((u.GOM.navigationBar.$newContent = jQuery('<div class="nGY2Navigationbar"></div>')),
        ...
        (u.O.breadcrumbAutoHideTopLevel && 0 == t) ||
          (function (e) {
            if (
              (jQuery('<div class="nGY2NavigationbarItem nGY2Breadcrumb"></div>').appendTo(
                u.GOM.navigationBar.$newContent
              ),
              u.O.breadcrumbOnlyCurrentLevel)
            )
              0 == e.length ? b(0) : (1 == e.length ? v(0) : v(e[0]), b(e[0]));
        ...
        if (r > 0) {
          for (o = 0; o < r; o++) {
            var l = u.I[e].albumTagList[o],
              ...
              c = 'Unselected';
            (jQuery.inArray(l, u.I[e].albumTagListSel) >= 0 &&
              ((c = 'Selected'), (s = u.O.icons.navigationFilterSelected)),
              jQuery(
                '<div class="nGY2NavigationbarItem nGY2NavFilter' +
                  c +
                  '">' +
                  s +
                  ' ' +
                ...
                .appendTo(u.GOM.navigationBar.$newContent)
                .click(function () {
                  var t = jQuery(this),
                    n = t.text().replace(/^\s*|\s*$/, '');
                  if ('single' == u.galleryFilterTagsMode.Get())
                    ((u.I[e].albumTagListSel = []), u.I[e].albumTagListSel.push(n));
                  else {
          ...
          jQuery(
            '<div class="nGY2NavigationbarItem nGY2NavFilterSelectAll">' +
              u.O.icons.navigationFilterSelectedAll +
              '</div>'
          )
            .appendTo(u.GOM.navigationBar.$newContent)
            .click(function () {
      ...
      'PAGINATION' == u.galleryDisplayMode.Get() &&
        u.O.galleryPaginationTopButtons &&
        u.layout.support.rows &&
        u.galleryMaxRows.Get() > 0 &&
        (jQuery(
          '<div class="nGY2NavigationbarItem nGY2NavPagination">' +
            u.O.icons.navigationPaginationPrevious +
            '</div>'
        )
          .appendTo(u.GOM.navigationBar.$newContent)
          .click(function () {
        ...
        jQuery(
          '<div class="nGY2NavigationbarItem nGY2NavPagination">' +
            u.O.icons.navigationPaginationNext +
            '</div>'
        )
          .appendTo(u.GOM.navigationBar.$newContent)
          .click(function () {
    ...
    function y() {
      ...
      (X(),
        u.galleryMaxRows.Get() > 0 &&
          (e = (u.GOM.items[u.GOM.items.length - 1].row + 1) / u.galleryMaxRows.Get()));
      var t = Math.ceil(e),
        ...
        case 'PAGINATION':
          if (u.layout.support.rows) {
            ...
            for (var i = 0; i < a; i++) {
              ...
              a.row >= e &&
                a.row < t &&
                (-1 == n && ((u.GOM.displayInterval.from = i), (n = i)),
    ...
    function w(e) {
      (ot('galleryRenderStart'), clearTimeout(u.GOM.slider.timerID), (u.GOM.slider.hostIdx = -1));
      var t = u.O.fnGalleryRenderStart;
      if (
        (null !== t &&
          ('function' == typeof t ? t(u.I[u.GOM.albumIdx]) : window[t](u.I[u.GOM.albumIdx])),
        u.layout.SetEngine(),
        (u.galleryResizeEventEnabled = !1),
        (u.GOM.albumIdx = -1),
        ...
        (n < u.O.galleryRenderDelay
          ? requestTimeout(function () {
              I(e);
            }, u.O.galleryRenderDelay - n)
          : I(e),
        ...
        (0 == u.GOM.navigationBar.$newContent.children().length && (i = !0),
          new NGTweenable().tween({
            ...
            attachment: { h: i },
            step: function (e, t) {
              (u.$E.conTnParent.css({ opacity: e.opacity }),
                t.h && u.$E.conNavigationBar.css({ opacity: e.opacity }));
            },
            finish: function (t, n) {
              (n.h && u.$E.conNavigationBar.css({ opacity: 0, display: 'none' }),
                u.GOM.ScrollToTop(),
                I(e));
            },
          }));
    ...
    function I(e) {
      ...
      u.$E.conNavigationBar.children().length > 0 && 0 == t)
        ? (u.$E.conNavigationBar.css({ opacity: 0, display: 'block' }),
          new NGTweenable().tween({
            from: { opacity: 0 },
            to: { opacity: 1 },
            duration: 200,
            ...
            finish: function (t) {
              (u.$E.conNavigationBar.css({ opacity: 1 }),
                requestTimeout(function () {
                  T(e);
                }, 20));
            },
    ...
    function T(e) {
      ...
      (null == u.CSStransformName
        ? u.$E.conTn.css('left', '0px')
        : u.$E.conTn.css(u.CSStransformName, 'none'),
        requestTimeout(function () {
          !(function (e) {
            var t = new Date();
            (u.$E.conTnParent.css('opacity', 1),
              ...
              'onBottom' == u.O.thumbnailLabel.get('position')
                ? (u.tn.labelHeight[u.GOM.curNavLevel] = (function () {
                    var e = [],
                      t = 0;
                    if (0 == u.O.thumbnailLabel.get('display')) return 0;
                    ((e[t++] =
                      '<div class="nGY2GThumbnail ' +
                      u.O.theme +
                      '" style="display:block;visibility:hidden;position:absolute;top:-9999px;left:-9999px;" ><div class="nGY2GThumbnailSub">'),
                      1 == u.O.thumbnailLabel.get('display') &&
                        ((e[t++] =
                          '  <div class="nGY2GThumbnailLabel" ' + u.tn.style.getLabel() + '>'),
                        (e[t++] =
                          '    <div class="nGY2GThumbnailAlbumTitle" ' +
                          u.tn.style.getTitle() +
                          '>aAzZjJ</div>'),
                        1 == u.O.thumbnailLabel.get('displayDescription') &&
                          (e[t++] =
                            '    <div class="nGY2GThumbnailDescription" ' +
                            u.tn.style.getDesc() +
                            '>aAzZjJ</div>'),
                        (e[t++] = '  </div>')));
                    e[t++] = '</div></div>';
            ...
            ((u.GOM.albumIdx = e), ot('galleryRenderEnd'));
            var n = u.O.fnGalleryRenderEnd;
            null !== n &&
              ('function' == typeof n ? n(u.I[u.GOM.albumIdx]) : window[n](u.I[u.GOM.albumIdx]));
            !(function () {
              for (
                var e = '', t = u.I[u.GOM.albumIdx].GetID(), n = u.I.length, i = 0, a = 0;
                a < n;
                a++
              ) {
                var o = u.I[a];
                if (o.isToDisplay(t)) {
                  var r = o.thumbImg().width,
                    l = o.thumbImg().height;
                  (!u.layout.prerequisite.imageSize ||
                    (0 != r && 0 != l) ||
                    (e +=
                      '<img src="' +
                      o.thumbImg().src +
                    ...
                    if (t.isLoaded) {
                      ...
                      if (t.img.getAttribute('data-albumidx') == u.GOM.albumIdx) {
                        ...
                        for (let e in o)
                          o.hasOwnProperty(e) &&
                            e != u.GOM.curWidth &&
                            u.tn.settings.width.l1[e] == u.tn.settings.getW() &&
                            u.tn.settings.height.l1[e] == u.tn.settings.getH() &&
                            ((a.thumbs.width.l1[e] = i.imageWidth),
                            (a.thumbs.height.l1[e] = i.imageHeight));
                        o = a.thumbs.width.lN;
                        for (let e in o)
                          o.hasOwnProperty(e) &&
                            e != u.GOM.curWidth &&
                            u.tn.settings.width.lN[e] == u.tn.settings.getW() &&
                            u.tn.settings.height.lN[e] == u.tn.settings.getH() &&
                            ((a.thumbs.width.lN[e] = i.imageWidth),
              ...
              : (S(),
                (function () {
                  ...
                  switch (u.galleryDisplayTransition.Get()) {
                    case 'ROTATEX':
                      (u.$E.base.css({ perspective: '1000px', 'perspective-origin': '50% 0%' }),
                        new NGTweenable().tween({
                          from: { r: 50 },
                          to: { r: 0 },
                          ...
                          easing: 'easeOutCirc',
                          step: function (e, t) {
                            t.orgIdx == u.GOM.albumIdx &&
                              u.$E.conTnParent.css(u.CSStransformName, 'rotateX(' + e.r + 'deg)');
                          },
                        }));
                      break;
                    case 'SLIDEUP':
                      (u.$E.conTnParent.css({ opacity: 0 }),
                        new NGTweenable().tween({
                          ...
                          step: function (e, t) {
                            t.orgIdx == u.GOM.albumIdx &&
                              u.$E.conTnParent
                                .css(u.CSStransformName, 'translate( 0px, ' + e.y + 'px)')
                                .css('opacity', e.o);
                          },
                        }));
                  }
    ...
    function x() {
      var e = new Date();
      if (((u.galleryResizeEventEnabled = !1), 0 == S()))
        return (
          (u.galleryResizeEventEnabled = !0),
    ...
    function S() {
      var e = !0;
      switch (
        ((u.GOM.cache.areaWidth = u.$E.conTnParent.width()),
        (u.GOM.displayArea = { width: 0, height: 0 }),
        u.layout.engine)
      ) {
        case 'JUSTIFIED':
          e = (function () {
            for (
              var e = 0,
                ...
                r = [],
                l = !1,
                s = u.tn.settings.GetResponsive('gutterWidth'),
                c = u.tn.settings.GetResponsive('gutterHeight'),
                h = 0,
                d = 0,
                m = !1,
                p = !1,
                g = u.tn.defaultSize.getOuterHeight(),
                f = 2 * u.tn.opt.Get('borderHorizontal'),
                b = 2 * u.tn.opt.Get('borderVertical'),
                v = 1,
            ...
            for (y = 0; y < O; y++) {
              ...
              if (!(e.imageWidth > 0)) return !1;
              {
                ...
                (u.O.RTL && (m = t - n - e.width),
                  (e.left = m),
                  (n += e.width + s),
                  y == a[o] && ((i += e.height + c), (u.GOM.lastFullRow = o - 1), o++, (n = 0)));
              }
            }
        ...
        case 'CASCADING':
          e = (function () {
            var e = 0,
              ...
              l = 0,
              s = 1,
              c = u.tn.defaultSize.getOuterWidth(),
              h = u.GOM.items.length,
              d = 0;
            o =
              'justified' == u.O.thumbnailAlignment
                ? 1 == (a = Math.min(a, h))
                  ? 0
                  : (t - a * c) / (a - 1)
                : u.tn.settings.GetResponsive('gutterWidth');
            var m = 2 * u.tn.opt.Get('borderHorizontal'),
              p = 2 * u.tn.opt.Get('borderVertical');
            if (((u.GOM.lastFullRow = -1), 'fillWidth' == u.O.thumbnailAlignment)) {
              var g = (a - 1) * o;
              ((s = (t - g) / (a * c)) > 1 && a++,
                (g = (a - 1) * o),
                (s = Math.min((t - g) / (a * c), 1)));
            }
            for (
              var f = (c = Math.round(c * s)) - m,
                b = Math.round(u.tn.opt.Get('baseGridHeight') * s),
                v = 0;
              v < h;
              v++
            ) {
              var O = u.GOM.items[v];
              if (1 == O.deleted) break;
              if (O.imageHeight > 0 && O.imageWidth > 0) {
                var y = 0,
                  G = ((d = 0), O.imageHeight / O.imageWidth);
                if (
                  ((O.resizedContentWidth = f),
                  (O.resizedContentHeight = O.resizedContentWidth * G),
                  b > 0)
                ) {
                  var M = Math.max(Math.trunc(O.resizedContentHeight / b), 1);
                  O.resizedContentHeight = b * M + (M - 1) * (p + r);
                }
                if (
                  ((O.height = O.resizedContentHeight + p + u.tn.labelHeight.get()),
                  (O.width = c),
                  (O.row = 0),
                  0 == n)
                )
                  ((y = e * (c + o)), (i[e] = O.height + r), ++e >= a && ((e = 0), n++));
                else {
                  for (var w = 0, I = i[0], T = 1; T < a; T++)
                    i[T] + 5 < I && ((I = i[T]), (w = T));
                  ((d = i[w]), (y = w * (c + o)), (i[w] = d + O.height + r));
                }
                var x = y;
                (u.O.RTL && (x = l - y - c), (O.left = x), (O.top = d));
              }
            }
            return ((u.GOM.displayArea.width = a * (c + o) - o), !0);
          })();
          break;
        case 'MOSAIC':
          e = (function () {
            ...
            for (var m = 0; m < o; m++) {
              ...
              if (((h = Math.max(h, p + g)), (c = Math.max(c, e.c - 1 + e.w)), ++s >= d.length))
                break;
            }
            var f = (c - 1) * n,
            ...
            for (m = 0; m < o; m++) {
              let e = u.GOM.items[m],
                o = d[s];
              ((e.top =
                Math.round((o.r - 1) * u.tn.defaultSize.getOuterHeight() * b) +
                (o.r - 1) * t +
                r * l +
                u.tn.labelHeight.get() * (o.r - 1)),
                r > 0 && (e.top += t),
                (e.left =
                  (o.c - 1) * Math.round(u.tn.defaultSize.getOuterWidth() * b) + (o.c - 1) * n),
                (e.height =
                  Math.round(o.h * u.tn.defaultSize.getOuterHeight() * b) +
                  (o.h - 1) * t +
                  u.tn.labelHeight.get() * o.h),
        ...
        default:
          e = (function () {
            ...
            for (
              var b = 0,
                v = (h = Math.round(h * d)) - p,
                O = Math.round(u.tn.defaultSize.getOuterHeight() * d) + u.tn.labelHeight.get(),
                y = Math.round(u.tn.defaultSize.getOuterHeight() * d) - g,
                G = 0;
              G < m;
              G++
            ) {
              ...
              ((w.top = t),
                ...
                'fillWidth' == u.O.thumbnailAlignment &&
                  ((w.resizedContentWidth = v), (w.resizedContentHeight = y)),
                (w.row = b),
                ++s >= o && ((s = 0), (t += O + a), (u.GOM.lastFullRow = b), b++));
            }
            return ((u.GOM.displayArea.width = r), !0);
          })();
      }
      ot('galleryLayoutApplied');
    ...
    function E(e) {
      ...
      for (var i = 0; i < t; i++) {
        let t = u.GOM.items[i];
        i >= u.GOM.displayInterval.from && n < u.GOM.displayInterval.len
          ? ((t.inDisplayArea = !0), e && (t.neverDisplayed = !0), u.GOM.itemsDisplayed++, n++)
          : (t.inDisplayArea = !1);
      }
      f();
      var a = [],
      ...
      for (i = 0; i < t; i++) {
        ...
        if (e.inDisplayArea) {
          if (
            (-1 == u.GOM.clipArea.top && (u.GOM.clipArea.top = e.top),
            e.top - u.GOM.clipArea.top <= -1 && (u.GOM.clipArea.top = e.top),
            (u.GOM.clipArea.height = Math.max(
              u.GOM.clipArea.height,
              e.top - u.GOM.clipArea.top + e.height
            )),
            e.neverDisplayed)
          ) {
            var l = u.GOM.cache.containerOffset.top + (e.top - u.GOM.clipArea.top);
            if (
              l + e.height >= u.GOM.cache.viewport.t - 50 &&
              l <= u.GOM.cache.viewport.t + u.GOM.cache.viewport.h + 50
            ) {
              let t = u.I[e.thumbnailIdx];
              (null == t.$elt && _(t, e.thumbnailIdx, i),
                a.push({ idx: i, delay: n, top: e.top, left: e.left }),
                n++);
            }
      ...
      if (
        ((u.GOM.displayArea.width == u.GOM.displayAreaLast.width &&
          u.GOM.clipArea.height == u.GOM.displayAreaLast.height) ||
          (u.$E.conTn.width(u.GOM.displayArea.width).height(u.GOM.clipArea.height),
        ...
        return ((u.GOM.cache.areaWidth = u.$E.conTnParent.width()), S(), L(), void E(e));
      if (
        u.layout.support.rows &&
        ('ROWS' == u.galleryDisplayMode.Get() ||
          ('FULLCONTENT' == u.galleryDisplayMode.Get() &&
            u.galleryLastRowFull.Get() &&
            -1 != u.GOM.lastFullRow)) &&
        ((u.GOM.lastDisplayedIdxNew = r < t - 1 ? r : -1), -1 != u.GOM.lastDisplayedIdx)
      ) {
        u.I[u.GOM.items[u.GOM.lastDisplayedIdx].thumbnailIdx]
          .$getElt('.nGY2GThumbnailIconsFullThumbnail')
          .html('');
      }
      ...
      (k(o),
        u.GOM.thumbnails2Display.forEach(function (e) {
          !(function (e, t) {
            ...
            switch (u.tn.opt.Get('displayTransition')) {
              case 'RANDOMSCALE': {
                for (
                  var o = [0.95, 1, 1.05, 1.1], r = [1, 2, 3, 4], l = n(0, 3);
                  l == u.GOM.lastRandomValue;
                )
                  l = n(0, 3);
                u.GOM.lastRandomValue = l;
                let t = o[l];
                (e.$elt.css({
                  'z-index': u.GOM.lastZIndex + r[l],
                  'box-shadow': '0px 0px 5px 3px rgba(0,0,0,0.74)',
                }),
                  (i = { scale: 0.5, opacity: 0 }),
                  (a = { scale: t, opacity: 1 }));
                break;
              }
              case 'SCALEUP': {
              ...
              case 'FLIPUP': {
                let e = u.tn.opt.Get('displayTransitionStartVal');
                (0 == e && (e = 100),
                  (i = { opacity: 0, translateY: e, rotateX: 45 }),
                  (a = { opacity: 1, translateY: 0, rotateX: 0 }));
                break;
              }
              case 'FLIPDOWN': {
                let e = u.tn.opt.Get('displayTransitionStartVal');
              ...
              case 'SLIDEUP2': {
                let e = u.tn.opt.Get('displayTransitionStartVal');
                (0 == e && (e = 100),
                  (i = { opacity: 0, translateY: e, rotateY: 40 }),
                  (a = { opacity: 1, translateY: 0, rotateY: 0 }));
                break;
              }
              case 'IMAGESLIDEUP':
            ...
            s.tween({
              from: i,
              to: a,
              attachment: { $e: e.$elt, item: e, tw: s },
              delay: t,
                ...
                window.requestAnimationFrame(function () {
                  if (null !== t.item.$elt)
                    switch (u.tn.opt.Get('displayTransition')) {
                      ...
                      case 'SCALEUP':
                        t.$e
                          .css(u.CSStransformName, 'scale(' + e.scale + ')')
                          .css('opacity', e.opacity);
                        break;
                      case 'SCALEDOWN':
        ...
        (u.GOM.thumbnails2Display = []),
        'NONE' == u.tn.opt.Get('displayTransition')
          ? ((u.galleryResizeEventEnabled = !0), ot('galleryDisplayed'))
          : requestTimeout(
              function () {
                ((u.galleryResizeEventEnabled = !0), ot('galleryDisplayed'));
              },
    ...
    function k(e) {
      ...
      if (
        ('random' == n
          ? NGY2Tools.AreaShuffle(e)
          : ('rowByRow' == n &&
              'JUSTIFIED' != u.layout.engine &&
              'GRID' != u.layout.engine &&
              (n = ''),
            ('colFromRight' != n && 'colFromLeft' != n) ||
              'CASCADING' == u.layout.engine ||
              'GRID' == u.layout.engine ||
              (n = '')),
        'colFromRight' == n || 'colFromLeft' == n)
      ) {
        for (var i = [], a = [], o = 0; o < t; o++)
          (null == i[e[o].left] && ((i[e[o].left] = []), a.push(e[o].left)),
      ...
      var s = 0,
        c = e[0].top;
      for (o = 0; o < t; o++)
        ('rowByRow' == n ? e[o].top > c && (s++, (c = e[o].top)) : s++, D(e[o].idx, s));
      return s;
    }
    function D(e, t) {
      var n = 0,
      ...
      if (i.neverDisplayed) {
        ...
        if (
          (u.tn.opt.Get('stacks') > 0
            ? (o.$elt.last().css({ display: 'block' }), o.$elt.css({ top: r, left: i.left }))
            : o.$elt.css({ display: 'block', top: r, left: i.left }),
          (n = r),
        ...
        (!(function (e, t) {
          ...
          if ('NONE' == u.tn.opt.Get('displayTransition')) (i.$elt.css({ opacity: 1 }), H(i));
          else {
            ...
            if (a + (n.top - u.GOM.clipArea.top) >= o.t - 50 && a <= o.t + o.h + 50) {
              ...
              return void ('CUSTOM' == u.tn.opt.Get('displayTransition')
                ? 'lN' == u.GOM.curNavLevel
                  ? u.O.fnThumbnailDisplayEffect(i.$elt, i, e, r)
                  : u.O.fnThumbnailL1DisplayEffect(i.$elt, i, e, r)
                : u.GOM.thumbnails2Display.push({ itm: i, d: r }));
            }
            (i.$elt.css({ opacity: 1 }), H(i));
          }
        })(e, t),
          (i.displayed = !0),
          (i.neverDisplayed = !1));
        ...
        if (
          u.O.thumbnailDisplayOutsideScreen ||
          (l + i.height >= s.t - s.h && l <= s.t + 4 * s.h) ||
          (r + i.height >= s.t - s.h && r <= s.t + 4 * s.h)
        )
          if (i.displayed) {
            if (o.top != i.top || o.left != i.left)
              if (1 == u.O.galleryResizeAnimation)
                new NGTweenable().tween({
                  from: { top: o.top, left: o.left, height: o.height, width: o.width },
            ...
            ((i.displayed = !0),
              o.$elt.css({ display: 'block', top: n, left: i.left, opacity: 1 }),
              H(o));
        else ((i.displayed = !1), o.$elt.css({ display: 'none' }));
      }
      if (
        ((o.left = i.left),
        (o.top = n),
        (o.width == i.width && o.height == i.height) ||
          (o.$elt.css({ width: i.width, height: i.height }),
          (o.width = i.width),
          (o.height = i.height),
          (o.resizedContentWidth == i.resizedContentWidth &&
            ...
            ('albumUp' == o.kind ||
              (o
                .$getElt('.nGY2GThumbnailImage')
                .css({ height: i.resizedContentHeight, width: i.resizedContentWidth }),
              'JUSTIFIED' == u.layout.engine &&
                o
                  .$getElt('.nGY2GThumbnailImg')
                  .css({ height: i.resizedContentHeight, width: i.resizedContentWidth })),
            (o.resizedContentWidth = i.resizedContentWidth),
            (o.resizedContentHeight = i.resizedContentHeight))),
        u.GOM.lastDisplayedIdxNew == e &&
          u.layout.support.rows &&
          (('ROWS' == u.galleryDisplayMode.Get() && u.galleryMaxRows.Get() > 0) ||
            ('FULLCONTENT' == u.galleryDisplayMode.Get() &&
              u.galleryLastRowFull.Get() &&
              -1 != u.GOM.lastFullRow)))
      ) {
        ...
        ('0' != o.albumID && u.O.thumbnailLevelUp && c--,
          c > 0
            ? ((u.O.thumbnailOpenInLightox || u.O.thumbnailSliderDelay > 0) &&
                o.$getElt('.nGY2GThumbnailIconsFullThumbnail').html('+' + c),
              'right' != u.O.thumbnailLabel.get('position') &&
                'left' != u.O.thumbnailLabel.get('position') &&
                u.GOM.slider.hostItem != u.GOM.NGY2Item(e) &&
                (Y(u.GOM.slider.hostItem),
                ...
                (function () {
                  ...
                  0 == e.$getElt('.nGY2TnImgNext').length &&
                    (e
                      .$getElt('.nGY2TnImg')
                      .clone()
                      .removeClass('nGY2TnImg')
                      .addClass('nGY2TnImgNext')
                      .insertAfter(e.$getElt('.nGY2TnImg')),
                    e
                      .$getElt('.nGY2TnImgBack')
                      .clone()
                      .removeClass('nGY2TnImgBack')
                      .addClass('nGY2TnImgBackNext')
                      .insertAfter(e.$getElt('.nGY2TnImg', !0)),
            ...
            : (Y(u.GOM.slider.hostItem), (u.GOM.slider.hostIdx = -1)),
          (u.GOM.lastDisplayedIdx = e));
      }
    }
    function N() {
      (u.GOM.slider.nextIdx++,
        u.GOM.slider.nextIdx >= u.GOM.items.length &&
          (u.GOM.slider.nextIdx = u.GOM.slider.hostIdx));
      var e = u.GOM.NGY2Item(u.GOM.slider.nextIdx),
        t = "url('" + u.emptyGif + "')";
      (null != e.imageDominantColors && (t = "url('" + e.imageDominantColors + "')"),
        u.GOM.slider.hostItem
          .$getElt('.nGY2TnImgBackNext', !0)
          .css({ 'background-image': t, opacity: 1 }),
        u.GOM.slider.hostItem
          .$getElt('.nGY2TnImgNext', !0)
          .css({ 'background-image': "url('" + e.thumbImg().src + "')", opacity: 1 }),
        u.GOM.slider.hostItem
          .$getElt('.nGY2TnImgNext .nGY2GThumbnailImg', !0)
          .attr('src', e.thumbImg().src));
    }
    function V() {
      if (null != u.GOM.slider.hostItem.$getElt()) {
        var e = new NGTweenable();
        ((u.GOM.slider.tween = e),
          e.tween({
            from: { left: 100 },
            to: { left: 0 },
            duration: 800,
            ...
            easing: 'easeOutQuart',
            step: function (e) {
              null != u.GOM.slider.hostItem.$getElt()
                ? (u.GOM.slider.hostItem.CSSTransformSet(
                    '.nGY2TnImgBack',
                    'translateX',
                    -(100 - e.left) + '%'
                  ),
                ...
                : u.GOM.slider.tween.stop(!1);
            },
            finish: function (e) {
              null != u.GOM.slider.hostItem.$getElt() &&
                null != u.GOM.NGY2Item(u.GOM.slider.nextIdx) &&
                (Y(u.GOM.NGY2Item(u.GOM.slider.nextIdx)),
    ...
    function Y(e) {
      if (-1 != u.GOM.slider.hostIdx) {
        null != u.GOM.slider.tween &&
          1 == u.GOM.slider.tween._isTweening &&
          u.GOM.slider.tween.stop(!1);
        ...
        if (
          ...
          u.GOM.slider.hostItem
            .$getElt('.nGY2TnImg')
            .css('background-image', "url('" + e.thumbImg().src + "')"),
          u.GOM.slider.hostItem
            .$getElt('.nGY2TnImg .nGY2GThumbnailImg')
            .attr('src', e.thumbImg().src),
          ...
          ('album' != e.kind && (n = u.O.icons.thumbnailImage),
            u.GOM.slider.hostItem.$getElt('.nGY2GThumbnailTitle').html(n + F(e)),
            u.GOM.slider.hostItem.$getElt('.nGY2GThumbnailDescription').html(n + z(e)));
        }
      }
    }
    function A(e) {
    ...
    function _(e, t, n) {
      if (
        ...
        null != e.imageDominantColors
          ? (c = "background-image: url('" + e.imageDominantColors + "');")
          : null != e.imageDominantColor
            ? (s = 'background-color:' + e.imageDominantColor + ';')
            : (c = '');
        var h = 'opacity:1;';
        (1 == u.O.thumbnailWaitImageLoaded && (h = 'opacity:0;'),
          (i[a++] =
            A(s) +
            '<div class="nGY2GThumbnail nGY2GThumbnail_' +
            u.GOM.curNavLevel +
            '" style="display:none;opacity:0;' +
            o +
            '"><div class="nGY2GThumbnailSub ' +
            (u.O.thumbnailSelectable && e.selected ? 'nGY2GThumbnailSubSelected' : '') +
            '">'));
        var d = u.tn.settings.getW(),
          m = u.tn.settings.getH();
        null !== u.tn.settings.getMosaic() &&
          ((d = u.GOM.items[n].width), (m = u.GOM.items[n].height));
        var p = 'contain';
        ...
        ((i[a++] = '<div class="nGY2GThumbnailImage nGY2TnImg" style="' + f + '">'),
          (i[a++] =
            '  <img class="nGY2GThumbnailImg nGY2TnImg2" src="' +
            r +
            '" alt="' +
            l +
            '" style="opacity:0;" data-idx="' +
            t +
            '" data-albumidx="' +
            u.GOM.albumIdx +
            '" >'),
          ...
          1 == u.O.thumbnailLabel.get('display') &&
            ((i[a++] = '  <div class="nGY2GThumbnailLabel" ' + u.tn.style.getLabel(e) + '>'),
            'album' == e.kind
              ? (i[a++] =
                  '    <div class="nGY2GThumbnailTitle nGY2GThumbnailAlbumTitle" ' +
                  u.tn.style.getTitle() +
                  '>' +
                  u.O.icons.thumbnailAlbum +
                  l +
                  '</div>')
              : (i[a++] =
                  '    <div class="nGY2GThumbnailTitle nGY2GThumbnailImageTitle" ' +
                  u.tn.style.getTitle() +
                  '>' +
            ...
            (i[a++] = '  </div>')),
          (i[a++] = (function (e) {
            var t = P(e, 'topLeft') + P(e, 'topRight') + P(e, 'bottomLeft') + P(e, 'bottomRight');
        ...
        (null !== v && ('function' == typeof v ? v(b, e, n) : window[v](b, e, n)),
          'image gallery by nanogallery2 [build]' != e.title && U(n));
      } else
        !(function (e, t) {
          var n = [],
            i = 0,
          ...
          (!1 === u.O.thumbnailOpenInLightox && (a = 'cursor:default;'),
            (n[i++] =
              A('') + '<div class="nGY2GThumbnail" style="display:none;opacity:0;' + a + '" >'),
            (n[i++] = '  <div class="nGY2GThumbnailSub">'));
          var o = u.tn.defaultSize.getHeight(),
            r = u.tn.defaultSize.getWidth();
          ((n[i++] =
            '    <div class="nGY2GThumbnailImage" style="width:' +
            r +
            'px;height:' +
            o +
            'px;"><img class="nGY2GThumbnailImg" src="' +
            u.emptyGif +
            '" alt="" style="max-width:' +
            r +
            'px;max-height:' +
            ...
            'px;" ></div>'),
            (n[i++] =
              '    <div class="nGY2GThumbnailAlbumUp" >' + u.O.icons.thumbnailAlbumUp + '</div>'),
            (n[i++] = '  </div>'),
            (n[i++] = '</div>'));
      ...
      if ('' != i[t]) {
        ...
        for (var l = i[t].split(','), s = l.length, c = 0; c < s; c++) {
          var h = l[c].replace(/^\s*|\s*$/, ''),
            ...
            p = !0;
          if (
            (/xs|sm|me|la|xl/i.test(d) &&
              (a[d] > a[u.GOM.curWidth] && (p = !1), (m = h.substring(2))),
            p)
          ) {
            var g = c + 1 < s ? '&nbsp;' : '';
            switch (m) {
              case 'COUNTER':
                'album' == e.kind &&
                  ((n += '    <li class="nGY2GThumbnailIcon" data-ngy2action="">'),
                  (n += '      <div class="nGY2GThumbnailIconImageCounter"></div>'),
                  (n +=
                    '      <div class="nGY2GThumbnailIconText">' +
                    u.O.icons.thumbnailCounter +
                    Math.max(e.getContentLength(!1), e.numberItems) +
                    g +
                    '</div>'),
                  (n += '    </li>'),
                  o++);
              ...
              case 'COUNTER2':
                'album' == e.kind &&
                  ((n += '    <li class="nGY2GThumbnailIcon" data-ngy2action="">'),
                  (n +=
                    '      <div class="nGY2GThumbnailIconTextBadge">' +
                    u.O.icons.thumbnailCounter +
                    Math.max(e.getContentLength(!1), e.numberItems) +
                    g +
                    '</div>'),
              ...
              case 'DISPLAY':
                ((n += '    <li class="nGY2GThumbnailIcon" data-ngy2action="DISPLAY">'),
                  (n +=
                    '      <div class="nGY2GThumbnailIconImageShare">' +
                    u.O.icons.thumbnailDisplay +
                    '</div>'),
                  (n += '    </li>'),
                  o++);
                break;
              ...
              case 'CUSTOM10':
                ...
                ((n +=
                  '    <li class="nGY2GThumbnailIcon" data-ngy2action="' + m.toLowerCase() + '">'),
                  (n +=
                    '      <div class="nGY2GThumbnailIconImageShare">' +
                    u.O.icons['thumbnailCustomTool' + f] +
                    '</div>'),
                  (n += '    </li>'),
                  o++);
                break;
              case 'FEATURED':
                !0 === e.featured &&
                  ((n += '    <li class="nGY2GThumbnailIcon" data-ngy2action="">'),
                  (n +=
                    '      <div class="nGY2GThumbnailIconImageFeatured">' +
                    u.O.icons.thumbnailFeatured +
                    '</div>'),
                  (n += '    </li>'),
                  o++);
                break;
              case 'SELECT':
                1 == u.O.thumbnailSelectable &&
                  ((n += '    <li class="nGY2GThumbnailIcon" data-ngy2action="TOGGLESELECT">'),
                  !0 === e.selected
                    ? (n +=
                        '      <div class="nGY2GThumbnailIconImageSelect nGY2ThumbnailSelected">' +
                        u.O.icons.thumbnailSelected +
                        '</div>')
                    : (n +=
                        '      <div class="nGY2GThumbnailIconImageSelect nGY2ThumbnailUnselected">' +
                        u.O.icons.thumbnailUnselected +
                        '</div>'),
                  (n += '    </li>'),
                  o++);
            }
    ...
    function F(e) {
      ...
      if (1 == u.O.thumbnailLabel.get('display')) {
        ((void 0 !== t && 0 != t.length) || (t = '&nbsp;'),
          '' != u.i18nTranslations.thumbnailImageTitle &&
            (t = u.i18nTranslations.thumbnailImageTitle));
        ...
        t =
          'album' == e.kind
            ? '' != u.i18nTranslations.thumbnailImageDescription
              ? u.i18nTranslations.thumbnailAlbumDescription
              : e.description
            : '' != u.i18nTranslations.thumbnailImageDescription
              ? u.i18nTranslations.thumbnailImageDescription
              : e.description;
      ...
      return (
        (n =
          'justified' == u.O.thumbnailAlignment
            ? Math.floor(e / t)
            : Math.floor(
                (e + u.tn.settings.GetResponsive('gutterWidth')) /
                  (t + u.tn.settings.GetResponsive('gutterWidth'))
              )),
    ...
    function H(e) {
      ...
      if (t > 0) {
        ...
        for (var n = 0.9, i = t - 1; i >= 0; i--) (e.$elt.eq(i).css('opacity', n), (n -= 0.2));
      }
    }
    function U(e) {
      var t = u.GOM.items[e],
    ...
    function W() {
      if (-1 != u.GOM.albumIdx)
        for (var e = u.GOM.items.length, t = 0; t < e; t++)
          (U(t), (u.I[u.GOM.items[t].thumbnailIdx].hovered = !1));
    }
    function j(e) {
    ...
    function X() {
      if (-1 != u.GOM.albumIdx)
        for (var e = u.GOM.items.length, t = 0; t < e; t++)
          u.GOM.items[t].inDisplayArea ? Q(t) : (u.I[u.GOM.items[t].thumbnailIdx].hovered = !1);
    }
    function Q(e) {
      if (-1 != u.GOM.albumIdx && u.galleryResizeEventEnabled && u.GOM.slider.hostIdx != e) {
        var t = u.GOM.items[e],
    ...
    function q(e, t) {
      ...
      -1 != i ? (u.O.debugMode && console.log('#DisplayPhoto : ' + i), Ie(i)) : Z(t, q, e, t);
    }
    function Z(e, t, n, i) {
      switch (u.O.kind) {
        case '':
    ...
    this.initiateGallery2 = function (e, t) {
      if (
        ...
        for (var n = '', i = !0; i; )
          document.getElementById('my_nanogallery' + n)
            ? '' == n
              ? (n = 1)
              : n++
            : ((i = !1), (u.baseEltID = 'my_nanogallery' + n));
        u.$E.base.attr('id', u.baseEltID);
      }
      if (
        ((u.O.$markup = []),
        (function () {
          ('PICASA' != u.O.kind.toUpperCase() && 'GOOGLE' != u.O.kind.toUpperCase()) ||
            (u.O.kind = 'google2');
          ((u.GOM.cache.viewport = a()),
            (u.GOM.curWidth = dt()),
          ...
          'overImageOnBottom' == u.O.thumbnailLabel.position &&
            ((u.O.thumbnailLabel.valign = 'bottom'), (u.O.thumbnailLabel.position = 'overImage'));
          'overImageOnMiddle' == u.O.thumbnailLabel.position &&
            ((u.O.thumbnailLabel.valign = 'middle'), (u.O.thumbnailLabel.position = 'overImage'));
          'overImageOnTop' == u.O.thumbnailLabel.position &&
            ((u.O.thumbnailLabel.valign = 'top'), (u.O.thumbnailLabel.position = 'overImage'));
          void 0 !== u.O.thumbnailL1Label &&
            void 0 !== u.O.thumbnailL1Label.position &&
            ('overImageOnBottom' == u.O.thumbnailL1Label.position &&
              ((u.O.thumbnailL1Label.valign = 'bottom'),
              (u.O.thumbnailL1Label.position = 'overImage')),
            'overImageOnMiddle' == u.O.thumbnailL1Label.position &&
              ((u.O.thumbnailL1Label.valign = 'middle'),
              (u.O.thumbnailL1Label.position = 'overImage')),
            'overImageOnTop' == u.O.thumbnailL1Label.position &&
              ((u.O.thumbnailL1Label.valign = 'top'),
              (u.O.thumbnailL1Label.position = 'overImage')));
          ((u.O.thumbnailLabel.get = function (e) {
            return 'l1' == u.GOM.curNavLevel &&
              void 0 !== u.O.thumbnailL1Label &&
              void 0 !== u.O.thumbnailL1Label[e]
              ? u.O.thumbnailL1Label[e]
              : u.O.thumbnailLabel[e];
          }),
            (u.O.thumbnailLabel.set = function (e, t) {
              'l1' == u.GOM.curNavLevel &&
              void 0 !== u.O.thumbnailL1Label &&
              void 0 !== u.O.thumbnailL1Label[e]
                ? (u.O.thumbnailL1Label[e] = t)
                : (u.O.thumbnailLabel[e] = t);
            }),
            '' != u.O.blockList && (u.blockList = u.O.blockList.toUpperCase().split('|')));
          '' != u.O.allowList && (u.allowList = u.O.allowList.toUpperCase().split('|'));
          if (
            void 0 !== u.O.albumList2 &&
            null !== u.O.albumList2 &&
            u.O.albumList2.constructor === Array
          ) {
            var o = u.O.albumList2.length;
            for (n = 0; n < o; n++) u.albumList.push(u.O.albumList2[n]);
          }
          void 0 !== u.O.albumList2 &&
            'string' == typeof u.O.albumList2 &&
            u.albumList.push(u.O.albumList2);
          function l(e, t, n) {
            ((u.tn.opt.lN[n] = u.O[e]),
              (u.tn.opt.l1[n] = u.O[e]),
          ...
          ((u.tn.opt.lN.crop = u.O.thumbnailCrop),
            (u.tn.opt.l1.crop =
              null != u.O.thumbnailL1Crop ? u.O.thumbnailL1Crop : u.O.thumbnailCrop),
            ...
            (u.galleryDisplayMode.l1 =
              null != u.O.galleryL1DisplayMode
                ? u.O.galleryL1DisplayMode.toUpperCase()
                : u.O.galleryDisplayMode.toUpperCase()),
            (u.galleryMaxRows.lN = u.O.galleryMaxRows),
            (u.galleryMaxRows.l1 =
              'number' == r(u.O.galleryL1MaxRows) ? u.O.galleryL1MaxRows : u.O.galleryMaxRows),
            (u.galleryLastRowFull.lN = u.O.galleryLastRowFull),
            (u.galleryLastRowFull.l1 =
              null != u.O.galleryL1LastRowFull ? u.O.galleryL1LastRowFull : u.O.galleryLastRowFull),
            (u.gallerySorting.lN = u.O.gallerySorting.toUpperCase()),
            (u.gallerySorting.l1 =
              null != u.O.galleryL1Sorting
                ? u.O.galleryL1Sorting.toUpperCase()
                : u.gallerySorting.lN),
            (u.galleryDisplayTransition.lN = u.O.galleryDisplayTransition.toUpperCase()),
            (u.galleryDisplayTransition.l1 =
              null != u.O.galleryL1DisplayTransition
                ? u.O.galleryL1DisplayTransition.toUpperCase()
                : u.galleryDisplayTransition.lN),
            (u.galleryDisplayTransitionDuration.lN = u.O.galleryDisplayTransitionDuration),
            (u.galleryDisplayTransitionDuration.l1 =
              null != u.O.galleryL1DisplayTransitionDuration
                ? u.O.galleryL1DisplayTransitionDuration
                : u.galleryDisplayTransitionDuration.lN),
            (u.galleryMaxItems.lN = u.O.galleryMaxItems),
            (u.galleryMaxItems.l1 =
              'number' == r(u.O.galleryL1MaxItems) ? u.O.galleryL1MaxItems : u.O.galleryMaxItems),
            (u.galleryFilterTags.lN = u.O.galleryFilterTags),
            (u.galleryFilterTags.l1 =
              null != u.O.galleryL1FilterTags ? u.O.galleryL1FilterTags : u.O.galleryFilterTags),
            (u.galleryFilterTagsMode.lN = u.O.galleryFilterTagsMode),
            (u.galleryFilterTagsMode.l1 =
              null != u.O.galleryL1FilterTagsMode
                ? u.O.galleryL1FilterTagsMode
                : u.O.galleryFilterTagsMode),
            (u.O.galleryPaginationMode = u.O.galleryPaginationMode.toUpperCase()),
            'number' == r(u.O.slideshowDelay) && u.O.slideshowDelay >= 2e3
              ? (u.VOM.slideshowDelay = u.O.slideshowDelay)
              : d(u, 'Parameter "slideshowDelay" must be an integer >= 2000 ms.'));
          'boolean' == typeof u.O.thumbnailDisplayTransition &&
            (!0 === u.O.thumbnailDisplayTransition
              ? ((u.tn.opt.lN.displayTransition = 'FADEIN'),
                (u.tn.opt.l1.displayTransition = 'FADEIN'))
              : ((u.tn.opt.lN.displayTransition = 'NONE'),
                (u.tn.opt.l1.displayTransition = 'NONE')));
          '' !== u.O.fnThumbnailDisplayEffect &&
            ((u.tn.opt.lN.displayTransition = 'CUSTOM'),
          ...
          function m(e, t) {
            if ('string' == typeof e) {
              ...
              (1 == n.length && (u.tn.opt[t].displayTransition = e.toUpperCase()),
                2 == n.length &&
                  ((u.tn.opt[t].displayTransition = n[0].toUpperCase()),
          ...
          (l(
            'thumbnailDisplayTransitionEasing',
            'thumbnailL1DisplayTransitionEasing',
            ...
            l(
              ...
              'thumbnailL1DisplayTransitionDuration',
            ...
            switch (r(b)) {
              case 'string': {
                ...
                for (n = 0; n < e.length; n++) {
                  let t = re();
                  ((t = ie(e[n].trim(), t)), null != t && u.tn.hoverEffects.level1.push(t));
                }
                break;
              }
              case 'object': {
          ...
          u.tn.hoverEffects.level1 = oe(u.tn.hoverEffects.level1);
          ...
          switch (r(v)) {
            case 'string': {
              ...
              for (n = 0; n < e.length; n++) {
                let t = re();
                ((t = ie(e[n].trim(), t)), null != t && u.tn.hoverEffects.std.push(t));
              }
              break;
            }
            case 'object': {
          ...
          ((u.tn.hoverEffects.std = oe(u.tn.hoverEffects.std)),
            null == u.O.touchAnimationL1 && (u.O.touchAnimationL1 = u.O.touchAnimation));
          0 == u.tn.hoverEffects.std.length &&
            (0 == u.tn.hoverEffects.level1.length && (u.O.touchAnimationL1 = !1),
          ...
          (0 != u.O.thumbnailL1Height && '' != u.O.thumbnailL1Height) ||
            (u.O.thumbnailL1Height = 'auto');
          (0 != u.O.thumbnailL1Width && '' != u.O.thumbnailL1Width) ||
            (u.O.thumbnailL1Width = 'auto');
          (c('thumbnailWidth', 'width', 'lN'),
            ...
            null != u.O.galleryMosaic &&
              ((u.tn.settings.mosaic.l1.xs = JSON.parse(JSON.stringify(u.O.galleryMosaic))),
          ...
          null != u.O.galleryL1Mosaic &&
            ((u.tn.settings.mosaic.l1.xs = JSON.parse(JSON.stringify(u.O.galleryL1Mosaic))),
          ...
          for (var O = ['xs', 'sm', 'me', 'la', 'xl'], y = 0; y < O.length; y++)
            null != u.O['galleryMosaic' + O[y].toUpperCase()] &&
              ((u.tn.settings.mosaic.lN[O[y]] = JSON.parse(
                JSON.stringify(u.O['galleryMosaic' + O[y].toUpperCase()])
              )),
              (u.tn.settings.mosaic.l1[O[y]] = JSON.parse(
                JSON.stringify(u.O['galleryMosaic' + O[y].toUpperCase()])
              )),
              u.tn.settings.mosaicCalcFactor('lN', O[y]),
              u.tn.settings.mosaicCalcFactor('l1', O[y]));
          for (y = 0; y < O.length; y++)
            null != u.O['galleryL1Mosaic' + O[y].toUpperCase()] &&
              ((u.tn.settings.mosaic.l1[O[y]] = JSON.parse(
                JSON.stringify(u.O['galleryL1Mosaic' + O[y].toUpperCase()])
              )),
              u.tn.settings.mosaicCalcFactor('l1', O[y]));
          switch (
            ((u.O.imageTransition = u.O.imageTransition.toUpperCase()),
            u.layout.SetEngine(),
            u.O.kind)
          ) {
            case '':
        ...
        (function () {
          ...
          if (!u.O.lightboxStandalone) {
            (u.$E.base.text(''),
              ...
              (function () {
                ...
                void 0 !== i.border &&
                  '' !== i.border &&
                  (a += n + '.nGY2Navigationbar { border:' + i.border + '; }\n');
                void 0 !== i.borderTop &&
                  '' !== i.borderTop &&
                  (a += n + '.nGY2Navigationbar { border-top:' + i.borderTop + '; }\n');
                void 0 !== i.borderBottom &&
                  '' !== i.borderBottom &&
                  (a += n + '.nGY2Navigationbar { border-bottom:' + i.borderBottom + '; }\n');
                void 0 !== i.borderRight &&
                  '' !== i.borderRight &&
                  (a += n + '.nGY2Navigationbar { border-right:' + i.borderRight + '; }\n');
                void 0 !== i.borderLeft &&
                  '' !== i.borderLeft &&
                  (a += n + '.nGY2Navigationbar { border-left:' + i.borderLeft + '; }\n');
                i = e.navigationBreadcrumb;
                ((a +=
                  n +
                  '.nGY2Breadcrumb { background:' +
                  i.background +
                  '; border-radius:' +
                  i.borderRadius +
                  '; }\n'),
                ...
                ((a +=
                  ...
                  (a +=
                    ...
                    i.colorSelected +
                    '; background:' +
                    i.backgroundSelected +
                    '; border-radius:' +
                    i.borderRadius +
                    '; }\n'),
                  (a +=
                    n +
                    '.nGY2NavFilterSelectAll { color:' +
                    i.colorSelected +
                    '; background:' +
                    i.background +
                    '; border-radius:' +
                ...
                ((a +=
                  ...
                  (a +=
                    n +
                    '.nGY2GThumbnail_l1 { border-top-width:' +
                    u.tn.opt.l1.borderVertical +
                    'px; border-right-width:' +
                    u.tn.opt.l1.borderHorizontal +
                  ...
                  (a +=
                    n +
                    '.nGY2GThumbnail_lN { border-top-width:' +
                    u.tn.opt.lN.borderVertical +
                    'px; border-right-width:' +
                    u.tn.opt.lN.borderHorizontal +
                    'px; border-bottom-width:' +
                    u.tn.opt.lN.borderVertical +
                    'px; border-left-width:' +
                    u.tn.opt.lN.borderHorizontal +
                  ...
                  (a +=
                    n +
                    '.nGY2GThumbnailAlbumUp { background:' +
                    i.background +
                    '; background-image:' +
                    i.backgroundImage +
                    '; color:' +
                    e.thumbnail.titleColor +
                    '; }\n'),
                  (a += n + '.nGY2GThumbnailIconsFullThumbnail { color:' + i.titleColor + '; }\n'),
                  (a +=
                    n +
                    '.nGY2GThumbnailLabel { background:' +
                    i.labelBackground +
                    '; opacity:' +
                    i.labelOpacity +
                    '; }\n'),
                  (a +=
                    n +
                    '.nGY2GThumbnailImageTitle  { color:' +
                    i.titleColor +
                    '; background-color:' +
                    i.titleBgColor +
                    '; ' +
                    ('' == i.titleShadow ? '' : 'Text-Shadow:' + i.titleShadow + ';') +
                    ' }\n'),
                  (a +=
                    n +
                    '.nGY2GThumbnailAlbumTitle { color:' +
                    i.titleColor +
                    '; background-color:' +
                    i.titleBgColor +
                    '; ' +
                  ...
                  (a +=
                    n +
                    '.nGY2GThumbnailDescription { color:' +
                    i.descriptionColor +
                    '; background-color:' +
                    i.descriptionBgColor +
                    '; ' +
                    ('' == i.descriptionShadow ? '' : 'Text-Shadow:' + i.descriptionShadow + ';') +
                    ' }\n'));
                i = e.thumbnailIcon;
                ((a += n + '.nGY2GThumbnailIcons { padding:' + i.padding + '; }\n'),
                  (a +=
                    n +
                    '.nGY2GThumbnailIcon { color:' +
                    i.color +
                    '; ' +
                    ('' == i.shadow ? '' : 'Text-Shadow:' + i.shadow + ';') +
                    ' }\n'),
                  (a +=
                    n + '.nGY2GThumbnailIconTextBadge { background-color:' + i.color + '; }\n'));
                i = e.pagination;
                'NUMBERS' != u.O.galleryPaginationMode
                  ? ((a +=
                      n +
                      '.nGY2paginationDot { border:' +
                      i.shapeBorder +
                      '; background:' +
                      i.shapeColor +
                      ';}\n'),
                    (a +=
                      n +
                      '.nGY2paginationDotCurrentPage { border:' +
                      i.shapeBorder +
                      '; background:' +
                      i.shapeSelectedColor +
                      ';}\n'),
                    (a +=
                      n +
                      '.nGY2paginationRectangle { border:' +
                      i.shapeBorder +
                      '; background:' +
                      i.shapeColor +
                      ';}\n'),
                    (a +=
                      n +
                      '.nGY2paginationRectangleCurrentPage { border:' +
                      i.shapeBorder +
                      '; background:' +
                      i.shapeSelectedColor +
                      ';}\n'))
                  : ((a +=
                    ...
                    (a +=
                      n +
                      '.nGY2paginationItemCurrentPage { background:' +
                      i.background +
                      '; color:' +
                      i.color +
                      '; border-radius:' +
                ...
                ((a +=
                  n +
                  '.nGY2GalleryMoreButtonAnnotation { background:' +
                  i.background +
                  '; border-color:' +
                  i.borderColor +
                  ...
                  (a +=
                    n +
                    '.nGY2GalleryMoreButtonAnnotation  { color:' +
                    i.titleColor +
                    '; ' +
                    ('' == i.titleShadow ? '' : 'Text-Shadow:' + i.titleShadow) +
                    '; }\n'),
              ...
              u.O.thumbnailLabel.get('hideIcons') &&
                ((u.O.icons.thumbnailAlbum = ''), (u.O.icons.thumbnailImage = '')));
            var t = '';
            switch (
              (null != u.O.navigationFontSize &&
                '' != u.O.navigationFontSize &&
                (t = ' style="font-size:' + u.O.navigationFontSize + ';"'),
              (u.$E.conNavigationBar = jQuery(
                '<div class="nGY2Navigationbar" ' + t + '></div>'
              ).appendTo(u.$E.base)),
              (u.$E.conLoadingB = jQuery(
                '<div class="nanoGalleryLBarOff"><div></div><div></div><div></div><div></div><div></div></div>'
              ).appendTo(u.$E.base)),
              (u.$E.conTnParent = jQuery('<div class="nGY2Gallery"></div>').appendTo(u.$E.base)),
              (u.$E.conTn = jQuery('<div class="nGY2GallerySub"></div>').appendTo(
                u.$E.conTnParent
              )),
            ...
            for (
              var o = u.tn.hoverEffects.std.concat(u.tn.hoverEffects.level1), l = 0;
              l < o.length;
              l++
            )
              switch (o[l].type) {
            ...
            if (
              ...
              var s =
                ...
                c =
                  'font-weight:bold !important;color: #FF0075 !important;font-size: 14px !important;text-transform: lowercase !important;cursor:pointer !important;text-align: center !important;Text-Shadow: #000000 1px 0px 0px, #000000 1px 1px 0px, #000000 1px -1px 0px, #000000 -1px 1px 0px, #000000 -1px 0px 0px, #000000 -1px -1px 0px, #000000 0px 1px 0px, #000000 0px -1px 0px !important;';
              ((u.$E.ngy2i = jQuery(
                '<div class="nGY2PortInfo"><a href="http://nano.gallery" target="_blank" title="nanogallery2 | easy photo gallery for your website" style="' +
                  c +
                  '"><img src="' +
                  s +
                  '" style="height:32px !important;width:initial !important;box-shadow: none !important;vertical-align: middle !important;"/> &nbsp; nanogallery2</a></div>'
              ).appendTo(u.$E.base)),
                u.$E.ngy2i.find('a').on({
                  mouseenter: function () {
          ...
          if (
            ((u.$E.conConsole = jQuery('<div class="nGY2ConsoleParent"></div>').appendTo(
              u.$E.base
            )),
            (function () {
              ...
              if ('object' == r(u.O.i18n))
                for (var t in u.O.i18n) {
                  var n = t.substr(e);
                  n == '_' + u.i18nLang
                    ? (u.i18nTranslations[t.substr(0, t.length - n.length)] = u.O.i18n[t])
                    : (u.i18nTranslations[t] = u.O.i18n[t]);
                }
            })(),
            ...
            switch (
              ((function () {
                (se(u.O.thumbnailLabel, 'lN'),
                  void 0 !== u.O.thumbnailL1Label
                    ? se(u.O.thumbnailL1Label, 'l1')
                    : se(u.O.thumbnailLabel, 'l1'));
                u.O.thumbnailL1Label &&
                  u.O.thumbnailL1Label.display &&
                  se(u.O.thumbnailL1Label, 'l1');
                for (var e = ['xs', 'sm', 'me', 'la', 'xl'], t = 0; t < e.length; t++) {
                  if ('auto' != (i = u.tn.settings.width.lN[e[t]]))
                    ((u.tn.defaultSize.width.lN[e[t]] = i), (u.tn.defaultSize.width.l1[e[t]] = i));
                  else {
        ...
        (function () {
          u.O.lightboxStandalone ||
            (u.$E.conTnParent.on({ mouseenter: ve, mouseleave: Oe }, '.nGY2GThumbnail'),
            ...
            u.GOM.hammertime.on('pan', function (e) {
              u.VOM.viewerDisplayed ||
                (u.O.paginationSwipe &&
                  u.layout.support.rows &&
                  'PAGINATION' == u.galleryDisplayMode.Get() &&
                  (Math.abs(e.deltaY) > u.GOM.panThreshold && (u.GOM.panYOnly = !0),
                  u.GOM.panYOnly ||
                    u.$E.conTn.css(u.CSStransformName, 'translate(' + e.deltaX + 'px,0px)')));
            }),
            ...
            u.GOM.hammertime.on('tap', function (e) {
              if (!u.VOM.viewerDisplayed)
                if (
                  ...
                  if ('exit' == ce(e.srcEvent)) return;
                } else {
                  var t = ye(e.srcEvent, !1);
                  if (-1 == t.GOMidx) return;
                  if ('NONE' != t.action && 'OPEN' != t.action) return void ce(e.srcEvent);
                  if (u.GOM.slider.hostIdx == t.GOMidx)
                    return (X(), void Ge(u.GOM.items[u.GOM.slider.currentIdx].thumbnailIdx, !0));
                  if (
                    ('l1' == u.GOM.curNavLevel && 0 == u.O.touchAnimationL1) ||
                    ('lN' == u.GOM.curNavLevel && 0 == u.O.touchAnimation)
                  )
                    return void Ge(u.GOM.items[t.GOMidx].thumbnailIdx, !0);
                  u.O.touchAutoOpenDelay > 0
                    ? (X(),
                      j(t.GOMidx),
                      window.clearInterval(u.touchAutoOpenDelayTimerID),
                      (u.touchAutoOpenDelayTimerID = window.setInterval(function () {
                        (window.clearInterval(u.touchAutoOpenDelayTimerID),
                          Ge(u.GOM.items[t.GOMidx].thumbnailIdx, !0));
                      }, u.O.touchAutoOpenDelay)))
                    : u.I[u.GOM.items[t.GOMidx].thumbnailIdx].hovered
                      ? Ge(u.GOM.items[t.GOMidx].thumbnailIdx, !0)
                      : (X(), j(t.GOMidx));
                }
            }),
            u.O.locationHash &&
              jQuery(window).on('hashchange.nanogallery2.' + u.baseEltID, function () {
                rt();
              }));
          if (
            (jQuery(window).on(
              'resize.nanogallery2.' +
                u.baseEltID +
                ' orientationChange.nanogallery2.' +
                u.baseEltID,
              s(st, u.O.eventsDebounceDelay, !1)
            ),
            jQuery(window).on(
              'scroll.nanogallery2.' + u.baseEltID,
              s(ut, u.O.eventsDebounceDelay, !1)
            ),
            !u.O.lightboxStandalone)
          ) {
            u.$E.scrollableParent = at(u.$E.base[0]);
            var e = at(u.$E.base[0]);
            null !== e &&
              ((u.$E.scrollableParent = jQuery(e)),
              u.$E.scrollableParent.on(
                'scroll.nanogallery2.' + u.baseEltID,
                s(ut, u.O.eventsDebounceDelay, !1)
              ));
          }
          ((u.VOM.toolsHide = s(Ae, u.O.viewerHideToolsDelay, !1)),
            ...
            jQuery(window).bind('mousemove', function (e) {
              u.VOM.viewerDisplayed &&
                ...
                ((u.VOM.singletapTime = new Date().getTime()), s(_e, 100, !1)());
            }),
            ngscreenfull.enabled &&
              ngscreenfull.onchange(function () {
                u.VOM.viewerDisplayed &&
                  (ngscreenfull.isFullscreen
                    ? ((u.VOM.viewerIsFullscreen = !0),
                      u.VOM.$viewer.find('.fullscreenButton').html(u.O.icons.viewerFullscreenOff))
                    : ((u.VOM.viewerIsFullscreen = !1),
        ...
        var o = u.O.album;
        if (
          ('' == o && '' != u.O.photoset && ((o = u.O.photoset), (u.O.album = u.O.photoset)),
          '' != o && ((u.O.displayBreadcrumb = !1), 'NONE' != o.toUpperCase()))
        )
          return (
            'nano_photos_provider2' == u.O.kind &&
              o == decodeURIComponent(o) &&
              ((o = encodeURIComponent(o)), (u.O.album = o)),
          ...
          (function () {
            if (u.O.lightboxStandalone)
              ((u.GOM.curNavLevel = 'l1'),
                null == u.O.items
                  ? ne(
                      jQuery('[data-nanogallery2-Lightbox'),
                      u.$E.base[0].dataset.nanogallery2Lgroup
                    )
                  : ee(),
                m());
    ...
    var J = {
      youtube: {
        ...
        markup: function (e) {
          return (
            '<iframe class="nGY2ViewerMedia" src="https://www.youtube.com/embed/' +
            e +
      ...
      vimeo: {
        ...
        markup: function (e) {
          return (
            '<iframe class="nGY2ViewerMedia" src="https://player.vimeo.com/video/' +
            e +
      ...
      dailymotion: {
        ...
        markup: function (e) {
          return (
            '<iframe class="nGY2ViewerMedia" src="https://www.dailymotion.com/embed/video/' +
            e +
            '?rel=0" frameborder="0" allow="autoplay" allowfullscreen></iframe>'
          );
        },
      ...
      selfhosted: {
        ...
        markup: function (e) {
          var t = e.split('.').pop();
          return (
            '<video controls class="nGY2ViewerMedia"><source src="' +
            e +
            '" type="video/' +
            t +
            '" preload="auto">Your browser does not support the video tag (HTML 5).</video>'
          );
        },
        kind: 'video',
        selfhosted: !0,
    ...
    function ee() {
      ...
      ((u.I[0].contentIsLoaded = !0),
        jQuery.each(u.O.items, function (n, a) {
          var o = '';
          void 0 === (o = ht(a, 'title')) && (o = '');
          var r = '';
          K(
            (r = void 0 !== a['src' + dt().toUpperCase()] ? a['src' + dt().toUpperCase()] : a.src)
          ) || (r = u.O.itemsBaseURL + r);
          var l = '';
          (void 0 !== a.srct && a.srct.length > 0
            ? K((l = a.srct)) || (l = u.O.itemsBaseURL + l)
            : (l = r),
            '' != u.O.thumbnailLabel.get('title') && (o = GetImageTitle(r)));
          var s = '';
          void 0 === (s = ht(a, 'description')) && (s = '');
          var c = ht(a, 'tags');
          void 0 === c && (c = '');
          var h = 0;
          ...
          ('' != o && e++,
            p.setMediaURL(r, 'img'),
            jQuery.each(J, function (e, t) {
              var n = t.getID(r);
              if (null != n)
                return (
                  l == r && 'function' == typeof t.thumbUrl && (l = t.thumbUrl(n)),
          ...
          if (
            ((p.thumbs = {
              url: {
                l1: { xs: l, sm: l, me: l, la: l, xl: l },
                lN: { xs: l, sm: l, me: l, la: l, xl: l },
              },
              width: {
                l1: { xs: g, sm: g, me: g, la: g, xl: g },
                lN: { xs: g, sm: g, me: g, la: g, xl: g },
              },
              height: {
                l1: { xs: f, sm: f, me: f, la: f, xl: f },
                lN: { xs: f, sm: f, me: f, la: f, xl: f },
              },
            }),
            'img' == p.mediaKind)
          ) {
            ...
            for (n = 0; n < b.length; n++) {
              ...
              (void 0 !== v &&
                (K(v) || (v = u.O.itemsBaseURL + v), (p.url.l1[b[n]] = v), (p.url.lN[b[n]] = v)),
                null != (g = a['imgt' + b[n].toUpperCase() + 'Width']) &&
                  ((p.width.l1[b[n]] = parseInt(g)), (p.width.lN[b[n]] = parseInt(g))),
                null != (f = a['imgt' + b[n].toUpperCase() + 'Height']) &&
                  ((p.height.l1[b[n]] = parseInt(f)), (p.height.lN[b[n]] = parseInt(f))));
            }
          }
    ...
    function te(e) {
      var t = '';
      return (
        void 0 !== e.childNodes[0] &&
          null !== e.childNodes[0].nodeValue &&
          void 0 !== e.childNodes[0].nodeValue &&
          (t = e.childNodes[0].nodeValue.trim()),
        t
      );
    }
    function ne(t, n) {
        ...
        jQuery.each(t, function (t, l) {
          if (l.dataset.nanogallery2Lgroup == n && 'SCRIPT' != l.nodeName) {
            ...
            (s.hasOwnProperty('data-ngsrc' + d) && (h = s['data-ngsrc' + d]),
              void 0 === (h = h || s['data-ngsrc'] || s.href) ||
                K(h) ||
                (h = u.O.itemsBaseURL + h));
            var m = '';
            if (
              (s.hasOwnProperty('src') && (m = s.src),
              '' == m && s.hasOwnProperty('data-ngthumb') && (m = s['data-ngthumb']),
              '' == m && (m = h),
              void 0 === m || K(m) || (m = u.O.itemsBaseURL + m),
              void 0 !== h || void 0 !== m)
            ) {
              var p = s['data-ngdesc'],
                g = s.id || s['data-ngid'],
              ...
              ('' != c && a++,
                ...
                jQuery.each(J, function (e, t) {
                  ...
                  if (null != n)
                    return (
                      m == h && 'function' == typeof t.thumbUrl && (m = t.thumbUrl(n)),
              ...
              ((y.imageDominantColors = s['data-ngimagedominantcolors']),
                ...
                (y.contentIsLoaded = !0),
                void 0 !== jQuery(l).data('customdata') &&
                  (y.customData = i(jQuery(l).data('customdata'))),
                void 0 !== jQuery(l).data('ngcustomdata') &&
                  (y.customData = i(jQuery(l).data('ngcustomdata'))));
              var T = u.O.fnProcessData;
              (null !== T &&
                ('function' == typeof T ? T(y, 'markup', l) : window[T](y, 'markup', l)),
                o(v));
            }
          }
        }),
    ...
    function oe(e) {
      for (var a = [], o = 0; o < e.length; o++)
        switch (e[o].name.toUpperCase()) {
          case 'BORDERLIGHTER': {
            let i = t(ue().thumbnail.borderColor),
              r = 'thumbnail_borderColor_' + i + '_' + n(0.5, i);
            a.push(ie(r, e[o]));
            break;
          }
          case 'BORDERDARKER': {
          ...
          case 'SCALE120':
            a.push(ie('thumbnail_scale_1.00_1.20', e[o]));
            break;
          case 'LABELAPPEAR':
          case 'LABELAPPEAR75':
            a.push(ie('label_opacity_0.00_1.00', e[o]));
            break;
          case 'TOOLSAPPEAR':
            a.push(ie('tools_opacity_0_1', e[o]));
            break;
          case 'TOOLSSLIDEDOWN':
            a.push(ie('tools_translateY_-100%_0%', e[o]));
            break;
          case 'TOOLSSLIDEUP':
            a.push(ie('tools_translateY_100%_0%', e[o]));
            break;
          case 'LABELOPACITY50':
            a.push(ie('label_opacity_1.00_0.50', e[o]));
            break;
          case 'LABELSLIDEUPTOP':
          case 'LABELSLIDEUP':
            (a.push(ie('label_translateY_100%_0%', e[o])),
              a.push(ie('label_translateY_100%_0%', e[o])));
            break;
          case 'LABELSLIDEDOWN':
            a.push(ie('label_translateY_-100%_0%', e[o]));
            break;
          case 'SCALELABELOVERIMAGE':
            a.push(ie('label_scale_0.00_1.00', e[o]));
            var r = i(e[o]);
            a.push(ie('image_scale_1.00_0.00', r));
            break;
          case 'OVERSCALE':
          case 'OVERSCALEOUTSIDE':
            a.push(ie('label_scale_2.00_1.00', e[o]));
            r = i(e[o]);
            (a.push(ie('label_opacity_0.00_1.00', r)),
              (r = i(e[o])),
              a.push(ie('image_scale_1.00_0.00', r)),
              (r = i(e[o])),
              a.push(ie('image_opacity_1.00_0.00', r)));
            break;
          case 'DESCRIPTIONAPPEAR':
            a.push(ie('description_opacity_0_1', e[o]));
            break;
          case 'SLIDERIGHT':
            (a.push(ie('image_translateX_0%_100%', e[o])),
              a.push(ie('label_translateX_-100%_0%', i(e[o]))));
            break;
          case 'SLIDELEFT':
            (a.push(ie('image_translateX_0%_-100%', e[o])),
              a.push(ie('label_translateX_100%_0%', i(e[o]))));
            break;
          case 'SLIDEUP':
            (a.push(ie('image_translateY_0%_-100%', e[o])),
              a.push(ie('label_translateY_100%_0%', i(e[o]))));
            break;
          case 'SLIDEDOWN':
            (a.push(ie('image_translateY_0%_100%', e[o])),
              a.push(ie('label_translateY_-100%_0%', i(e[o]))));
            break;
          case 'IMAGESCALE150':
          case 'IMAGESCALE150OUTSIDE':
            a.push(ie('image_scale_1.00_1.50', e[o]));
            break;
          case 'IMAGESCALEIN80':
            a.push(ie('image_scale_1.20_1.00', e[o]));
            break;
          ...
          case 'LABELSLIDEUPDOWN':
            a.push(ie('label_translateY_0%_100%', e[o]));
            break;
          case 'DESCRIPTIONSLIDEUP':
            a.push(ie('description_translateY_110%_0%', e[o]));
            break;
          case 'IMAGEBLURON':
            a.push(ie('image_blur_2.00px_0.00px', e[o]));
            break;
          case 'IMAGEBLUROFF':
            a.push(ie('image_blur_0.00px_2.00px', e[o]));
            break;
          case 'IMAGEGRAYON':
            a.push(ie('image_grayscale_0%_100%', e[o]));
            break;
          case 'IMAGEGRAYOFF':
            a.push(ie('image_grayscale_100%_0%', e[o]));
            break;
          case 'IMAGESEPIAON':
            a.push(ie('image_sepia_100%_1%', e[o]));
            break;
          case 'IMAGESEPIAOFF':
            a.push(ie('image_sepia_1%_100%', e[o]));
            break;
          default:
            a.push(e[o]);
        }
    ...
    function se(e, t) {
      ...
      switch (
        ('onBottom' != e.position &&
          (e.titleMultiLine && (u.tn.style[t].title += 'white-space:normal;'),
      ...
      (null != e.titleFontSize &&
        '' != e.titleFontSize &&
        (u.tn.style[t].title += 'font-size:' + e.titleFontSize + ';'),
        null != e.descriptionFontSize &&
          '' != e.descriptionFontSize &&
          (u.tn.style[t].desc += 'font-size:' + e.descriptionFontSize + ';'),
    ...
    function ce(e) {
      ...
      switch (
        (u.GOM.slider.hostIdx == t.GOMidx &&
          (n = u.GOM.items[u.GOM.slider.currentIdx].thumbnailIdx),
        t.action)
      ) {
        case 'OPEN':
          return (Ge(n, !1), 'exit');
        ...
        case 'DOWNLOAD':
          return (he(n), 'exit');
        case 'INFO':
          return (Be(u.I[n]), 'exit');
        case 'SHOPPINGCART':
          return (de(n, 'gallery'), 'exit');
        default:
          var i = u.O.fnThumbnailToolCustAction;
          null !== i &&
            ('function' == typeof i ? i(t.action, u.I[n]) : window[i](t.action, u.I[n]));
      }
    }
    function he(e) {
    ...
    function de(e, t) {
      for (var n = 0; n < u.shoppingCart.length; n++) {
        ...
        if (u.shoppingCart[n].idx == e)
          return (
            u.shoppingCart[n].qty++,
            $(u.I[e]),
            null !== (i = u.O.fnShoppingCartUpdated) &&
              ('function' == typeof i
                ? i(u.shoppingCart, u.I[e], t)
                : window[i](u.shoppingCart, u.I[e], t)),
            void ot('shoppingCartUpdated')
          );
      }
      (u.shoppingCart.push({ idx: e, ID: u.I[e].GetID(), qty: 1 }),
        $(u.I[e]),
        null !== (i = u.O.fnShoppingCartUpdated) &&
          ('function' == typeof i
            ? i(u.shoppingCart, u.I[e], t)
            : window[i](u.shoppingCart, u.I[e], t)),
        ot('shoppingCartUpdated'));
    }
    function me() {
      u.GOM.nbSelected = 0;
    ...
    function pe(e) {
      var t = u.I[e];
      !0 === t.selected
        ? (ge(t, !1), u.GOM.nbSelected--, ot('itemUnSelected'))
        : (ge(t, !0), u.GOM.nbSelected++, ot('itemSelected'));
    }
    function ge(e, t) {
      ((e.selected = t),
        (function (e) {
          ...
          !0 === e.selected
            ? (t.addClass('nGY2GThumbnailSubSelected'),
              n.addClass('nGY2ThumbnailSelected'),
              n.removeClass('nGY2ThumbnailUnselected'),
              n.html(u.O.icons.thumbnailSelected))
            : (t.removeClass('nGY2GThumbnailSubSelected'),
    ...
    function fe(e) {
      ...
      var a = '<br><br>';
      ((a +=
        '<div class="nGY2PopupOneItem" style="text-align:center;" data-share="facebook">' +
        u.O.icons.shareFacebook +
        '</div>'),
        (a +=
          '<div class="nGY2PopupOneItem" style="text-align:center;" data-share="pinterest">' +
          u.O.icons.sharePinterest +
          '</div>'),
        (a +=
          '<div class="nGY2PopupOneItem" style="text-align:center;" data-share="tumblr">' +
          u.O.icons.shareTumblr +
          '</div>'),
        (a +=
          '<div class="nGY2PopupOneItem" style="text-align:center;" data-share="twitter">' +
          u.O.icons.shareTwitter +
          '</div>'),
        (a +=
          '<div class="nGY2PopupOneItem" style="text-align:center;" data-share="vk">' +
          u.O.icons.shareVK +
          '</div>'),
        (a +=
          '<div class="nGY2PopupOneItem" style="text-align:center;" data-share="mail">' +
          u.O.icons.shareMail +
          '</div>'),
        (a += '<div class="nGY2PopupOneItem" style="text-align:center;"></div>'),
        (a +=
          '<input class="nGY2PopupOneItemText" readonly type="text" value="' +
          n +
          i +
      ...
      var o = t.title,
        r = t.thumbImg().src;
      (be('nanogallery2 - share to:', a, 'Center'),
        u.popup.$elt.find('.nGY2PopupOneItem').on('click', function (e) {
          ...
          switch (jQuery(this).attr('data-share').toUpperCase()) {
            ...
            case 'PINTEREST':
              t =
                'https://pinterest.com/pin/create/button/?media=' +
                r +
                '&url=' +
                n +
                '&description=' +
          ...
          i &&
            (window.open(t, '', 'height=550,width=500,left=100,top=100,menubar=0'),
            u.popup.close());
        }));
    }
    function be(e, t, n) {
      ...
      ((i +=
        '<div class="nGY2PopupCloseButton" style="font-size:0.9em;">' +
        u.O.icons.buttonClose +
        '</div>'),
    ...
    function Ge(e, t) {
      ...
      if (
        (null !== i && ('function' == typeof i ? i(n.$elt, n) : window[i](n.$elt, n)),
        ...
        switch (n.kind) {
          case 'image':
            !1 === t && u.GOM.nbSelected > 0 ? pe(e) : Ie(e);
            break;
          case 'album':
            if (!1 === t && u.GOM.nbSelected > 0) pe(e);
            else {
              if (u.O.thumbnailAlbumDisplayImage && 0 != e) return void Me(e);
              g('-1', n.GetID());
            }
            break;
          case 'albumUp':
    ...
    function Me(e) {
      ...
      for (var t = u.I[e], n = u.I.length, i = 0; i < n; i++)
        if (u.I[i].albumID == t.GetID()) return void Ie(i);
      Z(t.GetID(), Me, e, null);
    }
    function we(e) {
      switch (u.O.kind) {
    ...
    function Ie(e) {
      if (u.O.thumbnailOpenInLightox)
        if (u.O.thumbnailOpenOriginal) we(u.I[e]);
        else {
          var t = [];
          ...
          if (null === r)
            if (u.VOM.viewerDisplayed) {
              ...
              ('img' == e.mediaKind &&
                0 != e.imageWidth &&
                0 != e.imageHeight &&
                (l = '<div class="nGY2ViewerMediaLoaderHidden"></div>'),
                u.VOM.content.current.$media.append(l + e.mediaMarkup),
                tt(u.VOM.content.next, 0),
                tt(u.VOM.content.previous, 0),
                'img' == e.mediaKind && u.VOM.ImageLoader.loadImage(et, e),
                Je(''));
            } else Ne();
    ...
    function Te() {
      if (u.O.viewerZoom && !u.VOM.viewerMediaIsChanged) {
        ...
        if ('img' == e.mediaKind && e.imageHeight > 0 && e.imageWidth > 0)
          return (
            !1 === u.VOM.zoom.isZooming &&
              ((u.VOM.zoom.userFactor = 1), (u.VOM.zoom.isZooming = !0)),
            !0
          );
      }
      return !1;
    ...
    function xe(e) {
      (e ? ((u.VOM.zoom.userFactor += 0.1), Se()) : ((u.VOM.zoom.userFactor -= 0.1), Le()), Ce());
    }
    function Se() {
    ...
    function Ce() {
      (u.VOM.zoom.isZooming || (u.VOM.zoom.userFactor = 1),
        ke(u.VOM.content.current, !0),
        ke(u.VOM.content.previous, !1),
        ke(u.VOM.content.next, !1));
    }
    function Ee(e) {
    ...
    function ke(e, t) {
      ...
      if ('img' == n.mediaKind)
        if (0 != n.imageHeight && 0 != n.imageWidth) {
          ...
          t
            ? (u.VOM.zoom.isZooming || ((u.VOM.panPosX = 0), (u.VOM.panPosY = 0)),
              (u.VOM.zoom.posX = d),
              (u.VOM.zoom.posY = 0),
              De(u.VOM.panPosX, u.VOM.panPosY, i, !1))
            : (Qe(u.VOM.swipePosX),
              (i.children().eq(1)[0].style[u.CSStransformName] =
                'translate(0px, 0px) rotate(' + n.rotationAngle + 'deg)'));
        } else tt(e, 0);
      else Ee(i);
    }
    function De(e, t, n, i) {
      (i && ((u.VOM.panPosX = e), (u.VOM.panPosY = t)),
        (e += u.VOM.zoom.posX),
        (t += u.VOM.zoom.posY),
        (n.children().eq(1)[0].style[u.CSStransformName] =
          'translate(' +
          e +
          'px, ' +
          t +
          'px) rotate(' +
          u.VOM.content.current.NGY2Item().rotationAngle +
          'deg)'));
    }
    function Ne(e) {
      ((u.GOM.firstDisplay = !1),
        jQuery('head').append(
          '<style id="nGY2_body_scrollbar_style" type="text/css">.nGY2_body_scrollbar{margin-right: ' +
            (window.innerWidth - document.documentElement.clientWidth) +
            'px;}</style>'
        ),
        jQuery('body').addClass('nGY2_body_scrollbar'),
        (u.VOM.$baseCont = jQuery(
          '<div  class="nGY2 nGY2ViewerContainer" style="opacity:1"></div>'
        ).appendTo('body')),
        (function () {
          if ('' == u.VOM.viewerTheme) {
            ...
            ((n += t + '.nGY2Viewer .toolbarBackground { background:' + e.barBackground + '; }\n'),
              ...
              (n +=
                t +
                '.nGY2Viewer .toolbar .label .description { color:' +
                e.barDescriptionColor +
                '; }\n'),
        ...
        (u.VOM.$viewer = jQuery(
          '<div class="nGY2Viewer" style="opacity:0" itemscope itemtype="http://schema.org/ImageObject"></div>'
        ).appendTo(u.VOM.$baseCont)),
        u.VOM.$viewer.css({ msTouchAction: 'none', touchAction: 'none' }),
        (u.VOM.content.current.vIdx = null == e ? 0 : e),
        (u.VOM.content.previous.vIdx = u.VOM.IdxNext()),
        (u.VOM.content.next.vIdx = u.VOM.IdxPrevious()));
      var t =
        '<div class="nGY2ViewerMediaPan"><div class="nGY2ViewerMediaLoaderDisplayed"></div>' +
        u.VOM.content.previous.NGY2Item().mediaMarkup +
        '</div>';
      ((t +=
        '<div class="nGY2ViewerMediaPan"><div class="nGY2ViewerMediaLoaderDisplayed"></div>' +
        u.VOM.content.current.NGY2Item().mediaMarkup +
        '</div>'),
        (t +=
          '<div class="nGY2ViewerMediaPan"><div class="nGY2ViewerMediaLoaderDisplayed"></div>' +
          u.VOM.content.next.NGY2Item().mediaMarkup +
          '</div>'));
      var n = '',
      ...
      null != i &&
        '' != i &&
        (n +=
          '<div class="nGY2ViewerAreaPrevious ngy2viewerToolAction" data-ngy2action="previous">' +
          i +
          '</div>');
      ...
      (null != a &&
        '' != a &&
        (n +=
          '<div class="nGY2ViewerAreaNext ngy2viewerToolAction" data-ngy2action="next">' +
          a +
          '</div>'),
        (u.VOM.$content = jQuery('<div class="nGY2ViewerContent">' + t + n + '</div>').appendTo(
          u.VOM.$viewer
        )),
      ...
      ((u.VOM.content.previous.$media[0].style[u.CSStransformName] =
        'translate(-' + c.w + 'px, 0px)'),
        (u.VOM.content.next.$media[0].style[u.CSStransformName] = 'translate(' + c.w + 'px, 0px)'),
        u.VOM.ImageLoader.loadImage(et, u.VOM.content.current.NGY2Item()),
        u.VOM.ImageLoader.loadImage(et, u.VOM.content.previous.NGY2Item()),
        u.VOM.ImageLoader.loadImage(et, u.VOM.content.next.NGY2Item()),
        (u.VOM.padding.H =
          parseInt(u.VOM.$content.css('padding-left')) +
          parseInt(u.VOM.$content.css('padding-right'))),
        (u.VOM.padding.V =
          parseInt(u.VOM.$content.css('padding-top')) +
          parseInt(u.VOM.$content.css('padding-bottom'))));
      var d = '',
        m = ' toolbarBackground';
      ...
      var g =
        '<div class="toolbarContainer nGEvent' +
        d +
        '" style="visibility:' +
        (u.O.viewerToolbar.display ? 'visible' : 'hidden') +
        ';' +
        p +
        '"><div class="toolbar nGEvent' +
        m +
        '"></div></div>';
      ((u.VOM.$toolbar = jQuery(g).appendTo(u.VOM.$viewer)),
        'min' == u.VOM.toolbarMode ||
        (u.O.viewerToolbar.autoMinimize > 0 &&
          u.O.viewerToolbar.autoMinimize >= u.GOM.cache.viewport.w)
          ? je()
          : We());
      for (
        var f = '<div class="nGY2ViewerToolsTopLeft nGEvent"><div class="toolbar nGEvent">',
          b = u.O.viewerTools.topLeft.split(','),
          v = 0,
          O = b.length;
        v < O;
        v++
      ...
      for (
        var y = '<div class="nGY2ViewerToolsTopRight nGEvent"><div class="toolbar nGEvent">',
          G = u.O.viewerTools.topRight.split(','),
          M = ((v = 0), G.length);
        v < M;
        v++
      )
      ...
      ((y += '</div></div>'),
        ...
        Re(),
        ngscreenfull.enabled &&
          u.O.viewerFullscreen &&
          (ngscreenfull.request(), (u.VOM.viewerIsFullscreen = !0)),
        (function () {
          if (((u.VOM.gallery.firstDisplay = !0), 'none' != u.O.viewerGallery)) {
            for (
              var e = u.O.viewerGalleryTWidth, t = u.O.viewerGalleryTHeight, n = 2, i = '', a = 0;
              a < u.VOM.items.length;
              a++
            ) {
              var o = u.VOM.items[a].ngy2ItemIdx,
                r = u.I[o].thumbImg().src.replace(/'/g, '%27');
              i +=
                '<div class="nGY2VThumbnail" style="width:' +
                e +
                'px;height:' +
                t +
                'px;left:' +
                ...
                'px;background-image: url(&apos;' +
                (r = r.replace(/\\/g, '\\\\')) +
                '&apos;);" data-ngy2_lightbox_thumbnail="true" data-ngy2_idx="' +
                o +
                '" data-ngy2_vidx="' +
                a +
                '" ></div>';
            }
            ((u.VOM.gallery.gwidth = (e + 2 * n) * u.VOM.items.length),
              (u.VOM.gallery.oneTmbWidth = e + 2 * n));
            var l =
              "<div class='nGY2VThumbnailContainer' style='height:" +
              (t + 2 * n) +
              'px;left:0;width:' +
              u.VOM.gallery.gwidth +
              "px;' data-ngy2_lightbox_gallery='true'>" +
              i +
              '</div>';
            ((u.VOM.gallery.$elt = jQuery(
              '<div class="nGY2viewerGallery" style="display: inline-block;height:' +
                (t + 2 * n) +
                'px;left:0;right:0;">' +
                l +
                '</div>'
            ).appendTo(u.VOM.$viewer)),
        ...
        new NGTweenable().tween({
          from: { opacity: 0, posY: 0.5 * u.VOM.window.lastHeight },
          to: { opacity: 1, posY: 0 },
          delay: 10,
          duration: 450,
        ...
        new NGTweenable().tween({
          ...
          step: function (e) {
            ((u.VOM.$toolbarTR[0].style[u.CSStransformName] = 'translateY(' + e.posY + 'px) '),
              ...
              'none' != u.O.viewerGallery &&
                (u.VOM.gallery.$elt.css({ opacity: e.opacity }),
                (u.VOM.gallery.$elt[0].style[u.CSStransformName] = 'scale(' + e.scale + ')')));
          },
          finish: function () {
            ((u.VOM.viewerDisplayed = !0),
              Qe(0),
              null == u.VOM.hammertime &&
                ((u.VOM.hammertime = new NGHammer.Manager(u.VOM.$baseCont[0], {
                  recognizers: [
                ...
                u.VOM.hammertime.on('pan', function (e) {
                  if (Ve())
                    switch (
                      ('off' == u.VOM.panMode &&
                        (null != e.target.dataset.ngy2_lightbox_thumbnail ||
                        null != e.target.dataset.ngy2_lightbox_gallery
                          ? (u.VOM.panMode = 'gallery')
                          : u.VOM.zoom.isZooming
                            ? (u.VOM.panMode = 'zoom')
                            : (u.VOM.panMode = 'media')),
                      u.VOM.panMode)
                    ) {
                      case 'zoom':
                        (De(
                          u.VOM.panPosX + e.deltaX,
                          u.VOM.panPosY + e.deltaY,
                          u.VOM.content.current.$media,
                          !1
                        ),
                          u.VOM.toolsHide());
                        break;
                      case 'media':
                        if (
                          Math.abs(e.deltaY) > u.VOM.panThreshold &&
                          Math.abs(e.deltaX) < u.VOM.panThreshold &&
                          !u.VOM.panXOnly
                        ) {
                          Qe(0);
                          var t = 0;
                          ((t = e.deltaY < 0 ? Math.max(e.deltaY, -200) : Math.min(e.deltaY, 200)),
                            (u.VOM.$viewer[0].style[u.CSStransformName] =
                              'translateY(' + t + 'px) '),
                  ...
                  if (Ve()) {
                    switch (u.VOM.panMode) {
                      ...
                      case 'media':
                        var t = !1;
                        (u.VOM.panXOnly ||
                          (Math.abs(e.deltaY) > 50 && Math.abs(e.deltaX) < 50 && (nt(), (t = !0))),
                          t ||
                            (Math.abs(e.deltaX) < 50
                              ? Qe(0)
                              : e.deltaX > 50
                                ? Ze(Math.abs(e.velocityX))
                                : qe(Math.abs(e.velocityX))),
                          (u.VOM.panXOnly = !1));
                        break;
                      case 'gallery':
                ...
                u.O.viewerZoom
                  ? (u.VOM.hammertime.add(
                      new NGHammer.Tap({ event: 'doubletap', taps: 2, interval: 250 })
                    ),
                    u.VOM.hammertime.add(new NGHammer.Tap({ event: 'singletap' })),
                        ...
                        if (null != e.target.dataset.ngy2_lightbox_thumbnail) {
                          ...
                          if (!isNaN(t) && n != u.VOM.content.current.vIdx) {
                            if (n > u.VOM.content.current.vIdx) {
                              (ot('lightboxNextImage'), u.VOM.content.next.$media.empty());
                              var i = u.I[t];
                              ...
                              ('img' == i.mediaKind &&
                                0 != i.imageWidth &&
                                0 != i.imageHeight &&
                                (e = '<div class="nGY2ViewerMediaLoaderHidden"></div>'),
                                u.VOM.content.next.$media.append(e + i.mediaMarkup),
                                'img' == i.mediaKind
                                  ? u.VOM.ImageLoader.loadImage(et, i)
                                  : Ee(u.VOM.content.next.$media),
                                Je('nextImage'));
                            } else {
                              (ot('lightboxPreviousImage'), u.VOM.content.previous.$media.empty());
                              var a = u.I[t];
                              ...
                              ('img' == a.mediaKind &&
                                ...
                                'img' == a.mediaKind
                                  ? u.VOM.ImageLoader.loadImage(et, a)
                                  : Ee(u.VOM.content.previous.$media),
                                Je('previousImage'));
                            }
                            return;
                          }
                        }
                        if ((Ye(e.srcEvent), 0 == u.VOM.toolbarsDisplayed))
                          (s(_e, 100, !1)(), (u.VOM.singletapTime = new Date().getTime()));
                        else {
                          if (new Date().getTime() - u.VOM.singletapTime < 400) return;
                          'img' == u.VOM.content.current.NGY2Item().mediaKind &&
                            -1 !== e.target.className.indexOf('nGY2ViewerMedia') &&
                            ((e.srcEvent instanceof MouseEvent
                              ? e.srcEvent.pageX
                              : e.srcEvent.changedTouches[0].pageX) <
                            u.GOM.cache.viewport.w / 2
                              ? Ze()
                              : qe());
                        }
                      }
                    ...
                    u.VOM.hammertime.on('doubletap', function (e) {
                      Ve() &&
                        ...
                        -1 !== e.target.className.indexOf('nGY2ViewerMedia') &&
                          (u.VOM.zoom.isZooming
                            ? ((u.VOM.zoom.isZooming = !1), it(!0))
                            : Te() && ((u.VOM.zoom.userFactor = 1.5), Ce())));
                    }),
                    ...
                    u.VOM.hammertime.on('pinch', function (e) {
                      (e.srcEvent.stopPropagation(),
                        e.srcEvent.preventDefault(),
                        Te() && ((u.VOM.zoom.userFactor = e.scale), Se(), Le(), Ce()));
                    }))
                  : (u.VOM.hammertime.add(new NGHammer.Tap({ event: 'singletap' })),
                    u.VOM.hammertime.on('singletap', function (e) {
                      if (Ve())
              ...
              Je(''),
              u.O.slideshowAutoStart && ((u.VOM.playSlideshow = !1), Ue()),
              _e(),
              Ke(''));
          },
        }));
    ...
    function Re() {
      (u.VOM.$viewer.off('touchstart click', '.ngy2viewerToolAction', Fe),
        u.VOM.$viewer.on('touchstart click', '.ngy2viewerToolAction', Fe));
    }
    function Fe(t) {
        ...
        if (null != i) {
          switch (i) {
            ...
            case 'zoomOut':
              ...
              break;
            case 'minimize':
              (Ye(t), 'std' == u.VOM.toolbarMode ? je() : We());
              break;
            case 'fullScreen':
              (t.stopPropagation(), ngscreenfull.enabled && ngscreenfull.toggle());
              break;
            case 'info':
              (t.stopPropagation(), Be(u.VOM.content.current.NGY2Item()));
              break;
            case 'close':
              if ((Ye(t), new Date().getTime() - u.VOM.timeImgChanged < 400)) return;
              nt();
              break;
            case 'download':
              (Ye(t), he(u.VOM.items[u.VOM.content.current.vIdx].ngy2ItemIdx));
              break;
            case 'share':
              (Ye(t), fe(u.VOM.items[u.VOM.content.current.vIdx].ngy2ItemIdx));
              break;
            case 'linkOriginal':
              (Ye(t), we(u.VOM.content.current.NGY2Item()));
              break;
            case 'rotateLeft':
              (Ye(t), ze(-90));
              break;
            case 'rotateRight':
              ...
              break;
            case 'shoppingcart':
              (Ye(t), de(u.VOM.items[u.VOM.content.current.vIdx].ngy2ItemIdx, 'lightbox'));
          }
          var a = u.O.fnImgToolbarCustClick;
          0 == i.indexOf('custom') &&
            null !== a &&
            ('function' == typeof a
              ? a(i, n, u.VOM.content.current.NGY2Item())
              : window[a](i, n, u.VOM.content.current.NGY2Item()));
        }
      }
    }
    function ze(e) {
    ...
    function Be(e) {
      ...
      ((t += '<div class="nGY2PopupOneItemText">' + e.description + '</div>'),
        '' != e.author &&
          (t += '<div class="nGY2PopupOneItemText">' + u.O.icons.user + ' ' + e.author + '</div>'),
        '' != e.exif.model &&
          (t +=
      ...
      '' != e.exif.time
        ...
        '' != e.exif.location
          ? ((t +=
              '<div class="nGY2PopupOneItemText">' +
              u.O.icons.location +
              ' <a href="http://maps.google.com/maps?z=12&t=m&q=' +
              encodeURIComponent(e.exif.location) +
              '" target="_blank">' +
              e.exif.location +
              '</a></div>'),
            (t +=
              '<iframe width="300" height="150" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com/maps?&amp;t=m&amp;q=' +
              encodeURIComponent(e.exif.location) +
              '&amp;output=embed"></iframe>'))
          : (t += '<div class="nGY2PopupOneItemText">' + u.O.icons.location + ': n/a</div>'));
      var i = { title: u.O.icons.viewerInfo, content: t },
        a = u.O.fnPopupMediaInfo;
      (null !== a &&
        (i = 'function' == typeof a ? a(e, i.title, i.content) : window[a](e, i.title, i.content)),
        be(i.title, i.content, 'Left'));
    }
    function He(e) {
      ...
      switch (n) {
        ...
        case 'previous':
          t +=
            'previousButton nGEvent" data-ngy2action="previous">' +
            u.O.icons.viewerPrevious +
            '</div>';
          break;
        case 'pageCounter':
        ...
        case 'playPause':
          t +=
            'playButton playPauseButton nGEvent" data-ngy2action="playPause">' +
            u.O.icons.viewerPlay +
            '</div>';
          break;
        case 'rotateLeft':
          t +=
            'rotateLeftButton nGEvent" data-ngy2action="rotateLeft">' +
            u.O.icons.viewerRotateLeft +
            '</div>';
          break;
        case 'rotateRight':
          t +=
            'rotateRightButton nGEvent" data-ngy2action="rotateRight">' +
            u.O.icons.viewerRotateRight +
            '</div>';
          break;
        case 'downloadButton':
        case 'download':
          t +=
            'downloadButton nGEvent" data-ngy2action="download">' +
            u.O.icons.viewerDownload +
            '</div>';
          break;
        case 'zoomButton':
        case 'zoom':
          t +=
            'nGEvent" data-ngy2action="zoomIn">' +
            u.O.icons.viewerZoomIn +
            '</div><div class="ngbt ngy2viewerToolAction nGEvent" data-ngy2action="zoomOut">' +
            u.O.icons.viewerZoomOut +
            '</div>';
          break;
        ...
        case 'fullscreen':
          ...
          (ngscreenfull.enabled && u.VOM.viewerIsFullscreen && (a = u.O.icons.viewerFullscreenOff),
            (t +=
              'setFullscreenButton fullscreenButton nGEvent" data-ngy2action="fullScreen">' +
              a +
              '</div>'));
          break;
        case 'infoButton':
        ...
        case 'linkOriginal':
          t +=
            'linkOriginalButton nGEvent" data-ngy2action="linkOriginal">' +
            u.O.icons.viewerLinkOriginal +
            '</div>';
          break;
        case 'closeButton':
        case 'close':
        ...
        case 'label':
          t +=
            '"><div class="label"><div class="title nGEvent" itemprop="name"></div><div class="description nGEvent" itemprop="description"></div></div></div>';
          break;
        case 'shoppingcart':
          t +=
            'closeButton nGEvent" data-ngy2action="shoppingcart">' +
            u.O.icons.viewerShoppingcart +
            '</div>';
          break;
        default:
          if (0 == n.indexOf('custom')) {
            ...
            if (
              (null !== r && ('function' == typeof r ? r(n) : window[r](n)), null == o || '' == o)
            ) {
              var l = n.substring(6);
    ...
    function Ue() {
      u.VOM.playSlideshow
        ? (window.clearTimeout(u.VOM.playSlideshowTimerID),
          (u.VOM.playSlideshow = !1),
          u.VOM.$viewer.find('.playPauseButton').html(u.O.icons.viewerPlay))
        : ((u.VOM.playSlideshow = !0),
          qe(),
    ...
    function je() {
      if (null == u.O.viewerToolbar.minimized || '' == u.O.viewerToolbar.minimized) We();
      else {
        u.VOM.toolbarMode = 'min';
        for (
          var e = '', t = u.O.viewerToolbar.minimized.split(','), n = 0, i = t.length;
          n < i;
          n++
        )
          e += He(t[n]);
    ...
    function Xe() {
      ...
      if (null != e) {
        ...
        (void 0 !== t.title && '' != t.title
          ? (u.VOM.$viewer.find('.ngy2viewerToolAction').find('.title').html(t.title), (n = !0))
          : u.VOM.$viewer.find('.ngy2viewerToolAction').find('.title').html(''),
          void 0 !== t.description && '' != t.description
            ? (u.VOM.$viewer.find('.ngy2viewerToolAction').find('.description').html(t.description),
              (n = !0))
            : u.VOM.$viewer.find('.ngy2viewerToolAction').find('.description').html(''),
          n
            ? u.VOM.$viewer.find('.ngy2viewerToolAction').find('.label').show()
            : u.VOM.$viewer.find('.ngy2viewerToolAction').find('.label').hide());
    ...
    function Qe(e) {
      if (((u.VOM.swipePosX = e), null == u.CSStransformName));
        ...
        if (u.O.imageTransition.startsWith('SWIPE')) {
          (t.mediaTransition() && tt(u.VOM.content.previous, 1),
            n.mediaTransition() && tt(u.VOM.content.next, 1));
          var i = Math.min(Math.max(Math.abs(e) / u.VOM.window.lastWidth, 0.8), 1);
          if (('SWIPE' == u.O.imageTransition && (i = 1), e > 0)) {
            let a = u.VOM.window.lastWidth;
            (t.mediaTransition() &&
              (u.VOM.content.previous.$media[0].style[u.CSStransformName] =
                'translate(' + (-a + e) + 'px, 0px) scale(' + i + ')'),
              n.mediaTransition() &&
                (u.VOM.content.next.$media[0].style[u.CSStransformName] =
                  'translate(' + a + 'px, 0px) scale(' + i + ')'));
          } else {
            let a = -u.VOM.window.lastWidth;
            (n.mediaTransition() &&
              (u.VOM.content.next.$media[0].style[u.CSStransformName] =
        ...
        if ('SLIDEAPPEAR' == u.O.imageTransition)
          if (
            ...
            (n.mediaTransition() && tt(u.VOM.content.next, i),
              t.mediaTransition() && tt(u.VOM.content.previous, 0));
          } else {
            let i = e / u.VOM.window.lastWidth;
            (t.mediaTransition() && tt(u.VOM.content.previous, i),
              n.mediaTransition() && tt(u.VOM.content.next, 0));
          }
      }
    }
    function qe(e) {
      ((e = e || 0),
        u.VOM.viewerMediaIsChanged ||
          new Date().getTime() - u.VOM.timeImgChanged < 300 ||
          (ot('lightboxNextImage'), Je('nextImage', e)));
    }
    function Ze(e) {
      ((e = e || 0),
        u.VOM.viewerMediaIsChanged ||
          new Date().getTime() - u.VOM.timeImgChanged < 300 ||
          (u.VOM.playSlideshow && Ue(), ot('lightboxPreviousImage'), Je('previousImage', e)));
    }
    function Je(e, t) {
      ((t = t || 0),
      ...
      if ((lt(i.NGY2Item().albumID, i.NGY2Item().GetID()), '' != e)) {
        var a = u.GOM.cache.viewport,
          o = '',
          r = (500 * (a.w - Math.abs(u.VOM.swipePosX))) / a.w;
        if (
          (t > 0 && ((r = Math.min((a.w - Math.abs(u.VOM.swipePosX)) / t, r)), (o = 'linear')),
          null == u.CSStransformName)
        )
          (tt(i, 1), tt(n, 1), Ke(e));
        else
                  ...
                  step: function (e, t) {
                    if (
                      ((u.VOM.content.current.$media[0].style[u.CSStransformName] =
                        'translate(' + e.t + 'px, 0px)'),
                      t.media_transition)
                    ) {
                      var n = Math.min(Math.max(Math.abs(e.t) / u.VOM.window.lastWidth, 0.8), 1);
                      ('SWIPE' == u.O.imageTransition && (n = 1),
                        (t.new_content_item.$media[0].style[u.CSStransformName] =
                          'translate(' + (-t.dir + e.t) + 'px, 0px) scale(' + n + ')'));
                    }
                  },
                  finish: function (e, t) {
                    ((u.VOM.content.current.$media[0].style[u.CSStransformName] = ''),
                      tt(u.VOM.content.current, 0),
                      (t.new_content_item.$media[0].style[u.CSStransformName] = ''),
                      Ke(t.dT));
                  },
                }));
              ...
              ((i.$media[0].style[u.CSStransformName] = ''),
                ...
                new NGTweenable().tween({
                  ...
                  step: function (e, t) {
                    ((u.VOM.content.current.$media[0].style[u.CSStransformName] =
                      'translate(' + e.t + 'px, 0px)'),
                      t.media_transition && tt(t.new_content_item, e.o));
                  },
                  finish: function (e, t) {
                    ((u.VOM.content.current.$media[0].style[u.CSStransformName] = ''), Ke(t.dT));
                  },
                }));
          }
      }
    ...
    function Ke(e) {
      ...
      if (
        (null !== i && ('function' == typeof i ? i(n) : window[i](n)),
        (u.VOM.swipePosX = 0),
        '' != e)
      ) {
      ...
      (u.VOM.content.current.$media.insertAfter(o.last()),
        'img' == n.mediaKind && 0 == n.imageWidth
          ? tt(u.VOM.content.current, 0)
          : (u.VOM.content.current.$media
              .children()
              .eq(0)
              .attr('class', 'nGY2ViewerMediaLoaderHidden'),
            tt(u.VOM.content.current, 1)),
      ...
      ('img' == r.mediaKind &&
        ...
        tt(u.VOM.content.next, 0),
        tt(u.VOM.content.previous, 0),
        'img' == r.mediaKind ? u.VOM.ImageLoader.loadImage(et, r) : Ee(u.VOM.content.next.$media),
      ...
      ((l = '<div class="nGY2ViewerMediaLoaderDisplayed"></div>'),
        ...
        tt(u.VOM.content.next, 0),
        'img' == s.mediaKind
          ? u.VOM.ImageLoader.loadImage(et, s)
          : Ee(u.VOM.content.previous.$media),
        u.VOM.playSlideshow &&
          u.VOM.content.current.$media
            .children()
            ...
            .always(function (e) {
              u.VOM.playSlideshow &&
                (u.VOM.playSlideshowTimerID = window.setTimeout(function () {
                  qe();
                }, u.VOM.slideshowDelay));
            }),
        it(),
        (u.VOM.viewerMediaIsChanged = !1),
        ot('lightboxImageDisplayed'));
    }
    function et(e, t, n, i) {
      ((n.imageWidth = e),
        (n.imageHeight = t),
        u.VOM.content.current.NGY2Item() == n &&
          (u.VOM.content.current.$media
            .children()
            .eq(0)
            .attr('class', 'nGY2ViewerMediaLoaderHidden'),
        ...
        u.VOM.content.next.NGY2Item() == n &&
          u.VOM.content.next.$media.children().eq(0).attr('class', 'nGY2ViewerMediaLoaderHidden'),
        u.VOM.content.previous.NGY2Item() == n &&
          u.VOM.content.previous.$media
            .children()
            .eq(0)
            .attr('class', 'nGY2ViewerMediaLoaderHidden'),
        Ce());
    ...
    function tt(e, t) {
      ...
      'img' != n.mediaKind || 0 != n.imageWidth
        ? 0 == t
          ? i.children().css({ opacity: 0, visibility: 'hidden' })
          : i.children().css({ opacity: t, visibility: 'visible' })
        : i.children().eq(1).css({ opacity: 0, visibility: 'hidden' });
    }
    function nt(e) {
      if (
        (null == e && (e = u.VOM.content.current.vIdx),
        (u.VOM.viewerMediaIsChanged = !1),
        u.VOM.viewerDisplayed)
      ) {
        if (
          ...
          u.VOM.playSlideshow &&
            (window.clearTimeout(u.VOM.playSlideshowTimerID), (u.VOM.playSlideshow = !1)),
          u.VOM.hammertime.destroy(),
          (u.VOM.hammertime = null),
          ngscreenfull.enabled &&
            u.VOM.viewerIsFullscreen &&
            ((u.VOM.viewerIsFullscreen = !1), ngscreenfull.exit()),
        ...
        if (u.O.thumbnailAlbumDisplayImage)
          if (null == e);
            ...
            u.GOM.albumIdx != n.albumID ? g('-1', n.albumID) : (x(), lt('', ''), W());
          }
        else
          null != e &&
            (-1 == u.GOM.albumIdx
              ? g('', u.I[u.VOM.items[e].ngy2ItemIdx].albumID)
              : (x(), lt(u.I[u.VOM.items[e].ngy2ItemIdx].albumID, ''), W()));
        u.VOM.timeImgChanged = new Date().getTime();
      }
    }
    function it(e) {
      if (((e = void 0 !== e && e), null !== u.VOM.$toolbar)) {
        ...
        if (
          null != u.VOM.content.current.$media.children().eq(1) &&
          -1 != u.VOM.content.current.vIdx &&
          (e || u.VOM.window.lastWidth != t || u.VOM.window.lastHeight != n)
        ) {
          ((u.VOM.window.lastWidth = t), (u.VOM.window.lastHeight = n));
          var i = 0,
            a = 0;
          switch (
            ('none' != u.O.viewerGallery && (i = u.O.viewerGalleryTHeight + 10),
            'bottom' == u.O.viewerGallery && (a = i),
            u.O.viewerToolbar.position)
          ) {
            case 'top':
            case 'topOverImage':
              (u.VOM.$content.css({ height: n, width: t, top: 0 }),
                u.VOM.$toolbar.css({ top: 0, bottom: '' }));
              break;
            case 'bottom':
            case 'bottomOverImage':
            default:
              ((n -= a),
                u.VOM.$content.css({ height: n, width: t, bottom: -a, top: 0 }),
                u.VOM.$toolbar.css({ bottom: i }));
          }
          !u.VOM.viewerMediaIsChanged && u.VOM.zoom.isZooming
            ? Ce()
            : u.VOM.zoom.isZooming ||
                (0 == u.VOM.zoom.userFactor &&
                  0 == u.VOM.panPosX &&
                  0 == u.VOM.panPosY &&
                  0 == u.VOM.zoom.posX &&
                  0 == u.VOM.zoom.posY)
    ...
    function rt() {
      ...
      if (
        ...
        return (
          u.O.debugMode && console.log('display root album'),
          (u.locationHashLastUsed = ''),
      ...
      if (t != u.locationHashLastUsed) {
        if (0 == t.indexOf(e)) {
          ...
          return '0' != n.imageID
            ? (u.O.debugMode && console.log('display image: ' + n.albumID + '-' + n.imageID),
              q(n.imageID, n.albumID),
              !0)
            : (u.O.debugMode && console.log('display album: ' + n.albumID), g('-1', n.albumID), !0);
        }
        return !1;
      }
    }
    function lt(e, t) {
      ...
      if (
        (u.O.debugMode && console.log('------------------------ SET LOCATION HASH'),
        ...
        return (
          ...
          (u.locationHashLastUsed = ''),
          void (
            u.O.debugMode && console.log('new2 G.locationHashLastUsed: ' + u.locationHashLastUsed)
          )
        );
      ...
      if (
        (u.O.debugMode &&
          (console.log('newLocationHash2: ' + n), console.log('location.hash: ' + i)),
    ...
    function st() {
      ...
      var e = u.GOM.curNavLevel,
        t = u.GOM.curWidth;
      if (u.VOM.viewerDisplayed) (it(), u.VOM.gallery.Resize());
        ...
        if (-1 != u.GOM.albumIdx) {
          ...
          if ('MOSAIC' == u.layout.engine) {
            ...
            i.height[e][t] != i.height[e][n] ||
            i.width[e][t] != i.width[e][n] ||
            i.gutterHeight[e][t] != i.gutterHeight[e][n] ||
            i.gutterWidth[e][t] != i.gutterWidth[e][n]
          )
            return (
              (u.GOM.curWidth = n),
              (u.GOM.pagination.currentPage = 0),
    ...
    function ut() {
      u.VOM.viewerDisplayed || ct();
    }
    function ct() {
      0 == u.galleryResizeEventEnabled ? window.setTimeout(ct, 10) : x();
    }
    function ht(e, t) {
      return '' != u.i18nLang &&
        void 0 !== e[t + '_' + u.i18nLang] &&
        e[t + '_' + u.i18nLang].length > 0
        ? e[t + '_' + u.i18nLang]
        : e[t];
    }
    function dt() {
      var e = u.GOM.cache.viewport.w;
      return u.O.breakpointSizeSM > 0 && e < u.O.breakpointSizeSM
        ? 'xs'
        : u.O.breakpointSizeME > 0 && e < u.O.breakpointSizeME
          ? 'sm'
          : u.O.breakpointSizeLA > 0 && e < u.O.breakpointSizeLA
            ? 'me'
            : u.O.breakpointSizeXL > 0 && e < u.O.breakpointSizeXL
              ? 'la'
              : 'xl';
    }
    function mt(e) {
   ...
   */ ((e.nanogallery2 = function (e, t) {
    ...
    ((i.$e = jQuery(e)),
      ...
      (i.init = function () {
        (void 0 === window.NGY2Item &&
          ((window.NGY2Tools = (function () {
            function e() {}
            return (
              (e.FilterAlbumName = function (e, t) {
                var n = e.toUpperCase();
              ...
              (e.NanoAlert = function (t, n, i) {
                (e.NanoConsoleLog.call(t, n),
                  null != t.$E.conConsole &&
                    (t.$E.conConsole.css({ visibility: 'visible', minHeight: '100px' }),
                    0 == i
                      ? t.$E.conConsole.append('<p>' + n + '</p>')
                      : t.$E.conConsole.append(
                          '<p>nanogallery2: ' + n + ' [' + t.baseEltID + ']</p>'
                        )));
              }),
              ...
              (e.PreloaderDisplay = function (e) {
                if (!0 === e) {
                  if (
                    (this.$E.conLoadingB
                      .removeClass('nanoGalleryLBarOff')
                      .addClass('nanoGalleryLBar'),
                    null != this.GOM.albumIdxLoading && -1 != this.GOM.albumIdxLoading)
                  ) {
                    this.I[this.GOM.albumIdxLoading].$Elts['.nGY2TnImg'].addClass(
                      'nGY2GThumbnailLoaderDisplayed'
                    );
                  }
                } else if (
                  (this.$E.conLoadingB
                    .removeClass('nanoGalleryLBar')
                    .addClass('nanoGalleryLBarOff'),
                  null != this.GOM.albumIdxLoading && -1 != this.GOM.albumIdxLoading)
                ) {
                  this.I[this.GOM.albumIdxLoading].$Elts['.nGY2TnImg'].removeClass(
                    'nGY2GThumbnailLoaderDisplayed'
                  );
                }
              }),
              (e.AreaShuffle = function (e) {
                for (
                  var t, n, i = e.length;
                  i;
                  t = Math.floor(Math.random() * i), n = e[--i], e[i] = e[t], e[t] = n
                );
                return e;
              }),
              (e.GetImageTitleFromURL = function (e) {
                return '%filename' == this.O.thumbnailLabel.get('title')
                  ? e.split('/').pop().replace('_', ' ')
                  : '%filenameNoExt' == this.O.thumbnailLabel.get('title')
              ...
              (e.AlbumPostProcess = function (t) {
                ...
                if ('' != n || i > 0) {
                  ...
                  switch (n) {
                    ...
                    case 'TITLEASC':
                      a.sort(function (e, t) {
                        return e.title.toUpperCase() < t.title.toUpperCase()
                          ? -1
                          : e.title.toUpperCase() > t.title.toUpperCase()
                            ? 1
                            : 0;
                      });
                      break;
          ...
          (window.NGY2Item = (function () {
            ...
            ((t.Get = function (e, t) {
              ...
              (t.New = function (e, n, i, o, r, l, s) {
                ...
                if (
                  -1 != r &&
                  0 != r &&
                  'image gallery by nanogallery2 [build]' != n &&
                  e.O.thumbnailLevelUp &&
                  0 == u.getContentLength(!1) &&
                  '' == e.O.album
                ) {
                  let n = new t('0');
                  (e.I.push(n),
                ...
                (null === c &&
                  ...
                  (c.albumID = r),
                  (c.kind = l),
                  'image' == l && ((u.mediaCounter += 1), (c.mediaNumber = u.mediaCounter)));
              ...
              (t.prototype.delete = function () {
                ...
                for (
                  var e = this.G.GOM.items.length, n = this.GetID(), i = -1, a = -1, o = 0;
                  o < e;
                  o++
                ) {
                  ...
                  l.GetID() == n
                    ? r.neverDisplayed || ((i = r.thumbnailIdx), (a = o))
                    : -1 != i &&
                      (r.neverDisplayed ||
                        (l.$getElt('.nGY2GThumbnail').data('index', o - 1),
                        l.$getElt('.nGY2GThumbnailImg').data('index', o - 1)));
                }
                if (-1 != i) {
                  var s = this.G;
                  (1 == this.selected && ((this.selected = !1), s.GOM.nbSelected--),
            ...
            function o(e, t) {
              ...
              var n = Number(e.replace(/[a-zA-Z]/g, '')),
                ...
                a = '';
              return (
                null != i && i.length > 0 && (a = i.join()),
                isNaN(n) || 0 == n ? e : (n *= t) + a
              );
            }
            return (
              (t.get_nextId = function () {
                return e;
              }),
              (t.prototype.$getElt = function (e, t) {
                return null == this.$elt
                  ? null
                  : ((void 0 !== this.$Elts[e] && 1 == !t) ||
                      (this.$Elts[e] = '.nGY2GThumbnail' == e ? this.$elt : this.$elt.find(e)),
                    this.$Elts[e]);
              }),
              ...
              (t.prototype.thumbSet = function (e, t, n, i, a) {
                ...
                if (void 0 === i || '' == i || null == i)
                  for (var r = 0; r < o.length; r++)
                    void 0 === a || '' == a
                      ? ((this.thumbs.url.l1[o[r]] = e),
                        (this.thumbs.height.l1[o[r]] = n),
                        (this.thumbs.width.l1[o[r]] = t),
                        (this.thumbs.url.lN[o[r]] = e),
                        (this.thumbs.height.lN[o[r]] = n),
                        (this.thumbs.width.lN[o[r]] = t))
                      : ((this.thumbs.url[a][o[r]] = e),
                        (this.thumbs.height[a][o[r]] = n),
                        (this.thumbs.width[a][o[r]] = t));
                else
                  void 0 === a || '' == a || null == a
                    ? ((this.thumbs.url.l1[i] = e),
                      (this.thumbs.height.l1[i] = n),
                      (this.thumbs.width.l1[i] = t),
                      (this.thumbs.url.lN[i] = e),
                      (this.thumbs.height.lN[i] = n),
                      (this.thumbs.width.lN[i] = t))
                    : ((this.thumbs.url[a][i] = e),
                      (this.thumbs.height[a][i] = n),
                      (this.thumbs.width[a][i] = t));
                for (r = 0; r < o.length; r++) this.thumbs.height.l1[o[r]] = n;
                for (r = 0; r < o.length; r++)
                  this.G.tn.settings.height.lN[o[r]] == this.G.tn.settings.getH() &&
                    this.G.tn.settings.width.l1[o[r]] == this.G.tn.settings.getW() &&
                    (this.thumbs.height.lN[o[r]] = n);
              }),
              (t.prototype.thumbSetImgHeight = function (e) {
                for (var t = ['xs', 'sm', 'me', 'la', 'xl'], n = 0; n < t.length; n++)
                  this.G.tn.settings.height.l1[t[n]] == this.G.tn.settings.getH() &&
                    this.G.tn.settings.width.l1[t[n]] == this.G.tn.settings.getW() &&
                    (this.thumbs.height.l1[t[n]] = e);
                for (n = 0; n < t.length; n++)
                  this.G.tn.settings.height.lN[t[n]] == this.G.tn.settings.getH() &&
                    this.G.tn.settings.width.l1[t[n]] == this.G.tn.settings.getW() &&
                    (this.thumbs.height.lN[t[n]] = e);
              }),
              (t.prototype.thumbSetImgWidth = function (e) {
                for (var t = ['xs', 'sm', 'me', 'la', 'xl'], n = 0; n < t.length; n++)
                  this.G.tn.settings.height.l1[t[n]] == this.G.tn.settings.getH() &&
                    this.G.tn.settings.width.l1[t[n]] == this.G.tn.settings.getW() &&
                    (this.thumbs.width.l1[t[n]] = e);
                for (n = 0; n < t.length; n++)
                  this.G.tn.settings.height.lN[t[n]] == this.G.tn.settings.getH() &&
                    this.G.tn.settings.width.l1[t[n]] == this.G.tn.settings.getW() &&
                    (this.thumbs.width.lN[t[n]] = e);
              }),
              (t.prototype.thumbImg = function () {
                var e = { src: '', width: 0, height: 0 };
                return 'image gallery by nanogallery2 [build]' == this.title
                  ? ((e.src = this.G.emptyGif), (e.url = this.G.emptyGif), e)
                  : ((e.src = this.thumbs.url[this.G.GOM.curNavLevel][this.G.GOM.curWidth]),
              ...
              (t.prototype.setMediaURL = function (e, t) {
                ((this.src = e),
                  ...
                  'img' == t &&
                    (this.mediaMarkup =
                      '<img class="nGY2ViewerMedia" src="' +
                      e +
                      '" alt=" " itemprop="contentURL" draggable="false">'));
              }),
              ...
              (t.prototype.isSearchFound = function () {
                return (
                  '' == this.G.GOM.albumSearch ||
                  -1 != this.title.toUpperCase().indexOf(this.G.GOM.albumSearch)
                );
              }),
                ...
                if ('.nGY2GThumbnail' == e)
                  for (
                    ...
                    var d =
                      ...
                      o(t.translate, 1) +
                      ')';
                    (this.G.IE <= 9 || this.G.isGingerbread
                      ? (d += ' rotate(' + o(t.rotateZ, u) + ')')
                      : (d +=
                          ' rotateX(' +
                          o(t.rotateX, l) +
                          ') rotateY(' +
                      ...
                      n > 0 &&
                        ((i -= this.G.tn.opt.Get('stacksTranslateX')),
              ...
              (t.prototype.CSSFilterApply = function (e) {
                ...
                if (null != t.$elt)
                  for (var i = 0; i < t.$elt.length; i++)
                    null != t.$elt[i] &&
                      ((t.$elt[i].style.WebkitFilter = n), (t.$elt[i].style.filter = n));
              }),
              (t.prototype.CSSFilterSet = function (e, t, n, i) {
                (null == this.eltFilter[e] &&
                  ((this.eltFilter[e] = {
                    blur: 0,
                    brightness: '100%',
                    grayscale: '0%',
              ...
              (t.prototype.animate = function (e, t, i) {
                if (null != this.$getElt()) {
                  ...
                  ((a.G = this.G),
                    ...
                    (a.cssKind = ''),
                    i
                      ? (null == this.eltEffect[e.element] && (this.eltEffect[e.element] = []),
                        null == this.eltEffect[e.element][e.type] &&
                          (this.eltEffect[e.element][e.type] = { initialValue: 0, lastValue: 0 }),
                        e.firstKeyframe &&
                          (this.eltEffect[e.element][e.type] = {
                            initialValue: e.from,
                            lastValue: e.from,
                          }),
                        (a.animeFrom = e.from),
                        ...
                        (a.animeEasing = e.easing))
                      : ((a.animeFrom = this.eltEffect[e.element][e.type].lastValue),
                  ...
                  !i ||
                    '.nGY2GThumbnail' != e.element ||
                    ('scale' != e.type && 'rotateX' != e.type) ||
                    ...
                    s.tween({
                          ...
                          if (!t.hoverIn || t.item.hovered) {
                            if (t.G.VOM.viewerDisplayed) t.tweenable.stop(!1);
                              ...
                              switch (t.cssKind) {
                                ...
                                default:
                                  var a = e.v;
                                  (('rgb(' != e.v.substring(0, 4) &&
                                    'rgba(' != e.v.substring(0, 5)) ||
                                    (a = n(0, a)),
                                    t.item.$getElt(t.effect.element).css(t.effect.type, a));
                              }
                              i &&
                                (t.item.eltEffect[t.effect.element][t.effect.type].lastValue = e.v);
                            }
                      ...
                      finish: function (e, t) {
                        if (
                          ...
                          null != t.item.$getElt() &&
                            (!t.hoverIn || t.item.hovered) &&
                            !t.G.VOM.viewerDisplayed)
                        )
                          switch (t.cssKind) {
                            case 'transform':
    ...
    (jQuery.nanogallery2.defaultOptions = {
      ...
      icons: {
        ...
        navigationFilterUnselected:
          '<i style="color:#ddd;opacity:0.3;" class="nGY2Icon-circle-empty"></i>',
        ...
        galleryMoreButton:
          '<i class="nGY2Icon-picture"></i> &nbsp; <i class="nGY2Icon-right-open"></i>',
            ...
            for (var o = n, r = i, l = 0; l < a.shoppingCart.length; l++)
              if (a.shoppingCart[l].ID == o) {
                ...
                (a.ThumbnailToolbarOneCartUpdate(e),
                  ...
                  null !== (u = a.O.fnShoppingCartUpdated) &&
                    ('function' == typeof u
                      ? u(a.shoppingCart, e, 'api')
                      : window[u](a.shoppingCart, e, 'api')));
                break;
              }
            return a.shoppingCart;
      ...
      e.ngimagesLoaded = (function (e, t) {
        ...
        return (
          ...
          (r.makeJQueryPlugin = function (t) {
            (t = t || e.jQuery) &&
              ((n = t).fn.ngimagesLoaded = function (e, t) {
    ...
    (function () {
              ...
              function (a) {
                ...
                ((t = t || e.documentElement),
                  / Version\/5\.1(?:\.\d+)? Safari\//.test(navigator.userAgent)
                    ? t[o]()
                    : t[o](n ? Element.ALLOW_KEYBOARD_INPUT : {}),
                  this.on('change', r));
              }.bind(this)
            );
          },
      ...
      i
        ? (Object.defineProperties(o, {
          ...
          t ? (module.exports = o) : (window.ngscreenfull = o))
        : t
          ? (module.exports = !1)
          : (window.ngscreenfull = !1);
    })(),
    function () {
      ...
      var t,
        n = (function () {
          var t,
            ...
            u = 'undefined' != typeof SHIFTY_DEBUG_NOW ? SHIFTY_DEBUG_NOW : s;
          function c() {}
          function h(e, t) {
            var n;
          ...
          function p(e, n, i, a, o, r, l) {
            ...
            for (s in n)
              n.hasOwnProperty(s) &&
                ((c = 'function' == typeof (u = l[s]) ? u : t[u]), (n[s] = g(i[s], a[s], c, h)));
            return n;
          }
          function g(e, t, n, i) {
            return e + (t - e) * n(i);
          ...
          function f(e, t) {
            var n = O.prototype.filter,
              i = e._filterArgs;
            h(n, function (a) {
              void 0 !== n[a][t] && n[a][t].apply(e, i);
            });
          }
          function b(e, t, n, l, s, c, h, d, m, g, b) {
            ((i = t + n + l),
              (a = Math.min(b || u(), i)),
              (o = a >= i),
              (r = l - (i - a)),
              e.isPlaying() &&
                (o
                  ? (m(h, e._attachment, r), e.stop(!0))
                  : ((e._scheduleId = g(e._timeoutHandler, 16.666666666666668)),
                    f(e, 'beforeTween'),
                    a < t + n ? p(1, s, c, h, 1, 1, d) : p(a, s, c, h, l, t + n, d),
                    f(e, 'afterTween'),
                    m(s, e._attachment, r))));
          }
          function v(e, t) {
          ...
          return (
            ...
            (O.prototype.setConfig = function (e) {
              ((e = e || {}),
                ...
                (this._currentState = d({}, e.from || this.get())),
                (this._originalState = this.get()),
                (this._targetState = d({}, e.to || this.get())));
              var t = this;
            ...
            (O.prototype.resume = function () {
              return (
                this._isPaused && (this._timestamp += u() - this._pausedAtTime),
                (this._isPaused = !1),
                (this._isTweening = !0),
            ...
            (O.prototype.setScheduleFunction = function (e) {
            ...
            'function' == typeof SHIFTY_DEBUG_NOW && (e.timeoutHandler = b),
            'object' == typeof exports
              ? (module.exports = O)
              : 'function' == typeof define && define.amdDISABLED
                ? define(function () {
                    return O;
                  })
                : void 0 === e.NGTweenable && (e.NGTweenable = O),
            O
          );
        })();
      /*!
       ...
       */ (n.shallowCopy(n.prototype.formula, {
        ...
        (function (e) {
          var t = /(\d|\-|\.)/,
            ...
            i = /[0-9.\-]+/g,
            a = new RegExp(
              'rgb\\(' + i.source + /,\s*/.source + i.source + /,\s*/.source + i.source + '\\)',
              'g'
            ),
            o = /^.*\(/,
            r = /#([0-9]|[a-f]){3,6}/gi,
          ...
          function u(t) {
            e.each(t, function (e) {
              var n = t[e];
              'string' == typeof n && n.match(r) && (t[e] = m(r, n, c));
            });
          }
          function c(e) {
            var t = (function (e) {
          ...
          function m(e, t, n) {
            var i = t.match(e),
              a = t.replace(e, l);
            if (i)
              for (var o, r = i.length, s = 0; s < r; s++)
                ((o = i.shift()), (a = a.replace(l, n(o))));
            return a;
          }
          function p(e) {
          ...
          function g(t, n) {
            e.each(n, function (e) {
              for (var i = v(t[e]), a = i.length, o = 0; o < a; o++) t[n[e].chunkNames[o]] = +i[o];
              delete t[e];
            });
          }
          function f(t, n) {
            e.each(n, function (e) {
              var i = t[e],
                o = (function (e, t) {
                  b.length = 0;
                  for (var n = t.length, i = 0; i < n; i++) b.push(e[t[i]]);
                  return b;
                })(
                  (function (e, t) {
                    for (var n, i = {}, a = t.length, o = 0; o < a; o++)
                      ((i[(n = t[o])] = e[n]), delete e[n]);
                    return i;
                  })(t, n[e].chunkNames),
                  n[e].chunkNames
                );
              ((i = (function (e, t) {
                for (var n = e, i = t.length, a = 0; a < i; a++) n = n.replace(l, +t[a].toFixed(4));
                return n;
              })(n[e].formatString, o)),
                (t[e] = m(a, i, p)));
            });
                    ...
                    if ('string' == typeof o) {
                      ...
                      h[e] = {
                        formatString:
                          ...
                          (a = i.match(n)),
                          a
                            ? (1 === a.length || i.charAt(0).match(t)) && a.unshift('')
                            : (a = ['', '']),
                          a.join(l)),
                        chunkNames: s(r, e),
                      };
    ...
    (function (e, t, n, i) {
      ...
      function d(e, t, n) {
        ...
        if (e)
          ...
          else if (e.length !== i) for (a = 0; a < e.length; ) (t.call(n, e[a], a, e), a++);
          else for (a in e) e.hasOwnProperty(a) && t.call(n, e[a], a, e);
      }
      function m(t, n, i) {
        ...
        'function' != typeof Object.assign
          ? function (e) {
              ...
              for (var t = Object(e), n = 1; n < arguments.length; n++) {
                var a = arguments[n];
                if (a !== i && null !== a) for (var o in a) a.hasOwnProperty(o) && (t[o] = a[o]);
              }
              return t;
            }
          : Object.assign;
      ...
      function v(e, t) {
        return 'function' == typeof e ? e.apply((t && t[0]) || i, t) : e;
      }
      function O(e, t) {
        return e === i ? t : e;
      }
      ...
      function L(e, t) {
        for (var n, a, r = t[0].toUpperCase() + t.slice(1), l = 0; l < o.length; ) {
          if ((a = (n = o[l]) ? n + r : t) in e) return a;
          l++;
        }
        return i;
      }
        ...
        ((n.isFirst = !!r),
          ...
          (function (e, t) {
            ...
            ((t.timeStamp = u()),
              ...
              (function (e, t) {
                ...
                (1 !== t.eventType && 4 !== o.eventType) ||
                  ((a = e.prevDelta = { x: o.deltaX || 0, y: o.deltaY || 0 }),
            ...
            ((t.overallVelocityX = d.x),
              ...
              (t.overallVelocity = s(d.x) > s(d.y) ? d.x : d.y),
              (t.scale = l ? ((m = l.pointers), (p = a), H(p[0], p[1], _) / H(m[0], m[1], _)) : 1),
              (t.rotation = l
                ? (function (e, t) {
                    return U(t[1], t[0], _) + U(e[1], e[0], _);
                  })(l.pointers, a)
                : 0),
              ...
              (function (e, t) {
                ...
                if (8 != t.eventType && (u > 25 || l.velocity === i)) {
                  var c = t.deltaX - l.deltaX,
                    h = t.deltaY - l.deltaY,
                    d = z(u, c, h);
                  ((a = d.x),
                    (o = d.y),
                    (n = s(d.x) > s(d.y) ? d.x : d.y),
                    (r = B(c, h)),
                    (e.lastInterval = t));
                } else ((n = l.velocity), (a = l.velocityX), (o = l.velocityY), (r = l.direction));
                ((t.velocity = n), (t.velocityX = a), (t.velocityY = o), (t.direction = r));
              })(n, t));
            var m, p;
            var g = e.element;
            M(t.srcEvent.target, g) && (g = t.srcEvent.target);
            t.target = g;
          })(e, n),
      ...
      function $(e) {
        for (var t = [], n = 0; n < e.pointers.length; )
          ((t[n] = { clientX: l(e.pointers[n].clientX), clientY: l(e.pointers[n].clientY) }), n++);
        return { timeStamp: u(), pointers: t, center: F(t), deltaX: e.deltaX, deltaY: e.deltaY };
      }
      function F(e) {
        var t = e.length;
      ...
      var W = { mousedown: 1, mousemove: 2, mouseup: 4 },
        ...
        X = 'mousemove mouseup';
      function Q() {
        ((this.evEl = j), (this.evWin = X), (this.pressed = !1), P.apply(this, arguments));
      }
      f(Q, P, {
        handler: function (e) {
          var t = W[e.type];
      ...
      var q = { pointerdown: 1, pointermove: 2, pointerup: 4, pointercancel: 8, pointerout: 8 },
        Z = { 2: N, 3: 'pen', 4: V, 5: 'kinect' },
        J = 'pointerdown',
        K = 'pointermove pointerup pointercancel';
      function ee() {
        ((this.evEl = J),
          (this.evWin = K),
      ...
      (e.MSPointerEvent &&
        !e.PointerEvent &&
        ((J = 'MSPointerDown'), (K = 'MSPointerMove MSPointerUp MSPointerCancel')),
        f(ee, P, {
          handler: function (e) {
            var t = this.store,
              n = !1,
              ...
              a = q[i],
              o = Z[e.pointerType] || e.pointerType,
              r = o == N,
              l = T(t, e.pointerId, 'pointerId');
            (1 & a && (0 === e.button || r)
              ? l < 0 && (t.push(e), (l = t.length - 1))
              : 12 & a && (n = !0),
              l < 0 ||
                ((t[l] = e),
      ...
      function ae() {
        ((this.evTarget = ne), (this.evWin = ie), (this.started = !1), P.apply(this, arguments));
      }
      function oe(e, t) {
        var n = x(e.touches),
      ...
      function se() {
        ((this.evTarget = le), (this.targetIds = {}), P.apply(this, arguments));
      }
      function ue(e, t) {
        var n = x(e.touches),
          i = this.targetIds;
        ...
        for (a = 0; a < r.length; )
          (i[r[a].identifier] && l.push(r[a]), 12 & t && delete i[r[a].identifier], a++);
      ...
      function he(e, t) {
        1 & e
          ? ((this.primaryTouch = t.changedPointers[0].identifier), de.call(this, t))
          : 12 & e && de.call(this, t);
      }
      function de(e) {
      ...
      f(ce, P, {
        handler: function (e, t, n) {
          ...
          if (!(a && n.sourceCapabilities && n.sourceCapabilities.firesTouchEvents)) {
            if (i) he.call(this, t, n);
            else if (a && me.call(this, n)) return;
            this.callback(e, t, n);
          }
        },
        destroy: function () {
      ...
      we.prototype = {
        set: function (e) {
          (e == fe && (e = this.compute()),
            ge && this.manager.element.style && Me[e] && (this.manager.element.style[pe] = e),
        ...
        compute: function () {
          var e = [];
          return (
            d(this.manager.recognizers, function (t) {
        ...
        preventDefaults: function (e) {
          ...
          if (this.manager.session.prevented) t.preventDefault();
            ...
            if (!r || !o) return a || (o && 6 & n) || (r && n & Y) ? this.preventSrc(t) : void 0;
          }
        },
      ...
      function Ae(e, t) {
        return (((t = t || {}).recognizers = O(t.recognizers, Ae.defaults.preset)), new _e(e, t));
      }
      ((Te.prototype = {
        defaults: {},
        set: function (e) {
        ...
        recognizeWith: function (e) {
          ...
          return (t[(e = Le(e, this)).id] || ((t[e.id] = e), e.recognizeWith(this)), this);
        },
        dropRecognizeWith: function (e) {
          return (
            h(e, 'dropRecognizeWith', this) || ((e = Le(e, this)), delete this.simultaneous[e.id]),
            this
          );
        },
        requireFailure: function (e) {
          ...
          return (-1 === T(t, (e = Le(e, this))) && (t.push(e), e.requireFailure(this)), this);
        },
        ...
        recognize: function (e) {
          var t = a({}, e);
          if (!v(this.options.enable, [this, t])) return (this.reset(), void (this.state = Ie));
        ...
        f(Ce, Te, {
          ...
          process: function (e) {
            var t = this.state,
              ...
              i = 6 & t,
              a = this.attrTest(e);
            return i && (8 & n || !a) ? 16 | t : i || a ? (4 & n ? 8 | t : 2 & t ? 4 | t : 2) : Ie;
          },
        }),
        f(Ee, Ce, {
          ...
          getTouchAction: function () {
            var e = this.options.direction,
              t = [];
            return (6 & e && t.push(Ge), e & Y && t.push(ye), t);
          },
          ...
          attrTest: function (e) {
            return (
              Ce.prototype.attrTest.call(this, e) &&
              (2 & this.state || (!(2 & this.state) && this.directionTest(e)))
            );
          },
          emit: function (e) {
            ((this.pX = e.deltaX), (this.pY = e.deltaY));
            var t = Se(e.direction);
          ...
          attrTest: function (e) {
            ...
            return (
              ...
              this._super.attrTest.call(this, e) &&
                ...
                s(t) > this.options.velocity &&
                4 & e.eventType
            );
          },
          emit: function (e) {
            var t = Se(e.offsetDirection);
          ...
          process: function (e) {
            ...
            if (i && a && n) {
              ...
              var o = !this.pTime || e.timeStamp - this.pTime < t.interval,
                r = !this.pCenter || H(this.pCenter, e.center) < t.posThreshold;
              if (
      ...
      function _e(e, t) {
        ...
        ((this.options = a({}, Ae.defaults, t || {})),
          ...
          (this.oldCssProps = {}),
          (this.element = e),
          (this.input = new ((n = this).options.inputClass || (D ? se : k ? ce : Q))(n, R)),
      ...
      function Pe(e, t) {
        var n,
          i = e.element;
        i.style &&
          (d(e.options.cssProps, function (a, o) {
            ((n = L(i.style, o)),
              t
                ? ((e.oldCssProps[n] = i.style[n]), (i.style[n] = a))
      ...
      ((_e.prototype = {
        ...
        recognize: function (e) {
          ...
          if (!t.stopped) {
            ...
            for (var o = 0; o < i.length; )
              ((n = i[o]),
                2 === t.stopped || (a && n != a && !n.canRecognizeWith(a))
                  ? n.reset()
                  : n.recognize(e),
        ...
        ((void 0 !== e ? e : 'undefined' != typeof self ? self : {}).NGHammer = Ae),
        'function' == typeof define && define.amdDISABLED
          ? define(function () {
              return Ae;
            })
  ...
  function () {
    ...
    ((e = function () {
      ...
      for (e = document.querySelectorAll('[data-nanogallery2-lightbox]'), t = 0; t < e.length; t++)
        (e[t].classList.add('NGY2ThumbnailLightbox'),
          e[t].addEventListener('click', function (e) {
            e.preventDefault();
            for (
              var t = { lightboxStandalone: !0, viewerToolbar: { display: !1 } },
                n = this.dataset.nanogallery2Lgroup,
                i = document.querySelectorAll('[data-nanogallery2-lightbox]'),
                a = 0;
              a < i.length;
              a++
            )
              if (
                i[a].dataset.nanogallery2Lgroup == n &&
                '' !== i[a].dataset.nanogallery2Lightbox
              ) {
  ...
  (function (e) {
    'use strict';
    'function' == typeof define && define.amd
      ? define(['jquery', 'nanogallery2'], e)
      : 'object' == typeof exports && 'function' == typeof require
        ? e(require(['jquery', 'nanogallery2']))
        : e(jQuery);
  })(function (e) {
    jQuery.nanogallery2.data_nano_photos_provider2 = function (e, t) {
        ...
        i = function (t, i, s, c) {
          ...
          try {
            ...
            (n.O.debugMode && console.log('nanoPhotosProvider2 URL: ' + d),
              jQuery
                .getJSON(d, function (e, a, d) {
                  (clearTimeout(m),
                    r(!1),
                    o(h, e),
                    'ok' == e.nano_status
                      ? (u(t), null != i && i(s, c, null))
                      : l(
                          n,
                          'Could not retrieve nanoPhotosProvider2 data. Error: ' +
                            e.nano_status +
                            ' - ' +
                            e.nano_message
                        ));
      ...
      function o(e, t) {
        ...
        (jQuery.each(t.album_content, function (e, i) {
          var o = n.O.dataProvider.substring(
              0,
              n.O.dataProvider.indexOf('nano_photos_provider2.php')
            ),
            r = o + a(i.src),
            l = i.title,
          ...
          if (
            ('album' == c &&
              (s(l, h) || (d = !0), ('' == n.O.album && '' == n.O.photoset) || (d = !0)),
            'image' == c || !d)
          ) {
            var m = 0;
            ...
            (g.setMediaURL(r, 'img'),
              ...
              'album' == c
                ? (g.numberItems = i.cnt)
                : ((g.imageWidth = i.imgWidth), (g.imageHeight = i.imgHeight)),
              '' != i.originalURL && (g.downloadURL = o + a(i.originalURL)));
            for (
              var f = n.GOM.curNavLevel, b = ['xs', 'sm', 'me', 'la', 'xl'], v = 0;
              v < b.length;
              v++
            )
            ...
            null !== O &&
              ('function' == typeof O
                ? O(g, n.O.dataProvider, t)
                : window[O](g, n.O.dataProvider, t));
          }
        }),
          ...
          try {
            ...
            jQuery
              ...
              .fail(function (e, t, i) {
                ...
                l(
                  n,
                  'Could not retrieve Google data. Error: ' +
                    (t + ', ' + i + ' ' + a + '<br><br>URL:' + s)
                );
              });
          } catch (e) {
        ...
        (jQuery.each(i, function (e, i) {
          if ('object' == typeof i && null !== i) {
            var r = '',
              l = '';
            ('image' == t
              ? (void 0 !== i.description && (r = i.description),
                '' != n.O.thumbnailLabel.get('title') && (l = u(i.filename)))
              : (l = i.title),
              null == l && (l = ''));
            var h = i.id;
            ...
            ('image' == t
              ? ((g = i.baseUrl),
                n.O.viewerZoom || null == n.O.viewerZoom
                  ? (g += '=h' + i.mediaMetadata.height + '-w' + i.mediaMetadata.width)
                  : window.screen.width > window.screen.height
                    ? (g += '=w' + window.screen.width)
                    : (g = s + '=h' + window.screen.height),
                d.setMediaURL(g, 'img'),
                void 0 !== i.mediaMetadata.width &&
                  ((d.imageWidth = parseInt(i.mediaMetadata.width)), (m = d.imageWidth)),
                void 0 !== i.mediaMetadata.height &&
                  ((d.imageHeight = parseInt(i.mediaMetadata.height)), (p = d.imageHeight)),
                void 0 !== i.mediaMetadata.photo &&
                  (null != i.mediaMetadata.photo.exposureTime &&
                    (d.exif.exposure = i.mediaMetadata.photo.exposureTime),
                  null != i.mediaMetadata.photo.focalLength &&
                    (d.exif.focallength = i.mediaMetadata.photo.focalLength),
                  null != i.mediaMetadata.photo.apertureFNumber &&
                    (d.exif.fstop = i.mediaMetadata.photo.apertureFNumber),
                  null != i.mediaMetadata.photo.isoEquivalent &&
                    (d.exif.iso = i.mediaMetadata.photo.isoEquivalent),
                  null != i.mediaMetadata.photo.cameraModel &&
                    (d.exif.model = i.mediaMetadata.photo.cameraModel)),
                void 0 !== i.mediaMetadata.video &&
                  (null != i.mediaMetadata.video.cameraModel &&
                    (d.exif.model = i.mediaMetadata.video.cameraModel),
                  (d.downloadURL = i.baseUrl + '=dv')))
              : (d.numberItems = i.mediaItemsCount),
              (d.thumbs = o('l1', d.thumbs, i, t, p, m)),
              (d.thumbs = o('lN', d.thumbs, i, t, p, m)));
            var f = n.O.fnProcessData;
            null !== f &&
              ('function' == typeof f ? f(d, 'google2', i) : window[f](d, 'google2', i));
          }
        }),
          (n.I[e].contentIsLoaded = !0));
      }
        ...
        for (var l = ['xs', 'sm', 'me', 'la', 'xl'], s = 0; s < l.length; s++) {
          ...
          if ('album' == a) {
            ...
            t.url[e][l[s]] =
              i.coverPhotoBaseUrl +
              '=h' +
              n.tn.settings.getH(e, l[s]) +
              '-w' +
              n.tn.settings.getW(e, l[s]);
          }
        }
        return t;
      }
  ...
  (function (e) {
    ...
    jQuery.nanogallery2.data_flickr = function (e, t) {
      var n = e,
        ...
        a = function (e, t, a, l) {
          ...
          var s = NGY2Item.GetIdx(n, e),
            d = '',
            m = 'image';
          ('NONE' == n.O.photoset.toUpperCase() || 'NONE' == n.O.album.toUpperCase()
            ? (d =
                i.url() +
                '?&method=flickr.people.getPublicPhotos&api_key=' +
                n.O.flickrAPIKey +
                '&user_id=' +
                n.O.userID +
                '&extras=description,views,tags,url_o,url_sq,url_t,url_q,url_s,url_m,url_z,url_b,url_h,url_k&per_page=500&format=json')
            : 0 == n.I[s].GetID()
              ? ((d =
                  i.url() +
                  ...
                  '&user_id=' +
                  n.O.userID +
                  '&per_page=500&primary_photo_extras=tags,url_o,url_sq,url_t,url_q,url_s,url_m,url_l,url_z,url_b,url_h,url_k&format=json'),
                (m = 'album'))
              : (d =
                  i.url() +
                  ...
                  '&photoset_id=' +
                  n.I[s].GetID() +
                  '&extras=description,views,tags,url_o,url_sq,url_t,url_q,url_s,url_m,url_l,url_z,url_b,url_h,url_k&format=json'),
          ...
          var g = setTimeout(function () {
            ...
            b = function (i, d) {
              jQuery
                .getJSON(i + '&page=' + d + '&jsoncallback=?', function (v, O, y) {
                  var G = 0;
                  if ('album' == m) {
                    if (void 0 !== v.stat && 'fail' === v.stat)
                      return (
                        h(
                          n,
                          'Could not retrieve Flickr album list: ' +
                            v.message +
                            ' (code: ' +
                            v.code +
                            ').'
                    ...
                    'NONE' == n.O.photoset.toUpperCase() ||
                    'NONE' == n.O.album.toUpperCase()
                  )
                    ((f = f.concat(v.photos.photo)), (G = v.photos.pages));
                  else {
                    if (void 0 !== v.stat && 'fail' === v.stat)
                      return (
                        h(
                          n,
                          'Could not retrieve Flickr album: ' +
                            v.message +
                            ' (code: ' +
                            v.code +
                            ').'
      ...
      function o(e, t, a) {
        (n.O.debugMode && (console.log('Flickr parse photos:'), console.dir(a)),
          jQuery.each(a, function (e, a) {
            ...
            var p = {};
            for (var g in a)
              (0 != g.indexOf('height_') && 0 != g.indexOf('width_') && 0 != g.indexOf('url_')) ||
                (p[g] = a[g]);
      ...
      function r(e, t, i) {
        (n.O.debugMode && (console.log('Flickr parse list of albums:'), console.dir(i)),
          jQuery.each(i, function (e, i) {
            ...
            if (m(a, i.id)) {
              ...
              var c = '';
              void 0 !== i.primary_photo_extras &&
                void 0 !== i.primary_photo_extras.tags &&
                (c = i.primary_photo_extras.tags);
              ...
              null !== p &&
                ('function' == typeof p ? p(h, 'flickr', i) : window[p](h, 'flickr', i));
            }
          }),
          (n.I[e].contentIsLoaded = !0));
      }
        ...
        for (var o = ['xs', 'sm', 'me', 'la', 'xl'], r = 0; r < o.length; r++)
          if ('auto' == n.tn.settings.width[i][o[r]] || '' == n.tn.settings.width[i][o[r]]) {
            let l = s(
              'height_',
              Math.ceil(
                n.tn.settings.height[i][o[r]] *
                  n.tn.scale *
                  a *
                  n.tn.settings.mosaic[i + 'Factor'].h[o[r]]
              ),
              t
            );
            ((e.url[i][o[r]] = l.url),
            ...
            'auto' == n.tn.settings.height[i][o[r]] ||
            '' == n.tn.settings.height[i][o[r]]
          ) {
            let l = s(
              'width_',
              Math.ceil(
                n.tn.settings.width[i][o[r]] *
                  n.tn.scale *
                  a *
                  n.tn.settings.mosaic[i + 'Factor'].w[o[r]]
              ),
              t
            );
            ((e.url[i][o[r]] = l.url),
            ...
            n.tn.settings.width[i][o[r]] > n.tn.settings.height[i][o[r]] &&
              ((l = 'width_'),
              (u = Math.ceil(
                n.tn.settings.width[i][o[r]] *
                  n.tn.scale *
      ...
      function s(e, t, n) {
        for (
          var a = { url: '', width: 0, height: 0 }, o = 0, r = 0;
          r < i.thumbAvailableSizes.length;
          r++
        ) {
