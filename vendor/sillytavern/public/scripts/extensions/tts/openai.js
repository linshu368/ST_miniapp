...
class OpenAITtsProvider {
  static voices = [
    ...
    },
    {
      ...
      voice_id: 'ash',
      lang: 'en-US',
      preview_url: 'https://cdn.openai.com/API/docs/audio/ash.wav',
    },
    {
      name: 'Coral',
      voice_id: 'coral',
      lang: 'en-US',
      preview_url: 'https://cdn.openai.com/API/docs/audio/coral.wav',
    },
    {
      name: 'Echo',
      voice_id: 'echo',
    ...
    },
    {
      ...
      voice_id: 'sage',
      lang: 'en-US',
      preview_url: 'https://cdn.openai.com/API/docs/audio/sage.wav',
    },
    {
      name: 'Shimmer',
      voice_id: 'shimmer',
  ...
  populateCharacterInstructions() {
    const currentCharacters = $('.tts_voicemap_block_char span')
      .map((i, el) => $(el).text())
      .get();
