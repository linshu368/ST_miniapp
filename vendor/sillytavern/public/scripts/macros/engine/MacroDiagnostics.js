...
export const onboardingExperimentalMacroEngineMutex = new SimpleMutex(
  onboardingExperimentalMacroEngineUnsafe
);
 ...
 */
export const onboardingExperimentalMacroEngine = onboardingExperimentalMacroEngineMutex.update.bind(
  onboardingExperimentalMacroEngineMutex
);
...
async function onboardingExperimentalMacroEngineUnsafe(feature = null) {
  ...
  if (result == POPUP_RESULT.AFFIRMATIVE) {
    ...
    $('#experimental_macro_engine')
      .prop('checked', power_user.experimental_macro_engine)
      .trigger('input');
  }
