...
async function showSamplerSelectPopup() {
  ...
  html.attr('id', 'sampler_view_list').addClass('flex-container flexFlowColumn');
  ...
  if (main_api === 'textgenerationwebui') {
    ...
    $('#prioritizeManuallySelectedSamplers').toggleClass(
      'toggleEnabled',
      isSamplerManualPriorityEnabled()
    );
    $('#prioritizeManuallySelectedSamplers')
      .off('click')
      .on('click', function () {
