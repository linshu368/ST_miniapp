...
async function* parseStreamData(json) {
  if (
    ...
    for (let i = 0; i < json.candidates.length; i++) {
      ...
      if (
        typeof json.candidates[0].content === 'object' &&
        Array.isArray(json.candidates[i].content.parts)
      ) {
    ...
    if (typeof json.choices[0].text === 'string' && json.choices[0].text.length > 0) {
      ...
      typeof json.choices[0].thinking === 'string' &&
      json.choices[0].thinking.length > 0
    ) {
      ...
      if (typeof json.choices[0].delta.text === 'string' && json.choices[0].delta.text.length > 0) {
        ...
        typeof json.choices[0].delta.reasoning_content === 'string' &&
        json.choices[0].delta.reasoning_content.length > 0
      ) {
        ...
        typeof json.choices[0].delta.reasoning === 'string' &&
        json.choices[0].delta.reasoning.length > 0
      ) {
        ...
        json.choices[0].delta.content.length > 0
      ) {
        ...
        if (
          Array.isArray(json.choices[0].delta.content[0].thinking) &&
          json.choices[0].delta.content[0].thinking.length > 0
        ) {
          if (
            typeof json.choices[0].delta.content[0].thinking[0].text === 'string' &&
            json.choices[0].delta.content[0].thinking[0].text.length > 0
          ) {
